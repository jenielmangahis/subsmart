...
<section class="about-section-b">
  <div class="container spacing-ft">
      <div class="row">
          <div class="col-sm-3 text-center">
            <span class="material-icons mdc-bottom-navigation__list-item__icon show-less icon-about">remove_red_eye</span>
            <span class="about-icon-txt">Focus</span>
            <hr class="about-hr"/>
            <span class="about-icon-description">We have a 100% commitment to making all our sites the best they can possibly be, no matter what it takes to get there.</span>
          </div>
          <div class="col-sm-3 text-center">
            <span class="material-icons mdc-bottom-navigation__list-item__icon show-less icon-about">favorite</span>
            <span class="about-icon-txt">Passion</span>
            <hr class="about-hr"/>
            <span class="about-icon-description">Our desire to produce good work runs deep - that's what lets us handle every project with fresh energy and enthusiasm.</span>
          </div>
          <div class="col-sm-3 text-center">
            <span class="material-icons mdc-bottom-navigation__list-item__icon show-less icon-about">sync_alt</span>
            <span class="about-icon-txt">Empathy</span>
            <hr class="about-hr"/>
            <span class="about-icon-description">While we share our knowledge and experience, we listen hard to understand your business and your needs.</span>
          </div>
          <div class="col-sm-3 text-center">
...
<section class="about-section-f">
    <div class="container spacing-ft">
        <div class="row">
          ...
          <div class="btn-learn-about">
            <a href="<?php echo url('registration') ?>" class="about-btn">Learn More</a>
          </div>
        </div>
    </div>
</section>
