...
<table>
    <tr style="text-align:center ; " >
        ...
        <td style="background-color:#5cb85c;font-size:10px; padding:10px 20px; border-radius:25px;line-height: 30px;text-align:center; width:100px; font-weight: bold"> 
            <a style="color:#fff; background-color:#5cb85c; text-decoration: none">Email</a>
        </td>
    </tr>
</table>