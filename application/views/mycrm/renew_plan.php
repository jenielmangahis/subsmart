...
<div class="pl-3 pr-3 mt-1 row">
    <div class="col mb-4 left alert alert-warning mt-0 mb-2">
        <span style="color:black;font-family: 'Open Sans',sans-serif !important;font-weight:300 !important;font-size: 14px;">Renew your plan subscription</span>
    </div>
</div>
    ...
    <div class="row">
        ...
        <div class="col-md-5">
            <div class="plan">                
                ...
                <p class="margin-bottom" style="font-size: 16px;">These are your current account options</p>
                ...
                <div class="row" style="font-size: 16px;">
                    ...
                    <div class="col-sm-12 col-md-12">
                        <div class="plan-option-box" style="text-align: center;">   
                            <span style="color:#f43d34;font-size: 14px;">Expired on <?= date("d-M-Y", strtotime($client->plan_date_expiration)); ?></span>
                        </div>
                    </div>
                </div>
            </div>
...
<div class="card" style="width: 56%; font-size: 17px;">
    <h4>Availed Add-ons</h4>
