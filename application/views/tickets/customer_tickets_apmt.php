        ...
        <div class="nsm-page">
            <div class="nsm-page-content">
                ...
                <?php 
                    ...
                    $appointment_time_to        = $_GET['appointment_time_to'];
                    // address 
                ...
                <div class="row">
                    <div class="col-md-4">
                        ...
                        <input type="text" class="form-control" name="service_location" id="service_location"
                                ...
                                onChange="jQuery('#customer_name').text(jQuery(this).val());" value="<?php echo $customer_address ?>" />
                    </div>
                    <div class="col-md-2">
                        <label for="job_location"><b>City</b></label>
                        <input type="text" class="form-control" name="customer_city" id="customer_city"
                                required placeholder="Enter address" 
                                onChange="jQuery('#customer_name').text(jQuery(this).val());" value="<?php echo $customer_city ?>" />
                    </div>
                </div>
                <div class="row">
                    <div class="col-md-2">
                        ...
                        <input type="text" class="form-control" name="customer_state" id="customer_state"
                                required placeholder="Enter address" 
                                onChange="jQuery('#customer_name').text(jQuery(this).val());" value="<?php echo $customer_state ?>" />
                    </div>
                    <div class="col-md-2">
                        <label for="job_location"><b>Zip Code</b></label>
                        <input type="text" class="form-control" name="customer_zip" id="customer_zip"
                                required placeholder="Enter address" 
                                onChange="jQuery('#customer_name').text(jQuery(this).val());" value="<?php echo $customer_zip ?>" />
                    </div>
                    <div class="col-md-2" style="display: ;">
                        <label for="job_location"><b>Customer Phone #</b></label>
                        <input type="text" class="form-control" name="customer_phone" id="customer_phone" required placeholder="Enter address"  value="<?php echo $customer_phone ?>" />
                    </div>
                </div>
                <div class="row">
                    <div class="col-md-6">
                                ...
                                <div class="row">
                                    <div class="col-md-3">
                                        ...
                                        <input type="text" class="form-control" name="ticket_no" id="ticket_no"
                                                required placeholder="Enter Ticket#" value="<?= $prefix . $next_num; ?>" />
                                    </div>
                                    <div class="col-md-3">
                                        ...
                                        <div class="input-group date" data-provide="datepicker">
                                            <input type="text" class="form-control" name="ticket_date" id="ticket_date"
                                                    placeholder="Enter Ticket Date" value="<?php $dateScheduled = date('m/d/Y', strtotime($appointment_date)); echo $dateScheduled; ?>" required>
