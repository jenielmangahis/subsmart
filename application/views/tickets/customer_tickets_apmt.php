                            ...
                            <div class="nsm-card-content">
                                <div class="row">
                                    ...
                                    <div class="col-md-3">
                                        ...
                                        <input type="time" class="form-control" name="scheduled_time_to" id="scheduled_time_to" value="<?php $time = date("H:i", strtotime($appointment_time_to)); echo $time; ?>" required />
                                    </div>
                                </div>
                                <div class="row">
                                    <div class="col-md-3">
