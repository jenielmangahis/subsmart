...
<body style="font-family: Gill Sans, sans-serif; font-size: 11px;" >
    <div style="box-shadow:0 2px 8px 0 rgba(0,0,0,.2);background-color: #fff;border: 1px solid #d4d7dc;-webkit-transition: all .3s ease;position:relative;top:20px;width: 95%;margin: 0 auto; padding:1%;">
        <div style="float:left;">
            <img src="<?= getCompanyBusinessProfileImage(); ?>" class="company-logo2" style="width:100px;"/>
        </div>  
        ...
        <div>
            <table style="width:100%;">
                <tr>
                    <td style="border:solid gray 1px;text-align:center;padding:3px;">
                        <div>
        ...
        <div>
            ...
            <span><?php echo $service_location; ?></span> <br>
                ...
                <table style="width:100%;">
                    <tr>
                        <td style="border:solid gray 1px;text-align:center;padding:3px;"><b>Job Tag </b> <br> <?php echo $job_tag ? $job_tag : '-'; ?></td>
                        <td style="border:solid gray 1px;text-align:center;padding:3px;"><b>Panel Type </b> <br> <?php echo $panel_type ? $panel_type : '-'; ?></td>
                        <td style="border:solid gray 1px;text-align:center;padding:3px;"><b>Service Type </b> <br> <?php echo $service_type ? $service_type : '-'; ?></td>
                        <td style="border:solid gray 1px;text-align:center;padding:3px;"><b>Warranty Type</b> <br> <?php echo $warranty_type ? $warranty_type : '-'; ?></td>
                    </tr>
                </table>
