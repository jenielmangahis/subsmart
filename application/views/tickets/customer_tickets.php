                ...
                <div class="row">
                    <div class="col-md-4">
                        ...
                        <input type="text" class="form-control" name="service_location" id="service_location"
                                required placeholder="Enter address" value="<?php echo $custIndividual->mail_add; ?>"
                    ...
                    <div class="col-md-2">
                        ...
                        <input type="text" class="form-control" name="customer_city" id="customer_city"
                                required placeholder="Enter address"  value="<?php echo $custIndividual->city; ?>"
                                onChange="jQuery('#customer_name').text(jQuery(this).val());"/>
                    </div>
                </div>
                <div class="row">
                    <div class="col-md-2">
                        ...
                        <input type="text" class="form-control" name="customer_state" id="customer_state"
                                required placeholder="Enter address"  value="<?php echo $custIndividual->state; ?>"
                                onChange="jQuery('#customer_name').text(jQuery(this).val());"/>
                    </div>
                    <div class="col-md-2">
                        <label for="job_location"><b>Zip Code</b></label>
                        <input type="text" class="form-control" name="customer_zip" id="customer_zip"
                                required placeholder="Enter address"  value="<?php echo $custIndividual->zip_code; ?>"
                                onChange="jQuery('#customer_name').text(jQuery(this).val());"/>
                    </div>
                                    ...
                                    <div class="col-md-3 form-group">
                                        ...
                                        <div class="input-group">
                                            ...
                                            <!-- <span class="input-group-btn">
                                                <a href="#" class="btn btn-primary" data-toggle="modal" data-target="#addServiceType">Add New</a>
                                            </span> -->
                                        </div><!-- /input-group -->
                                    </div>
                                    <div class="col-md-3 form-group">
