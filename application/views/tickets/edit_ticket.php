                                        ...
                                        <table class="table table-hover">
                                            ...
                                            <tbody id="jobs_items_table_body">
                                                ...
                                                <tr style="display:;">
                                                    ...
                                                    <td width="10%" class="hidden_mobile_view"><input type="hidden" class="form-control " name="total[]" data-counter="<?php echo $i; ?>" id="item_total_<?php echo $i; ?>" min="0"  value="<?php echo number_format($itemL->total,2); ?>">$<span id="span_total_<?php echo $i; ?>"><?php echo $itemL->total; ?></span></td>
