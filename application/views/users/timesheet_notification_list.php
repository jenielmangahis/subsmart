                            ...
                            <?php if ($this->session->userdata('logged')['role'] < 5) : ?>
                                ...
                                <div class="row">
                                    <div class="col-lg-12 table-responsive">
                                        <table id="ts-notification" class="table table-hover table-to-list" style="display:none;">
                                            <thead>
                                                <tr>
                                                    <th>ID</th>
                                                    <th>Employee Name</th>
                                                    ...
                                                    <th><input type="checkbox" id="checkAl"> Select All
                                                        <button class="btn btn-primary btn-md" id="btn_delete"><i class="fa fa-trash"></i></button>
                                                    </th>
                                            ...
                                            <tbody id="notifytd">
                                                ...
                                                ?>
                                                    <tr id="<?php echo $notify->id; ?>">
                                                        ...
                                                        <td class="tbl-status">
                                                            <center>
                                                                <a href="<?php echo site_url(); ?>timesheet/notification" id="notificationDP" data-id="<?php echo $notify->id; ?>" title="" data-toggle="tooltip" data-original-title="Notification Not Viewed ">
                                                                    <i class="fa fa-eye-slash" aria-hidden="true"></i>
                                                                </a>
                                                            </center>
                                                        </td>
                                                        <td>
                                                            <center><input type="checkbox" id="checkItem" name="check[]" value="<?php echo $notify->id; ?>">
                                                            </center>
                                                        </td>
