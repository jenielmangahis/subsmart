                                            ...
                                            <?php foreach ($users as $cnt => $user) : ?>
                                                ...
                                                <tr>
                                                    ...
                                                    <td class="tbl-emp-action">
                                                        <a href="javascript:void(0)" class="employee-break" id="<?php echo $break_id ?>" <?php echo $break; ?> data-id="<?php echo $user->id ?>" data-name="<?php echo $user->FName; ?> <?php echo $user->LName; ?>" data-approved="<?php echo logged("id"); ?>"><i class="fa fa-coffee fa-lg"></i></a>
                                                        <a href="javascript:void(0)" class="employee-in-out" <?php echo $disabled ?> id="<?php echo $btn_action; ?>" data-week="<?php echo $week_id ?>" data-attn="<?php echo $attn_id; ?>" data-name="<?php echo $user->FName; ?> <?php echo $user->LName; ?>" data-id="<?php echo $user->id; ?>" data-approved="<?php echo logged("id"); ?>"><i class="fa fa-user-clock fa-lg"></i></a>
