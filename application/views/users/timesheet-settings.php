                        ...
                        <div class="card-body">
                            ...
                            <div class="row" style="padding: 10px 33px 20px 33px;">
                                <div class="col-md-12 banking-tab-container">
                                    ...
                                    <a href="<?php echo url('/timesheet/settings') ?>" class="banking-tab<?php echo ($this->uri->segment(1) == "settings") ?: '-active'; ?>">PTO</a>
                                </div>
                            </div>

                            <center>
                                <h3 class="mt-0 header-title">Leave Requests</h3>
                            </center>
                            <!-- Date Selector -->
                            <div class="row">
                                <div class="col-lg-12">
