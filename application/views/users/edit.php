                        ...
                        <div class="card-body">
                            ...
                            <div class="row">
                                ...
                                <div class="col-md-4 form-group">
                                    ...
                                    <input type="text" class="form-control" name="phone" id="formClient-Contact"
                                           placeholder="Enter Contact Number" value="<?php echo $User->phone ?>"/>
                                </div>
                            </div>
                            <!-- end row -->
                            <div class="row">
                            ...
                            <div class="row">
                                <div class="col-md-4 form-group">
                                    ...
                                    <select name="status" id="formClient-Status"
                                            class="form-control" <?php echo logged('id') == $User->id ? 'disabled' : '' ?>>
