                        ...
                        <div class="row pl-0 pr-0">
                            <div class="col-md-12 pl-0 pr-0">
                                <div class="col-md-12 pr-3" style="padding-left: 15px;">
                                    <h3 class="page-title mt-0">Add New Vendor</h3>
                                    ...
                                    <div class="row">
                                        <div class="col-6">
                                            ...
                                            <div class="form-group">
                                                ...
                                                <input type="text" class="form-control" value="" name="vendor_email" id="vendor-email" required/>
                                            </div>
                                            <div class="form-group">
            ...
            setTimeout(function () {
                $.ajax({
                    ...
                    success: function(data) {
                        ...
                        Swal.fire({
                          title: 'Great!',
                          text: 'Vendor was successfully created.',
                          icon: 'success',
