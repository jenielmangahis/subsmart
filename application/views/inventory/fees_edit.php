            ...
            <div class="box">
                ...
                <div class="col-xl-12">
                    <div class="card">
                        <div class="row pl-0 pr-0">
                            <div class="col-md-12 pl-0 pr-0">
                                <div class="col-md-12 pr-3" style="padding-left: 15px;">
                                    <h3 class="page-title mt-0">Edit Fee</h3>
                                    <div class="pl-3 pr-3 mt-1 row">
                                        <div class="col mb-4 left alert alert-warning mt-0 mb-2">
                                          <span style="color:black;font-family: 'Open Sans',sans-serif !important;font-weight:300 !important;font-size: 14px;">
                                              Edit your inventory fee.
                                          </span>
                                        </div>
                                    </div>
                                </div>
                        ...
                        <div class="row">
                            <div class="col-md-12">
                                <?php echo form_open_multipart('inventory/fees/update', [ 'class' => 'form-validate', 'autocomplete' => 'off' ]); ?>
                                    <input type="hidden" name="fid" value="<?php echo $item->id; ?>">
                                    <div class="form-group">
                                        <label>Name</label> <span class="form-required">*</span>
                                        <input type="text" class="form-control" value="<?php echo $item->title; ?>" name="title" id="title" required/>
                                    </div>
                                    <div class="form-group">
                                        <label>Description</label> <span class="form-required">*</span>
                                        <input type="text" class="form-control" value="<?php echo $item->description; ?>" name="description" id="description"/>
                                    </div>
                                    <div class="form-group">
                                        <label>Price</label> <span class="form-required">*</span>
                                        <input type="number" step="any" class="form-control" value="<?php echo $item->price; ?>" name="price" id="price" required/>
                                    </div>
                                    <div class="form-group">
