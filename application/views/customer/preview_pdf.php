                        ...
                        <div class="row ">
                            <div class="col-md-12">
                                <div style="margin-top: 1px;">
                                    ...
                                    <a style="position:absolute; right: 10px;text-align: right;margin-top: -5px;" class="btn btn-primary btn-md" href="<?php echo url('customer/add_lead') ?>"><span class="fa fa-print"></span> Print</a>
                                </div>
                            </div>
                        </div>
                    </div>
