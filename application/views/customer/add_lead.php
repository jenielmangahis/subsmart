                                ...
                                <div class="col-md-12">
                                    <div class="row">
                                                ...
                                                <div class="row">
                                                    ...
                                                    <div class="col-md-12">
                                                        <div class="form-group" id="customer_type_group">
                                                            ...
                                                            <select id="fk_lead_id" name="fk_lead_id" data-customer-source="dropdown" class="form-control">
                                                    ...
                                                    <div class="col-md-12">
                                                        <div class="form-group" id="customer_type_group">
                                                            ...
                                                            <select id="fk_sr_id" name="fk_sr_id" data-customer-source="dropdown" class="form-control searchable-dropdown">
                                                                <option value="">Select</option>
                                                    ...
                                                    <div class="col-md-12">
                                                        <div class="row">
                                                            <div class="col-md-12">
                                                                <div class="form-group" id="customer_type_group">
                                                                    <label for=""></label><br/>
                                                                    <select id="credit_report" name="credit_report" data-customer-source="dropdown" class="form-control searchable-dropdown" placeholder="Select">
                                                ...
                                                <div class="row">
                                                    ...
                                                    <div class="col-md-12">
                                                        <div class="form-group" id="customer_type_group">
                                                            ...
                                                            <div class="row">
                                                                <div class="col-md-3">
                                                                    <input type="text" class="form-control" name="phone_home[]" id="phone_home" required/>
                                                                </div>-
                                                                <div class="col-md-3">
                                                                    <input type="text" class="form-control" name="phone_home[]" id="phone_home" required/>
                                                                </div>-
                                                    ...
                                                    <div class="col-md-12">
                                                        <div class="form-group" id="customer_type_group">
                                                            ...
                                                            <div class="row">
                                                                <div class="col-md-3">
                                                                    <input type="text" class="form-control" name="phone_cell[]" id="phone_cell" required/>
                                                                </div>-
                                                                <div class="col-md-3">
                                                                    <input type="text" class="form-control" name="phone_cell[]" id="phone_cell" required/>
                                                                </div>-
                                                    ...
                                                    <div class="col-md-12">
                                                        <div class="form-group" id="customer_type_group">
                                                            ...
                                                            <div class="row">
                                                                <div class="col-md-3">
                                                                    <input type="text" class="form-control" name="sss_num[]" id="sss_num" required/>
                                                                </div>-
                                                                <div class="col-md-3">
                                                                    <input type="text" class="form-control" name="sss_num[]" id="sss_num" required/>
                                                                </div>-
                                                    ...
                                                    <div class="col-md-12">
                                                        <div class="row">
                                                            <div class="col-md-12">
                                                                <div class="form-group" id="customer_type_group">
                                                                    <label for=""></label><br/>
                                                                    <input value="No History" type="text" class="form-control" name="report_history" id="report_history"/>
                                                                </div>
                                                            </div>
                                                            <div class="col-md-12"><br>
                                                                <div class="form-group" id="customer_type_group">
                                        ...
                                        <div class="form-group pull-right" style="margin-right: 5px;">
                                            <a href="<?php echo base_url('customer/leads'); ?>"><button type="button" class="btn btn-flat btn-primary">Cancel</button></a>
                                        </div>
                                </div>
                            </form>
                        </div>
