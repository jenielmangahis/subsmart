                                ...
                                <div class="nsm-card-body">
                                    <div class="row">
                                        <div class="col-md-4 mb-3">
                                            <span>Firstname</span>
                                            <input class="form-control" type="text" name="firstname" id="firstname" value="<?php if (isset($leads_data)) {
                                                                                                                                echo $leads_data->firstname;
                                                                                                                            } ?>" required>
                                        </div>
                                        <div class="col-md-2 mb-3">
                                            <span>Middlename</span>
                                            <input class="form-control" type="text" name="middlename" id="middlename" value="<?php if (isset($leads_data)) {
                                                                                                                                    echo $leads_data->middle_name;
                                                                                                                                } ?>">
                                        </div>
                                        <div class="col-md-4 mb-3">
                                            <span>Lastname</span>
                                            <input class="form-control" type="text" name="lastname" id="lastname" value="<?php if (isset($leads_data)) {
                                                                                                                                echo $leads_data->lastname;
                                                                                                                            } ?>" required>
                                        </div>
                                        <div class="col-md-2 mb-3">
                                            <span>Suffix</span>
                                        ...
                                        <div class="col-md-3 mb-3">
                                            <span>Birthdate</span>
                                            <input class="form-control" type="date" name="date_of_birth" id="date_of_birt" value="<?php if (isset($leads_data)) {
                                                                                                                                        echo $leads_data->date_of_birth;
                                                                                                                                    } ?>">
                                        </div>
                                        <div class="col-md-3 mb-3">
                                            <span>Email Address</span>
                                            <input class="form-control" type="email" name="email_add" id="email_add" value="<?php if (isset($leads_data)) {
                                                                                                                                echo $leads_data->email_add;
                                                                                                                            } ?>">
                                        </div>
                                        <div class="col-md-3 mb-3">
                                            <span>Mobile Number</span>
                                            <input class="form-control phone_number" type="text" maxlength="12" placeholder="xxx-xxx-xxxx" name="phone_cell" id="phone_cell" value="<?php if (isset($leads_data)) {
                                                                                                                                                                                        echo $leads_data->phone_cell;
                                                                                                                                                                                    } ?>" required>
                                        </div>
                                        <div class="col-md-3 mb-3">
                                            <span>Home Phone Number</span>
                                            <input class="form-control phone_number" type="text" name="phone_home" id="phone_home" maxlength="12" placeholder="xxx-xxx-xxxx" value="<?php if (isset($leads_data)) {
                                                                                                                                                                                        echo $leads_data->phone_home;
                                                                                                                                                                                    } ?>">
                                        </div>

                                        <div class="col-md-6 mb-3">
                                            <span>Address</span>
                                            <input class="form-control" type="text" name="address" id="customer_address" value="<?php if (isset($leads_data)) {
                                                                                                                                    echo $leads_data->address;
                                                                                                                                } ?>" required>
                                        </div>
                                        <div class="col-md-6 mb-3">
                                            <span>Country</span>
                                            <input class="form-control" type="text" name="country" id="country" value="<?php if (isset($leads_data)) {
                                                                                                                            echo $leads_data->country;
                                                                                                                        } ?>" required>
                                        </div>
                                        <div class="col-md-3 mb-3">
                                            <span>State</span>
                                            <input class="form-control" type="text" name="state" id="state" value="<?php if (isset($leads_data)) {
                                                                                                                        echo $leads_data->state;
                                                                                                                    } ?>" required>
                                        </div>
                                        <div class="col-md-3 mb-3">
                                            <span>City</span>
                                            <input class="form-control" type="text" name="city" id="city" value="<?php if (isset($leads_data)) {
                                                                                                                        echo $leads_data->city;
                                                                                                                    } ?>" required>
                                        </div>
                                        <div class="col-md-3 mb-3">
                                            <span>County</span>
                                            <input class="form-control" type="text" name="county" id="county" value="<?php if (isset($leads_data)) {
                                                                                                                            echo $leads_data->county;
                                                                                                                        } ?>" required>
                                        </div>
                                        <div class="col-md-3 mb-3">
                                            <span>Zip</span>
                                            <input class="form-control" type="text" name="zip" id="zip" value="<?php if (isset($leads_data)) {
                                                                                                                    echo $leads_data->zip;
                                                                                                                } ?>" required>
                                        </div>
                                        <div class="col-md-3 mb-3">
                                        ...
                                        <div class="col-md-3 mb-3">
                                            ...
                                            <select class="form-select" id="status" name="status">
                                                <option <?php if (isset($leads_data)) {
                                                            if ($leads_data->status == 'New') {
                                                                echo "selected";
                                                            }
                                                        } ?> value="New">New</option>
                                                <option <?php if (isset($leads_data)) {
                                                            if ($leads_data->status == 'Contacted') {
                                                                echo "selected";
                                                            }
                                                        } ?> value="Contacted">Contacted</option>
                                                <option <?php if (isset($leads_data)) {
                                                            if ($leads_data->status == 'Follow Up') {
                                                                echo "selected";
                                                            }
                                                        } ?> value="Follow Up">Follow Up</option>
                                                <option <?php if (isset($leads_data)) {
                                                            if ($leads_data->status == 'Converted') {
                                                                echo "selected";
                                                            }
                                                        } ?> value="Converted">Converted</option>
                                                <option <?php if (isset($leads_data)) {
                                                            if ($leads_data->status == 'Closed') {
                                                                echo "selected";
                                                            }
