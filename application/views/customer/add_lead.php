                    ...
                    <div class="row">
                        <div class="col-6">
                            <div class="nsm-card">
                                <div class="nsm-card-content">
                                    <div class="col-md-12">
                                    <div class="text-ter margin-bottom-sec fw-bold">General Information</div>
                                    <div class="row">
                                        <div class="col-md-12">
                        ...
                        <div class="col-6">
                            <div class="nsm-card">
                                <div class="nsm-card-content">
                                    <div class="col-md-12">
                                        <div class="text-ter margin-bottom-sec fw-bold">Contact Information</div>
                                        <div class="row">
                                            <div class="col-md-3">
                    ...
                    <div class="row" style="margin-top: 20px;">
                        <div class="col-6">
                            <div class="nsm-card">
                                <div class="nsm-card-content">
                                    <div class="col-md-12">
                                        <div class="text-ter margin-bottom-sec fw-bold">New Credit Report</div>
                                        <div class="row">
                                            <div class="col-md-12">
                                        ...
                                        <div class="row">
                                            <div class="col-md-3">
                                                <button type="submit" class="nsm-button primary"><span class="fa fa-play"></span> Run Credit</button>
                                            </div>
                                        </div>
                                    </div>
                                </div>
                        ...
                        <div class="col-6">
                            <div class="nsm-card">
                                <div class="nsm-card-content">
                                    <div class="col-md-12">
                                        <div class="text-ter margin-bottom-sec fw-bold">Report History</div>
                                        <div class="row">
                                            <div class="col-md-12">
