                        ...
                        <div class="card-body">
                            <div class="row">
                                    ...
                                    <div class="form-group" id="customer_type_group">
                                        ...
                                        <div class="checkbox checkbox-sec margin-right my-0 mr-3">
                                            <input type="radio" name="customer_type" value="Residential"
                                                   id="customer_type" <?php echo (!empty($customer->customer_type) && $customer->customer_type == 'Residential') ? 'checked' : ''; ?>
                                        ...
                                        <div class="checkbox checkbox-sec margin-right mr-3">
                                            <input type="radio" name="customer_type" value="Commercial"
                                                   id="Commercial" <?php echo (!empty($customer->customer_type) && $customer->customer_type == 'Commercial') ? 'checked' : ''; ?>
                                                   onchange="toggle_advance_options()">
                                            <label for="Commercial"><span>Commercial</span></label>
                                        </div>
                                        <div class="checkbox checkbox-sec margin-right my-0">
                                            <input type="radio" name="customer_type" value="Advance"
                                                   id="advance" <?php echo (!empty($customer->customer_type) && $customer->customer_type == 'Advance') ? 'checked' : ''; ?>
                                                   onchange="toggle_advance_options()">
                                ...
                                <div class="col-md-6 form-group">
                                    ...
                                    <input type="text" class="form-control"
                                           value="<?php echo $customer->contact_name ?>" name="contact_name"
                                           id="contact_name" required placeholder="Enter Name" autofocus
                                           onChange="jQuery('#customer_name').text(jQuery(this).val());"/>
                                </div>
                                <div class="col-md-6 form-group">
                                    <label for="contact_email">Contact Email</label>
                                    <input type="email" class="form-control"
                                           value="<?php echo $customer->contact_email ?>" name="contact_email"
                                ...
                                <div class="col-md-6 form-group">
                                    ...
                                    <input type="text" class="form-control" value="<?php echo $customer->mobile ?>"
                                           name="contact_mobile" id="contact_mobile" placeholder="Enter Mobile"
                                           required/>
                                </div>
                                <div class="col-md-6 form-group">
                                    <label for="contact_phone">Phone</label>
                                    <input type="text" class="form-control" value="<?php echo $customer->phone ?>"
                                           name="contact_phone" id="contact_phone" placeholder="Enter Phone"/>
                                </div>
                            </div>
                                ...
                                <div class="col-auto form-group">
                                    ...
                                    <div class="checkbox checkbox-sec margin-right my-0 mr-3">
                                        <input type="checkbox" name="notify_by" value="Email" checked
                                               id="notify_by_email" <?php echo (!empty($customer->notification_method) && $customer->notification_method == 'Email') ? 'checked' : ''; ?>>
                                        <label for="notify_by_email"><span>Notify By Email</span></label>
                                    </div>
                                    <div class="checkbox checkbox-sec margin-right my-0 mr-3">
                                        <input type="checkbox" name="notify_by" value="SMS"
                                               id="notify_by_sms" <?php echo (!empty($customer->notification_method) && $customer->notification_method == 'SMS') ? 'checked' : ''; ?>>
                            ...
                            <div class="row">
                                <div class="col-md-12">
                                                    ...
                                                    <li class="customer-contact-list__item">
                                                        <div class="row">
                                                            ...
                                                            <div class="col-md-2 col-sm-4 text-right">
                                                                <a class="customer-contact-list__edit"
                                                                   data-toggle="modal"
                                                                   data-target="#modalAdditionalContacts"
                                                                   data-customer-id="<?php echo $customer->id ?>"
                                                                   data-id="<?php echo $key ?>"
                                                                   href="javascript:void(0)"><span
                                                                            class="fa fa-edit"></span> edit</a>
                                                                <a class="customer-contact-list__delete"
                                                                   data-customer-contact-delete-modal="open"
                                                                   data-customer-id="<?php echo $customer->id ?>"
                                                                   data-id="<?php echo $key ?>"
                                                                   href="javascript:void(0)"><span
                                    ...
                                    <a class="link-modal-open" data-customer-id="<?php echo $customer->id; ?>"
                                       data-id="-1" href="javascript:void(0)" data-toggle="modal"
                                       data-target="#modalAdditionalContacts"><span
                                                class="fa fa-plus-square fa-margin-right"></span> Add New Contact</a>
                                </div>
                            </div>
                            ...
                            <div class="row">
                                ...
                                <div class="col-md-6 form-group">
                                    ...
                                    <input type="text" class="form-control"
                                           value="<?php echo $customer->street_address ?>" name="street_address"
                                           id="street_address" required placeholder="Enter Name" autofocus
                                           onChange="jQuery('#customer_name').text(jQuery(this).val());"/>
                                </div>
                                <div class="col-md-6 form-group">
                                    <label for="suite_unit">Suite/Unit</label>
                                    <input type="text" class="form-control" value="<?php echo $customer->suite_unit ?>"
                                           name="suite_unit" id="suite_unit" required placeholder="Enter Name" autofocus
                                           onChange="jQuery('#customer_name').text(jQuery(this).val());"/>
                                </div>

                                <div class="col-md-4 form-group">
                                    <label for="city">City</label>
                                    <input type="text" class="form-control" value="<?php echo $customer->city ?>"
                                           name="city" id="city" required placeholder="Enter Name" autofocus
                                           onChange="jQuery('#customer_name').text(jQuery(this).val());"/>
                                </div>
                                <div class="col-md-4 form-group">
                                    <label for="zip">Zip/Postal Code</label>
                                    <input type="text" class="form-control" value="<?php echo $customer->postal_code ?>"
                                           name="zip" id="zip" required placeholder="Enter Name" autofocus
                                           onChange="jQuery('#customer_name').text(jQuery(this).val());"/>
                                </div>
                                <div class="col-md-4 form-group">
                                        ...
                                        <?php foreach (get_config_item('states') as $key => $state) { ?>
                                            <?php if ($customer->state == $key) { ?>
                                                <option value="<?php echo $key ?>"
                                                        selected><?php echo $state; ?></option>
                                            <?php } else { ?>
                        ...
                        <a class="customer-address-list__delete"
                            ...
                            <div class="row">
                                ...
                                <div class="col-md-5 form-group">
                                    ...
                                    <div class="input-group date" data-provide="datepicker">
                                        <input type="text" class="form-control" name="birthday" id="birthday"
                                               value="<?php echo date('m/d/Y', strtotime($customer->birthday)) ?>">
                                ...
                                <div class="col-md-7 form-group">
                                    ...
                                    <select id="customer_source" name="customer_source_id"
 ...
 <a class="link-modal-open" href="javascript:void(0)" data-toggle="modal" data-target="#modalAddNewGroup"><span class="fa fa-plus-square fa-margin-right"></span> Add Group</a>
                                            ...
                                            <?php foreach ($groups as $group) { ?>
                                                <div class="checkbox checkbox-sec margin-right">
                                                    <input type="checkbox" name="customer_group[]"
                                                           ...
                                                           id="customer_group_<?php echo $group->id ?>"
                                                    <?php echo ( (is_array($customer->customer_group)) && (array_search($group->id, $customer->customer_group) !== false)) ? "checked" : "" ?>>
                                                    <label for="customer_group_<?php echo $group->id ?>">
                                ...
                                <div class="col-md-12 form-group">
                                    ...
                                    <textarea name="notes" cols="40" rows="3" class="form-control"
                                              autocomplete="off"><?php echo $customer->comments ?></textarea>
                                </div>
                            </div>


                            <div class="row" id="advance_customer_view"
                                 style="display: <?php echo ((!empty($customer->customer_type) && $customer->customer_type !== 'Advance')) ? 'none' : 'block' ?>">
                                ...
                                <div class="row p-3">
                                    ...
                                    <div class="col-md-4 form-group">
                                        ...
                                        <input type="text"
                                               value="<?php echo (!empty($customer->additional_info)) ? $customer->additional_info['monitoring_id'] : '' ?>"
                                               class="form-control" name="additional[monitoring_id]" id="monitoring_id"
                                    ...
                                    <div class="col-md-4 form-group">
                                        ...
                                        <input type="text"
                                               value="<?php echo (!empty($customer->additional_info)) ? $customer->additional_info['signal_confirmation_number'] : '' ?>"
                                               class="form-control" name="additional[signal_confirmation_number]"
                                    ...
                                    <div class="col-md-4 form-group">
                                        ...
                                        <input type="text"
                                               value="<?php echo (!empty($customer->additional_info)) ? $customer->additional_info['monitoring_confirmation'] : '' ?>"
                                               class="form-control" name="additional[monitoring_confirmation]"
                                               id="monitoring_confirmation" placeholder="Enter Monitoring Confirmation"
                                               onChange="jQuery('#customer_name').text(jQuery(this).val());" disabled/>
                                    </div>
                                    <div class="col-md-4 form-group">
                                    ...
                                    <div class="col-md-4 form-group">
                                        ...
                                        <input type="text"
                                               value="<?php echo (!empty($customer->additional_info)) ? $customer->additional_info['abort_code'] : '' ?>"
                                               class="form-control" name="additional[abort_code]" id="abort_code"
                                               placeholder="Enter Abort Code"
                                               onChange="jQuery('#customer_name').text(jQuery(this).val());" disabled/>
                                    </div>
                                    ...
                                    <div class="col-md-6 form-group">
                                        ...
                                        <input type="text"
                                               value="<?php echo (!empty($customer->additional_info)) ? $customer->additional_info['sales_rep'] : '' ?>"
                                               class="form-control" name="additional[sales_rep]" id="sales_rep"
                                    ...
                                    <div class="col-md-6 form-group">
                                        ...
                                        <input type="text"
                                               value="<?php echo (!empty($customer->additional_info)) ? $customer->additional_info['sales_rep_phone'] : '' ?>"
                                               class="form-control" name="additional[sales_rep_phone]"
                                    ...
                                    <div class="col-md-6 form-group">
                                        ...
                                        <input type="text"
                                               value="<?php echo (!empty($customer->additional_info)) ? $customer->additional_info['technician'] : '' ?>"
                                               class="form-control" name="additional[technician]" id="technician"
                                    ...
                                    <div class="col-md-6 form-group">
                                        ...
                                        <input type="text"
                                               value="<?php echo (!empty($customer->additional_info)) ? $customer->additional_info['technician_phone'] : '' ?>"
                                               class="form-control" name="additional[technician_phone]"
                                    ...
                                    <div class="col-md-4 form-group">
                                        ...
                                        <div class="input-group date" data-provide="datepicker">
                                            <input type="text"
                                                   value="<?php echo (!empty($customer->additional_info['install_date'])) ? date('m/d/Y', strtotime($customer->additional_info['install_date'])) : '' ?>"
                                                   class="form-control" name="additional[install_date]"
                                        ...
                                        <div data-calendar="time-end-container">
                                            ...
                                            <div class="form-group">
                                                <div class='input-group date timepicker'>
                                                    <input type='text'
                                                           value="<?php echo (!empty($customer->additional_info)) ? $customer->additional_info['technician_arrival_time'] : '' ?>"
                                                           name="additional[technician_arrival_time]"
                                    ...
                                    <div class="col-md-4 form-group">
                                        <div data-calendar="time-end-container">
                                            ...
                                            <div class="form-group">
                                                <div class='input-group date timepicker'>
                                                    <input type='text'
                                                           value="<?php echo (!empty($customer->additional_info)) ? $customer->additional_info['technician_departure_time'] : '' ?>"
                                                           name="additional[technician_departure_time]"
                                    ...
                                    <div class="col-md-6 form-group">
                                        ...
                                        <input type="text"
                                               value="<?php echo (!empty($customer->additional_info)) ? $customer->additional_info['panel_type'] : '' ?>"
                                               class="form-control" name="additional[panel_type]" id="panel_type"
                                    ...
                                    <div class="col-md-6 form-group">
                                        ...
                                        <input type="text"
                                               value="<?php echo (!empty($customer->additional_info)) ? $customer->additional_info['system_type'] : '' ?>"
                                               class="form-control" name="additional[system_type]" id="system_type"
                                    ...
                                    <div class=" col-md-12">
                                        ...
                                        <div class="checkbox checkbox-sec card-types margin-right mr-4">
                                            <input type="radio" name="card[radio_credit_card]"
                                                   value="Visa" <?php echo ((!empty($customer->card_info)) && $customer->card_info['radio_credit_card'] == 'Visa') ? 'checked' : '' ?>
                                                   id="radio_credit_card" disabled>
                                            <label for="radio_credit_card"><span>Visa</span></label>
                                        </div>
                                        <div class="checkbox checkbox-sec margin-right mr-4">
                                            <input type="radio" name="card[radio_credit_card]"
                                                   value="Amex" <?php echo ((!empty($customer->card_info)) && $customer->card_info['radio_credit_card'] == 'Amex') ? 'checked' : '' ?>
                                                   id="radio_credit_cardAmex" disabled>
                                            <label for="radio_credit_cardAmex"><span>Amex</span></label>
                                        </div>
                                        <div class="checkbox checkbox-sec margin-right mr-4">
                                            <input type="radio" name="card[radio_credit_card]"
                                                   value="Mastercard" <?php echo ((!empty($customer->card_info)) && $customer->card_info['radio_credit_card'] == 'Mastercard') ? 'checked' : '' ?>
                                                   id="radio_credit_cardMastercard" disabled>
                                            <label for="radio_credit_cardMastercard"><span>Mastercard</span></label>
                                        </div>
                                        <div class="checkbox checkbox-sec margin-right mr-4">
                                            <input type="radio" name="card[radio_credit_card]"
                                                   value="Discover" <?php echo ((!empty($customer->card_info)) && $customer->card_info['radio_credit_card'] == 'Visa') ? 'Discover' : '' ?>
                                    ...
                                    <div class=" col-md-12">
                                        <div class="row" style="border:none; margin-bottom:20px; padding-bottom:0px;">
                                            <div class=" col-md-6">
                                                ...
                                                <input type="text"
                                                       value="<?php echo (!empty($customer->card_info)) ? $customer->card_info['card_no'] : '' ?>"
                                                       class="form-control card-number required" name="card[card_no]"
                                                       id="card_no" placeholder="" required disabled/>
                                            </div>
                                            <div class="col-md-2">
                                                <label class='form-label'>Expiration Month</label>
                                                <input value="<?php echo (!empty($customer->card_info)) ? $customer->card_info['exp_month'] : '' ?>"
                                            ...
                                            <div class=" col-md-2">
                                                ...
                                                <input type="text"
                                                       value="<?php echo (!empty($customer->card_info)) ? $customer->card_info['exp_date'] : '' ?>"
                                            ...
                                            <div class=" col-md-2">
                                                ...
                                                <input type="text"
                                                       value="<?php echo (!empty($customer->card_info)) ? $customer->card_info['cvv'] : '' ?>"
                                                       class="form-control card-cvc required" name="card[cvv]" id="cvv"
    ...
    $(document).ready(function () {
        ...
        $('#customer_source')
            ...
            .append($("<option/>") //add option tag in select
                ...
                .text("<?php echo get_customer_source($customer->source_id)->title ?>")) //set a text for show in select
