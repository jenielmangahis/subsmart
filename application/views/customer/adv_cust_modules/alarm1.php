            ...
            <div class="col-sm-6">
                <div class="contacttext">
                    <table width="100%" border="0" cellspacing="0" cellpadding="0">
                        ...
                        <tr>
                            <td width="40%" align="right" valign="top">
                                <label class="alarm_label" style="margin-right: 6px;"> <span >Pass Thru Cost :</span> </label>

                            </td>
                            <td width="50%" align="right" valign="top">
                                <label class="alarm_answer"><b> <br> <br><?php if(isset($alarm_info)){ echo $alarm_info->pass_thru_cost; } ?></b> </label>
                            </td>
                        </tr>
                        <tr>
                            <td width="40%" align="right" valign="top">
                                <label class="alarm_label" style="margin-right: 6px;"> <span >Account Cost :</span> </label>

                            </td>
                            <td width="50%" align="right" valign="top">
                                <label class="alarm_answer"><b> <br> <br><?php if(isset($alarm_info)){ echo $alarm_info->account_cost; } ?></b> </label>
                            </td>
                        </tr>
                        </tbody>
                    </table>
            ...
            <div class="col-sm-6">
                <div class="contacttext">
                    <table width="100%" border="0" cellspacing="0" cellpadding="0">
                        ...
                        <tr>
                            <td width="50%" align="right" valign="top">
                                <label class="alarm_label" style="margin-right: 7px;"> <span >Signal :</span> </label>
                            </td>
                            <td width="50%" align="right" valign="top">
