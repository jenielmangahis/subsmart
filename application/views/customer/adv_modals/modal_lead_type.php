...
<div class="modal fade" id="modal_edit_lead_type" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
    <div class="modal-dialog" role="document">
        <div class="modal-content">
            <div class="modal-header">
                ...
                <div class="modal-body">
                    <div class="col-md-12">
                        <div class="row form_line" id="customer_type_group">
                            ...
                            <div class="col-md-8">
                                <input type="text" class="form-control" name="lead_name" id="edit_lead_name"  required/>
