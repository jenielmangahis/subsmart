                        ...
                        <div class="card">
                            <div class="card-body">
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-md-4 form-group">
                                        <label for="tech_info_3tech">3rd Teh</label>
                                        <select class="form-control"
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-md-6 form-group">
                                        ...
                                        <?php if (!empty(get_config_item('services'))) { ?>
                                            <select
                                                    name="plan_type"
                                                    id="plan_type"
                                                    class="form-control">
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-sm-12 col-md-3">
                                        <strong>IP Cam</strong><br>
                                        <div class="checkbox checkbox-sec margin-right mr-4">
                                            <input type="checkbox" name="ip_cam[honeywell]"
                                                   value="honeywell"
                                                   id="ip_cam_honeywell">
                                            <label for="ip_cam_honeywell">
                                                <span>Honey well</span>
                                            </label>
                                        </div>
                                        <div class="checkbox checkbox-sec margin-right mr-4">
                                            <input type="checkbox" name="ip_cam[alarm.com]"
                                                   value="alarm.com"
                                                   id="ip_cam_alarm.com">
                                            <label for="ip_cam_alarm.com">
                                                <span>Alarm.com</span>
                                            </label>
                                        </div>
                                    </div>
                                    ...
                                    <div class="col-sm-12 col-md-3">
                                        ...
                                        <div class="checkbox checkbox-sec margin-right mr-4">
                                            <input type="checkbox" name="dvr[honeywell]"
                                                   value="honeywell"
                                                   id="dvr_honeywell">
                                            <label for="dvr_honeywell">
                                                <span>Honey well</span>
                                            </label>
                                        </div>
                                        <div class="checkbox checkbox-sec margin-right mr-4">
                                            <input type="checkbox" name="dvr[other]"
                                                   value="alarm.com"
                                                   id="dvr_other">
                                            <label for="dvr_other">
                                                <span>Alarm.com</span>
                                    ...
                                    <div class="col-sm-12 col-md-3">
                                        ...
                                        <div class="checkbox checkbox-sec margin-right mr-4">
                                            <input type="checkbox" name="thermostat[honeywell]"
                                                   value="honeywell"
                                                   id="thermostat_honeywell">
                                            <label for="thermostat_honeywell">
                                                <span>Honey well</span>
                                            </label>
                                        </div>
                                        <div class="checkbox checkbox-sec margin-right mr-4">
                                            <input type="checkbox" name="thermostat[alarm.com]"
                                                   value="alarm.com"
                                                   id="thermostat_alarm.com">
                                            <label for="thermostat_alarm.com">
                                                <span>Alarm.com</span>
                                            </label>
                                        </div>
                                    </div>
                                        ...
                                        <?php foreach ($equipments as $equipment) { ?>
                                            <div class="col-md-12 mb-5">
                                                <table>
                                                    <thead>
                                                    <tr>
                                                        <th width="50%"><?php echo $equipment->title ?></th>
                                                        <th width="10%">QTY</th>
                                                    ...
                                                    <tr>
                                                        <td>
                                                            <select name="equipment[item_id]"
                                                                    onchange="get_item_details(this)"
                                                                    class="form-control">
                                                                <option>SELECT ITEM</option>
                                                                <?php if (count_equipment_items($equipment->id)) { ?>
                                                                    <?php foreach (get_equipment_items($equipment->id) as $item) { ?>
                                                        ...
                                                        <td>
                                                            <button type="button" class="btn btn-danger btn-sm">X
                                                            </button>
                                                        </td>
                                                    </tr>
                                                    </tbody>
...
<script>
    ...
    function get_item_details(element) {
        console.log($(element).val());

        $.ajax({
            url: base_url + 'equipments/item',
            type: 'GET',
            data: {item_id: $(element).val()},
            success: function (response) {
                ...
                $(row).find('td:nth-child(3) > input').val(json['price']);
                $(row).find('td:nth-child(4) > input').val(json['price']);
            }
        });
    }
