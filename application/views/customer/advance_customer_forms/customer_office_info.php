<div class="card">
    ...
    <div class="card-body">
        <div class="row form_line">
            ...
            <div class="col-md-7">
                <input type="checkbox" class="form-control" name="welcome_sent" value="1" id="welcome_sent" <?php if(isset($office_info)){ echo $office_info->welcome_sent == 1 ? 'checked': ''; } ?>>
            </div>
        </div>
        <div class="row form_line">
            <div class="col-md-5">
                <label for="welcome_sent"><span>Rebate Status</span>
            </div>
            <div class="col-md-7">
                <div class="row">
                    <div class="col-md-6">
                        <label for="rebate1"><span> Received</span></label>
                        <input type="radio" name="rebate[]" class="form-controls" value="1" id="rebate1" <?php if(isset($office_info)){ echo $office_info->rebate == 1 ? 'checked': ''; } ?> >
                    </div>
                    <div class="col-md-6">
                        <input type="radio" name="rebate[]" class="form-controls" value="0"  id="rebate" <?php if(isset($office_info)){ echo $office_info->rebate == 0 ? 'checked': ''; } ?>>
                        <label for="rebate"><span> Paid</span></label>
                    </div>
                </div>
            </div>
        </div>
        ...
        <div class="row form_line">
            ...
            <div class="col-md-7">
                <div class="row">
                    <div class="col-md-6">
                    <input type="radio" name="pso[]" class="form-control" value="1" id="pso1" <?php if(isset($office_info)){ echo $office_info->pso == 1 ? 'checked': ''; } ?> >
                    <label for="pso1"><span>On</span></label>
                    </div>
                    <div class="col-md-6">
                    <input type="radio" name="pso[]" class="form-control" value="0" id="pso" <?php if(isset($office_info)){ echo $office_info->pso == 0 ? 'checked': ''; } ?> >
        ...
        <div class="row form_line">
            ...
            <div class="col-md-8">
                <select id="assign_to" name="assign_to"  data-customer-source="dropdown" class="input_select searchable-dropdown" >
        ...
        <div class="row form_line">
            ...
            <div class="col-md-8">
                <input type="checkbox" name="rebate_offer" class="form-control" value="1"  id="rebate_offer" <?php if(isset($office_info)){ echo $office_info->rebate_offer == 1 ? 'checked': ''; } ?>>
            </div>
        </div>
        <div class="row form_line">
            <div class="col-md-3">
        ...
        <div class="row form_line">
            <div class="col-md-12">
                <div class="row">
                    <div class="col-md-3">
                    <input type="radio" class="form-control" name="way_of_pay" value="None" <?php if(isset($office_info)){ echo $office_info->way_of_pay == 'None' || $office_info->way_of_pay == '' || $office_info->way_of_pay == 'Email' ? 'checked': ''; }else {echo 'checked'; } ?>  id="way_of_pay_none">
                    <label for="way_of_pay_none"><span>None</span></label>
                    </div>
                    <div class="col-md-3">
                    <input type="radio" class="form-control" name="way_of_pay" value="Check" <?php if(isset($office_info)){ echo $office_info->way_of_pay == 'Check'? 'checked': ''; } ?>  id="way_of_pay_check">
                    <label for="way_of_pay_check"><span>Check</span></label>
                    </div>

                    <div class="col-md-3">
                    <input type="radio" class="form-control" name="way_of_pay" value="Credit" <?php if(isset($office_info)){ echo $office_info->way_of_pay == 'Credit'? 'checked': ''; } ?>  id="way_of_pay_credit">
                    <label for="way_of_pay_credit"><span>Credit</span></label>
                    </div>

                    <div class="col-md-3">
                    <input type="radio" class="form-control" name="way_of_pay" value="Paid" <?php if(isset($office_info)){ echo $office_info->way_of_pay == 'Paid'? 'checked': ''; } ?> id="way_of_pay_paid">
