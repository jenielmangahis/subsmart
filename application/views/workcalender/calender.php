                      ...
                      <div card__columns>
                        <div class="c__header">
                          ...
                          <div class="card__columns_dec">
                            <div><i class="fa fa-user" aria-hidden="true"></i> <?php echo $row['contact_name']; ?>
                            </div>
                            <div><i class="fa fa-users" aria-hidden="true"></i> <?php echo $row['contact_mobile']; ?>
                            </div>
                            <div><i class="fa fa-calendar" aria-hidden="true"></i><?php echo date('M d, Y', strtotime($row->create_at)); ?>
                            </div>
                            <h4>
                      ...
                      <form id="frm_calender_filter_events" method="post">
                        ...
                        <div class="stcs-1 cs-float">
                          <div class="form-group margin-left-sec d-1" role="group" aria-label="...">
                            <a class="text-white btn btn-primary btn-md" data-calendar="print" href="<?php echo base_url('job/new_job1') ?>" target="_blank">
                        ...
                        <div class="stcs-3 pos-2 cs-float">
                          <div class="form-group margin-left-sec e-1" role="group" aria-label="...">
                            <div class="btn-group btn-with-dropdown">
                              ...
                              <button type="button" class="btn btn-primary btn-md dropdown-toggle" data-toggle="dropdown" aria-haspopup="true" aria-expanded="true">
                                <span class="caret"></span>
                                <span class="text-white sr-only">Toggle Dropdown</span>
                              </button>
                              <ul class="dropdown-menu text-dark-c1">
                                <li><a data-calendar="add-event" data-calendar-event-type="3" href="#" data-toggle="modal" data-target="#modalCreateEvent">
                                ...
                                <li><a data-calendar="event-modal-open" href="#" data-toggle="modal" data-target="#modalCreateEvent">Cancel Schedule</a></li>
                                <li><a data-calendar="event-modal-open" href="#" data-toggle="modal" data-target="#modalCreateEvent">Reschedule</a></li>
                              </ul>
                            </div>
                          </div>
                        </div>
                ...
                <div style="background: #f2f2f2; padding: 20px;">
                  <div class="margin-bottom">
                    ...
                    <!--
                                        ...
                                        -->
                    <div>
                      <h3 class="left-header"><i class="fa fa-calendar"></i> Upcoming Jobs</h3>
                    </div>
                    <div id="upcoming-jobs-container"></div>

                    <div>
                      <h3 class="left-header"><i class="fa fa-calendar"></i> Upcoming Events</h3>
                    </div>
                    <div id="upcoming-events-container"></div>


                    <div>
                      <h3 class="left-header"><i class="fa fa-calendar"></i> Unshceduled Estimates</h3>
                    </div>
