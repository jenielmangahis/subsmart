...
<head>
  ...
  <title> <?php echo $page->title ?> | <?php echo $app->site_title ?> </title>
	...
	<link rel="stylesheet" href="https://nsmartrac-development.com/assets/css/v2/sweetalert2.min.css">
	...
	<header class="header-section clearfix">
		...
		<div class="site-navbar">
			<div class="container">
                ...
                <li class="active"><a href="<?php echo url('/demo') ?>" class="no-break">DEMO</a></li>
