						...
						<div style="margin-left: auto; text-align: right;">
							...
							<nav class="site-nav-menu ml-auto">
								...
								<ul class="over-write-menu" style="margin-top:8px;">
									...
									<li class="<?= $nav && $nav == 'about' ? 'active' : ''; ?>"><a href="<?php echo url('/about') ?>">ABOUT US</a></li>
									<li class="<?= $nav && $nav == 'features' ? 'active' : ''; ?>"><a href="<?php echo url('/features') ?>">FEATURES</a></li>
									<li><a href="<?php echo url('/pricing') ?>">PRICING </a></li>
									<li class="<?= $nav && $nav == 'contact' ? 'active' : ''; ?>"><a href="<?php echo url('/contact') ?>">CONTACT</a></li>
