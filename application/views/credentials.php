...
<div class="card">
    <div class="row">
    	...
    	<div class="col-xs-16 text-right">
    		    		<a class="btn btn-default btn-lg" href="https://www.markate.com/pro/business/services">« Back</a>
    		    		    		<button class="btn btn-primary btn-lg margin-left" name="btn-continue" type="button">Next »</button>
    		    	</div>
    </div>
</div>
</form>    </div>
