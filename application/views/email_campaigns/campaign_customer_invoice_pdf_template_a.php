        ...
        <td style="vertical-align: top;text-align: right;">
            <table>
                <tr>
                    ...
                    <td align="right"><?= date("d-M-Y", strtotime($orderPayments->date_paid)); ?></td>
                </tr>
                <tr>
                    <td align="right">Status:</td>
                    <td align="right"><?= ucfirst($orderPayments->status) ?></td>
                </tr>
                <tr>
                ...
                <tr>
                    ...
                    <td align="right"><?= ucfirst($orderPayments->payment_method) ?></td>
                </tr>
                <tr>
...
<table style="width: 100%;padding: 3px;">
    ...
    <tr>
        ...
        <td>1</td>
        <td>Deal : <?= strtoupper($emailBlast->campaign_name); ?><br/>Send Date : <?= date("d-M-Y",strtotime($emailBlast->send_date)); ?>
        </td>
        <td style="text-align: right;">$<?= number_format($emailBlast->total_cost, 2); ?></td>
    </tr>
    <tr>
        <td colspan="4"></td>
    </tr>
    <tr>
        ...
        <td style="text-align: right"><b>$<?= number_format($emailBlast->total_cost, 2); ?></b></td>
    </tr>
    <tr>
        <td colspan="3" style="text-align: right">Payment Due</td>
        <td style="color:red;text-align: right;">(-) $<?= number_format($emailBlast->total_cost, 2); ?></td>
    </tr>
    <tr>
