                ...
                <div class="col-xl-12">
                    <div class="card mt-0">
                        ...
                        <div class="card-body">
                            ...
                            <div class="tabs-menu">
                                <ul class="clearfix">
                                  <li class="active"><a href="<?= base_url("promote/edit_deals/" . $dealsSteals->id); ?>">1. Edit Deal</a></li>
                            ...
                            <div class="row">
                              ...
                              <div class="col-md-12 form-group">
                                  ...
                                  <img src="<?= base_url("uploads/deals_steals/" . $dealSteals->company_id . "/" . $dealSteals->photos); ?>" style="width: 30%;">
                                ...
                                <div class="row">
                                    <div class="col-sm-8 col-md-4">
                                        ...
                                        <div class="input-group">
                                            ...
                                            <input type="text" name="price" value="<?= number_format($dealSteals->deal_price,2); ?>" id="price-deal" class="form-control" autocomplete="off">
                                        </div>
                                    </div>
                                    <div class="col-sm-8 col-md-4">
                                    ...
                                    <div class="col-sm-8 col-md-4">
                                        ...
                                        ?>
                                        <div style="padding-top: 63px;">Discount you offer: &nbsp; $<span id="discount-fixed"><?= number_format($discount_offer, 2); ?></span></div>
                                    </div>
                                </div>
                            </div>
                            <hr />
