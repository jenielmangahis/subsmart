        ...
        <div class="container-fluid">
            <section class="content">
                ...
                <div class="box">
                    ...
                    <?php echo form_open('equipments/update/' . $equipment->id, ['class' => 'form-validate']); ?>
                                        ...
                                        <div class="col-sm-6">
                                            <div class="form-group">
                                                ...
                                                <input type="text"
                                                       ...
                                                       name="title"
                                                       id="formClient-Name"
                                                       value="<?php echo (!empty($equipment)) ? $equipment->title : '' ?>"
                                            ...
                                            <div class="table-responsive">
                                                <table class="table table-hover">
                                                    ...
                                                    <?php if ((count_equipment_items($equipment->id))) { ?>
                                                        <?php foreach (get_equipment_items($equipment->id) as $key => $item) { ?>
                                                            <tr>
                                                                <td><input type="text"
                                                                           name="items[<?php echo $key ?>][title]"
