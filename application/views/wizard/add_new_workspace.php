            ...
            <div class="row">
                <div class="col-xl-12">
                    <div class="card mt-0" style="min-height: 400px !important;">
                        <h3 class="page-title mb-0"><i class="fa fa-plus"></i> Add New Work Space</h3>
                        <hr/>
                        <?php include viewPath('flash'); ?>
                        <?php echo form_open_multipart('wizard/create_workspace', [ 'class' => 'form-validate', 'autocomplete' => 'off' ]); ?>
