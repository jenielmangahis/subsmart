								  	...
								  	<div class="hint-box">
								  		<div class="row">
								  			...
								  			<div class="col-md-4 col-sm-4">
								  				<a href="#" class="btn-main">I want to build my own</a>
								  			</div>
								  		</div>
								  	</div>
						  		</div>
...
$(document).ready(function(){
  ...
  $('#prefetch .typeahead').typeahead(null, {
   ...
   limit:10,
   templates:{
    suggestion:Handlebars.compile('<div class="row"><div class="col-md-2" style="padding-right:5px; padding-left:5px;"><img src="<?php echo $url->assets ?>/{{app_img}}" class="img-thumbnail" width="48" /></div><div class="col-md-10" style="padding-right:5px; padding-left:5px;">{{app_name}}</div></div>')
   }
  });
});
</script>