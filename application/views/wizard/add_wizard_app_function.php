                                    ...
                                    <div id="fList" class="row col-lg-12">
                                        <div class="col-lg-12 mb-5">
                                            <div class="form-group">
                                                ...
                                                <input type="text" name="" id="fn_nice" placeholder="Please enter the Title of the function" class="form-control">
                                            </div>
                                            <div class="form-group">
                                                <label>Function Name <br /> <small><span class="text-danger">ex. createCalendar</span></small></label>
                                                <input type="text" name="" id="fn_name" placeholder="Please enter name of function" class="form-control">
                                            </div>
                                            <div class="form-group">
                                                <label>Description <br /> <small><span class="text-danger">Note: This is viewable to the users</span></small></label>
                                                <textarea class="form-control" cols="10" rows="10" id="fn_desc" placeholder="Please enter Description"></textarea>
                                            </div>
                                            <div class="form-group">
