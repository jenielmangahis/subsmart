...
<div class="row page-content g-0">
    ...
    <div class="col-12">
        <div class="nsm-callout primary">
            ...
            Locations are places, like warehouses, sites, or work vehicles, where inventory is stored. Product items
            represent products in your inventory stored at a particular location, such as bolts stored in a warehouse.
            Each product item is associated with a product and a location in nSmarTrac.
        </div>
    </div>
    <div class="col-12">
        <div class="nsm-page">
                                    ...
                                    <div class="nsm-card-title">
                                        <span class="d-block">
                                            <div class="right-text">
                                                <span class="page-title " style="font-weight: bold;font-size: 18px;"><i
                                                        class='bx bxs-layer-plus'></i>&nbsp;Add New Item</span>
                                            </div>
                                        </span>
                                    </div>
                                </div>
                                        ...
                                        <div class="row">
                                            <div class="col-lg-4 mb-2">
                                                ...
                                                <input type="text" class="form-control" maxlength="25"
                                                    placeholder="Maximum 25 characters only" name="title" id="title"
                                                    required />
                                            </div>
                                            <div class="col-lg-4 mb-2">
                                                <strong>Brand</strong>
                                            ...
                                            <div class="col-lg-4 mb-2">
                                                ...
                                                <input type="text" class="form-control " name="qty_order"
                                                    id="qty_order" />
                                            </div>
                                            <div class="col-lg-4 mb-2">
                                                <strong>Reorder Point</strong>
                                                <input type="text" class="form-control " name="re_order_points"
                                                    id="re_order_points" />
                                            </div>
                                            <div class="col-lg-4 mb-2">
                                                <strong>Item Group</strong>
                                                <select class="form-control" name="item_categories_id"
                                                    id="item_categories_id" required>
                                                    <option value="">Select</option>
                                                    <?php foreach($item_categories as $cat) : ?>
                                                    <option value="<?= $cat->item_categories_id; ?>"><?= $cat->name; ?>
                                                    </option>
                                                    <?php endforeach; ?>
                                                </select>
                                            </div>
                                            <div class="col-lg-12 mb-2">
                                                ...
                                                <textarea rows="3" id="descriptionItem" name="description"
                                            ...
                                            <div class="col-lg-12 mb-2">
                                                ...
                                                <input type="file" onchange="readURL(this);" name="attached_image"
                                                    class="form-control" id="attached_image">
                                            </div>
                                            <div class="col-lg-9 mb-2">
                                                <strong>Location</strong>
                                                <select id="locations" name="loc_id[]" class="form-select"
                                                    placeholder="Select" multiple="multiple" required>
                                            ...
                                            <div class="col-lg-3 mb-2">
                                                ...
                                                <input type="number" class="form-control " name="initial_quantity"
                                                    id="initial_quantity" required />
                                            </div>
                                            <?php foreach($custom_fields as $field) : ?>
                                            <div style="position: relative;" class="col-lg-6 mt-2">
                                                <strong
                                                    class="content-subtitle fw-bold d-block mb-2"><?=$field->name; ?></strong>
                                                <a style="position: absolute; top: 1px; right: 15px;"
                                                    href="javascript:void(0);"
                                                    class="content-subtitle d-block mb-2 nsm-link btn-edit-field"
                                                    data-id="<?=$field->id; ?>" data-name="<?=$field->name; ?>">Edit</a>
                                                <input type="text" name="custom_field[<?=$field->id?>]"
                                                    class="nsm-field form-control" />
                                            </div>
                                            <?php endforeach; ?>
                                            <div class="col-lg-12 mt-2">
                                                <div class="float-end">
                                                    <button class="nsm-button" id="CANCEL_BUTTON_INVENTORY"
                                                        type="button">Cancel</button>
                                                    <button type="submit" class="nsm-button primary"><i
