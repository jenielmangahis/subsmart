                ...
                <div class="row">
                        ...
                        <div class="col-md-12">                                    
                            <div class="payment-options">                                                              
                                <table class="table table-no-border table-payment-details">
                                  <tr>
                                    <td colspan="2"><h4>Order # <?= $smsCampaign->order_number; ?></h4></td>
                                  </tr>
                                  <tr>
                                    <td style="width:200px;">Date:</td>
                                    <td><b><?= date("d-M-Y H:i", strtotime($smsCampaign->date_paid)); ?></b></td>
                                  </tr>
                                  <tr>
                                ...
                                <table class="table table-payment-details">
                                  ...
                                  <tr>
                                    ...
                                    <td>1</td>
                                    <td>
                                      <span>Campaign : <?= $smsCampaign->campaign_name; ?></span><br />
                                      <span>Send Date : <?= date("d-M-Y",strtotime($smsCampaign->send_date)); ?></span><br />
                                    </td>
                    ...
                    <div class="row mt-5">   
                        <div class="col-12 mt-3 text-end">
                            <a class="nsm-button primary" href="<?php echo url('sms_campaigns/invoice_pdf/' . $smsCampaign->id) ?>" target="_new" style="margin-right: 10px;">PDF Invoice
                            </a>
                            <a class="nsm-button primary" href="<?php echo url('sms_campaigns/order_pdf/' . $smsCampaign->id) ?>" target="_new" style="margin-right: 10px;">PDF Order</a>
