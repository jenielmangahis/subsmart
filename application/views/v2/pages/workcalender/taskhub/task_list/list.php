                                        ...
                                        <td>
                                            <div class="dropdown table-management">
                                                ...
                                                <ul class="dropdown-menu dropdown-menu-end">
                                                    <li>
                                                        <a class="dropdown-item" name="dropdown_edit" href="javascript:void(0);" data-id="<?= $list->id; ?>">Edit</a>
                                                    </li>
                                                    <li>
                                                        <a class="dropdown-item btn-delete-task" href="javascript:void(0);" data-id="<?= $list->id; ?>" data-name="<?= $list->name; ?>">Delete</a>
                                                    </li>
                                                </ul>
                                            </div>
                                        </td>
