...
<style>
    .residentialCustomerGroupContainer {
        max-height: 200px;
    }

    .residentialCustomerStatusCategory {
        background: #00000008;
        border-radius: 5px;
    ...
    <div class="col-12">
        <div class="nsm-page">
            <div class="nsm-page-content">
                <div class="row">
                    <div class="col-12">
                        <div class="nsm-callout primary">
                            ...
                            Displays all residential customers, including details of those enrolled in home-based service plans.
                        </div>
                    </div>
                </div>
                <div class="row">
                    <div class="col mt-3 residentialCustomerBadgeLoader">
                ...
                <div class="row mb-3 table-responsive residentialCustomerGroupContainer"></div>
                <div class="row">
                    ...
                    <div class="col-lg-12">
                        <div class="col mt-3 residentialCustomerLoader">
                            <div class="text-center">
                                <div class="spinner-border text-secondary" role="status">
                                    <span class="visually-hidden">Loading...</span>
                                </div>
                    ...
                    <div class="col-lg-12 residentialCustomerListContent display_none"></div>
                </div>
...
<script>    
    function getResidentialCustomers() {
        $.ajax({
            type: "POST",
            ...
            success: function(response) {
                ...
                if (data.length != 0) {
                    ...
                    sortedKeys.forEach((key) => {
                            ...
                            return `
                                <tr>
                                    ...
                                    <td style="width: 0;" class="p-0">
                                        <div class='dropdown'>
                                            <button class='btn dropdown-toggle text-muted' type='button' id='residentialCustomerButtonDropdown' data-bs-toggle='dropdown' aria-expanded='false'><i class='fas fa-ellipsis-v'></i></button>
                                            <ul class='dropdown-menu' aria-labelledby='residentialCustomerButtonDropdown'>
                        ...
                        html += `
                            <div class="residentialCustomerGroupAccordion border rounded mb-2">
                                ...
                                <div class="collapse" id="${collapseId}">
                                    <div class="border-top position-relative">
                                        <div class="table-responsive residentialCustomerTableContainer">
            ...
            success: function(response) {
                ...
                if (data.length != 0) {
                    Object.entries(data).forEach(([key, value]) => {
                        ...
                        html += `
                            <div class="col-lg-1">
                                <div class="residentialCustomerStatusCategory" style="background:${matchedColor.bg}; border:1px solid ${matchedColor.border};">
                                    <small class="text-uppercase residentialCustomerStatusName">${key}</small>
                                    <h5 class="residentialCustomerStatusCount">${value}</h5>
                                </div>
                            </div>
                        `;
                    });
                    ...
                    html += `
                        <div class="col-lg-1">
                            <div class="residentialCustomerStatusCategory">
                                <small class="text-uppercase residentialCustomerStatusName">No Status Found</small>
                                <h5 class="residentialCustomerStatusCount">0</h5>
                            </div>
                        </div>
                    `;
                }
    ...
    $('.residentialCustomerGroupSearch').on('input', function () {
        ...
        $('.residentialCustomerGroupAccordion').each(function () {
