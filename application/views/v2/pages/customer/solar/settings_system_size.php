                    ...
                    <div class="col-12 grid-mb text-end">
                        <div class="nsm-page-buttons page-button-container">
                            <button type="button" class="nsm-button primary" data-bs-toggle="modal" data-bs-target="#new_system_size_modal">
                                <i class='bx bx-fw bx-notepad'></i> New Lender Type
                            </button>
                        </div>
                    </div>
                </div>
...
<script type="text/javascript">
    $(document).ready(function() {
        ...
        $("#new_system_size_form").on("submit", function(e) {
            ...
            var url = "<?php echo base_url(); ?>customer/settings_solar_system_size";
                ...
                success: function(result) {
                    if (result === "Updated") {
                        ...
                        Swal.fire({
                            ...
                            text: "New Lender Type has been added successfully.",
                            icon: 'success',
        ...
        $(document).on("click", ".delete-item", function() {
            ...
            Swal.fire({
                ...
                text: "Are you sure you want to delete this Lender Type?",
                icon: 'question',
                ...
                if (result.value) {
                    $.ajax({
                        type: 'POST',
                        url: "<?php echo base_url(); ?>customer/settings_solar_system_size",
                        data: {
                            lenderName : id
                        },
                        success: function(result) {
