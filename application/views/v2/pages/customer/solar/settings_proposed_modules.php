                    ...
                    <div class="col-12 grid-mb text-end">
                        <div class="nsm-page-buttons page-button-container">
                            <button type="button" class="nsm-button primary" data-bs-toggle="modal" data-bs-target="#new_proposed_module_modal">
                                <i class='bx bx-fw bx-notepad'></i> New Proposed Module
                            </button>
                        </div>
                    </div>
                </div>
...
<script type="text/javascript">
    $(document).ready(function() {
        ...
        $("#new_proposed_module_form").on("submit", function(e) {
            ...
            var url = "<?php echo base_url(); ?>customer/settings_solar_modules";
                ...
                success: function(result) {
                    if (result === "Updated") {
                        ...
                        Swal.fire({
                            ...
                            text: "New Proposed Module has been added successfully.",
                            icon: 'success',
        ...
        $(document).on("click", ".delete-item", function() {
            ...
            Swal.fire({
                ...
                text: "Are you sure you want to delete this Proposed Module?",
                icon: 'question',
                ...
                if (result.value) {
                    $.ajax({
                        type: 'POST',
                        url: "<?php echo base_url(); ?>customer/settings_solar_modules",
                        data: {
                            lenderName : id
                        },
                        success: function(result) {
