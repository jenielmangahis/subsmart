    ...
    <div class="nsm-card nsm-grid">
        ...
        <div class="row g-3">
                ...
                <div class="col-12 col-md-4">
                    ...
                    <!-- <a role="button" class="nsm-button w-100 ms-0 mt-3 call-customer" href="javascript:void(0);" data-id="<?= $profile_info->prof_id; ?>" data-phone="<?= $phone; ?>" style="width:100px !important;">
                        <i class='bx bx-fw bx-phone-call'></i> Call Customer
                    </a> -->
                    <button role="button" class="nsm-button w-100 ms-0 mt-3 owner-call-customer" data-id="<?= $profile_info->prof_id; ?>" data-phone="<?= $phone; ?>">
                        <i class='bx bx-fw bx-phone-call'></i> Call Customer
                    </button>
                </div>
            </div>
...
<!--Send Message Modal-->
<div class="modal fade nsm-modal fade" id="ownerModalSendMessage" tabindex="-1" aria-labelledby="ownerModalSendMessageLabel" aria-hidden="true">
...
<!--SMS Templates Modal-->
<div class="modal fade nsm-modal fade" id="ownerModalSmsTemplate" tabindex="-1" aria-labelledby="ownerModalSmsTemplateLabel" aria-hidden="true">
...
<!--Call Dialpad Modal-->
<div class="modal fade nsm-modal fade" id="ownerModalCallDialPad" tabindex="-1" aria-labelledby="ownerModalCallDialPadLabel" aria-hidden="true">
...
$(document).on('click', '.send-sms-message', function(){
    ...
    if( customer_phone != '' ){
        ...
        $('#ownerModalSendMessage').modal('show');
...
$(document).on('click', ".btn-use-template", function(){
    ...
    $.ajax({
        ...
        success: function(o) {
            ...
            $('#ownerModalSendMessage').modal('show');
            $('#ownerModalSmsTemplate').modal('hide');
        },
    });
});
...
<script type="text/javascript">
    $(document).ready(function() {
        ...
        $(document).on('click', '.owner-call-customer',function(){
            ...
            $('#cid').val(cid);
            $('#ownerModalCallDialPad').modal('show');
        });
    ...
    $(function() {
        ...
        var $acceptedTemplate = $('#ownerModalCallDialPad');
