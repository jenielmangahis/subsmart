                                    ...
                                    <div class="col-md-12">
                                        <div class="col-sm-12">
                                            <div class="form-group <?php echo (isset($custom_errors['title']) && $custom_errors['title']!='' )?'has-feedback':''; ?>">
                                                ...
                                                <input type="text" class="form-control col-sm-6" name="title" id="title" value="<?= $customerGroup->title; ?>" placeholder="Group Name" style="width:50%;" autofocus/>
                                        ...
                                        <div class="col-md-12 mt-3 form-group <?php echo (isset($custom_errors['description']) && $custom_errors['description']!='' )?'has-feedback':''; ?>">
                                            ...
                                            <textarea name="description" cols="40" rows="3" class="form-control" autocomplete="off"><?php echo (isset($old_data['description']))?$old_data['description']:''  ?><?= $customerGroup->description; ?></textarea>
