        ...
        <div class="row">
          <?php if($workorder){ ?>
              ...
              <div id="printableArea" style="">
                <div class="row mb-4">
                  <h4 class="title-border">CONVERTED</h4>
                  <div class="col-md-12 col-12"><span style="font-size:16px;">1. This Work Order Agreement (the 'Agreement') is made as of <?= date('m/d/Y'); ?>, by and between <?= $company->business_name; ?>., (the 'Company') and <?= $customer->first_name . ' ' . $customer->last_name; ?>, the ('Customer') as the service address shown below (the 'Premise/Service Location').<hr /></span></div>
                </div>
                ...
                <div class="row mt-4">
                  <div class="col-md-6 col-12" style="font-size:16px;">
                      ...
                      <div class="col-xl-5 ml-0 pl-0">
                        ...
                        <span class="">Phone: <?= formatPhoneNumber($company->office_phone); ?></span>
                      </div>
                  </div>                    
                  <div class="col-md-6 col-12" style="font-size:16px;">
                      ...
                      <div class="">
                        ...
                        <span class="">Mobile: <span class=""><?= formatPhoneNumber($customer->phone_m); ?></span><br />
                      </div>
                  </div>
                </div>
                <div class="row mt-4">
