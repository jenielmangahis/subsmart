...
<div class="card">
    <div class="row g-3 card-body">
        ...
        <div class="col-12 col-md-6">
            ...
            <input type="text" name="middle_name" class="nsm-field form-control" required />
        </div>
        <div class="col-12 col-md-6">
        ...
        <div class="col-12 col-md-6">
            ...
            <input type="email" name="contact_email" class="nsm-field form-control" required />
        </div>
        <div class="col-12 col-md-6">
        ...
        <div class="col-12 col-md-6">
            ...
            <input type="text" name="contact_mobile" class="nsm-field form-control" required />
        </div>
        <div class="col-12 col-md-6">
            <label class="content-subtitle fw-bold d-block mb-2">Phone</label>
            <input type="text" name="contact_phone" class="nsm-field form-control" required />
        </div>
        <div class="col-12 col-md-6">
        ...
        <div class="col-12">
            <div class="accordion">
                <div class="accordion-item">
                    ...
                    <div id="more_info_collapse" class="accordion-collapse collapse show">
                        <div class="accordion-body">
                            <div class="row g-3">
                                ...
                                <div class="col-12 col-md-4">
                                    ...
                                    <input type="text" name="city" class="nsm-field form-control" required />
                                </div>
                                <div class="col-12 col-md-4">
                                    <label class="content-subtitle fw-bold d-block mb-2">Zip/Postal Code</label>
                                    <input type="text" name="postcode" class="nsm-field form-control" required />
                                </div>
                                <div class="col-12 col-md-4">
                                    <label class="content-subtitle fw-bold d-block mb-2">State/Province</label>
                                    <input type="text" name="state" class="nsm-field form-control" required />
