...
?>
    ...
    ?>
        <tr>
            ...
            <td>0 - <a href="javascript:void(0)" class="nsm-link">View Log</td>
            <td>
                <?php
                $is_active = '';
                if ($s->is_active == 1) {
            ...
            <td>
                <div class="dropdown table-management">
                    ...
                    <ul class="dropdown-menu dropdown-menu-end">
                        <li>
                            <a class="dropdown-item" href="<?php echo base_url('email_automation/edit_automation/' . $s->id) ?>">Edit</a>
                        </li>
                        <li>
                            <a class="dropdown-item delete-item" href="javascript:void(0);" data-name="<?= $s->name; ?>" data-id="<?= $s->id; ?>">Delete</a>
                        </li>
                    </ul>
                </div>
            </td>
