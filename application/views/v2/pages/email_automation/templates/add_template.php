                            ...
                            <div class="nsm-card-content">
                                <div class="row g-3">
                                    <div class="col-6 col-md-6">
                                        ...
                                        <input type="text" class="nsm-field form-control" name="name" id="" required placeholder="" autocomplete="off" autofocus/>
                                    </div>
                                </div>
                                <div class="row mt-5">
                                    <div class="col-6 col-md-6">
                                        <label class="content-subtitle fw-bold d-block mb-2"><b>Subject</b></label>
                                        <input type="text" class="nsm-field form-control" name="email_subject" id="email_subject" required placeholder="" autocomplete="off" autofocus/>
                                    </div>
                                    <div class="col-12 col-md-12 mt-5">
                                        <label class="content-subtitle fw-bold d-block mb-2"><b>Email Body</b></label>
                                        <textarea name="email_body" cols="40" rows="30"  class="nsm-field form-control" id="email_body" autocomplete="off"></textarea>
                                    </div>
                                </div>
                            </div>
                        </div>
