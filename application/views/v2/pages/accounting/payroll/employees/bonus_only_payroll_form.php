            ...
            <div class="row">
                <div class="col-md-3">
                    <div class="form-group">
                        ...
                        <select name="pay_from" id="payFrom" class="form-select nsm-field">
                                ...
                                <tbody>
                                    <?php foreach($payDetails as $payDetail) : ?>
                                        ...
                                        <tr>
                                            ...
                                            <td>
                                                <a href="#" class="text-decoration-none"><?php echo $employee->LName . ', ' . $employee->FName?></a>
                                            </td>
...
<div class="modal-footer">
    <div class="row w-100">
        <div class="col-md-4">
            <button type="button" class="nsm-button primary" data-bs-dismiss="modal" id="bonus-pay-select">Back</button>
        </div>
        <div class="col-md-4">
