                ...
                <table class="nsm-table" id="tags-table">
                    ...
                    <tbody>
                        ...
                        <tr data-id="<?=$tag['id']?>" data-type="<?=$tag['type']?>" class="<?= $bg_group; ?>">
                            <td>
                                <div class="table-row-icon table-checkbox">
                                    <input class="form-check-input select-one table-select" type="checkbox" name="tagsgrp[]" value="<?=$tag['type']?>_<?=$tag['id']?>">
                                </div>
                            </td>
                        ...
                        <tr class="group-tag-id-<?= $groupTag['group_tag_id']; ?> collapse collapse-<?=$index?>" data-id="<?=$groupTag['id']?>" data-type="group-tag">
                            <td>
                                <div class="table-row-icon table-checkbox">
                                    <input class="form-check-input select-one table-select" type="checkbox" name="tagsgrp[]" value="group-tag_<?=$groupTag['id']?>">
                                </div>
                            </td>
