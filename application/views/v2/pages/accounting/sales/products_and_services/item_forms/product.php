                    ...
                    <td>
                        <table class="nsm-table" id="storage-locations">
                            ...
                            <tbody class="cursor-pointer">
                                <tr>
                                    <td>
                                        <select name="location_id[]" class="form-control nsm-field select2-hidden-accessible" tabindex="-1" aria-hidden="true">
                                       
                                        </select></td>
                                    <td>
                                        <input type="number" name="quantity[]" class="text-right form-control nsm-field">
                                    </td>
                                    <td>
