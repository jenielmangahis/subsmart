                ...
                <th>
                    <div class="row" style="height: 68.5px;">
                        <div class="col-12 col-sm-2">
                            <div class="type-icon" style="width: 72px; background-image: url('<?php echo base_url(); ?>assets/img/accounting/service.png');"></div>
                        </div>
                        <div class="col-12 col-sm-10 d-flex align-items-center">
                            <h5><span>Service</span></h5> &nbsp;&nbsp; <a href="#" class="text-decoration-none" id="select-item-type"><span>Change type</span></a>
                        </div>
                    </div>
                </th>
            </tr>
