<?php foreach ($NsmartUpgrades as $nu) : ?>
    <?php if( in_array($nu->id, $active_addons_id)): ?>
        <div class="col-12 col-md-3">
            ...
            ?>
            <div class="nsm-card primary p-5 <?= $add_class; ?>" role="button" data-id="<?= $nu->id; ?>">
                <div class="nsm-card-content h-100">
                    <div class="row h-100 align-content-between">
                        ...
                        <div class="col-12 text-center">
                            ...
                            <?php if (!in_array($nu->id, $active_addons_id)) : ?>
                                <button type="button" class="nsm-button">Subscribe Now</button>
                            <?php else : ?>
                                <button type="button" class="nsm-button primary">Active Addon</button>
                            <?php endif; ?>
                        </div>
                    </div>
                </div>
