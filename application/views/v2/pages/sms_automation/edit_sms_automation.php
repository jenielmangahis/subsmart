    ...
    <div class="col-12">
        <div class="nsm-page">
            <div class="nsm-page-content">
                ...
                <?php echo form_open_multipart('', ['class' => 'form-validate', 'id' => 'create_sms_automation', 'autocomplete' => 'off']); ?>
                    <div class="tabs-menu">
                        <ul class="clearfix">
                          <li class="active">1. Edit Rules</li>
                          <li>2. Build SMS</li>
                          <li>3. Preview</li>
                          <li>4. Payment</li>
                        </ul>
                    ...
                    <div class="row">
                        <div class="col-md-6">
                            ...
                            <div class="form-group mt-5">
                                ...
                                <input type="text" class="form-control" name="automation_name" id="" required placeholder="" value="<?= $smsAutomation->automation_name; ?>" autofocus style="width: 55%;"/>
                            </div>
                        </div>
                        <div class="col-md-6">
                            <div class="form-group">
