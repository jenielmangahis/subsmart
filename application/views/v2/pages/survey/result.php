    ...
    <div class="col-12">
        <div class="nsm-page">
            <div class="nsm-page-content">
                <div class="row">
                    <div class="col-12">
                        <div class="nsm-callout primary">
                            ...
                            <div>
                            Survey Result<br/><br />
                            <b style="font-size:20px;">Survey Title: <span class="font-weight-bold"><?= $survey->title ?></span></b>
                            </div>
                        </div>
                    </div>
                </div>
                ...
                <div class="row">
                  <div class="col-sm-12 col-md-6">
                    ...
                    <div class="row mt-5 mb-5">
                      <div class="col-xs-12 col-sm-6 col-md-4 button-container">
                        <a href="<?php echo base_url()?>survey/edit/<?php echo $survey->id?>" class="nsm-button primary"><i class='bx bx-pencil'></i> Edit</a>
                      </div>
                      <div class="col-xs-12 col-sm-6 col-md-4 button-container">
                        <a href="javascript:void(0);" class="nsm-button primary btn-share-survey"><i class='bx bx-share-alt'></i> Share</a>
                      </div>
                      <div class="col-xs-12 col-sm-6 col-md-4 button-container">
                        <a href="javascript:void(0);" class="nsm-button primary btn-delete-survey" data-id="<?= $survey->id; ?>"><i class='bx bx-trash'></i> Delete</a>
                      </div>
                    </div>
                      ...
                      <!-- <div class="card-body"> -->
                        ...
                        <div class="form-group">
                          <div class="input-group">
                            ...
                            <button onclick="copyLink()" id="btnCopyLink" class="nsm-button" style="margin: 0px;"><i class="fa fa-copy"></i> Copy Link</button>
                          </div>
                        </div>
                      <!-- </div> -->
                    </div>
                              ...
                              <div class="row ">
                                <div class="col-sm-12 ">
                                  <div class="tool-icon" style="display:block;margin-bottom: 42px;">
                                    <button id="toggle-chart-data" onclick="toggleDataChart()" class="nsm-button" style="float: right;"><i class='bx bx-list-ul'></i> Expand</button>          
                                  </div>
                  ...
                  <div class="col-sm-12 col-md-6">
                    ...
                    <div class="row">
                        <div class="col-md-12">
                            <a href="<?php echo base_url()?>survey/preview/<?php echo $survey->id?>?mode=preview" class="nsm-button primary text-center" style="display: block;" target="_blank"><i class="fa fa-eye"></i> Preview on another page</a>
                        </div>  
                    </div>
                  </div>
                </div>                      
                ...
                <!-- Modal Share -->
                <div class="modal fade nsm-modal fade" id="modalShare" aria-labelledby="modalShareLabel" aria-hidden="true">
                    <div class="modal-dialog modal-lg">
                        <div class="modal-content">
                            <div class="modal-header">
                                <span class="modal-title content-title" id="new_feed_modal_label">Share your survey to others</span>
