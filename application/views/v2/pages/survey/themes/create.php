                ...
                <div class="row">
                    <div class="col-12">
                        <div class="nsm-callout primary">
                            ...
                            <div>Create your own theme<br /><br /><i class='bx bxs-info-circle' ></i> Before submitting your theme, make sure you view first your design before submitting your theme.</div>
                        </div>
                    </div>
                </div>
                ...
                <?= form_open_multipart('survey/themes/add', array('id'=>'frm-add-survey-theme'))?>
                    ...
                    <div class="row">
                      <div class="col-12 mt-3 text-end">
                          ...
                          <button id="btnSubmit" class="nsm-button primary" type="submit" style="margin:5px;">Create Theme</button>                          
                      </div>
                    </div>
