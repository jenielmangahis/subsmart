                    ...
                    <div class="nsm-card primary h-auto">
                        ...
                        <div class="nsm-card-content">
                            <div class="color-box-custom">
                                ...
                                <input id="EVENT_COLOR" name="event_color" type="hidden" value="#2e9e39">
                            </div>
                        </div>
                    </div>
                </div>
                            ...
                            <div class="row">
                                <div class="col-lg-12">
                                    <div class="float-end">                 
                                        ...
                                        <button class="nsm-button primary" type="submit" id="btn-save">Schedule</button>
                                    </div>
                                </div>
                            </div>
                        </div>
...
$(function () {
    ...
    $('#ADD_EVENT_FORM').submit(function (e) {
        ...
        if( location == '' ){
            ...
            $.ajax({
                type: 'POST',
                url: base_url + 'events/event_save',
                data: $('#ADD_EVENT_FORM').serialize(),
                dataType: 'json',
                success: function(response) {
                    $('#btn-save').html('Schedule');
                ...
                $('#btn-save').html('<div class="col"><span class="bx bx-loader bx-spin"></span></div>'); 
                }
            });        
        }    
    });
