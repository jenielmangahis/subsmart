            ...
            <div class="nsm-page-content">
                <div class="row">
                    <div class="col-12 grid-mb">
                        <div class="nsm-callout primary">Create your own event type</div>
                    </div>
                </div>
                ...
                <div class="row">
                    ...
                    <div class="col-12 mt-3 text-end">
                        <button type="button" name="btn_back" class="nsm-button" onclick="location.href='<?php echo url('event_types/index') ?>'">Go Back to Event Type List</button>
