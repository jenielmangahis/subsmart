                                            ...
                                            <?php foreach($customize_lead_forms_default as $formDefault){ ?>
                                                <tr>
                                                    ...
                                                    <td style="text-align:center;">
                                                        <input class="form-check-input" type="checkbox" id="" value="" checked="" disabled="">
                                                    </td>
                                                    <td style="text-align:center;">
                                                        <input class="form-check-input" type="checkbox" id="" value="" checked="" disabled="">
                                                    </td>
                            ...
                            <div class="nsm-card-content">
                                <div class="row mb-3">                                    
                                    <div class="col-sm-12 col-md-6">
                                        ...
                                        <select name="" class="nsm-field form-select" id="form-text-size">
                                    ...
                                    <div class="col-sm-12 col-md-6">
                                        ...
                                        <input type="color" style="width:30%;height:32px;" class="form-control" id="form-text-color">
                                    </div>
                                    <div class="col-sm-12 col-md-6">
                                        <label for="form-text-font" class="col-sm-2 col-form-label">Text Font</label>
                                        <select name="" class="nsm-field form-select" id="form-text-font">
                                    ...
                                    <div class="col-sm-12 col-md-6">
                                        ...
                                        <input type="color" style="width:30%;height:32px;" class="form-control" id="form-button-color">
                                    </div>
                                    <div class="col-sm-12 col-md-6">
                                        <label for="form-text-font" class="col-sm-12 col-form-label">Text Font</label>
                                        <select name="" class="nsm-field form-select" id="form-text-font">
                                            <option value="roboto">Roboto</option>
                                            <option value="Open Sans">Open Sans</option>
                                            <option value="Lato">Lato</option>
                                    ...
                                    <div class="col-sm-12 col-md-6">
                                        ...
                                        <input type="color" style="width:30%;height:32px;" class="form-control" id="form-button-text-color">
                                    </div>
                                        ...
                                        <div class="row mb-3">   
                                            <div class="col-sm-12 col-md-6">
                                                <div class="form-check form-check-inline">
                                                    <input class="form-check-input" type="checkbox" id="custom-form-notification-email" value="option1">
                                                    <label class="form-check-label" for="custom-form-notification-email">Email</label>
                                                </div>
                                                <div class="form-check form-check-inline">
                                                    <input class="form-check-input" type="checkbox" id="custom-form-notification-app" value="option2">
...
<?php include viewPath('v2/pages/inquiry/js/index'); ?>
