    ...
    <div class="col-12">
        ...
        <table class="table inquiry-details">
            ...
            <tr>
                ...
                <td><?php echo $inquiry->phone != '' ? formatPhoneNumber($inquiry->phone) : '---'; ?></td>
            </tr>
            <tr>
                <td class="td-label">Email</td>
                <td><?php echo $inquiry->email != '' ? $inquiry->email : '---'; ?></td>
            </tr>
            <tr>
            ...
            <tbody>
                <?php foreach($bookingItems as $bi){ ?>
                    ...
                    <tr>
                        ...
                        <td><?php echo $bi->item_unit != '' ? $bi->item_unit : 'each'; ?></td>
                        <td style="text-align:right;"><?php echo number_format($bi->item_price,2); ?></td>                        
                        <td style="text-align:right;"><?php echo number_format($bi->total_amount, 2); ?></td>
                    </tr>
                <?php } ?>
            </tbody>
        </table>
