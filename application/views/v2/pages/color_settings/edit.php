            ...
            <div class="nsm-page-content">
                <div class="row">
                    <div class="col-12 grid-mb">
                        <div class="nsm-callout primary">Edit Color</div>
                    </div>
                </div>
                            ...
                            <div class="nsm-card-content">
                                <div class="row g-3">
                                    <div class="col-4 col-md-4">
                                        ...
                                        <input type="text" name="color_name" value="<?= $colorSetting->color_name; ?>" class="nsm-field form-control" required="" autocomplete="off" />
                                    </div>
                                    <div class="col-4 col-md-2">
                                        <label class="content-subtitle fw-bold d-block mb-2">Color</label>
                                        <input type="text" name="color_code" class="nsm-field form-control colorpicker" value="<?= $colorSetting->color_code; ?>" required="" autocomplete="off">
                                    </div>
                                </div>
                            </div>
                        </div>
