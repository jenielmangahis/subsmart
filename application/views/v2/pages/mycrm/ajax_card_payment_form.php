	...
	<div class="col-6">
		...
		<div class="col-auto">
			<div class="input-group">
				...
				<input type="number" class="form-control" value="<?= number_format($num_license, 2); ?>" disabled="">
			</div>
		</div>
	</div>
	<div class="col-6">
		...
		<div class="col-auto">
			<div class="input-group">
				...
				<input type="number" class="form-control" value="<?= number_format($total_cost, 2); ?>" disabled="">
			</div>
		</div>
	</div>
	<div class="col-6"></div>
