<div class="row">
	<div class="col-12 col-md-12 mt-2">
		<div id="subscription-payment-element"></div>
		<button id='subscription-payment-btn' class="btn btn-primary mt-3" type="submit" style="margin-top: 20px; width: 100%;padding: 7px;">PAY</button>
	</div>
</div>
<script>
    $(function(){
		...
		paymentForm.addEventListener('submit', async (e) => {
			...
			return;
				...
				$('#subscription-payment-intent-id').val(payment_intent_id);
				process_subscription_payment();
			}
		});

		function process_subscription_payment(){
			var url = base_url + 'mycrm/_process_subscription_payment';
			$.ajax({
				type: "POST",
				url: url,
				dataType: "json",
