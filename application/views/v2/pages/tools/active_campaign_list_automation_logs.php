    ...
    <div class="col-12">
        <div class="nsm-page">
            <div class="nsm-page-content">
                <div class="row">
                    <div class="col-8">
                        <h1>Active Campaign : Export List / Automation Logs</h1>                        
                    </div>                    
                </div>
                <div class="row mt-5">
                    <div class="col-12 grid-mb text-end">
                        <div class="nsm-page-subnav">
                            <ul>                                
                                <li class="active" onclick="location.href='<?= base_url('tools/active_campaign_list_automation_logs') ?>'">
                                    <a class="nsm-page-link" href="javascript:void(0);">
                                        <span>List / Automation</span>
                                    </a>
                                </li>
                                <li class="" onclick="location.href='<?= base_url('tools/active_campaign_customer_logs') ?>'">
                                    <a class="nsm-page-link" href="javascript:void(0);">
                                        <span>Customer</span>
                                    </a>
                                </li>
                ...
                <div class="row mb-5">
                    <div class="col-12">
                        <table class="nsm-table mt-5">                        
                            <thead>
                                <tr>
                                    <td class="table-icon" data-name="CustomerName" style="width:40%;">Customer Name</td>
                                    <td data-name="Type" style="width:10%;">Type</td>                                    
                                    <td data-name="ListAutomationName">List / Automation Name</td>       
                                    <td data-name="ActionDate">Action</td>    
                                    <td data-name="Errors">Errors</td>       
                                </tr>
                            </thead>
                            <tbody>
                                <?php foreach($activeCampaignListAutomationLogs as $log){ ?>
                                    <tr>
...
$(function(){
    ...
    $('#filter-logs').on('change', function(){
        var filter = $(this).val();
        if( filter == 'all' ){
            location.href = base_url + 'tools/active_campaign_list_automation_logs';
        }else{
            location.href = base_url + 'tools/active_campaign_list_automation_logs?filter=' + filter;    
        }
