<div class="row gy-3 text-center">
    ...
    <div class="col-12">
        ...
        <textarea placeholder="Secret Key" name="stripe_secret_key" class="nsm-field form-control" required><?= $stripe ? $stripe->stripe_secret_key : ''; ?></textarea>
    </div>
    <div class="col-12">
        <label class="content-subtitle d-block mb-2 fw-bold">Publish Key</label>
        <textarea placeholder="Publish Key" name="stripe_publish_key" class="nsm-field form-control" required rows=3><?= $stripe ? $stripe->stripe_publish_key : ''; ?></textarea>
    </div>
</div>