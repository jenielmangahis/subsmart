    ...
    <div class="card-body">
        ...
        <div class="row mb-2">
            <div class="col-md-12">
                <div class="input-group">
                    ...
                    <select class="form-select <?php echo "thumbnailFilter3_$id"; ?>">
        ...
        <div class="row">
            ...
            <div class="col text-nowrap <?php echo "textDataContainer_$id"; ?>">
                <div class="text-center textData">
                    <small class="text-muted text-uppercase fw-bold">TOTAL SUBSCRIBERS</small>
                    <br>
...
<script>
    ...
    function <?php echo "processData_$id"; ?>(category, dateFrom, dateTo, filter3) { 
        $.ajax({
            ...
            success: function(response) {
                if (response != "null") {
                    let <?php echo "textData1_$id"; ?> = new Intl.NumberFormat('en-US', { style: 'currency', currency: 'USD' }).format(JSON.parse(response)['TOTAL_SUBSCRIPTION_REVENUE']);
                    let <?php echo "textData2_$id"; ?> = JSON.parse(response)['TOTAL_SUBSCRIBERS'];
    ...
    let <?php echo "options_$id"; ?> = {
        ...
        xaxis: { categories: [] },
        chart: { height: 150, type: 'area', zoom: { enabled: false }, toolbar: { show: false } },
