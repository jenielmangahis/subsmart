...
// }
$category = "estimates";
$thumbanailName = "Estimates";
$description = "Estimate tracks pending cost proposals. This card displays the total number of open and expired estimates.";
        ...
        <div class="row">
            <div class="col textData_<?php echo $id; ?> <?php echo $isListView == 1 ? 'display_none' : ''; ?>">
                <div class="text-center p-2">
                    ...
                    <h2 id="first_content_<?php echo $id; ?>" class="mb-0"><?php echo count($estimates); ?></h2>
                </div>
            </div>
            <div class="col textData_<?php echo $id; ?> <?php echo $isListView == 1 ? 'display_none' : ''; ?>">
                <div class="text-center p-2">
                    <strong class="text-muted text-uppercase">TOTAL EXPIRED</strong>
                    <h2 id="second_content_<?php echo $id; ?>" class="mb-0"><?php echo count($expired_estimates); ?></h2>
                </div>
            </div>
