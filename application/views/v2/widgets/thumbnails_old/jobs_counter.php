...
<div class="<?php echo $class; ?>" data-id="<?php echo $id; ?>" id="thumbnail_<?php echo $id; ?>" draggable="true">
            ...
            <div class="nsm-card-header">
                <div class="nsm-card-title summary-report-header">
                    <div class="summary-report-header-sub ">
                        ...
                        <a role="button" class=" btn-sm m-0 me-2" href="job" style="color:#dc3545c9 !important ">
                            Job
                        </a>
                    </div>
    ...
    border: none;' onChange="filterThumbnail(this.value, '<?php echo $id; ?>', 'jobs')">
    ...
    <div class="nsm-card-content"
        ...
        <h1 id='JobsGraphLoader'> <span class="bx bx-loader bx-spin"></span></h1>
        <canvas id="JobsThumbnailGraph" style="max-height:100%;" class="nsm-chart"  data-chart-type="widgets/jobs_counter" data-chart-id="<?php echo $id; ?>"></canvas>
    </div>
