...
$category = "jobs";
$thumbanailName = "Job";
$description = "Job tracks work progress from scheduling to payment. This card displays the total number of jobs recorded.";
        ...
        <div class="row">
            <div class="col textData_<?php echo $id; ?> <?php echo $isListView == 1 ? 'display_none' : ''; ?>">
                <div class="text-center p-2">
                    <strong class="text-muted text-uppercase">JOBS COUNT</strong>
                    <h2 id="first_content_<?php echo $id; ?>" class="jobs_count_thumbnail"><span class="bx bx-loader bx-spin"></span></h2>
                </div>
            </div>
            <div class="col graphData_<?php echo $id; ?> <?php echo $isListView == 0 ? 'display_none' : ''; ?>">
                <div class="text-center p-2">
                    <canvas id="JobsThumbnailGraph" class="nsm-chart"  data-chart-type="widgets/jobs_counter" data-chart-id="<?php echo $id; ?>" style="max-height: 120px;"></canvas>
                </div>
            </div>
        </div>
