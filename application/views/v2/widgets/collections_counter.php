...
// }
$category = "collection";
$thumbanailName = "Collections";
$description = "Collection tracks overdue payments from customers. This card displays unpaid invoices that are overdue by more than 90 days.";
        ...
        <div class="row">
            <div class="col textData_<?php echo $id; ?> <?php echo $isListView == 1 ? 'display_none' : ''; ?>">
                <div class="text-center p-2">
                    <strong class="text-muted text-uppercase">TOTAL COLLECTIONS</strong>
                    <h2 id="first_content_<?php echo $id; ?>" class="mb-0"><?php echo $collection->total > 0 ?  '$'.number_format($collection->total, 2, ".", ",")  : '$0'; ?></h2>
                </div>
            </div>
            <div class="col graphData_<?php echo $id; ?> <?php echo $isListView == 0 ? 'display_none' : ''; ?>">
                <div class="text-center p-2">
                    <canvas id="collectionGraph" class="nsm-chart" data-chart-type="widgets/collections_counter" data-chart-id="<?php echo $id; ?>" style="max-height: 120px;"></canvas>
                </div>
            </div>
        </div>
