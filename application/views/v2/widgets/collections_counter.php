...
<div class="<?php echo $class; ?> collection-thumbnail" data-id="<?php echo $id; ?>" id="thumbnail_<?php echo $id; ?>" draggable="true">
    ...
    <div class="nsm-card-content"
        ...
        <canvas id="collectionGraph" style="max-height:100%;" class="nsm-chart" data-chart-type="widgets/collections_counter" data-chart-id="<?php echo $id; ?>"></canvas>
    </div>
    <div class="nsm-card-content"
