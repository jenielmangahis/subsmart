...
$thumbanailName = "Unpaid Invoices";
$description = "Unpaid invoices track outstanding balances. This card displays the total amount of invoices that have not been paid.";
        ...
        <div class="row">
            <div class="col textData_<?php echo $id; ?> <?php echo $isListView == 1 ? 'display_none' : ''; ?>">
                <div class="text-center p-2">
                    ...
                    <h2 id="first_content_<?php echo $id; ?>">$<?php echo get_invoice_amount('unpaid_thumb_widget'); ?></h2>
                </div>
            </div>
            <div class="col graphData_<?php echo $id; ?> <?php echo $isListView == 0 ? 'display_none' : ''; ?>">
                <div class="text-center p-2">
                    <canvas id="UnpaidInvoicesWidgetsGraph" class="nsm-chart"  data-chart-type="widgets/unpaid_invoices_counter" data-chart-id="<?php echo $id; ?>" style="max-height: 120px;"></canvas>
                </div>
            </div>
        </div>
