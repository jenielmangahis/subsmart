...
$thumbanailName = "Open Invoices";
$description = "Open invoices track outstanding payments. This card displays the total number of unpaid invoices.";
        ...
        <div class="row">
            <div class="col textData_<?php echo $id; ?> <?php echo $isListView == 1 ? 'display_none' : ''; ?>">
                <div class="text-center p-2">
                    <strong class="text-muted text-uppercase">TOTAL OPEN INVOICES</strong>
                    <h2 id="first_content_<?php echo $id; ?>"><?php echo count($open_invoices); ?></h2>
                </div>
            </div>
            <div class="col graphData_<?php echo $id; ?> <?php echo $isListView == 0 ? 'display_none' : ''; ?>">
                <div class="text-center p-2">
                    <canvas id="OpenInvoicesGraph" class="nsm-chart"  data-chart-type="widgets/open_invoices_counter" data-chart-id="<?php echo $id; ?>" style="max-height: 120px;"></canvas>
                </div>
            </div>
        </div>
