        ...
        <div class="estimates-container">
            <div class="estimates-items">
                <div class="row mb-4 mt-2 filter">
                    ...
                    <div class="col-4">
                        <input type="text" id="widget-open-estimates-filter-from"
                            class="nsm-field form-control widget-open-estimates-datepicker"
                            value="<?= date('01/Y') ?>" />
                    </div>
                    <div class="col-4">
                        <input type="text" id="widget-open-estimates-filter-to"
                            class="nsm-field form-control widget-open-estimates-datepicker" value="<?= date('m/Y') ?>"
                            required>
                    </div>
                </div>
            ...
            switch ($(this).val()) {
                ...
                case 'this-year':
                    ...
                    var from_date = String(1).padStart(2, '0') + '/' + String(1).padStart(2, '0') + '/' + date
                        .getFullYear();
                    var to_date = String(12).padStart(2, '0') + '/' + String(31).padStart(2, '0') + '/' + date
                        .getFullYear();
                    break;
                default:
                    var date = new Date();
