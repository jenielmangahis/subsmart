...
<head>
    <meta charset="UTF-8">
    <title>Customer Cancellation Request</title>
        ...
        <div style="width: 500px; margin: 0 auto; text-align: center;">
            ...
            <div style="margin: auto; text-align: center; padding: 20px;">
                <h1 style="text-align: center; font-size: 36px; margin-bottom: 0;">
                    Hi <span style="color: #6a4a86;"><?= ucwords(strtolower($name)); ?></span>!
                </h1>
            </div>

            <div class="content">
                    <p>A request for cancellation for customer <b><?= $customer_name; ?></b> has been sent. To view cancellation request click button below.</p>
                    <p>Let's get started.</p>
                    <div style="text-align: center; margin: 30px 0;">
                        <a href="<?= $cancellation_url; ?>" class="button button-primary" style="color: white !important;">View Request</a>
                    </div> 
                    <br /><br />
