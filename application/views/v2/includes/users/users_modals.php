    ...
    <div class="modal-dialog modal-lg modal-dialog-centered modal-dialog-scrollable">        
            <div class="modal-content">
                ...
                <div class="modal-footer">
                    ...
                    <button type="submit" name="btn_modal_save" id="btn-save-employee" class="nsm-button primary" form="add_employee_form">Save</button>
                </div>
            </div>
        ...
        <div class="modal-content">
            ...
            <div class="modal-body">
                <form method="POST" id="edit_employee_form">
                    <div id="edit_employee_container"></div>
                </form>
            </div>
            <div class="modal-footer">
                <button type="button" name="btn_modal_close" class="nsm-button" data-bs-dismiss="modal">Close</button>
                <button type="submit" name="btn_modal_save" id="btn-update-employee" class="nsm-button primary" form="edit_employee_form">Save</button>
            </div>
        </div>
    </div>
</div>
