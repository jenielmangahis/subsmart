    ...
    <div class="nsm-container">
        ...
        <div class="nsm-sidebar general-transition" style="padding:1rem;">
            ...
            <ul class="nsm-sidebar-menu">
                ...
                <li class="<?= $page_title == 'Customers' ? 'selected' : ''; ?>">
                ...
                <li class="<?= $page_title == 'SMS' ? 'selected' : ''; ?>">
                    <a href="<?= base_url("admin/sms") ?>">
                        <i class='bx bx-fw bx-message-square-dots'></i> SMS
                    </a>
                </li>
                <li class="<?= $page_title == 'Calls' ? 'selected' : ''; ?>">
                    <a href="<?= base_url("admin/calls") ?>">
                ...
                <li class="<?php if($page_parent == 'Settings'): echo 'active'; endif; ?>">
                    ...
                    <ul class="mt-3">
                        ...
                        <li class="<?php if($page_title == 'Lead Types'): echo 'selected'; endif; ?>">
                            <a href="<?= base_url("admin/lead_types") ?>">
                                <i class='bx bx-fw bx-list-ul'></i> Lead Types
                            </a>
                        </li>
                    </ul>
                </li>
