                            ...
                            <ul class="timeline">
                                <li class="timeline-item mb-5" id="timeline-item-1">
                                    <div class='col-12 d-flex gap-1'>
                                        ...
                                        <div class="entity-dropdown-container">
                                            <h4 id="entityDropdownBtn" class='cursor-pointer me-1 text-underline nsm-text primary fw-bold'>
                                                this happens
                                            </h4>
                                                            ...
                                                            <div class="accordion-item" style="border: none !important;">
                                                                <h2 class="accordion-header" id="heading<?php echo $index ?>">
                                                                    <button class="accordion-button collapsed" type="button" data-bs-toggle="collapse" data-bs-target="#collapse<?php echo $index ?>" aria-expanded="false" aria-controls="collapse<?php echo $index ?>">
                                                                        <i class="bx
                                                                        <?php echo $iconClass ?> me-3"></i><?php echo $article ?><?php echo $type ?>
                                                                    </button>
                                                                </h2>
                                        ...
                                        <div class="event-dropdown-container d-flex">
                                            <h4 id="eventDropdownBtn" class='cursor-pointer me-1 text-underline nsm-text fw-bold'>
                                        ...
                                        <div class="status-dropdown-container d-flex d-none">
                                            <h4 class='cursor-pointer  me-1'>
                                                of <span id="statusDropdownBtn" class=" text-underline nsm-text fw-bold">new</span>
                                            </h4>
                                ...
                                <li class="timeline-item d-flex mb-5" id="timeline-item-2" style="flex-flow: wrap;">
                                  <div class="operation-dropdown-container">
                                            <h4 id="operationDropdownBtn" class='cursor-pointer me-1 text-underline nsm-text fw-bold'>
                                                do this
                                            </h4>
                                        ...
                                        <div class="target-dropdown-container d-none">
                                            <h4 id="targetDropdownBtn" class='cursor-pointer me-1 text-underline nsm-text fw-bold'>
                                        ...
                                        <div class="action-dropdown-container d-none">
                                            <h4 id="actionDropdownBtn" class='cursor-pointer me-1  text-underline nsm-text fw-bold'></h4>
                                        ...
                                        <div class="time-dropdown-container d-none">
                                            <h4 id="timeDropdownBtn" class='cursor-pointer me-1  text-underline nsm-text fw-bold'></h4>
                                            <div class="dropdown-menu p-3" id="timeDropdownMenu" style="width: 400px;">
                                                <h6>Choose time:</h6>
                                                <div class="row gutter g-3">
                                                    <div class="col-4">
                                                        <button type="button" class="nsm-button-outlined primary w-100 time-btn" data-value='0'>immediately</button>
                                                    </div>
                                                    <div class="col-4">
                                                        <button type="button" class="nsm-button-outlined primary w-100 time-btn" data-value='10'>10 min</button>
                                                    </div>
                                                    <div class="col-4">
                                                        <button type="button" class="nsm-button-outlined primary w-100 time-btn" data-value='20'>20 min</button>
                                                    </div>
                                                    <div class="col-4">
                                                        <button type="button" class="nsm-button-outlined primary w-100 time-btn" data-value='30'>30 min</button>
                                                    </div>
                                                    <div class="col-4">
                                                        <button type="button" class="nsm-button-outlined primary w-100 time-btn" data-value='60'>1 hour</button>
                                                    </div>
                                                    <div class="col-4">
                                                        <button type="button" class="nsm-button-outlined primary w-100 time-btn" data-value='120'>2 hour</button>
                                                    </div>
                                                    <div class="col-4">
                                                        <button type="button" class="nsm-button-outlined primary w-100 time-btn" data-value='1440'>1 day</button>
                                                    </div>
                                                </div>
                                                <div class="container py-3">
                                                    ...
                                                    <div class="row gutter g-3">
                                                        <div class="col-6">
                                                            <button type="button" class="nsm-button-outlined primary w-100 timing-btn">ahead of</button>
                                                        </div>
                                                        <div class="col-6">
                                                            <button type="button" class="nsm-button-outlined primary w-100 timing-btn">after</button>
                                                        </div>
                                                    </div>
                                                </div>
                                                <div class="container">
                                        ...
                                        <div class="date-dropdown-container d-none">
                                            <h4 class='  me-1'>
                                                the <span id="dateDropdownBtn" class="cursor-pointer text-underline nsm-text fw-bold">date</span>
                                            </h4>
