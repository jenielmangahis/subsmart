<div class="nsm-page-subnav">
    <ul>
        <li class="<?php if($page->title == 'Workorder' || $page->title == 'Work Orders' || $page->title == 'Edit Work Order' || $page->title == 'New Workorder' || $page->title == 'New Work Order' || $page->title == 'Solar Stimulus Data Control / 2022 - 2024' || $page->title == 'Alarm System Work Order Agreement'): echo 'active'; endif; ?>" onclick="location.href='<?= base_url('workorder') ?>'">
