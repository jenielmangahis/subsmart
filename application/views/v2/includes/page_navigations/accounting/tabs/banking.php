<div class="nsm-page-nav">
    <ul>
        <li class="<?php if ($page->title == 'Link Bank' || $page->title == 'Categorized Link Bank' || $page->title == 'Excluded Link Bank') : echo 'active';
                    endif; ?>">
        ...
        <li class="<?php if ($page->title == 'Rules') : echo 'active';
                    endif; ?>">
        ...
        <li class="<?php if ($page->title == 'Receipts' || $page->title == 'Reviewed Receipts') : echo 'active';
                    endif; ?>">
        ...
        <li class="<?php if ($page->title == 'Tags' || $page->title == 'Transactions by tag') : echo 'active';
                    endif; ?>">
