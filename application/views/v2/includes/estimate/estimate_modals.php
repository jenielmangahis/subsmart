            ...
            <div class="modal-body">
                <div class="row text-center gy-3">
                    ...
                    <div class="col-12">
                        ...
                        <button type="button" class="nsm-button w-50 primary" onclick="window.open('<?php echo base_url('estimate/add?customer=' . $profile_info->prof_id) ?>', '_blank','location=yes, height=650, width=1200, scrollbars=yes, status=yes');">Standard Estimate</button>
                    </div>
                    <div class="col-12">
                        <label class="content-subtitle d-block mb-2">Customers can select all or only certain options</label>
                        <button type="button" class="nsm-button w-50 primary" onclick="window.open('<?php echo base_url('estimate/addoptions?type=2&customer=' . $profile_info->prof_id) ?>', '_blank','location=yes, height=650, width=1200, scrollbars=yes, status=yes');">Options Estimate</button>
                    </div>
                    <div class="col-12">
                        ...
                        <button type="button" class="nsm-button w-50 primary" onclick="window.open('<?php echo base_url('estimate/addbundle?type=3&customer=' . $profile_info->prof_id) ?>', '_blank','location=yes, height=650, width=1200, scrollbars=yes, status=yes');">Bundle Estimate</button>
                    </div>
                </div>
            </div>
