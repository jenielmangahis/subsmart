...
<div class="modal fade nsm-modal fade" id="new_lender_type_modal" tabindex="-1" aria-labelledby="new_lead_source_modal_label" aria-hidden="true">
    <div class="modal-dialog">
        <form method="POST" id="new_lender_type_form">
            <div class="modal-content">
                <div class="modal-header">
                    <span class="modal-title content-title">Add Lender Type</span>
                    <button type="button" data-bs-dismiss="modal" aria-label="Close"><i class='bx bx-fw bx-x m-0'></i></button>
                </div>
                <div class="modal-body">
                    <div class="row">
                        <div class="col-12">
                            <input type="text" name="lender_name" id="lender_name" class="nsm-field form-control mb-2" required />
                        </div>
                    </div>
                </div>
                <div class="modal-footer">
...
<div class="modal fade nsm-modal fade" id="new_system_size_modal" tabindex="-1" aria-labelledby="new_lead_source_modal_label" aria-hidden="true">
    <div class="modal-dialog">
        <form method="POST" id="new_system_size_form">
            <div class="modal-content">
                <div class="modal-header">
                    <span class="modal-title content-title">Add System Size</span>
                    <button type="button" data-bs-dismiss="modal" aria-label="Close"><i class='bx bx-fw bx-x m-0'></i></button>
                </div>
                <div class="modal-body">
                    <div class="row">
...
<div class="modal fade nsm-modal fade" id="new_proposed_inverter_modal" tabindex="-1" aria-labelledby="new_lead_source_modal_label" aria-hidden="true">
    <div class="modal-dialog">
        <form method="POST" id="new_proposed_inverter_form">
            <div class="modal-content">
                <div class="modal-header">
                    <span class="modal-title content-title">Add Proposed Inverter</span>
                    <button type="button" data-bs-dismiss="modal" aria-label="Close"><i class='bx bx-fw bx-x m-0'></i></button>
                </div>
                <div class="modal-body">
                    <div class="row">
...
<div class="modal fade nsm-modal fade" id="new_proposed_module_modal" tabindex="-1" aria-labelledby="new_lead_source_modal_label" aria-hidden="true">
    <div class="modal-dialog">
        <form method="POST" id="new_proposed_module_form">
            <div class="modal-content">
                <div class="modal-header">
                    <span class="modal-title content-title">Add Proposed Inverter</span>
                    <button type="button" data-bs-dismiss="modal" aria-label="Close"><i class='bx bx-fw bx-x m-0'></i></button>
