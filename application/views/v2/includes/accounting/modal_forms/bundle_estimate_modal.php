<div class="full-screen-modal">
    ...
    <?php else : ?>
    <form onsubmit="updateTransaction(event, this)" id="modal-form" data-href="/accounting/update-transaction/bundle-estimate/<?=$estimate->id?>">
    <?php endif; ?>
                                    ...
                                    <div class="col-12 col-md-4 text-end grid-mb">
                                        ...
                                        <h2>
                                            <span class="transaction-grand-total">
                                                <?php if(isset($estimate)) : ?>
                                                <?php
                                                    $total = ((float)$estimate->bundle1_total) + ((float)$estimate->bundle2_total);
                                        ...
                                        <div class="accordion">
                                            <div class="accordion-item">
                                                <h2 class="accordion-header">
                                                    <button class="accordion-button content-title" type="button" data-bs-toggle="collapse" data-bs-target="#collapse-bundle-1" aria-expanded="false" aria-controls="collapse-bundle-1">
                                                        Bundle 1 Items
                                                    </button>
                                                </h2>
                                                <div id="collapse-bundle-1" class="accordion-collapse collapse show">
                                                    <div class="accordion-body">
                                                        <div class="row">
                                                            <div class="col-12 mb-2">
                                                                <table class="nsm-table" id="bundle-1-item-table">
                                                                    <thead>
                                                                    ...
                                                                    <tbody>
                                                                        <?php if(isset($itemsBundle1) && count($itemsBundle1) > 0) : ?>
                                                                            <?php foreach($itemsBundle1 as $item) : ?>
                                                            ...
                                                            <div class="col-12 col-md-6">
                                                                <label for="bundle-1-message">Bundle 1 Message</label>
                                                                <textarea name="bundle_1_message" id="bundle-1-message" cols="40" rows="2" class="form-control nsm-field mb-2"></textarea>
                                                            </div>
                                                                    ...
                                                                    <tfoot>
                                                                        ...
                                                                        <tr>
                                                                            ...
                                                                            <td>
                                                                                ...
                                                                                <?php if(isset($estimate)) : ?>
                                                                                    <?php
                                                                                    $amount = '$'.number_format(floatval($estimate->bundle1_total), 2, '.', ',');
                                                                                    $amount = str_replace('$-', '-$', $amount);
                                                                                    echo $amount;
                                                                                    ?>
                                                                                <?php else : ?>
                                ...
                                <div class="row">
                                    <div class="col-12 grid-mb">
                                        <div class="accordion">
                                            <div class="accordion-item">
                                                <h2 class="accordion-header">
                                                    <button class="accordion-button content-title" type="button" data-bs-toggle="collapse" data-bs-target="#collapse-bundle-2" aria-expanded="false" aria-controls="collapse-bundle-2">
                                                        Bundle 2 Items
                                                    </button>
                                                </h2>
                                                <div id="collapse-bundle-2" class="accordion-collapse collapse show">
                                                    <div class="accordion-body">
                                                        <div class="row">
                                                            <div class="col-12 mb-2">
                                                                <table class="nsm-table" id="bundle-2-item-table">
                                                                    <thead>
                                                                        <td data-name="Item">ITEM</td>
                                                                        <td data-name="Group">GROUP</td>
                                                                        <td data-name="Quantity">QUANTITY</td>
                                                                    ...
                                                                    <tbody>
                                                                        <?php if(isset($itemsBundle2) && count($itemsBundle2) > 0) : ?>
                                                                            <?php foreach($itemsBundle2 as $item) : ?>
                                                                                <?php $itemDetails = $item->itemDetails;?>
                                                                                <?php $locations = $item->locations;?>
                                                                                <tr>
                                                                                    <td><?=$itemDetails->title?><input type="hidden" name="item[]" value="<?=$item->item_id?>"></td>
                                                            ...
                                                            <div class="col-12 col-md-6">
                                                                <label for="bundle-2-message">Bundle 2 Message</label>
                                                                <textarea name="bundle_2_message" id="bundle-2-message" cols="40" rows="2" class="form-control nsm-field mb-2"></textarea>
                                                            </div>
                                                            <div class="col-12 col-md-3 offset-md-3">
                                                                <table class="nsm-table float-end text-end" style="width: 75%">
                                                                    <tfoot>
                                                                        <tr>
                                                                            <td>Subtotal</td>
                                                                            <td>
                                                                        ...
                                                                        <tr>
                                                                            <td>
                                                                                <div class="row justify-content-end">
                                                                                    ...
                                                                                    <!-- <div class="col-3">
                                                                                        <input type="number" name="adjustment_value" step=".01" class="form-control nsm-field adjustment_input_cm_c" onchange="convertToDecimal(this)" value="<?=isset($estimate) ? number_format(floatval($estimate->bundle_discount), 2, '.', ',') : ''?>">
                                                                                    </div> -->
                                                                                </div>
                                                                            </td>
                                                                            <td>
                                                                                <input style="float: right; width: 75px;" type="number" name="adjustment_value" step=".01" class="form-control nsm-field adjustment_input_cm_c" onchange="convertToDecimal(this)" value="<?=isset($estimate) ? number_format(floatval($estimate->bundle_discount), 2, '.', ',') : ''?>">
                                                                                <!-- <span class="table-adjustment">
                                                                                    <?php if(isset($estimate)) : ?>
                                                                                        <?php
                                                                                        $amount = '$'.number_format(floatval($estimate->bundle_discount), 2, '.', ',');
                                                                                        $amount = str_replace('$-', '-$', $amount);
                                                                                        echo $amount;
                                                                                        ?>
                                                                                    <?php else : ?>
                                                                        ...
                                                                        <tr>
                                                                            ...
                                                                            <td>
                                                                                ...
                                                                                <?php if(isset($estimate)) : ?>
                                                                                    <?php
                                                                                    $amount = '$'.number_format(floatval($estimate->bundle2_total), 2, '.', ',');
                                                                                    $amount = str_replace('$-', '-$', $amount);
                                                                                    echo $amount;
                                                                                    ?>
                                                                                <?php else : ?>
