                            ...
                            <div class="dropdown mr-1">
                                ...
                                <div class="dropdown-menu p-3" style="width: 500px">
                                    ...
                                    <table class="nsm-table cursor-pointer recent-transactions-table" id="recent-vendor-credits">
                                        <tbody>
                                            <?php if(!empty($recent_vcredits)) : ?>
                                                <?php foreach($recent_vcredits as $recentVCredit) : ?>
                                                    <tr data-id="<?=$recentVCredit['id']?>" onclick="viewTransaction(this, event)">
                                                        <td><?=$recentVCredit['type']?></td>
                                                        <td><?=$recentVCredit['date']?></td>
                                                        <td><?=$recentVCredit['amount']?></td>
                                                        <td><?=$recentVCredit['name']?></td>
                                                    </tr>
                                                <?php endforeach; ?>
                                            <?php else : ?>
