                                    ...
                                    <div class="row" id="invoices-container">
                                        ...
                                        <div class="col-12 col-md-6 grid-mb text-end">
                                            <div class="nsm-page-buttons page-button-container">
                                                ...
                                                <ul class="dropdown-menu dropdown-menu-end" id="invoice-table-rows" style="min-width: min-content; left:95px">
                                                    <p class="m-0 text-center" style="font-weight: 600;">Rows</p>
                                                    <div class="list-group">
                                                        <li><a class="dropdown-item text-center active" href="javascript:void(0);" onclick="invoiceTableRows(this)">50</a></li>
                                                        <li><a class="dropdown-item text-center" href="javascript:void(0);" onclick="invoiceTableRows(this)">75</a></li>
                                                        <li><a class="dropdown-item text-center" href="javascript:void(0);" onclick="invoiceTableRows(this)">100</a></li>
                                                        <li><a class="dropdown-item text-center" href="javascript:void(0);" onclick="invoiceTableRows(this)">150</a></li>
                                                        <li><a class="dropdown-item text-center" href="javascript:void(0);" onclick="invoiceTableRows(this)">300</a></li>
                                                    </div>
                                                </ul>
                                            </div>
                                        </div>
                                    ...
                                    <div class="row" id="credits-container">
                                        ...
                                        <div class="col-12 col-md-6 grid-mb text-end">
                                            <div class="nsm-page-buttons page-button-container">
                                                ...
                                                <ul class="dropdown-menu dropdown-menu-end" id="credits-table-rows" style="min-width: min-content; left:95px">
                                                    <p class="m-0 text-center" style="font-weight: 600;">Rows</p>
                                                    <div class="list-group">
                                                        <li><a class="dropdown-item active" href="javascript:void(0);" onclick="creditsTableRows(this)">50</a></li>
                                                        <li><a class="dropdown-item" href="javascript:void(0);" onclick="creditsTableRows(this)">75</a></li>
