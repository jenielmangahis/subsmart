                                            ...
                                            <div class="row">
                                                <div class="col-12 col-md-6">
                                                    <div class="form-group">
                                                        ...
                                                        <textarea name="message_to_vendor" id="message_to_vendor" class="form-control nsm-field mb-2" rows="4"><?= isset($purchaseOrder) ? str_replace("<br />", "", $purchaseOrder->message_to_vendor) : '' ?></textarea>
                                                    </div>
                                                </div>
                                                <div class="col-12 col-md-6">
                                                    <div class="form-group">
                                                        <label for="memo">Memo</label>
                                                        <textarea name="memo" id="memo" class="form-control nsm-field mb-2" rows="4"><?= isset($purchaseOrder) ? str_replace("<br />", "", $purchaseOrder->memo) : '' ?></textarea>
                                                    </div>
                                                </div>
                                            </div>
                                            <div class="row mt-2">
                                                <div class="col-12 col-md-12">
                                                    <div class="attachments">
                                                        ...
                                                        <div id="purchase-order-attachments" class="dropzone d-block justify-content-center align-items-center" style="border: 1px solid #e1e2e3;background: #ffffff;width: 100%;" data-id="0">
