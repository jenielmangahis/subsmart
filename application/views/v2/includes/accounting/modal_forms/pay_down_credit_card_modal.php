                                                ...
                                                <div class="accordion-body">
                                                    <div class="row">
                                                        <div class="col-12 col-md-12">
                                                            ...
                                                            <textarea name="memo" id="memo" rows="4" class="form-control nsm-field mb-2"><?=isset($ccPayment) ? str_replace("<br />", "", $ccPayment->memo) : ''?></textarea>
                                                        </div>
                                                    </div>
                                                    ...
                                                    <div class="row">
                                                        <div class="col-12 col-md-12">
                                                            <div class="attachments">
                                                                ...
                                                                <div id="cc-payment-attachments" class="dropzone d-block justify-content-center align-items-center" style="border: 1px solid #e1e2e3;background: #ffffff;width: 100%;" data-id="0">
