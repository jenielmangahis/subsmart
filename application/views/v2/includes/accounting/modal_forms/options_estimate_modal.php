                                ...
                                <div class="col">
                                    ...
                                    <div class="row">
                                        <div class="col-12 col-md-6">
                                            ...
                                            <textarea name="customer_message" id="estimate-message-to-customer" cols="40" rows="6" class="form-control nsm-field mb-2"><?= isset($estimate) ? $estimate->customer_message : 'I would be happy to have an opportunity to work with you.' ?></textarea>
                                        </div>
                                        <div class="col-12 col-md-6">
                                            ...
                                            <textarea name="terms_conditions" id="estimate-terms-and-conditions" cols="40" rows="6" class="form-control nsm-field mb-2"><?= isset($estimate) ? $estimate->terms_conditions : '' ?></textarea>
                                        </div>
                                        <div class="col-12 col-md-6">
