<div class="full-screen-modal">
    ...
    <?php else : ?>
    <form onsubmit="updateTransaction(event, this)" id="modal-form" data-href="/accounting/update-transaction/standard-estimate/<?=$estimate->id?>">
    <?php endif; ?>
                                    ...
                                    <div class="col-12 col-md-4 text-end grid-mb">
                                        ...
                                        <h2>
                                            <span class="transaction-grand-total">
                                                <?php if(isset($estimate)) : ?>
                                                <?php
                                                    $amount = '$'.number_format(floatval($estimate->grand_total), 2, '.', ',');
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-12">
                                        <div class="nsm-callout primary">
                                            ...
                                            <span>This is a copy of a standard estimate. Revise as needed and save the standard estimate.</span>
                                        </div>
                                    </div>
                                    <?php endif; ?>
