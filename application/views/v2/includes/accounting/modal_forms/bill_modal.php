...
#billModal .nsm-table .table-checkbox{
    margin: 0 auto;
}
                            ...
                            <div class="row">
                                            ...
                                            <div id="collapse-item-details" class="accordion-collapse collapse <?=isset($items) && count($items) > 0 ? 'show' : ''?>">
                                                <div class="accordion-body">
                                                    <table class="nsm-table" id="item-details-table">
                                                        <thead>
                                                            <tr>
                                                                <td data-name="Product/Service" style="width:20%;">PRODUCT/SERVICE</td>
                                                                <td data-name="Type" style="width:15%;">TYPE</td>
                                                                ...
                                                                <td data-name="Total" style="width:10%;">TOTAL</td>
                                                                <?php if(isset($bill) && !is_null($bill->linked_transacs)) : ?>
                                                                <td data-name="Linked"></td>
                                                                <?php endif; ?>
                                                                <td data-name="Manage" style="width:3%;"></td>
                                ...
                                <div class="col-12 col-md-6 mt-4">                                    
                                    <div class="attachments">
                                        ...
                                        <div id="bill-attachments" class="dropzone d-block justify-content-center align-items-center" style="border: 1px solid #e1e2e3;background: #ffffff;width: 100%;">
                    ...
                    <div class="row w-100">
                        ...
                        <div class="col-md-4">
                            ...
                            <div class="btn-group float-end" role="group">
                                <button type="button" onclick="saveAndCloseForm(event)" class="nsm-button success" id="save-and-schedule-payment">
