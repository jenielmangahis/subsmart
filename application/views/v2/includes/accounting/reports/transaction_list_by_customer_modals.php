            ...
            <div class="modal-body">
                <table class="nsm-table">
                    <thead>
                        ...
                        <tr>
                            <td colspan="<?=37 + count($tag_groups)?>" class="<?=!isset($header_alignment) ? 'text-center' : 'text-'.$header_alignment?>">
                    ...
                    <tbody>
                        ...
                        <tr class="group-header">
                            <td colspan="<?=isset($columns) ? $total_index : '31'?>"><b><?=$transaction['name']?></b></td>
                    ...
                    <tfoot>
                        ...
                        <?php endif; ?>
                        <tr>
                            <td colspan="<?=37 + count($tag_groups)?>" class="<?=!isset($footer_alignment) ? 'text-center' : 'text-'.$footer_alignment?>">
                                        ...
                                        <div class="row g-3 grid-mb">
                                            ...
                                            <div class="col-12 col-md-4">
                                                <select id="custom-group-by" class="form-control nsm-field">
                                                    ...
                                                    <option value="sales-rep" <?=$group_by === 'sales-rep' ? 'selected' : ''?>>Sales Rep</option>
                                                    <option value="po-number" <?=$group_by === 'po-number' ? 'selected' : ''?>>P.O. Number</option>
                                                    <?php foreach($tag_groups as $group) : ?>
                                                    <option value="<?=$group['id']?>"><?=$group['name']?></option>
                                                    <?php endforeach; ?>
                                                    <option value="ungrouped-tags" <?=$group_by === 'ungrouped-tags' ? 'selected' : ''?>>Ungrouped tags</option>
                                                </select>
                                            </div>
                                            <div class="col-12 d-none">
                                                <div class="row g-3">
                                                    ...
                                                    <div class="col-12">
                                                        <div class="form-check">
                                                            <input class="form-check-input" type="checkbox" name="select_columns" value="1" id="select-paid-by-mas" <?=isset($columns) && in_array('Paid by MAS', $columns) || !isset($columns) ? 'checked' : ''?>>
                                                            <label class="form-check-label" for="select-paid-by-mas">
                                                                Paid by MAS
                                                            </label>
                                                        </div>
                                                    </div>
                                                    ...
                                                    <div class="col-12">
                                                        <div class="form-check">
                                                            <input class="form-check-input" type="checkbox" name="select_columns" value="1" id="select-group-<?=$group['id']?>" <?=isset($columns) && in_array($group['name'], $columns) || !isset($columns) ? 'checked' : ''?>>
                                                            <label class="form-check-label" for="select-group-<?=$group['id']?>">
                                                                <?=$group['name']?>
                                                            </label>
                                                        </div>
                                                    </div>
                                                    ...
                                                    <div class="col-12">
                                                        <div class="form-check">
                                                            <input class="form-check-input" type="checkbox" name="select_columns" value="1" id="select-ungrouped-tags" <?=isset($columns) && in_array('Ungrouped Tags', $columns) || !isset($columns) ? 'checked' : ''?>>
                                                            <label class="form-check-label" for="select-ungrouped-tags">
                                                                Ungrouped Tags
                                                            </label>
                                                        </div>
                                                    </div>
                                ...
                                <div id="collapse-filter" class="accordion-collapse collapse">
                                    <div class="accordion-body">
                                        <div class="row grid-mb g-3">
                                            ...
                                            <div class="col-12 col-md-6">
                                                <div class="form-check">
                                                    <input class="form-check-input" type="checkbox" <?=isset($filter_payment_method) ? 'checked' : '' ?> name="filter_payment_method" value="1" id="allow-filter-payment-method">
                                            ...
                                            <div class="col-12 col-md-6">
                                                <div class="form-check">
                                                    <input class="form-check-input" type="checkbox" <?=isset($filter_tags) ? 'checked' : '' ?> name="filter_tags" value="1" id="allow-filter-tags">
                                                    <label class="form-check-label" for="allow-filter-tags">
                                                        Tags
                                                    </label>
                                                </div>
                                            </div>
                                            <div class="col-12 col-md-6">
                                                <select name="filter_tags" id="filter-tags" class="nsm-field form-control">
                                                    <?php if(isset($filter_tags)) : ?>
                                                    <option value="<?=$filter_tags->id?>" selected><?=$filter_tags->name?></option>
                                                    <?php else : ?>
                                                    <option value="all" selected>All</option>
                                                    <?php endif; ?>
                                                </select>
                                            ...
                                            <div class="col-12 col-md-6">
                                                <div class="form-check">
                                                    <input class="form-check-input" <?=isset($filter_sales_printed) ? 'checked' : '' ?> type="checkbox" name="allow_filter_sales_printed" value="1" id="allow-filter-sales-printed">
                                                    <label class="form-check-label" for="allow-filter-sales-printed">
                                                        Sales Printed
                                                    </label>
                                                </div>
                                            </div>
                                            <div class="col-12 col-md-6">
                                                <select name="filter_sales_printed" id="filter-sales-printed" class="nsm-field form-control">
                                                    <option value="all" <?=empty($filter_sales_printed) || $filter_sales_printed === 'all' ? 'selected' : ''?>>All</option>
                                                    <option value="yes" <?=$filter_sales_printed === 'yes' ? 'selected' : ''?>>Printed</option>
                                                    <option value="no" <?=$filter_sales_printed === 'no' ? 'selected' : ''?>>To be printed</option>
                                                </select>
                                            </div>
                                            <div class="col-12 col-md-6">
                                                <div class="form-check">
                                                    <input class="form-check-input" <?=isset($filter_sent) ? 'checked' : '' ?> type="checkbox" name="allow_filter_sent" value="1" id="allow-filter-sent">
                                                    <label class="form-check-label" for="allow-filter-sent">
                                                        Sent
                                                    </label>
                                                </div>
                                            </div>
                                            <div class="col-12 col-md-6">
                                                <select name="filter_sent" id="filter-sent" class="nsm-field form-control">
                                                    <option value="all" <?=empty($filter_sent) || $filter_sent === 'all' ? 'selected' : ''?>>All</option>
                                                    <option value="yes" <?=$filter_sent === 'yes' ? 'selected' : ''?>>Sent</option>
                                                    <option value="no" <?=$filter_sent === 'no' ? 'selected' : ''?>>To be sent</option>
                                                </select>
                                            </div>
                                            <div class="col-12 col-md-6">
                                                <div class="form-check">
...
<div class="modal fade nsm-modal" id="email_report_modal" tabindex="-1" aria-labelledby="email_report_modal_label" aria-hidden="true">
    <div class="modal-dialog modal-lg">
        <div class="modal-content">
            <div class="modal-header">
                <span class="modal-title content-title" id="email_report_modal_label">Email Transaction List by Customer Report</span>
                <button type="button" data-bs-dismiss="modal" aria-label="Close"><i class='bx bx-fw bx-x m-0'></i></button>
            </div>
            <div class="modal-body">
