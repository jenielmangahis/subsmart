...
<div class="modal fade nsm-modal" id="print_customer_transactions_modal" tabindex="-1" aria-labelledby="print_customer_transactions_modal_label" aria-hidden="true">
    <div class="modal-dialog modal-xl">
        <div class="modal-content">
            <div class="modal-header">
                <span class="modal-title content-title" id="print_customer_transactions_modal_label">Print Customer Transactions List</span>
                <button type="button" data-bs-dismiss="modal" aria-label="Close"><i class='bx bx-fw bx-x m-0'></i></button>
            </div>
            <div class="modal-body">
            ...
            <div class="modal-footer">
                <button type="button" class="nsm-button" data-bs-dismiss="modal">Cancel</button>
                <button type="button" class="nsm-button primary" id="btn_print_customer_transactions">Print</button>
            </div>
        </div>
    </div>
</div>
