<div class="modal fade nsm-modal fade" id="tag-group-modal" tabindex="-1" aria-labelledby="tag-group-modal_label" aria-hidden="true">
    <div class="modal-dialog modal-lg modal-dialog-centered modal-dialog-scrollable">        
        
        <div class="modal-content">
            <div class="modal-header">
                <span class="modal-title content-title">Create New Group</span>
                <button type="button" name="btn_modal_close" data-bs-dismiss="modal" id="btn-tag-group-modal-close" aria-label="Close"><i class='bx bx-fw bx-x m-0'></i></button>
            </div>
            ...
            <div class="modal-footer">
                <button class="nsm-button primary" id="done-tag-group" data-bs-dismiss="modal">Done</button>
            </div>                       
        </div>
    </div>
</div>

<div class="modal fade nsm-modal fade" id="tag-modal" tabindex="-1" aria-labelledby="tag_modal_label" aria-hidden="true">
    <div class="modal-dialog modal-lg modal-dialog-centered modal-dialog-scrollable">        
