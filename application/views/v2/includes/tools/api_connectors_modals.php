...
<div class="modal fade nsm-modal fade" id="setup_vonage" tabindex="-1" aria-labelledby="setup_vonage_label" aria-hidden="true">
    <div class="modal-dialog">
        <?php echo form_open_multipart('', ['class' => 'form-validate', 'id' => 'form-vonage-account', 'autocomplete' => 'off']); ?>
        <div class="modal-content">
            <div class="modal-header">
                <span class="modal-title content-title" id="setup_vonage_modal_label">Setup Vonage</span>
                <button type="button" data-bs-dismiss="modal" aria-label="Close"><i class='bx bx-fw bx-x m-0'></i></button>
            </div>
            <div class="modal-body" id="vonage-container"></div>            
        </div>
        <?php echo form_close(); ?>
    </div>
</div>
...
<div class="modal fade nsm-modal fade" id="setup_plaid_modal" tabindex="-1" aria-labelledby="setup_plaid_label" aria-hidden="true">
    <div class="modal-dialog">
        <?php echo form_open_multipart('', ['class' => 'form-validate', 'id' => 'form-plaid-account', 'autocomplete' => 'off']); ?>
        <div class="modal-content">
            <div class="modal-header">
