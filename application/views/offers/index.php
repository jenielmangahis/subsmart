            ...
            <div class="row pt-3">
                <div class="col-xl-12">
                    <div class="card">
                        <div class="card-body" >
                            <div class="col-md-12">
                                <h3 class="page-title float-left">Offers</h3>
                                            ...
                                            <div class="tab-content" id="myTabContent">
                                                <div class="tab-pane fade show active p-3" id="active-offers" role="tabpanel" aria-labelledby="one-tab">
                                                    ...
                                                    <table class="table table-bordered table-striped dataTableOffer">
                                                        ...
                                                        <tbody>
                                                            <?php if ($offers_active_list) {
                                                                foreach ($offers_active_list as $active) { ?>
                                                                    <tr class="">
                                                ...
                                                <div class="tab-pane fade p-3" id="scheduled-offers" role="tabpanel" aria-labelledby="two-tab">
                                                    ...
                                                    <table class="table table-bordered table-striped dataTableOffer">
                                                        ...
                                                        <tbody>
<?php if ($offers_inactive_list) {
    foreach ($offers_inactive_list as $inactive) { ?>
                                                                    <tr class="">
    ...
    <?php }
                                                ...
                                                <div class="tab-pane fade p-3" id="ended-offers" role="tabpanel" aria-labelledby="three-tab">
                                                    ...
                                                    <table class="table table-bordered table-striped dataTableOffer">
                                                        ...
                                                        <tbody>
<?php if ($offers_ended_list) {
    foreach ($offers_ended_list as $ended) { ?>
                                                                    <tr class="">
    ...
    <?php }
                                                ...
                                                <div class="tab-pane fade p-3" id="draft-offers" role="tabpanel" aria-labelledby="four-tab">
                                                    ...
                                                    <table class="table table-bordered table-striped dataTableOffer">
                                                        ...
                                                        <tbody>
<?php if ($offers_draft_list) {
    foreach ($offers_draft_list as $draft) { ?>
                                                                    <tr class="">
