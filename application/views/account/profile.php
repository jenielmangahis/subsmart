  ...
  <div class="col-md-9">
    ...
    <div class="nav-tabs-custom">
      ...
      <ul class="nav nav-tabs">
        ...
        <li <?php echo $activeTab=='change_pic'?'class="active"':'' ?>><a href="#editCompanyProfileImage" onclick="updateUrl('<?php echo url('profile/index/change_pic') ?>')" data-toggle="tab">Change Company Profile Image</a></li>
		...
		<li <?php echo $activeTab=='change_profile_pic'?'class="active"':'' ?>><a href="#editUserProfilePic" onclick="updateUrl('<?php echo url('profile/index/change_profile_pic') ?>')" data-toggle="tab">Change Profile Image</a></li-->
		 
		<li <?php echo $activeTab=='profile'?'class="active"':'' ?>><a style="margin: 10px;" href="#viewProfile" data-toggle="tab">Profile</a></li>

        <li <?php echo $activeTab=='edit'?'class="active"':'' ?>><a style="margin: 10px;" href="#editProfile" data-toggle="tab">Edit</a></li>

         <li <?php echo $activeTab=='change_profile_pic'?'class="active"':'' ?>><a style="margin: 10px;" href="#editUserProfilePic" data-toggle="tab">Change Profile Image</a></li>

        <li <?php echo $activeTab=='change_password'?'class="active"':'' ?>><a style="margin: 10px;" href="#changePassword" data-toggle="tab">Change Password</a></li>
		 
		 <li <?php echo $activeTab=='change_pic'?'class="active"':'' ?>><a style="margin: 10px;" href="#editCompanyProfileImage" data-toggle="tab">Change Company Profile Image</a></li>

     <li <?php echo $activeTab=='signature'?'class="active"':'' ?>><a style="margin: 10px;" href="#editSignature" data-toggle="tab">Signature</a></li>
        ...
        <div class="<?php echo $activeTab=='change_pic'?'active':'' ?> tab-pane" id="editCompanyProfileImage">
          ...
          <?php echo form_open('/profile/updateProfilePic', ['method' => 'POST', 'autocomplete' => 'off', 'class' => 'form-horizontal form-validate', 'enctype' => 'multipart/form-data']); ?> 
            ...
            <div class="form-group">
              ...
              <label for="formAdmin-Image" class="col-sm-2 control-label">Comapny Image</label>
