...
<div class="login-box centered">
  ...
  <div class="login-box-body">
    ...
    <div class="form-group has-feedback">
      <input type="password" class="form-control" placeholder="Password" value="<?php echo $remember_password != '' ? $remember_password : ''; ?>" name="password">
    ...
    <div class="row">
      ...
      <div class="col-xs-4">
        <button name="button" type="submit" class="btn btn-primary btn-block btn-flat">Sign In</button>
      </div>
      <!-- /.col -->
    </div>
    <?php echo form_close(); ?>
