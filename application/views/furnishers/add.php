...
<script>
  $(function () {    
    ...
    $("#frm-create-furnisher").submit(function(e){
      e.preventDefault();
      var aid = $(this).attr("data-id");
      var url = base_url + 'creditor_furnisher/_create_furnisher';
      $(".btn-create-furnisher").html('<span class="spinner-border spinner-border-sm m-0"></span>');

      var formData = new FormData($("#frm-create-furnisher")[0]);   
      ...
      setTimeout(function () {
          $.ajax({
             ...
             {          
                ...
                $(".btn-create-furnisher").html('Save');
             }
          });
      }, 800);
    });
