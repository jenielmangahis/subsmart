...
<link
    ...
    <link href="<?php echo $url->assets ?>dashboard/css/style.css"
        rel="stylesheet" type="text/css">
<div class="wrapper" role="wrapper" style="padding-right:10%;">
    <!-- page wrapper start -->
    <?php 
    $total_amount = 0;
    ?>
                    ...
                    //   print_r($client);
                      ...
                      <div id="" style="">
                        ...
                        <!-- <div class="row">
                                    ...
                                    <input type="hidden" id="savecustomerSignatureDB1a"
    ...
    <div class="modal fade customerSignature" tabindex="-1" role="dialog" aria-labelledby="myLargeModalLabel" aria-hidden="true">
                <div class="modal-dialog modal-lg">
                    <div class="modal-content">
                            <div align="center">
                                <p style="padding:2%;background-color:#d2d2d2;width:380px;"> <b>Customer Signature </b></p>
                                <div align="center"><i><p style="padding:2%;background-color:#d2d2d2;width:80%;"> By Signing below you verify that the information is true and complete,
                                    ...
                                    <div class="box-wrap">
                                        ...
                                        <div id="signArea" >
                                            ...
                                            <input type="hidden" id="savecustomerSignatureDB1aMb" name="company_representative_approval_signature1aM">
                                            </div>
                                            </div>
                                            <br>
                                        </div>
...
$(document).on('click touchstart','#canvasb',function(){
    ...
    $("#savecustomerSignatureDB1aMb").val(dataURL);
});
</script>
