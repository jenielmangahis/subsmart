                    ...
                    <div class="card">
                        <div class="card-body">
                            <div class="row">
                                ...
                                <div class="col-md-3">
                                    <br><br><a class="link-modal-open nsm-link" href="javascript:void(0)" data-toggle="modal" data-target="#modalNewCustomer" style="color:#02A32C;"><span class="fa fa-plus fa-margin-right" style="color:#02A32C;"></span>New Customer</a>
                                </div>
                            </div>
                            <div class="row mb-3">
                                <div class="col-md-6">
