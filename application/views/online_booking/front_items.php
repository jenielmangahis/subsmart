                          ...
                          <td style="width:25%; vertical-align: top;">
                            <?php                      
                                ...
                                if(file_exists('uploads/' . $service_item_thumb) == FALSE || $service_item_thumb == null) {
                                    ...
                                    if(file_exists('uploads/service_item/'.$item->company_id.'/'.$service_item_thumb) == FALSE || $service_item_thumb == null) {
                                        $service_item_thumb_img = base_url('/assets/dashboard/images/online-booking.png');
                                    } else {
                                        $service_item_thumb_img = base_url('uploads/service_item/'.$item->company_id.'/'.$service_item_thumb);
                                    }
