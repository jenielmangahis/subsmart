            ...
            <div class="nsm-page-content">
                ...
                <form name="" data-form="form" style="width:100%;">
                            ...
                            <div class="nsm-card primary">
                                <div class="nsm-card-content">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <textarea cols="40" rows="10" class="form-control ft-instruction ckeditor"><?php echo $setting['page_instructions']; ?></textarea>
                                    </div>
                                    <div class="form-group">
                    ...
                    <div class="row-fluid margin-top">
                        <div class="col-sm-12">
                            <button type="button" class="nsm-button primary btn-update-setting" style="margin-top: 20px;">Save</button>
                        </div>
                    </div>
                </form>
                <?php echo form_close(); ?>
