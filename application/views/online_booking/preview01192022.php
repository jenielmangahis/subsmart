                                ...
                                <div class="form-group">
                                    ...
                                    <div class="row">
                                        <div class="col-sm-12">
                                            ...
                                            ?>
                                            <textarea style="min-height: 200px !important; background-color: #bababa;" class="input-focus form-control" rows="3" readonly="" id="code-iframe">&lt;iframe id="markate-widget-booking-iframe" src="<?= $url; ?>:14356:1c7836db" width="100%" height="1000" scrolling="no" frameborder="0" allowTransparency="true" style="border:none;overflow:hidden"&gt;&lt;/iframe&gt;</textarea>   
                                            <br />
