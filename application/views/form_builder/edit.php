...
<div class="wrapper">
    <div __wrapper_section>
        <div class="card my-2" style="height: 1250px">
            ...
            <div class="text-left">
                <h1><?= $form->forms_title?> <button type="button"
                        onclick="window.open('<?= base_url()?>form/<?=$form->forms_id?>', '_blank')"
                        class="btn btn-outline-info"><i class="fa fa-eye"></i> View Form</button></h1>
            </div>
                    ...
                    <div id="form-editor-window" class="form-editor-settings-window tab-pane fade show active">
                        ...
                        <div class="row">
                            <div class="col-xs-12 col-md-3 ">
                                ...
                                <ul class="nav nav-tabs">
                                    <li class="nav-item">
                                        <a class="nav-link active" data-toggle="list"
                                            href="#form-editor-build-sidenav">Build</a>
                                    </li>
                                    <li class="nav-item">
                                        <a class="nav-link" data-toggle="list"
                                            href="#form-editor-style-sidenav">Style</a>
                                    </li>
                                    <li class="nav-item">
                                        <a class="nav-link" data-toggle="list"
                                            href="#form-editor-rules-sidenav">Rules</a>
                                    </li>
                                </ul>
                                        ...
                                        <div id="accordion" class="overflow-none">
                                            <ul class="list-group">
                                                ...
                                                <li class="list-group-item" data-toggle="collapse"
                                                    data-target="#collapseCommonItemsMenu" aria-expanded="true"
                                                    aria-controls="collapse0">
                                                    Common Items
                                                </li>
                                                <div id="collapseCommonItemsMenu" class="collapse show "
                                                    ...
                                                    <div class="row" style="overflow-x: auto; height: 250px;">
                                                            ...
                                                            <div class="form-elements-draggable" data-element-id="1">
                                                                <div class="card p-1">
                                                                    <div class="card-content element-buttons">
                                                                        <span><i class="fa fa-dot-circle-o"></i> Radio
                                                                            Button</span>
                                                                    </div>
                                                                </div>
                                                            </div>
                                                        ...
                                                        <div class="col-xs-6 col-sm-6">
                                                            <div class="form-elements-draggable" data-element-id="2">
                                                                <div class="card p-1">
                                                                    <div class="card-content element-buttons">
                                                                        <span><i class="fa fa-caret-square-o-down"></i>
                                                                            Dropdown</span>
                                                                    </div>
                                                                </div>
                                                            </div>
                                                        ...
                                                        <div class="col-xs-6 col-sm-6 m-0">
                                                            <div class="form-elements-draggable" data-element-id="5">
                                                                <div class="card p-1">
                                                                    <div class="card-content element-buttons">
                                                                        <span><i class="fa fa-text-width"></i> Long
                                                                            Answer</span>
                                                                    </div>
                                                                </div>
                                                            </div>
                                                        ...
                                                        <div class="col-xs-6 col-sm-6 m-0">
                                                            <div class="form-elements-draggable" data-element-id="9">
                                                                <div class="card p-1">
                                                                    <div class="card-content element-buttons">
                                                                        <span><i class="fa fa-file"></i> File
                                                                            Upload</span>
                                                                    </div>
                                                                </div>
                                                            </div>
                                                        ...
                                                        <div class="col-xs-6 col-sm-6 m-0">
                                                            <div class="form-elements-draggable" data-element-id="10">
                                                                <div class="card p-1">
                                                                    <div class="card-content element-buttons">
                                                                        <span><i class="fa fa-list"></i> Text
                                                                            List</span>
                                                                    </div>
                                                                </div>
                                                            </div>
                                                            ...
                                                            <div class="form-elements-draggable" data-element-id="13">
                                                                <div class="card p-1">
                                                                    <div class="card-content">
                                                                        <span><i class="fa fa-square-o"></i> Hidden
                                                                            Field</span>
                                                                    </div>
                                                                </div>
                                                            </div>
                                                        ...
                                                        <div class="col-xs-6 col-sm-6 m-0">
                                                            <div class="form-elements-draggable" data-element-id="14">
                                                                <div class="card p-1">
                                                                    <div class="card-content element-buttons">
                                                                        <span><i class="fa fa-strikethrough"></i>
                                                                            Signature</span>
                                                                    </div>
                                                                </div>
                                                            </div>
                                                        ...
                                                        <div class="col-xs-6 col-sm-6 m-0">
                                                            <div class="form-elements-draggable" data-element-id="17">
                                                                <div class="card p-1">
                                                                    <div class="card-content element-buttons">
                                                                        <span><i class="fa fa-credit-card"></i> Credit
                                                                            Card</span>
                                                                    </div>
                                                                </div>
                                                            </div>
                                                        ...
                                                        <div class="col-xs-6 col-sm-6 m-0">
                                                            <div class="form-elements-draggable" data-element-id="18">
                                                                <div class="card p-1">
                                                                    <div class="card-content element-buttons">
                                                                        <span><i class="fa fa-address-book"></i> Contact
                                                                            Block</span>
                                                                    </div>
                                                                </div>
                                                            </div>
                                                        ...
                                                        <div class="col-xs-6 col-sm-6 m-0">
                                                            <div class="form-elements-draggable" data-element-id="19">
                                                                <div class="card p-1">
                                                                    <div class="card-content element-buttons">
                                                                        <span><i class="fa fa-save"></i> Save and
                                                                            Return</span>
                                                                    </div>
                                                                </div>
                                                            </div>
                                                ...
                                                <li class="list-group-item" data-toggle="collapse"
                                                    data-target="#collapseFormattingItemsMenu" aria-expanded="true"
                                                    aria-controls="collapse0">
                                                    Formatting Items
                                                </li>
                                                <div id="collapseFormattingItemsMenu" class="collapse "
                                                    aria-labelledby="headingOne" data-parent="#accordion">
                                                    <div class="row" style="overflow-x: auto; height: 250px;">
                                                        <div class="col-xs-6 col-sm-6 m-0">
                                                        ...
                                                        <div class="col-xs-6 col-sm-6 m-0">
                                                            <div class="form-elements-draggable" data-element-id="24">
                                                                <div class="card p-1">
                                                                    <div class="card-content element-buttons">
                                                                        <span><i class="fa fa-text-width"></i> Custom
                                                                            Code</span>
                                                                    </div>
                                                                </div>
                                                            </div>
                                                        ...
                                                        <div class="col-xs-6 col-sm-6 m-0">
                                                            <div class="form-elements-draggable" data-element-id="25">
                                                                <div class="card p-1">
                                                                    <div class="card-content element-buttons">
                                                                        <span><i class="fa fa-square"></i> Blank
                                                                            Space</span>
                                                                    </div>
                                                                </div>
                                                            </div>
                                                        ...
                                                        <div class="col-xs-6 col-sm-6 m-0">
                                                            <div class="form-elements-draggable" data-element-id="26">
                                                                <div class="card p-1">
                                                                    <div class="card-content element-buttons">
                                                                        <span><i class="fa fa-calendar"></i> Page Break
                                                                        </span>
                                                                    </div>
                                                                </div>
                                                            </div>
                                                        ...
                                                        <div class="col-xs-6 col-sm-6 m-0">
                                                            <div class="form-elements-draggable" data-element-id="27">
                                                                <div class="card p-1">
                                                                    <div class="card-content element-buttons">
                                                                        <span><i class="fa fa-square-o"></i> Block Text
                                                                        </span>
                                                                    </div>
                                                                </div>
                                                            </div>
                                                ...
                                                <li class="list-group-item" data-toggle="collapse"
                                                    data-target="#collapseOrderFormMenu" aria-expanded="true"
                                                    aria-controls="collapse0">
                                                    Order Form Tables
                                                </li>
                                                <div id="collapseOrderFormMenu" class="collapse "
                                                    aria-labelledby="headingOne" data-parent="#accordion">
                                                    <div class="row" style="overflow-x: auto; heightL 250px;">
                                                        <div class="col-xs-6 col-sm-6 m-0">
                                                            <div class="form-elements-draggable" data-element-id="31">
                                                                <div class="card p-1">
                                                                    <div class="card-content element-buttons">
                                                                        <span><i class="fa fa-calendar"></i> Table
                                                                            List</span>
                                                                    </div>
                                                                </div>
                                                            </div>
                                                ...
                                                <li class="list-group-item" data-toggle="collapse"
                                                    data-target="#collapseSurveyItemsFormMenu" aria-expanded="true"
                                                    aria-controls="surveyItems">
                                                    Survey Items
                                                </li>
                                                <div id="collapseSurveyItemsFormMenu" class="collapse "
                                                ...
                                                <li class="list-group-item" data-toggle="collapse"
                                                    data-target="#collapseMatrixGridMenu" aria-expanded="true"
                                                    aria-controls="collapse0">
                                                    Matrix/Grid Items
                                                </li>
                                                <div id="collapseMatrixGridMenu" class="collapse "
                                                    aria-labelledby="headingOne" data-parent="#accordion">
                                                    <div class="row" style="overflow-x: auto; heightL 250px;">
                                                        <div class="col-xs-6 col-sm-6 m-0">
                                                            <div class="form-elements-draggable" data-element-id="45">
                                                                <div class="card p-1">
                                                                    <div class="card-content element-buttons">
                                                                        <span><i class="fa fa-cog"></i> Radio Button
                                                                            Matrix</span>
                                                                    </div>
                                                                </div>
                                                            </div>
                                                        ...
                                                        <div class="col-xs-6 col-sm-6 m-0">
                                                            <div class="form-elements-draggable" data-element-id="47">
                                                                <div class="card p-1">
                                                                    <div class="card-content element-buttons">
                                                                        <span><i class="fa fa-cog"></i> Dropdown
                                                                            Matrix</span>
                                                                    </div>
                                                                </div>
                                                            </div>
                                                        ...
                                                        <div class="col-xs-6 col-sm-6 m-0">
                                                            <div class="form-elements-draggable" data-element-id="49">
                                                                <div class="card p-1">
                                                                    <div class="card-content element-buttons">
                                                                        <span><i class="fa fa-cog"></i> Checkbox
                                                                            Matrix</span>
                                                                    </div>
                                                                </div>
                                                            </div>
                                                        ...
                                                        <div class="col-xs-6 col-sm-6 m-0">
                                                            <div class="form-elements-draggable" data-element-id="51">
                                                                <div class="card p-1">
                                                                    <div class="card-content element-buttons">
                                                                        <span><i class="fa fa-cog"></i> Short Answer
                                                                            Matrix</span>
                                                                    </div>
                                                                </div>
                                                            </div>
                                                        ...
                                                        <div class="col-xs-6 col-sm-6 m-0">
                                                            <div class="form-elements-draggable" data-element-id="52">
                                                                <div class="card p-1">
                                                                    <div class="card-content element-buttons">
                                                                        <span><i class="fa fa-cog"></i> Long Answer
                                                                            Matrix</span>
                                                                    </div>
                                                                </div>
                                                            </div>
                                                        ...
                                                        <div class="col-xs-6 col-sm-6 m-0">
                                                            <div class="form-elements-draggable" data-element-id="54">
                                                                <div class="card p-1">
                                                                    <div class="card-content element-buttons">
                                                                        <span><i class="fa fa-cog"></i> Zone Information
                                                                            Table</span>
                                                                    </div>
                                                                </div>
                                                            </div>
                                                ...
                                                <li class="list-group-item" data-toggle="collapse"
                                                    data-target="#collapseContainers" aria-expanded="true"
                                                    aria-controls="collapse0">
                                                    Containers
                                                </li>
                                                <div id="collapseContainers" class="collapse "
                                                    aria-labelledby="headingOne" data-parent="#accordion">
                                                    <div class="row" style="overflow-x: auto; heightL 250px;">
                                                        <div class="col-xs-6 col-sm-6 m-0">
                                                            <div class="form-elements-draggable" data-element-id="55">
                                                                <div class="card p-1">
                                                                    <div class="card-content element-buttons">
                                                                        <span><i class="fa fa-cog"></i> Highlight
                                                                            Container</span>
                                                                    </div>
                                                                </div>
                                                            </div>
                                                ...
                                                <li class="list-group-item" data-toggle="collapse"
                                                    data-target="#collapseHeaderFooterMenu" aria-expanded="true"
                                                    aria-controls="collapse0">
                                                    Header/Footer
                                                </li>
                                                <div id="collapseHeaderFooterMenu" class="collapse "
                                                    aria-labelledby="headingOne" data-parent="#accordion">
                                    ...
                                    <div id="form-editor-style-sidenav" class="tab-pane fade">
                                        <div class="container-fluid py-3">
                                            <div class="form-group">
                                                ...
                                                <select name="form-title-font-family" id="fTFontFamily"
                                                    class="form-control">
                                            ...
                                            <div class="form-group">
                                                ...
                                                <select name="form-title-font-size" id="fTFontSize"
                                                    class="form-control">
                                            ...
                                            <div class="form-group">
                                                ...
                                                <select name="form-label-font-family" id="fLFontFamily"
                                                    class="form-control">
                                            ...
                                            <div class="form-group">
                                                ...
                                                <select name="form-label-font-size" id="fLFontSize"
                                                    class="form-control">
                            ...
                            <div class="col-xs-12 col-md-9">
                                ...
                                <div class="tab-content">
                                    <div id="windowEditor" class="tab-pane fade show active" style="height: 150px">
                                        ...
                                        <button id="btnEditorScrollDown" class="btn btn-secondary btn-block"><i
                                                class="fa fa-arrow-down"></i> Scroll down</button>
                                    </div>

                                    <div id="windowLiveForm" class="tab-pane fade" style="height: 150px">
                                        <div class="card container-fluid">
                                            <iframe src="<?= base_url()?>/form/<?= $form->forms_id?>?preview"
                                                frameborder="0" class="w-100" style="height: 500px"></iframe>
                                        </div>
                                    </div>
                            ...
                            <div class="col-xs-12 col-md-3">
                                <div id="form-settings-menu" class="list-group sticky-top">
                                    <a class="list-group-item list-group-item-action active" data-toggle="list"
                                        href="#forms-settings-general">General</a>
                                    ...
                                    <a class="list-group-item list-group-item-action" data-toggle="list"
                                        href="#forms-settings-success-pages">Success Pages</a>
                                    <a class="list-group-item list-group-item-action" data-toggle="list"
                                        href="#forms-settings-custom-text">Custom Text</a>
                                </div>
                            </div>
                                        ...
                                        <div class="card">
                                            <div class="card-content">
                                                <div class="d-flex w-100 justify-content-between">
                                                    ...
                                                    <button id="btnSaveGeneralSettings" class="btn btn-success">Save
                                                        Changes</button>
                                                </div>
                                                <hr />
                                                ...
                                                <ul class="nav nav-tabs">
                                                    <li class="nav-item">
                                                        <a class="nav-link active" data-toggle="tab"
                                                            href="#forms-settings-general-description-content">Description</a>
                                                    </li>
                                                    <li class="nav-item">
                                                        <a class="nav-link" data-toggle="tab"
                                                            href="#forms-settings-general-operations-content">Operations</a>
                                                    </li>
                                                </ul>

                                                <div class="tab-content">
                                                    <div class="tab-pane fade show active"
                                                        id="forms-settings-general-description-content">
                                                        <h4>Description</h4>
                                                        <div class="form-group">
                                                            <label for="txtFormName">Form Name:</label>
                                                            <input type="text" name="txtFormName" id="txtFormName"
                                                                class="form-control">
                                                        </div>
                                                        <div class="form-group">
                                                            <label for="txtPrivateNotes">Private Notes:</label>
                                                            <textarea class="form-control" name="txtPrivateNotes"
                                                                id="txtPrivateNotes" rows="3"></textarea>
                                                        </div>
                                                        <div class="form-group">
                                                            <label for="forms-terms-and-conditions">Terms And
                                                                Conditions</label>
                                                            <select name="forms-terms-and-conditions"
                                                                id="formsTermsAndConditions" class="form-control">
                                                                <option value="0">Select</option>
                                                            </select>
                                                        </div>
                                                        <div class="form-group">
                                                            <label for="txtSocialDescription">Social
                                                                Description:</label>
                                                            <textarea class="form-control" name="txtSocialDescription"
                                                                id="txtSocialDescription" rows="3"></textarea>
                                                        </div>
                                                    </div>
                                                    <div class="tab-pane fade"
                                                        id="forms-settings-general-operations-content">
                                                        <h4>Operations</h4>
                                                        <div class="card">
                                                            <div class="card-content">
                                                                <div class="form-check">
                                                                    <input type="checkbox" name="txtFormToggleStart"
                                                                        id="txtFormToggleStart">
                                                                    <label for="txtFormToggleStart">Use Start
                                                                        Date..</label>
                                                                    <small class="form-text text-muted">Open this form
                                                                        after this date</small>
                                                                    <blockquote class="blockquote"
                                                                        id="form-start-date-options">
                                                                        <div class="form-row">
                                                                            <div class="form-group">
                                                                                <label for="#txtStartDate">Start
                                                                                    Date</label>
                                                                        ...
                                                                        <div class="form-group">
                                                                            <label for="$txtMessageTitle">Message
                                                                                Title</label>
                                                                            <input type="text"
                                                                                name="txtStartMessageTitle"
                                                                                id="txtStartMessageTitle"
                                                                                class="form-control">
                                                                        </div>
                                                                        <div class="form-group">
                                                                            <label
                                                                                for="#txtMessageContent">Message:</label>
                                                                            <textarea name="txtStartMesasgeContent"
                                                                                class="form-control"
                                                                                id="txtStartMessageContent" cols="30"
                                                                                rows="10"></textarea>
                                                                        </div>
                                                                    </blockquote>
                                                                </div>
                                                        ...
                                                        <div class="card">
                                                            <div class="card-content">
                                                                <div class="form-check">
                                                                    <input type="checkbox" name="txtFormToggleEnd"
                                                                        id="txtFormToggleEnd">
                                                                    <label for="txtFormToggleEnd">Use End Date..</label>
                                                                    <small class="form-text text-muted">Close this form
                                                                        after this date</small>
                                                                    <blockquote class="blockquote"
                                                                        id="form-end-date-options">
                                                                        <div class="form-row">
                                                                            <div class="form-group">
                                                                                <label for="#txtEndDate">End
                                                                                    Date</label>
                                                                                <input type="date" class="form-control"
                                                                                    name="txtEndDate" id="txtEndDate">
                                                                            </div>
                                                                            <div class="form-group">
                                                                                <label for="#txtEndTime">End
                                                                                    Time</label>
                                                                                <input type="time" class="form-control"
                                                                                    name="txtEndTime" id="txtEndTime">
                                                                            </div>
                                                                        </div>
                                                                        <div class="form-group">
                                                                            <label for="#txtEndMessageTitle">Message
                                                                                Title</label>
                                                                            <input type="text" name="txtEndMessageTitle"
                                                                                id="txtEndMessageTitle"
                                                                                class="form-control">
                                                                        </div>
                                                                        <div class="form-group">
                                                                            <label
                                                                                for="#txtEndMessageContent">Message:</label>
                                                                            <textarea name="txtEndMessageContent"
                                                                                class="form-control"
                                                                                id="txtEndMessageContent" cols="30"
                                                                                rows="10"></textarea>
                                                                        </div>
                                                                    </blockquote>
                                                                </div>
                                                        ...
                                                        <div class="card">
                                                            <div class="card-content">
                                                                <div class="form-check">
                                                                    <input type="checkbox" name="txtFormToggleResult"
                                                                        id="txtFormToggleResult">
                                                                    <label for="txtFormToggleResult">Use Results
                                                                        Limit..</label>
                                                                    <small class="form-text text-muted">Close this form
                                                                        after this many stored results</small>
                                                                    <blockquote class="blockquote"
                                                                        id="form-results-options">

                                                                        <div class="form-group">
                                                                            <label for="#txtResultsLimit">Results
                                                                                Limit</label>
                                                                            <input type="number" class="form-control"
                                                                                name="txtResultsLimit"
                                                                                id="txtResultsLimit">
                                                                        </div>

                                                                        <div class="form-group">
                                                                            <label for="#txtResultsMessageTitle">Message
                                                                                Title</label>
                                                                            <input type="text"
                                                                                name="txtResultsMessageTitle"
                                                                                id="txtResultsMessageTitle"
                                                                                class="form-control">
                                                                        </div>
                                                                        <div class="form-group">
                                                                            <label
                                                                                for="#txtResultsMessageContent">Message:</label>
                                                                            <textarea name="txtResultsMessageContent"
                                                                                id="txtResultsMessageContent"
                                    ...
                                    <div id="forms-settings-success-pages" class="tab-pane fade">
                                        <div class="card">
                                            <div class="card-content">
                                                <div class="d-flex w-100 justify-content-between">
                                                    <h3>Success Pages</h3>
                                                    <button id="btnSaveSuccessPages" class="btn btn-success">Save
                                                        Settings</button>
                                                </div>
                                                <hr />
                                                ...
                                                <blockquote class="blockquote my-2">
                                                    <div class="form-group">
                                                        ...
                                                        <input type="text" name="txtRedirectLink" id="txtRedirectLink"
                                                            class="form-control" placeholder="https://">
                                                    </div>

                                                    <div class="form-group">
                                                        <label for="txtSuccessTitle">Heading Title</label>
                                                        <input type="text" name="txtSuccessTitle" id="txtSuccessTitle"
                                                            class="form-control">
                                                    </div>

                                                    <div class="form-group">
                                                        <label for="txtSuccessMessage">Message</label>
                                                        <textarea name="txtSuccessMessage" id="txtSuccessMessage"
                                                            cols="30" rows="10" class="form-control"></textarea>
                                                    </div>

                                                    <div class="custom-control custom-checkbox">
                                                        <input type="checkbox" name="chkSubmitResponse"
                                                            id="chkSubmitAnotherResponse" class="custom-control-input">
                                                        <label class="custom-control-label"
                                                            for="chkSubmitAnotherResponse">Show 'Submit another
                        ...
                        <div class="row">
                            <div class="col-xs col-md-3">
                                <div class="list-group">
                                    <a class="list-group-item list-group-item-action active" data-toggle="list"
                                        href="#forms-share-links">Links</a>
                                        ...
                                        <div class="card">
                                            <div class="card-content">
                                                ...
                                                <div class="form-group">
                                                    ...
                                                    <input type="text" name="txtSharableLink" id="txtSharableLink"
                                                        class="form-control"
                                                        value="<?= base_url()?>form/<?=$form->forms_id?>" readonly>
                                                    <div class="d-flex w-100 justify-content-between">
                                                        <div class="btn-group">
                                                            <button class="btn btn-link"><i class="fa fa-copy"></i>
                                                                Copy</button>
                                                            <button class="btn btn-link"><i class="fa fa-eye"></i>
                                                                View</button>
                                                        </div>
                                                        <div class="btn-group">
                    ...
                    <div id="form-editor-results" class="form-editor-settings-window tab-pane fade ">
                        <div class="row">
                            ...
                            <div class="col-xs-12 col-md-3">
                                <div id="form-settings-menu" class="list-group sticky-top">
                                    <a class="list-group-item list-group-item-action active" data-toggle="list"
                                        href="#forms-results-table">Results Table</a>
                                </div>
                            </div>
                              ...
                              if(empty($answers)){
                                ?>
                                                    <div class="alert alert-secondary w-100">
                                                        <p class="text-center w-100">There are no entries to this form
                                                            yet. </p>
                                                    </div>
                                                    <?php
                              }else{
        ...
        <div class="modal-content">
            <div class="modal-header">
                <div class="d-flex w-100 justify-content-between">
                    ...
                    <button class="btn btn-sm btn-success" onclick="saveElementSettings()" data-dismiss="modal">Save
                        Settings</button>
                </div>
                    ...
                    <div class="tab-content">
                        ...
                        <div id="modal-element-settings-settings" class="tab-pane fade show active">
                            ...
                            <div class="form-group">
                                ...
                                <textarea type="text" name="txtElementSettingsFieldLabel"
                                    id="txtElementSettingsFieldLabel" class="form-control"></textarea>
                            </div>
                                ...
                                <div class="col-xs-12 col-md-6">
                                    <div id="modal-element-settings-text-section">
                                        ...
                                        <div class="form-group">
                                            ...
                                            <input type="text" name="txtElementSettingsPlaceholderText"
                                                id="txtElementSettingsPlaceholderText" class="form-control">
                                        </div>

                                        <div class="form-group">
                                            <label for="txtElementSettingsLength">Validation Type</label>
                                            <select name="txtElementSettingsValidation"
                                                id="txtElementSettingsValidation" class="custom-select">
                                        ...
                                        <div class="tab-content">
                                            ...
                                            <div class="tab-pane fade show active" id="choices-add-choice">
                                                <div class="form-group">
                                                    ...
                                                    <img src="<?= base_url()?>uploads/formbuilder/db/img/img_450_9.jpg"
                                                        class="img-thumbnail">
                                                    <input type="file" name="fileElementImage" id="fileElementImage"
                                                        class="form-control-file" onchange="uploadImage()">
                                                </div>
                                            </div>
                                    ...
                                    <div id="modal-element-settings-choices-section">
                                        ...
                                        <div class="tab-content">
                                            ...
                                            <div class="tab-pane fade show active" id="choices-add-choice">
                                                <div class="form-group">
                                                    <textarea name="txtElementChoices" id="txtElementChoices" cols="30"
                                    ...
                                    <div id="model-element-settings-zone-section" style="display: none">
                                        <div class="col-6">
                                            <h4>Zone Length</h4>
                                            <input type="number" name="zone-length" id="setZoneLength" min="1"
                                                class="form-control">
                                        </div>
                                    </div>
                                    ...
                                    <div id="modal-element-settings-choices-row-section" style="display: none">
                                        ...
                                        <div class="tab-content">
                                            ...
                                            <div class="tab-pane fade show active" id="choices-add-choice">
                                                <div class="form-group">
                                                    <textarea name="txtElementChoicesRow" id="txtElementChoicesRow"
                                                        cols="30" rows="10" class="form-control"></textarea>
                                                    <small class="text-muted">You can place values to each box, just
                                                        separate them by a coma</small>
                                                    <small class="text-muted">Separated by spaces</small>
                                                </div>
                                ...
                                <div class="col-xs-12 col-md-6">
                                    <div id="modal-element-settings-choices-column-section" style="display: none">
                                        ...
                                        <div class="tab-content">
                                            ...
                                            <div class="tab-pane fade show active" id="choices-add-choice">
                                                <div class="form-group">
                                                    <textarea name="txtElementChoicesColumn"
                                                        id="txtElementChoicesColumn" cols="30" rows="10"
                                    ...
                                    <h4>Style</h4>
                                    <hr />
                                    <div class="custom-control custom-switch" id="setIsTitleContainer"
                                        style="display: none;">
                                        <input type="checkbox" class="custom-control-input" id="setIsTitle">
                                        <label class="custom-control-label" for="setIsTitle">Title</label>
                                    </div>
                                    <div class="custom-control custom-switch" id="setIsPageBreakContainer"
                                        style="display: none;">
                                        <input type="checkbox" class="custom-control-input" id="setIsPageBreak">
                                        <label class="custom-control-label" for="setIsPageBreak">Page Break</label>
                                    </div>
                                    <div class="form-group">
                                    ...
                                    <div class="form-check">
                                        <input type="checkbox" name="chkElementSettingsRequired"
                                            id="chkElementSettingsRequired" class="form-check-input">
                                        <label for="chkElementSettingsRequired">Required</label>
                                    </div>

                                    <div class="form-check">
                                        <input type="checkbox" name="chkElementSettingsReadonly"
                                            id="chkElementSettingsReadonly" class="form-check-input">
                                        <label for="chkElementSettingsReadonly">Read-Only</label>
                                    </div>

                                    <h5>Question Position</h5>
                                    <div class="form-check">
                                        <input type="radio" name="radElementSettingsQuestionPosition" value="1"
                                            id="selectedUserElement" class="form-check-input">
                                        <label for="radElementSettingsQuestionPosition">Top</label>
                                    </div>
                                    <div class="form-check">
                                        <input type="radio" name="radElementSettingsQuestionPosition" value="2"
                                            id="selectedUserElement" class="form-check-input">
                                        <label for="radElementSettingsQuestionPosition">Left</label>
                                    </div>
                                    <div class="form-check">
                                        <input type="radio" name="radElementSettingsQuestionPosition" value="3"
                                            id="selectedUserElement" class="form-check-input">
                            ...
                            <div class="row">
                                <div class="col-xs-12 col-md-12">
                                    <div class="form-group">
                                        ...
                                        <input type="text" name="txtElementSettingsDefaultValue"
                                            id="txtElementSettingsDefaultValue" class="form-control">
                                    </div>
                                </div>
                            </div>
                        </div>
                        ...
                        <div id="modal-element-settings-rules" class="tab-pane fade">
                            <h4>Display Rules</h4>
                            <hr />
                            <p>Conditionally show or hide this item. Use this page to configure rules for all items at
                                once.</p>
                            <div class="card">
                                <div class="card-content">
                                    <label>Item #1</label>
                        ...
                        <div id="modal-element-settings-calculations" class="tab-pane fade">
                            <div class="row">
                                <div class="col-xs-12 col-md-6">
                                    ...
                                    <div class="form-check">
                                        <input type="radio" name="radCalculationValues" id="radCalculationOption1"
                                            class="form-check-input">
                                        <label for="radCalculationOption1">Entire Item</label>
                                    </div>
                                    <div class="form-check">
                                        <input type="radio" name="radCalculationValues" id="radCalculationOption2"
                                            class="form-check-input">
                                        <label for="radCalculationOption2">Each Choice</label>
                                    </div>
                                    <div class="form-check">
                                        <input type="radio" name="radCalculationValues" id="radCalculationOption3"
                                            class="form-check-input">
                                ...
                                <div class="col-xs-12 col-md-6">
                                    ...
                                    <hr />
                                    <div class="form-check">
                                        <input type="checkbox" name="chkElementSettingsScoringCheck"
                                            id="chkElementSettingsScoringCheck" class="form-check-input">
...
<script src="<?= base_url()?>/assets/formbuilder/js/bootstrap.min.js"
...
editElement = elementId => {
    ...
    $.ajax({
        ...
        success: function(res) {
            ...
            document.querySelector('#txtElementSettingsPlaceholderText').value = element
                .fe_placeholder_text;
            ...
            document.querySelector('#setIsPageBreak').value = (element.fe_is_pagebreak == 1) ? true :
                false;
            document.querySelector('#chkElementSettingsRequired').checked = (element.fe_is_required ==
                1) ? true : false;
            document.querySelector('#chkElementSettingsReadonly').checked = (element.fe_is_readonly ==
                1) ? true : false;
            document.querySelector('#chkElementSettingsScoringCheck').checked = (element
                .fe_enable_score == 1) ? true : false;
            ...
            if (element.fe_element_id == 1 || element.fe_element_id == 2 || element.fe_element_id ==
                3) {
                ...
                document.querySelector("#txtElementChoices").value = choices.map(choice =>
                    `${choice.fc_choice}`).join("\n")
                ...
                document.querySelector("#txtElementChoicesRow").value = rowChoices.map(choice =>
                    `${choice.fc_choice}`).join("\n")
                document.querySelector("#txtElementChoicesColumn").value = columnChoices.map(choice =>
                    `${choice.fc_choice}`).join("\n")
            } else {
            ...
            document.querySelector('#modal-element-settings-choices-column-section').style.display =
                "none"
            if (element.fe_element_id == 1 || element.fe_element_id == 2 || element.fe_element_id ==
                3) {
                document.querySelector('#modal-element-settings-choices-section').style.display =
                    "block"
            }

            if (element.fe_element_id == 4 || element.fe_element_id == 5 || element.fe_element_id ==
                6 || element.fe_element_id == 7 || element.fe_element_id == 8) {
                document.querySelector('#modal-element-settings-text-section').style.display = "block"
            }

            if (element.fe_element_id == 44 || element.fe_element_id == 45 || element.fe_element_id ==
                46 || element.fe_element_id == 47 || element.fe_element_id == 48 || element
                .fe_element_id == 50 || element.fe_element_id == 53) {
                document.querySelector('#modal-element-settings-choices-row-section').style.display =
                    "block"
                document.querySelector('#modal-element-settings-choices-column-section').style.display =
                    "block"
            }
            ...
            if (element.fe_element_id == 25) {
                document.querySelector("#setIsPageBreakContainer").style.display = "block";
            } else {
                document.querySelector("#setIsPageBreakContainer").style.display = "none";
            }
...
saveElementSettings = () => {
    ...
    let data = {
        ...
        "fe_is_pagebreak": (document.querySelector('#setIsPageBreak').checked === true) ? 1 : 0,
...
window.onload = () => {
    loadFormSettings(<?= $form->forms_id?>);
    loadFormElements(<?= $form->forms_id?>, "edit", true);
};
...
document.querySelector('#btnSaveGeneralSettings').addEventListener('click', () => {
    let data = {
        ...
        "forms_use_results_limit": (document.querySelector('#txtFormToggleResult').checked === true) ? 1 :
            0,
        ...
        "forms_terms_and_conditions_id": document.querySelector('#formsTermsAndConditions').value,
    };
    $.ajax({
...
document.querySelector('#btnSaveSuccessPages').addEventListener('click', () => {
    let data = {
        ...
        'forms_show_repeat_form_check': (document.querySelector('#chkSubmitAnotherResponse').checked ===
            true) ? 1 : 0
    }
...
$('#windowPreviewContent').sortable({
    placeholder: {
        element: function(currentItem) {
            const el = $(currentItem[0]);
            let classList = el.attr('class');
            classList = classList.slice(9, classList.length);
            const height = el.height();
            return $(`<div class="${classList} bg-light card" style="height: ${height}"></div>`)[0];
        },
    ...
    items: 'div.draggable',
    update: (event, ui) => {
        const elements = $('#windowPreviewContent').sortable("toArray");
        const elementsCollection = formElements;
        elements.forEach((el, i) => {
            const id = el.split('-')[2];
            const elementObjIndex = elementsCollection.findIndex((el) => el.fe_id == id);
            elementsCollection[elementObjIndex].fe_order = i + 1;
            // elementsCollection[elementObjIndex].fe_block_id = i + 1;
        });
        const data = {
            'sort_update': true,
            'elements_collection': elementsCollection,
        }
        $.ajax({
            url: "<?= base_url()?>formbuilder/form/element/update/" + 1,
            data: data,
            dataType: 'json',
            type: 'POST',
            success: (res) => {
        ...
        //     if (replacedEl.fe_element_id == 54) {
        //         const subElements = formElements.filter((subEl) => {
        //             return subEl.fe_block_id === replacedEl.fe_id;
        //         })
        //         replacedEl = subElements[subElements.length - 1];
        //     }
        // } else {
        //     newIndex = newIndex+1;
        //     replacedEl = formElements[newIndex];
        // }
        // const newOrder = replacedEl.fe_order;
        // let id = currentEl.id;
        // let data = {
        //     "new_index": newOrder,
        //     "old_index": oldOrder,
        //     "fe_form_id": formElements[0].fe_form_id,
        //     "sort_update": true,
        //     "update_method": (newIndex > startIndex) ? 'move_up' : 'move_down',
        //     "id": id
        // }

        // console.table({newIndex, startIndex});
        // console.table(replacedEl);
        // return;
        // $.ajax({
