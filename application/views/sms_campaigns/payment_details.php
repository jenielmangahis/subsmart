                        ...
                        <div class="card-body">
                            ...
                            <table class="table table-no-border table-payment-details">
                              ...
                              <tr>
                                ...
                                <td><?= date("d-M-Y H:i", strtotime($smsBlast->date_paid)); ?></td>
                              </tr>
                              <tr>
                            ...
                            <div style="margin-top: 81px;">
                                <div class="col-md-12 form-group">
                                    <a class="btn btn-primary" href="<?php echo url('sms_campaigns/invoice_pdf/' . $smsBlast->id) ?>" target="_new" style="margin-right: 10px;">
                                      Download Invoice #<?= $dealsSteals->order_number; ?> as PDF</a>
                                    <a class="btn btn-primary" href="<?php echo url('sms_campaigns') ?>" style="margin-right: 10px;">Go Back to SMS Blast list</a>                                    
                                </div>
                            </div>
                        </div>
                    </div>
