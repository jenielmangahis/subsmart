...
<table style="width: 100%;padding: 3px;">
    ...
    <tr>
        <td>SMS CAMPAIGN</td>
        <td>1</td>
        <td>Deal : <?= strtoupper($smsBlast->campaign_name); ?><br/>Send Date : <?= date("d-M-Y",strtotime($smsBlast->send_date)); ?>
        </td>
        <td style="text-align: right;">$<?= number_format($smsBlast->total_price, 2); ?></td>
    </tr>
    <tr>
        <td colspan="4"></td>
    </tr>
    <tr>
        ...
        <td style="text-align: right"><b>$<?= number_format($smsBlast->total_price, 2); ?></b></td>
    </tr>
    <tr>
        <td colspan="3" style="text-align: right">Payment Due</td>
        <td style="color:red;text-align: right;">(-) $<?= number_format($smsBlast->total_price, 2); ?></td>
    </tr>
    <tr>
