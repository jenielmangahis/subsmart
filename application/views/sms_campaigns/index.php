        ...
        <div class="container-fluid">
            ...
            <section class="content-header">
              ...
              <div class="pull-right">
                <a href="<?php echo url('company/add') ?>" class="btn btn-primary"><i class="fa fa-plus"></i> Create SMS Blast</a>
              </div>              
                ...
                <div class="box-body" style="overflow-y: scroll;">                  
                  <div class="card-header tab-card-header">
                    <ul class="nav nav-tabs card-header-tabs" id="myTab" role="tablist">
                      <li class="nav-item">
                          <a class="nav-link" id="c-active-tab" data-toggle="tab" href="#active-campaigns" role="tab" aria-controls="One" aria-selected="true">Active Campaigns (0)</a>
                      </li>
                      <li class="nav-item">
