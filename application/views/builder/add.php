...
<style>
    ...
    .wrapper { padding: 0px; padding-top: 68px; }
    .form_builder_field { width: 100% !important; border-radius: 15px; border: 2px solid #ddd; }
    .form_builder_area .form_builder_field .form_output .form-group { margin-bottom: 10px !important; }
</style>
<!-- page wrapper start -->
<div class="wrapper">
            ...
            if(data != '') {
              ...
              $.each(result.questions, function( index, value ) {
                ...
                if(value.q_type == 'text') {
                  ...
                  var question_styling_column_width = value.parameter['column_width'];
                  $('#main-drag-and-drop-area ' + question_sub).append(getTextFieldHTML(value.Questions_id,value.question,value.description,value.parameter['required'],value.parameter['encrypt'],value.parameter['question_styling_class'],value.parameter['question_styling_maxlength'],question_styling_background_color,question_styling_font_color,question_styling_column_width));
                } else if(value.q_type == 'textarea') {
                  var question_styling_background_color = value.parameter['question_styling_background_color'];
                  var question_styling_font_color = value.parameter['question_styling_font_color'];
                  var question_styling_column_width = value.parameter['column_width'];
                  $('#main-drag-and-drop-area ' + question_sub).append(getTextAreaFieldHTML(value.Questions_id,value.question,value.description,value.parameter['required'],value.parameter['encrypt'],value.parameter['limit'],value.parameter['limit_range'],value.parameter['reachtextboxformatting'],value.parameter['question_styling_class'],value.parameter['question_styling_maxlength'],question_styling_background_color,question_styling_font_color,question_styling_column_width));
                  ...
                  var question_styling_font_color = value.parameter['question_styling_font_color'];
                  var question_styling_column_width = value.parameter['column_width'];
                  $('#main-drag-and-drop-area ' + question_sub).append(getFileUploadFieldHTML(value.Questions_id,value.question,value.description,value.parameter['required'],value.parameter['question_styling_class'],value.parameter['question_styling_maxlength'],question_styling_background_color,question_styling_font_color,question_styling_column_width));
                } else if(value.q_type == 'phone') {
                  var question_styling_background_color = value.parameter['question_styling_background_color'];
                  var question_styling_font_color = value.parameter['question_styling_font_color'];
                  var question_styling_column_width = value.parameter['column_width'];
                  $('#main-drag-and-drop-area ' + question_sub).append(getPhoneFieldHTML(value.Questions_id,value.question,value.description,value.parameter['required'],value.parameter['extension'],value.parameter['phone_type_selector'],value.parameter['question_styling_class'],value.parameter['question_styling_maxlength'],question_styling_background_color,question_styling_font_color,question_styling_column_width));
                  ...
                  var question_styling_font_color = value.parameter['question_styling_font_color'];
                  var question_styling_column_width = value.parameter['column_width'];
                  $('#main-drag-and-drop-area ' + question_sub).append(getAddressFieldHTML(value.Questions_id,value.question,value.description,value.parameter['required'],value.parameter['country_input'],value.parameter['question_styling_class'],value.parameter['question_styling_maxlength'],question_styling_background_color,question_styling_font_color,question_styling_column_width));
      ...
      $('#main-drag-and-drop-area').children('div').each(function(key,value) {
        ...
        if ( question_type == 'single-input' ) {
          ...
          $(value).find('.input-draggable-parent-child-div').children('.question-box').each(function(childrenKey,childrenValue){
              ...
              var parameter = {};
              parameter['column_width'] = $(childrenValue).find('select[name="question_col_width"]').val();
...
<script>
  ...
  function removeOptions(e) {
    ...
    function getWidthColInput (width = 'col-sm-6') {

        return ' <div class="row"> <label class="col-sm-2 col-form-label text-right">Select Input Width</label> <div class="col-sm-5"> <select name="question_col_width" class="form-control"> <option value="col-sm-1" '+(("col-sm-1" == width) ? 'selected' : '')+' >Column 1</option><option value="col-sm-2" '+(("col-sm-2" == width) ? 'selected' : '')+' >Column 2</option><option value="col-sm-3" '+(("col-sm-3" == width) ? 'selected' : '')+' >Column 3</option><option value="col-sm-4" '+(("col-sm-4" == width) ? 'selected' : '')+' >Column 4</option><option value="col-sm-5" '+(("col-sm-5" == width) ? 'selected' : '')+' >Column 5</option><option value="col-sm-6" '+(("col-sm-6" == width) ? 'selected' : '')+' >Column 6</option><option value="col-sm-7" '+(("col-sm-7" == width) ? 'selected' : '')+' >Column 7</option><option value="col-sm-8" '+(("col-sm-8" == width) ? 'selected' : '')+' >Column 8</option><option value="col-sm-9" '+(("col-sm-9" == width) ? 'selected' : '')+' >Column 9</option><option value="col-sm-10" '+(("col-sm-10" == width) ? 'selected' : '')+' >Column 10</option><option value="col-sm-11" '+(("col-sm-11" == width) ? 'selected' : '')+' >Column 11</option><option value="col-sm-12" '+(("col-sm-12" == width) ? 'selected' : '')+' >Column 12</option></select> </div> </div>';
    }
    function getTextFieldHTML(question_id = '0',question_label = '',question_description = '',question_required = false,question_encrypt = false, question_styling_class = '' , question_styling_maxlength = '' , question_styling_background_color = '#ffffff' , question_styling_font_color = '#000000', width = 'col-sm-6') {
      
        var required = question_required == 'true' ? 'checked' : '';
        var encryptData = question_encrypt == 'true' ? 'checked' : '';

        var field = generateField();
        var html = '<div data-question-id="'+question_id+'" data-input-type="text" class="input-main-box input-main-box-'+field+' h-auto w-auto question-box" data-input-box-type="single-input"> <div class="row"> <label class="col-sm-2 col-form-label text-right">Question / Label</label> <div class="col-sm-5"> <input value="'+question_label+'" name="question_label" class="form-control" type="text"> </div> <div class="col-sm-4 text-right">Text Field</div><div class="col-sm-1" style="text-align:right;padding-right:30px;"><i class="fa fa-times" style="font-size: 18px;" onClick=removeInput('+question_id+',this) ></i></div></div> <div class="row"> <label class="col-sm-2 col-form-label text-right">Field Description</label> <div class="col-sm-5"> <input value="'+question_description+'" name="question_description" class="form-control" type="text"> </div> </div>'+getWidthColInput(width)+'<div class="row"> <label class="col-sm-2 col-form-label text-right"></label> <div class="col-sm-2 text-left"> <input class="" type="checkbox" value="true" name="question_required" '+required+' > Required </div> <div class="col-sm-2 text-left"> <input class="" type="checkbox" name="question_encrypt" '+encryptData+'> Encrypt Data </div><div class="col-sm-6 text-right" style="padding-right:32px !important;"><a href="#" onclick="showHide(this)">Styling</a></div><div class="col-sm-12 styling pt-5 d-none"><label class="col-sm-1 col-form-label text-right"></label><label class="col-sm-11 col-form-label text-left" style="font-size: 19px;font-weight: bold;">Styling</label><div class="col-sm-12"><label class="col-sm-2 col-form-label text-right">Class</label><div class="col-sm-3 text-left"><input class="w-100" type="text" value="'+question_styling_class+'" name="question_styling_class"></div><label class="col-sm-2 col-form-label text-right">Max Length</label><div class="col-sm-3 text-left"><input class="w-100" type="number" value="'+question_styling_maxlength+'" name="question_styling_maxlength"></div></div><div class="col-sm-12 pt-1"><label class="col-sm-2 col-form-label text-right">Background</label><div class="col-sm-3 text-left"><input class="w-100" type="color" value="'+question_styling_background_color+'" name="question_styling_background_color"></div><label class="col-sm-2 col-form-label text-right">Color</label><div class="col-sm-3 text-left"><input class="w-100" type="color" value="'+question_styling_font_color+'" name="question_styling_font_color"></div></div></div></div> </div>';
        return html;
    }

    function getEmailFieldHTML(question_id = '0',question_label = '',question_description = '',question_required = false, question_styling_class = '' , question_styling_maxlength = '' , question_styling_background_color = '#ffffff' , question_styling_font_color = '#000000',width = 'col-sm-6') {
        var field = generateField();
        var required = question_required == 'true' ? 'checked' : '';
        var html = '<div data-question-id="'+question_id+'" data-input-type="email" class="input-main-box input-main-box-'+field+' h-auto w-auto question-box" data-input-box-type="single-input"> <div class="row"> <label class="col-sm-2 col-form-label text-right">Question / Label</label> <div class="col-sm-5"> <input value="'+question_label+'" name="question_label" class="form-control" type="text"> </div> <div class="col-sm-4 text-right">Email Field</div><div class="col-sm-1" style="text-align:right;padding-right:30px;"><i class="fa fa-times" style="font-size: 18px;" onClick=removeInput('+question_id+',this) ></i></div></div> <div class="row"> <label class="col-sm-2 col-form-label text-right">Field Description</label> <div class="col-sm-5"> <input value="'+question_description+'" name="question_description" class="form-control" type="text"> </div> </div>'+getWidthColInput(width)+'<div class="row"> <label class="col-sm-2 col-form-label text-right"></label> <div class="col-sm-2 text-left"> <input class="" type="checkbox" value="true" name="question_required" '+required+' > Required </div><div class="col-sm-8 text-right" style="padding-right:32px !important;"><a href="#" onclick="showHide(this)">Styling</a></div><div class="col-sm-12 styling pt-5 d-none"><label class="col-sm-1 col-form-label text-right"></label><label class="col-sm-11 col-form-label text-left" style="font-size: 19px;font-weight: bold;">Styling</label><div class="col-sm-12"><label class="col-sm-2 col-form-label text-right">Class</label><div class="col-sm-3 text-left"><input class="w-100" type="text" value="'+question_styling_class+'" name="question_styling_class"></div><label class="col-sm-2 col-form-label text-right">Max Length</label><div class="col-sm-3 text-left"><input class="w-100" type="number" value="'+question_styling_maxlength+'" name="question_styling_maxlength"></div></div><div class="col-sm-12 pt-1"><label class="col-sm-2 col-form-label text-right">Background</label><div class="col-sm-3 text-left"><input class="w-100" type="color" value="'+question_styling_background_color+'" name="question_styling_background_color"></div><label class="col-sm-2 col-form-label text-right">Color</label><div class="col-sm-3 text-left"><input class="w-100" type="color" value="'+question_styling_font_color+'" name="question_styling_font_color"></div></div></div>  </div> </div>';
        return html;
    }

    function getPhoneFieldHTML(question_id = '0',question_label = '',question_description = '',question_required = false,extension = false,phone_type_selector = false, question_styling_class = '' , question_styling_maxlength = '' , question_styling_background_color = '#ffffff' , question_styling_font_color = '#000000', width = 'col-sm-6') {
        var field = generateField();
        var required = question_required == 'true' ? 'checked' : '';
        ...
        html = html + 'class="input-main-box input-main-box-'+field+' h-auto w-auto question-box" data-input-box-type="single-input"> <div class="row"> <label class="col-sm-2 col-form-label text-right">Question / Label</label> <div class="col-sm-5"> <input value="'+question_label+'" name="question_label" class="form-control" type="text"> </div> <div class="col-sm-4 text-right">Phone</div><div class="col-sm-1" style="text-align:right;padding-right:30px;"><i class="fa fa-times" style="font-size: 18px;" onClick=removeInput('+question_id+',this) ></i></div></div> <div class="row"> <label class="col-sm-2 col-form-label text-right">Field Description</label> <div class="col-sm-5"> <input class="form-control" value="'+question_description+'" name="question_description" type="text"> </div> </div>'+getWidthColInput(width)+'<div class="row"> <label class="col-sm-2 col-form-label text-right"></label> <div class="col-sm-2 text-left"> <input class="" type="checkbox" value="true" name="question_required" '+required+' > Required </div> <div class="col-sm-3 text-left"> <input class="" type="checkbox" name="extension_input" '+extension+'> Include Extension Field</div> <div class="col-sm-3 text-left"> <input class="" type="checkbox" name="phone_type_selector" '+phone_type_selector+'> Include Phone Type Selector</div><div class="col-sm-2 text-right" style="padding-right:32px !important;"><a href="#" onclick="showHide(this)">Styling</a></div><div class="col-sm-12 styling pt-5 d-none"><label class="col-sm-1 col-form-label text-right"></label><label class="col-sm-11 col-form-label text-left" style="font-size: 19px;font-weight: bold;">Styling</label><div class="col-sm-12"><label class="col-sm-2 col-form-label text-right">Class</label><div class="col-sm-3 text-left"><input class="w-100" type="text" value="'+question_styling_class+'" name="question_styling_class"></div><label class="col-sm-2 col-form-label text-right">Max Length</label><div class="col-sm-3 text-left"><input class="w-100" type="number" value="'+question_styling_maxlength+'" name="question_styling_maxlength"></div></div><div class="col-sm-12 pt-1"><label class="col-sm-2 col-form-label text-right">Background</label><div class="col-sm-3 text-left"><input class="w-100" type="color" value="'+question_styling_background_color+'" name="question_styling_background_color"></div><label class="col-sm-2 col-form-label text-right">Color</label><div class="col-sm-3 text-left"><input class="w-100" type="color" value="'+question_styling_font_color+'" name="question_styling_font_color"></div></div></div> </div> </div>';
        return html;
    }

    function getAddressFieldHTML(question_id = '0',question_label = '',question_description = '',question_required = false,country_input = false, question_styling_class = '' , question_styling_maxlength = '' , question_styling_background_color = '#ffffff' , question_styling_font_color = '#000000', width = 'col-sm-6') {
        var field = generateField();
        var required = question_required == 'true' ? 'checked' : '';
        var country_input = country_input == 'true' ? 'checked' : '';

        var html = '<div data-question-id="'+question_id+'" data-input-type="address" class="input-main-box input-main-box-'+field+' h-auto w-auto question-box" data-input-box-type="single-input"> <div class="row"> <label class="col-sm-2 col-form-label text-right">Question / Label</label> <div class="col-sm-5"> <input value="'+question_label+'" name="question_label" class="form-control" type="text"> </div> <div class="col-sm-4 text-right">Address</div><div class="col-sm-1" style="text-align:right;padding-right:30px;"><i class="fa fa-times" style="font-size: 18px;" onClick=removeInput('+question_id+',this) ></i></div></div> <div class="row"> <label class="col-sm-2 col-form-label text-right">Field Description</label> <div class="col-sm-5"> <input value="'+question_description+'" name="question_description" class="form-control" type="text"> </div> </div>'+getWidthColInput(width)+'<div class="row"> <label class="col-sm-2 col-form-label text-right"></label> <div class="col-sm-2 text-left"> <input class="" type="checkbox" value="true" name="question_required" '+required+' > Required </div> <div class="col-sm-3 text-left"> <input class="" type="checkbox" name="country_input" '+country_input+' value="true"> Include Country Input</div><div class="col-sm-5 text-right" style="padding-right:32px !important;"><a href="#" onclick="showHide(this)">Styling</a></div><div class="col-sm-12 styling pt-5 d-none"><label class="col-sm-1 col-form-label text-right"></label><label class="col-sm-11 col-form-label text-left" style="font-size: 19px;font-weight: bold;">Styling</label><div class="col-sm-12"><label class="col-sm-2 col-form-label text-right">Class</label><div class="col-sm-3 text-left"><input class="w-100" type="text" value="'+question_styling_class+'" name="question_styling_class"></div><label class="col-sm-2 col-form-label text-right">Max Length</label><div class="col-sm-3 text-left"><input class="w-100" type="number" value="'+question_styling_maxlength+'" name="question_styling_maxlength"></div></div><div class="col-sm-12 pt-1"><label class="col-sm-2 col-form-label text-right">Background</label><div class="col-sm-3 text-left"><input class="w-100" type="color" value="'+question_styling_background_color+'" name="question_styling_background_color"></div><label class="col-sm-2 col-form-label text-right">Color</label><div class="col-sm-3 text-left"><input class="w-100" type="color" value="'+question_styling_font_color+'" name="question_styling_font_color"></div></div></div> </div> </div>';
        return html;
    }
    

    function getTextAreaFieldHTML(question_id = '0',question_label = '',question_description = '',question_required = false, question_encrypt = false,limit = false,limit_range = '',reachTextBoxFormatting = false, question_styling_class = '' , question_styling_maxlength = '' , question_styling_background_color = '#ffffff' , question_styling_font_color = '#000000', width = 'col-sm-6') {
        var field = generateField();
        var required = question_required == 'true' ? 'checked' : '';
        var encryptData = question_encrypt == 'true' ? 'checked' : '';
    ...
    function getFileUploadFieldHTML(question_id = '0',question_label = '',question_description = '',question_required = false, question_styling_class = '' , question_styling_maxlength = '' , question_styling_background_color = '#ffffff' , question_styling_font_color = '#000000', width = 'col-sm-6') {
        var field = generateField();
        var required = question_required == 'true' ? 'checked' : '';


        var html = '<div data-question-id="'+question_id+'" data-input-type="file-upload" class="input-main-box input-main-box-'+field+' h-auto w-auto question-box" data-input-box-type="single-input"> <div class="row"> <label class="col-sm-2 col-form-label text-right">Question / Label</label> <div class="col-sm-5"> <input value="'+question_label+'" name="question_label" class="form-control" type="text"> </div> <div class="col-sm-4 text-right">File Upload </div><div class="col-sm-1" style="text-align:right;padding-right:30px;"><i class="fa fa-times" style="font-size: 18px;" onClick=removeInput('+question_id+',this) ></i></div></div> <div class="row"> <label class="col-sm-2 col-form-label text-right">Field Description</label> <div class="col-sm-5"> <input value="'+question_description+'" name="question_description" class="form-control" type="text"> </div> </div>'+getWidthColInput(width)+'<div class="row"> <label class="col-sm-2 col-form-label text-right"></label> <div class="col-sm-2 text-left"> <input class="" type="checkbox" value="true" name="question_required" '+required+' > Required </div><div class="col-sm-8 text-right" style="padding-right:32px !important;"><a href="#" onclick="showHide(this)">Styling</a></div><div class="col-sm-12 styling pt-5 d-none"><label class="col-sm-1 col-form-label text-right"></label><label class="col-sm-11 col-form-label text-left" style="font-size: 19px;font-weight: bold;padding-right:33px;">Styling</label><div class="col-sm-12"><label class="col-sm-2 col-form-label text-right">Class</label><div class="col-sm-3 text-left"><input class="w-100" type="text" value="'+question_styling_class+'" name="question_styling_class"></div><label class="col-sm-2 col-form-label text-right">Max Length</label><div class="col-sm-3 text-left"><input class="w-100" type="number" value="'+question_styling_maxlength+'" name="question_styling_maxlength"></div></div><div class="col-sm-12 pt-1"><label class="col-sm-2 col-form-label text-right">Background</label><div class="col-sm-3 text-left"><input class="w-100" type="color" value="'+question_styling_background_color+'" name="question_styling_background_color"></div><label class="col-sm-2 col-form-label text-right">Color</label><div class="col-sm-3 text-left"><input class="w-100" type="color" value="'+question_styling_font_color+'" name="question_styling_font_color"></div></div></div> </div> </div>';
        return html;
    }

    function getDatePickerFieldHTML(question_id = '0',question_label = '',question_description = '',question_required = false, question_styling_class = '' , question_styling_maxlength = '' , question_styling_background_color = '#ffffff' , question_styling_font_color = '#000000', width = 'col-sm-6') {
      var field = generateField();
      var required = question_required == 'true' ? 'checked' : '';
