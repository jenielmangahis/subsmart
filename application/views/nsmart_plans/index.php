                    ...
                    <div class="card" style="min-height: 400px !important;">
                        <div class="row dashboard-container-1">
                            <div class="col-md-12 text-right">
                                <a class="btn btn-info" href="<?php echo base_url('nsmart_plans/add_new_plan'); ?>"><i class="fa fa-file"></i> New Plan</a>
                            </div>
                        </div>       
                        <hr />
                            ...
                            <tbody>
                                <?php foreach( $nSmartPlans as $p ){ ?>
                                    ...
                                    <tr>
                                        ...
                                        <td class="<?= $cell; ?>"><?= $option_status[$p->status]; ?></td>
                                        <td>
                                            <a class="btn btn-info btn-sm" href="<?php echo base_url('nsmart_plans/edit_plan/'.$p->nsmart_plans_id); ?>"><i class="fa fa-pencil"></i> Edit</a>
