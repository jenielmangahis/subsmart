                        ...
                        <div class="card-body">
                            <div class="row" style="background-color:white;">
                                <div class="col-md-5 form-group">
                                    ...
                                    <?php 
                                        // if( !empty($estimate[0]) ){
                                            $default_cust_id = $estimate->customer_id;
                                        // }
                                    ?>
                                ...
                                <br>
                                    ...
                                    <input type="text" class="form-control" value="<?= $estimate->job_location; ?>" name="jobs_location" id="invoice_jobs_location" />
                                </div>
                                <div class="col-md-5 form-group">
                                    <!-- <p>&nbsp;</p>
                                    <a class="link-modal-open" href="javascript:void(0)" data-toggle="modal"
                                ...
                                <br>
                                    ...
                                    <input type="text" class="form-control" value="<?= $estimate->job_name; ?>" name="job_name" id="job_name" />
                                </div>
                            </div>
                                        ...
                                        <?php if( empty($w_items) ){ ?>
                                            ...
                                            <?php foreach($itemsDetails as $data){ ?>
                                                        <tr>
                                                            ...
                                                            <td><a href="#" class="remove btn btn-sm btn-success"><i class="bx bx-fw bx-trash"></i></a></td>
                                                        </tr>
                                                    <?php } ?>
                                        <?php }else{ ?>
                                        ...
                                        <div class="col-md-5">
                                            <table class="table table_mobile" style="text-align:left;">
                                                ...
                                                <tr>
                                                    ...
                                                    <td align="center">
                                                    <input type="number" name="adjustment_value" id="adjustment_input" value="<?php if(!empty($estimate->adjustment_value) || $estimate->adjustment_value != 0 ) { echo $estimate->adjustment_value;}else{ echo '0'; } ?>" class="form-control adjustment_input" style="width:50%;display:inline;">
                                                        <span class="fa fa-question-circle" data-toggle="popover" data-placement="top" data-trigger="hover" data-content="Optional it allows you to adjust the total amount Eg. +10 or -10." data-original-title="" title=""></span>
                                                    </td>
                                                    <td>$<span id="adjustmentText"><?php if(!empty($estimate->adjustment_value) || $estimate->adjustment_value != 0 ) { echo $estimate->adjustment_value;}else{ echo '0'; } ?></span></td>
                                                </tr>
                                                <!-- <tr>
                                ...
                                <div class="col-md-4 form-group">
                                    <div class="input-group">
                                        <input type="text" name="deposit_amount" value="0" class="form-control"
                                               autocomplete="off" value="<?php echo $estimate->grand_total; ?>">
                                    </div>
                                </div>
                            </div>
                            <br>
                            ...
                            <br><br>
                                ...
                                <br><br>
                                    ...
                                    <textarea name="terms_and_conditions" cols="40" rows="2" class="form-control ckeditor editor1_tc"><?= htmlentities($estimate->terms_conditions); ?></textarea>
                                </div>
                            </div>
                            </div>
