...
<style>
    #invoice-table-first td + td
    {
        width: 50% !important;
    }
    .invoice-table-secondCol
    {
        width: 50% !important;
    }
</style>
                            ...
                            <div class="row">
                                ...
                                <div class="row col-xl-12" data-id="invoices">
                                    ...
                                    <div class="col-xl-10 margin-bottom margin-top pr-0" style="text-align:right;">
                                        <a class="btn btn-success" href="<?php echo base_url('share_link/print/'. $invoice->id . '?format=print') ?>" target="_blank"><span class="fa fa-print fa-margin-right"></span> Print</a>
                                    </div>
                                </div>
                            </div>
