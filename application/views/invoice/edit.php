        ...
        <div class="container-fluid">
            <div class="page-title-box">
                <div class="row align-items-center">
                    ...
                    <div class="col-sm-12">
                        <div class="validation-error" id="estimate-error" style="display: none;">You selected Credit Card Payments as payment method for this invoice. Please configure the <a href="<?php echo base_url('invoice') . '' ?>">Online Payment processor</a> first to accept cart payments.</div>
                    </div>
                </div>
            </div>
            <!-- end row -->
                    ...
                    <div class="card">
                        <div class="card-body">
                            ...
                            <div class="row">
                                ...
                                <div class="col-md-3 form-group">
                                    <label for="work_order">Work Order# <small>(optional)</small></label>
                                ...
                                <div class="col-md-3 form-group">
                                    <label for="purchase_order">Purchase Order# <small>(optional)</small></label>
