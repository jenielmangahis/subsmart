                    ...
                    <div class="col-md-12">
                        <div class="card">
                            <div class="card-header">
                                <h1 style="font-size: 1.75rem;">Converting Estimate to Job</h1>
                            </div>
                            <div class="card-body">
                            ...
                            <select id="job_type_option" name="jobtypes" class="form-control" required>
                                ...
                                <?php if(!empty($job_types)): ?>
                                    <?php foreach ($job_types as $type): ?>
                                        <option <?php if(isset($jobs_data) && $jobs_data->estimate_type == $type->title) {echo 'selected'; } ?> value="<?= $type->title; ?>"><?= $type->title; ?></option>
                                    <?php endforeach; ?>
                                <?php endif; ?>
                            </select>
