<html>
  ...
  <body>
    ...
    <div class="d-flex h-100 justify-content-center align-items-center">
      <?php 
        if($survey_theme == null || $survey->theme_id == null){
          ?>
            <img class="theme-image" style="width: 100%" src="https://via.placeholder.com/150" alt="">
          <?php
        }else{
          if($survey->backgroundImage != null && $survey->useBackgroundImage == true){
            if($survey->customBackgroundImage != ""){
              ?>
                <img class="theme-image " src="<?=base_url()?>uploads/survey/image_custom_background_db/<?=$survey->customBackgroundImage?>" alt="<?=substr($survey->backgroundImage, 0, 4)?>-image">
              <?php
            }
            ...
            ?>
              <img class="theme-image" src="<?=base_url()?>uploads/survey/themes/<?=$survey_theme->sth_primary_image?>" style="<?= $survey_theme->sth_primary_image_class ?>" alt="">
            <?php
          }
        }
      ?>
                    ...
                    ?>
                      <div id="survey-wrapper">
                        ...
                        <?php foreach($questions as $key => $question){ ?>    
                          <script>console.log(<?= json_encode($question)?>)</script>
                                ...
                                foreach ($question->questions as $key1 => $quest){
                                  switch($question->template_id){
                                    ...
                                    case 17: //date
                                      ?>
                                        <div class="form-group input-content">
                                          <input type="date" class="form-control" name="answer-<?=$question->id?>" value="" placeholder="Enter Date">
                                        </div>
                                      <?php
                                      break;
                                    case 18: //file
