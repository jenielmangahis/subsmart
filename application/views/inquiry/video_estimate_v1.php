...
<div class="wrapper" role="wrapper">
        ...
        <div class="card">
            <div class="container-fluid pl-0">
                ...
                <div class="alert alert-warning mt-0 mb-3" role="alert">
                    <span style="color:black;font-family: 'Open Sans',sans-serif !important;font-weight:300 !important;font-size: 14px;">Offer contactless Video estimates for your Clients. Replace in-home estimates with the convenience of Virtual Video Estimate. The client simply has to let you know they would like a contactless estimate and you can schedule a time to look at the Job, while video chatting the client so they can walk us through any work to be done. All estimates are paperless and sent via Markate.</span>
                </div>
                <!--
    ...
    <hr class="card-hr">
    <button data-on-click-label="Saving..." class="btn margin-right">Save Plugin Settings</button>
</div>
