...
<script>
        ...
        $.ajax({
            ...
            success: function(data) {
                ...
                $.each(template_data, function(i, o) {
                    ...
                    //console.log(cust_id);
                    toAppend += '<option ' + selected + ' value=' + o.prof_id + '>' + o
                        .last_name + ', ' + o.first_name + '</option>';
                });
        ...
        $.ajax({
            ...
            success: function(data) {
                ...
                $.each(template_data, function(i, o) {
                    ...
                    //console.log(cust_id);
                    toAppend += '<option ' + selected + ' value=' + o.prof_id + '>' + o.last_name +
                        ', ' + o.first_name + '</option>';
                });
                $('#customer_id').append(toAppend);
                //console.log(template_data);
    ...
    function load_customer_data($id) {
        $.ajax({
            ...
            success: function(data) {
                ...
                $('#cust_address').text(customer_data.mail_add + ' ' + customer_data.city + ',' + ' ' +
                ...
                initMap(customer_data.mail_add + ' ' + customer_data.city + ' ' + ' ' + customer_data
                    .state + ' ' + customer_data.zip_code);
                loadStreetView(customer_data.mail_add + ' ' + customer_data.city + ',' + ' ' + customer_data
                    .state + ' ' + customer_data.zip_code);
            }
        });
    }
    ...
    $(document).ready(function() {
        ...
        $("#fill_esign_btn").click(function() {
            $.ajax({
                ...
                success: function(data) {
                    ...
                    var toAppend = '';
                    $.each(template_data, function(i, o) {
                        toAppend += '<option value=' + o.esignLibraryTemplateId +
                            '>' + o.title + '</option>';
                    });
        ...
        $(".select_item").click(function() {
            ...
            console.log(total);
            markup = "<tr id=\"ss\">" +
                "<td width=\"35%\"><small>Item name</small><input value='" + title +
                "' type=\"text\" name=\"item_name[]\" class=\"form-control\" ><input type=\"hidden\" value='" +
                idd + "' name=\"item_id[]\"></td>\n" +
                "<td width=\"10%\"><small>Qty</small><input data-itemid='" + idd + "' id='" + idd +
                "' value='" + qty +
                "' type=\"number\" name=\"item_qty[]\" class=\"form-control qty\"></td>\n" +
                "<td width=\"10%\"><small>Unit Price</small><input id='price" + idd + "' value='" +
                price +
                "'  type=\"number\" name=\"item_price[]\" class=\"form-control\" placeholder=\"Unit Price\"></td>\n" +
                "<td width=\"10%\"><small>Unit Cost</small><input type=\"text\" name=\"item_cost[]\" class=\"form-control\"></td>\n" +
                "<td width=\"25%\"><small>Inventory Location</small><input type=\"text\" name=\"item_loc[]\" class=\"form-control\"></td>\n" +
                "<td style=\"text-align: center\" class=\"d-flex\" width=\"15%\"><b data-subtotal='" +
                total_ + "' id='sub_total" + idd + "' class=\"total_per_item\">" + total +
                "</b><a href=\"javascript:void(0)\" class=\"remove_item_row\"><i class=\"fa fa-times-circle\" aria-hidden=\"true\"></i></a></td>" +
                "</tr>";
        ...
        $("#start_time").on('change', function() {
            var tag_id = this.value;
            console.log(tag_id);
            var end_time = moment.utc(tag_id, 'hh:mm a')
                .add( <?= $settings['job_time_setting']; ?> ,
                    'hour').format('h:mm a');
            ...
            $.ajax({
                ...
                success: function(data) {
                    if (data === "Success") {
                        ...
                        warning(
                            'There is an error adding Customer. Contact Administrator!');
                        console.log(data);
                    }
                }
            });
