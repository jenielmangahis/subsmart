            ...
            <div class="nsm-page-content">
                ...
                <div class="row">
                    <div class="col-12 col-md-4">
                        <form action="<?php echo base_url('admin/adt_sales_sync_logs') ?>" method="GET">
                    ...
                    <div class="col-12 col-md-8 grid-mb text-end">
                        <div class="nsm-page-buttons page-button-container">
                            <a class="nsm-button primary btn-export-list" href="<?= base_url('admin/export_adt_sales_sync_logs') ?>" style="margin-left: 10px;"><i class="bx bx-fw bx-file"></i> Export List</a>                        
                        </div>
                    </div>
                </div>
                <table class="nsm-table">
                    <thead>
                        <tr>
                            <td class="Company Name" style="width: 30%;">Company Name</td>
                            <td data-name="Date">Date</td>
                            <td data-name="Total" style="width:10%;">Total Sync Data</td>
                        </tr>
                    </thead>
                    <tbody>
                        <?php if (!empty($syncLogs)){ ?>
                            <?php foreach ($syncLogs as $log) { ?>
                                <tr>
                                    ...
                                    <td><?= date("m/d/Y H:i:s", strtotime($log->date_sync)); ?></td>
                                    <td><?= $log->total_sync; ?></td>
                                </tr>
                            <?php } ?>
                        <?php }else{ ?>
                            <tr>
