        ...
        <div class="row refer-form-sec">
          <div class="col">
            <div class="refer-image">
              <img src="<?= base_url('assets/img/refer_friend_bannerjpg.png'); ?>" style="padding: 54px;">
            </div>
          </div>
          <div class="col">
            <div class="refer-form-content" style="margin-top:40px;">
              <h2>Refer to your Family and Friends</h2>
              <p>Enter your friends and family below</p>
              <br />
              <div class="mt-3">
                <form action="#" method="post" id="form-referer">
                  <div class="referer-fields">
                    <div class="row row-fields">
                      <div class="col-md-5">
                        <input type="text" name="refer[0][name]" required="" placeholder="Name">
                      </div>
                      <div class="col-md-5">
                        <input type="email" name="refer[0][email]" required="" placeholder="Email">    
                      </div>
                      <div class="col-md-2">
                        <a class="btn btn-add-more" href="javascript:void(0);" style="font-size: 27px;"><i class="fa fa-plus-circle"></i></a>    
                      </div>
                    </div>
                  </div>
...
$(function(){
  ...
  $("#form-referer").submit(function(e){
    ...
    $(".btn-send").html('<span class="spinner-border spinner-border-sm m-0"></span>');

    setTimeout(function () {
        $.ajax({
           type: "POST",
           url: base_url + '_send_refer_email',
           dataType:'json',
           data: $("#form-referer").serialize(),
           success: function(o)
           {
              if( o.is_success ){
                Swal.fire({
                  ...
                  text: 'Thank you for refering a friend.'
                });   
              }else{
                Swal.fire({
                  icon: 'error',
