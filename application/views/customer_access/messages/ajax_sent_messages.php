...
<a class="nsm-button primary send-message" data-agent-name="<?= ucwords($agent->FName) . ' ' . ucwords($agent->LName) ?>" data-id="<?= $agent->id; ?>" data-phone="<?= $agent->mobile; ?>" href="javascript:void(0);">Send Message</a>
</div>
