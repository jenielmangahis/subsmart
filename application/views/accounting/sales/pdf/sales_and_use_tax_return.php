...
<div style="font-family:arial;">
    <table style="width: 100%; margin-bottom: 10px;">
        <tbody>
            <tr>
                ...
                <td style="width:30%;text-align:center;"><h1>Sales and Use Tax Return</h1></td>
            ...
            <tr>
                <tbody>
                    <tr>
                        ...
                        <td style="width:30%">
                            <p style="font-size:12px;width:46%;margin-right:29px;float:right;">You may file and pay tax online or you may complete this return and pay tax by check or money order and mail to:</p>
                            <div style="clear:both;"></div>
                            <p style="font-size:14px;width:39%;margin-right:29px;float:right;">Florida Department 2 of Revenue 5050 W Tennessee StreetTallahassee, FL 32399-0120</p>
                            <div style="clear:both;"></div>
                            <p style="font-size:12px;width:46%;margin-right:29px;float:right;">Please read the Instructions for DR-15 Sales and Use Tax Returns (Form DR-15N), incorporated by reference in Rule 12A-1.097, F.A.C., before you complete this return. Instructions are posted at <b>floridarevenue.com/forms</b>. </p>
                            <div style="clear:both;"></div>
                        </td>
                    </tr>
                </tbody>
    ...
    <table style="width: 96%; margin-top:40px;margin-left:40px;border-collapse: collapse;">
        <tbody>
            <tr>
                <tbody>
                    <tr>
                    ...
                    <tr>
                        ...
                        <td colspan="4" style="text-align:center; font-size:25px; border-top:rgb(255,109,106) 1px solid; border-left:rgb(255,109,106) 1px solid">9100&nbsp;&nbsp;&nbsp;0&nbsp;&nbsp;&nbsp;20259999&nbsp;&nbsp;&nbsp;0001003031&nbsp;&nbsp;&nbsp;5&nbsp;&nbsp;&nbsp;4999999999&nbsp;&nbsp;&nbsp;0000&nbsp;&nbsp;&nbsp;5</td>
                    </tr>  
                    <tr>
                        <td style="">&nbsp;</td>
                        <td colspan="4">&nbsp;</td>
    ...
    <p><b>File and Pay Online to Receive a Collection Allowance.</b> When you electronically file your tax return and pay timely, you are entitled
...
<b>floridarevenue.com</b></p>
    ...
    <p>Due Dates. Returns and payments are <b>due on the 1st and late after the 20th day of the month</b> following each reporting period.
...
<table style="width: 95%; margin-bottom: 10px;">
    <tbody>
        ...
        <tr>
            ...
            <td style="">&nbsp;</td>
            <td style="">&nbsp;</td>
            <td olspan="2" style="text-align:center">(______)_______________________</td>
            <td style="">&nbsp;</td>
            <td style="">&nbsp;</td>
            <td colspan="2" style="">&nbsp;</td>
        </tr>
        <tr>
            ...
            <td style="">&nbsp;</td>
            <td style="">&nbsp;</td>
            <td olspan="2" style="text-align:center">Telephone Number</td>
            <td style="">&nbsp;</td>
            <td style="">&nbsp;</td>
            <td colspan="2" style="">&nbsp;</td>
        </tr>
...
<table style="width: 95%; margin-bottom: 10px; margin-top: 60px;">
    <tbody>
        <tr>
            <td colspan="10" style="text-align:center; padding-bottom: 25px;">Under penalties of perjury, I declare that I have read this return and the facts stated in it are true.</td>
        </tr>
