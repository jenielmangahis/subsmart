                ...
                <div class="row">
                            ...
                            <div class="col-md-12 mb-3" id="learn_how_payments" style="height:160px">
                                <div class="nsm-card primary">
                                    ...
                                    <div style="float:right;text-decoration:none;">
                                        <a href="#" class="text-decoration-none" id="not_now_link">Not Now</a> &emsp; <button onclick="window.location.href='<?= base_url('accounting/banking') ?>'" class="nsm-button success">Learn More</button>
                                    </div>
                                </div>
                            </div>
                            <div class="col-md-12 ">
                    ...
                    <div class="col-md-5 h-100">
                        <div class="nsm-card primary h-100">
                            ...
                            <table style="white-space: nowrap; display:flex; flex-wrap:wrap;">
                                <tr style="display:flex; cursor:pointer; flex-wrap:wrap; row-gap:15px">
                                    ...
                                    <td><a id="new-invoice" class="nsm-button success"> New Invoice</a></td>
                                    <td>
                                        <a id="new-recurring-invoice" class="nsm-button success">Recurring Invoice</a>
                                    </td>
                                    <td><a id="new-sales-receipt" class="nsm-button success">New Sale</a></td>
                                    <td><a id="new-recurring-sale" class="nsm-button success">Recurring Sale</a></td>
                                </tr>
