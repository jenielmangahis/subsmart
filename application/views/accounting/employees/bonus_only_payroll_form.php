                                ...
                                <div class="employees-table">
                                    <table class="table table-bordered table-hover" id="payroll-table">
                                        <thead>
                                            ...
                                            <th>BONUS</th>
                                            <th>MEMO</th>
                                            <th><?=$bonusPayType === 'gross-pay' ? 'TOTAL PAY' : 'GROSS PAY'?></th>
                                        </thead>
                                        <tbody>
                                            <?php foreach($payDetails as $payDetail) : ?>
                                                ...
                                                <tr>
                                                    ...
                                                    <td>
                                                        <input type="number" name="bonus[]" step="0.01" class="form-control w-75 float-right text-right">
                                                    </td>
                                                    <td>
...
<div class="modal-footer bg-secondary">
    <div class="row w-100">
        <div class="col-md-4">
            <button type="button" class="btn btn-secondary btn-rounded border" id="bonus-pay-select">Back</button>
        </div>
        <div class="col-md-4">
