...
for ($i=0;$i<count($pdf_data);$i++) {
    $format="pdf";
    $sub_data = $pdf_data[$i];
    $invoice = $sub_data["invoice"];
    $user = $sub_data["user"];
    $items = $sub_data["items"];
    $users = $sub_data["users"];
    $profile = $sub_data["profile"]; ?>


<div class="<?php echo ($format == 'print') ? 'print': '' ?>"
    style="width:100% !important;page-break-after: always;">
    <div class="<?php echo ($format == 'print') ? 'invoice-paper print-body': 'invoice-paper' ?>"
        id="presenter-paper">
        <?php if ($format == 'print') : ?>
        <div style="text-align: right; margin-bottom: 10px;">
            <!-- <a class="btn-print" onclick="window.print();" href="#">Print</a> -->
            <a class="btn-print" data-print-modal="open" href="#" onclick="printDiv('printableArea')"
                value="Print Work Order"><span class="fa fa-print"></span> Print</a>
        </div>
        <?php endif; ?>
                ...
                <table class="table-print" style="width: 100%; margin-bottom: 10px;">
                    <tbody>
                        <tr>
                            ...
                            <td id="presenter-col-right" class="presenter-col-right"
                                style="width: 50%; text-align: right;" valign="top">
                                <div id="presenter-title-container" class="presenter-title-container"
                                    style="margin-top: 10px; margin-bottom: 20px;">
                                    <span class="presenter-title"
                                        style="font-size: 30pt;color:#8c97c0;">INVOICE</span><br>
                                    ...
                                    <table style="width: 100%">
                                        <tbody>
                                            ...
                                            <tr>
                                                ...
                                                <td style="width: 160px; text-align: right;" class="text-right"><?php echo $invoice->invoice_type ?>
                                                </td>
                                            </tr>
                                            <tr>
                                                <td style="text-align: right;">Work Order#:</td>
                                                <td style="width: 160px; text-align: right;" class="text-right"><?php echo $invoice->work_order_number ?>
                                                </td>
                                            </tr>
                                            <tr>
                                                <td style="text-align: right;">Check Payable To:</td>
                                                <td style="width: 160px; text-align: right;" class="text-right"><?php echo $user->FName . ' ' . $user->LName ?>
                                                </td>
                                            </tr>
                                            <tr>
        ...
        echo "$0.00";
            ...
            <tr>
                ...
                <td style="width: 70%" valign="top">
                    <b>JOB LOCATION:</b><br>
                    <b><?php //echo get_customer_by_id($invoice->customer_id)->contact_name
                        echo $users->first_name .' '. $users->middle_name .' '. $users->last_name; ?>
                    </b><br>
                ...
                <table class="table-print table-items" style="width: 100%; border-collapse: collapse;">
                    <thead>
                        <tr>
                            ...
                            <th style="background: #f4f4f4; text-align: right; padding: 5px 8px 5px 0;"
                        ...
                        <tr>
                            ...
                            <td>
                                <table style="width: 100%; border-collapse: collapse;">
                                    <tbody>
                                        <tr>
                                            <td style="padding: 8px 0; text-align: right;" class="text-right">Subtotal
                                                (without tax)</td>
                                            <td style="padding: 8px 8px 8px 0; text-align: right;" class="text-right">$
                                                <?php //echo (false) ? number_format(floatval($invoice->invoice_totals['sub_total'] - $total_tax), 2, '.', ',') : ''
                                            echo number_format($invoice->sub_total, 2); ?>
                                            </td>
                                        </tr>
                                        <tr>
                                            <td style="padding: 8px 0; text-align: right;" class="text-right">Taxes</td>
                                            <td style="padding: 8px 8px 8px 0; text-align: right;" class="text-right">$
                                                <?php //echo (false) ? number_format($total_tax, 2, '.', ',') : ''
                                            echo number_format($invoice->taxes, 2); ?>
                                            </td>
                                        </tr>
                                        <tr>
                                            <td style="padding: 8px 0; text-align: right; background: #f4f4f4;"
                                                class="text-right"><b>Grand Total ($)</b></td>
                                            <td style="width: 120px; padding: 8px 8px 8px 0; text-align: right; background: #f4f4f4;"
                                                class="text-right"><b>$ <?php //echo (false) ? number_format($invoice->invoice_totals['grand_total'], 2, '.', ',') : ''
                                            echo number_format($invoice->grand_total, 2); ?>
                                                </b></td>
                                        </tr>
                                    </tbody>
                        ...
                        <tr>
                            ...
                            <td>
                                <table style="width: 100%; border-collapse: collapse;">
                                    <tbody>
                                        <tr>
                                            <td style="padding: 4px 0; text-align: right;" class="text-right"><b>Balance
                                                    Due</b></td>
                                            <td style="width: 120px; padding: 4px 8px 4px 0; text-align: right;"
                                                class="text-right"><b>
                                                    <?php if ($invoice->invoice_type == 'Total Due') {
                                                echo '$ '.number_format($invoice->grand_total, 2);
                                            } else {
