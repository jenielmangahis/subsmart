    ...
    <main role="main">
        <section class="jumbotron text-center">
            <div class="container">
                ...
                ?>
                <h2 style="text-align:left;">Refund Receipt #<?=$refund_receipt_id?>
                </h2>
                ...
                <div class="data-section">
                    ...
                    <div class="download-buttons">
                        <a href="<?=$refund_receipt_file_name?>"
                            class="download-sales-receipt"
                            style="color: #fff;font-size: 15px;font-weight: 100;">Download Refund Receipt</a>
                    </div>
