                                        ...
                                        <div class="col-md-6 divided">
                                            <div class="form-group">
                                                <div class="label">Email
                                                    <div class="email-cc-bcc-section">
                                                        <a href="#" class="cc-bcc-btn float-right">cc/bcc</a>
                                                        <div class="email-cc-bcc-panel">
                                                            ...
                                                            <div class="form-group">
                                                                ...
                                                                <input type="text" class="form-control" name="email-cc"
                                                                    placeholder="Email (Separate emails with a comma)">
                                                            </div>
                                                            <div class="form-group">
                                                                <div class="label">Bcc</div>
                                                                <input type="text" class="form-control" name="email-bcc"
                                                                    placeholder="Email (Separate emails with a comma)">
                                                            </div>
                                                            <div class="row">
                                                                <div class="col-md-6">
                                                                    <button class="btn btn-default cancel-btn px-4"
                                                                        type="button">Cancel</button>
                                                                </div>
                                                                <div class="col-md-6">
                                                                    <button class="btn btn-default done-btn px-4"
                        ...
                        <div class="row" style="margin-top: 30px;">
                            ...
                            <div class="col-md-3">
                                <div class="text-right">
                                    ...
                                    <h2><span class="grand_total_sr_t bigdisplay">$0.00</span></h2>
                                </div>
                                        ...
                                        <tbody>
                                            <tr class="item">
                                                ...
                                                <td width="150px" style="text-align: right;"><input type="hidden"
                                                    ...
                                                    $<span class="total_per_item_rr">0.00</span>
