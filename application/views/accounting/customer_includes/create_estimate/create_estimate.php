<div class="full-screen-modal">
    <div id="create_estimate_modal" class="modal fade modal-fluid" role="dialog">
                        ...
                        <div class="row" style="margin-top: 30px;">
                            <div class="col-md-6">
                                <div class="row">
                                    ...
                                    <div class="col-md-3">
                                        <div class="form-group" style="margin-bottom: 5px!important;">
                                            <div class="label">Sales Receipt date</div>
                                            <input type="date" class="form-control" name="sales_receipt_date">
                                        </div>
                                        <div class="ship-to-section">
                                            <div class="form-group" style="margin-bottom: 5px!important;">
