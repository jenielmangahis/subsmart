                                    ...
                                    <table id="items_table_refund_receipt" class="table table-hover" style="width: 100%;">
                                        ...
                                        <?php foreach($items as $item){ // print_r($item); ?>
                                            <tr>
                                                ...
                                                <td><button id="<?= $item->id; ?>" data-quantity="<?= $item->units; ?>" data-itemname="<?= $item->title; ?>" data-price="<?= $item->price; ?>" type="button" data-dismiss="modal" class="btn btn-sm btn-default select_item_rr">
...
$(".select_item_rr").click(function () {
            ...
            markup = "<tr id=\"ss\">" +
                ...
                "<td width=\"10%\"><input id='price_rr_"+idd+"' value='"+price+"'  type=\"number\" name=\"price[]\" class=\"form-control\" placeholder=\"Unit Price\"></td>\n" +
