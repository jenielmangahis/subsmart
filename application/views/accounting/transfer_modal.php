                    ...
                    <div class="row">
                        <div class="col-md-6">
                            <div class="form-group w-50">
                                ...
                                <select name="transfer_from" id="transferFrom" class="form-control">
                    ...
                    <div class="row">
                        <div class="col-md-6">
                            <div class="form-group w-50">
                                ...
                                <select name="transfer_to" id="transferTo" class="form-control">
                                    <option value="">Cash on hand</option>
                                </select>
                            </div>
                        </div>
                    ...
                    <div class="row">
                        <div class="col-md-6">
                            <div class="form-group w-50">
                                ...
                                <input type="number" name="transfer_amount" id="transferAmount" class="form-control">
                            </div>
                        </div>
