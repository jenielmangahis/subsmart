...
<div class="tile-container" >
    <div class="card no-padding" style="margin-top:0;">
        ...
        <div class="card-body pt-3" style="height:100px;">
                ...
                <div class="carousel-inner">
                    <div class="carousel-item active text-center">
                        <div class="col-lg-12 no-padding">
                            ...
                            <div class="col-lg-2 no-padding float-left text-center pointer">
                                <img class="col-lg-12" src="<?= assets_url('img/shortcuts/accounting/').'02_process_payment.png' ?>" />
                                <p>Process Payment</p>
                            </div>
                            <div class="col-lg-2 no-padding float-left pointer text-center">
