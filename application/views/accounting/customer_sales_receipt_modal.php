...
$(".select_item3").click(function () {
            ...
            markup = "<tr id=\"ss\">" +
                ...
                "<td width=\"10%\"><input data-itemid='"+idd+"' id='quantity_"+idd+"' value='"+qty+"' type=\"number\" name=\"quantity[]\" data-counter=\"0\"  min=\"0\" class=\"form-control quantitysr2\"></td>\n" +
