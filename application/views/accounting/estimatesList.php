...
<div class="wrapper" role="wrapper">
    ...
    <div class="card p-20">
      <div class="container-fluid pt-0 pl-0" style="font-size:14px;">
              ...
              <div class="col-auto">
                <div class="h1-spacer">
                  ...
                  <a class="btn btn-primary"
                    href="<?php echo base_url('estimate/print') ?>">
                    <span class="fa fa-print "></span> Print
                  </a>
                  <?php } ?>

                  <a class="btn btn-primary" data-toggle="modal" data-target="#newJobModal"
                    href="<?php echo url('job/new_job') ?>">
        ...
        <div class="col mb-4 left alert alert-warning mt-0 mb-2">
          <span
            style="color:black;font-family: 'Open Sans',sans-serif !important;font-weight:300 !important;font-size: 14px;">Create
            an estimate when you want to give your customer a quote, bid, or proposal for work you plan to do. There are
            3 forms of estimate: standard, options and bundle (package) The estimate can later be turned into a sales
            order or an invoice. With this layout you will be able to monitor the status of each estimate.</span>
        </div>
        ...
        <div class="row pb-2">
          <div class="col-md-12 banking-tab-container">
            ...
            <a href="<?php echo url('/accounting/newEstimateList')?>"
              class="banking-tab-active text-decoration-none">Estimates</a>
          ...
          <div class="row pl-0 pr-0">
            ...
            <div class="col col-8 fr-right text-right-sm d-flex align-items-center mb-fix-list">
              <form style="display: inline;" class="form-inline form-search" name="form-search"
                action="<?php echo base_url('estimate') ?>"
                method="get">
    ...
    continue;
            ...
            <li <?php echo ((!empty($tab)) && strtolower($status) === $tab) ? "class='active'" : "" ?>>
              <a class="nav-link" id="profile-tab"
                ...
                href="<?php echo base_url('accounting/newEstimateList/' . strtolower($status)) ?>"
                role="tab" aria-controls="profile" aria-selected="false"><?php echo $status ?>
                    ...
                    <div class="dropdown dropdown-btn">
                      ...
                      <ul class="dropdown-menu dropdown-menu-right" role="menu" aria-labelledby="dropdown-edit">
                        <li role="presentation"><a role="menuitem" tabindex="-1" href="#"
                            est-id="<?php echo $estimate->id;?>"
                            class="viewEstimate"><span class="fa fa-file-text-o icon"></span> View Estimate</a></li>
                        <li role="presentation"><a role="menuitem" tabindex="-1"
                        ...
                        <li role="presentation">
                          <a role="menuitem"
                            ...
                            data-delete-modal="open"><span class="fa fa-trash-o icon"></span> Delete</a>
                        </li>
                      </ul>
                    </div>
                  </td>
  ...
  <!-- Modal -->
  <div class="modal fade" id="estimateview" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel"
    aria-hidden="true">
          ...
          <div class="d-block">
            <div class="col-md-12" style="text-align: right;margin-bottom: 60px;">
              <a class="btn btn-success"
                href="<?php echo base_url('estimate/send_customer/' . $estimate->id) ?>"><span
                  class="fa fa-envelope-open-o icon"></span> SEND TO CUSTOMER</a>
              <a class="btn btn-info"
                href="<?php echo base_url('estimate/edit/' . $estimate->id) ?>"><span
                  class="fa fa-pencil icon"></span> EDIT</a>
              <a class="btn btn-info" target="_new"
                href="<?php echo base_url('estimate/view_pdf/' . $estimate->id) ?>"><span
                  class="fa fa-file-pdf-o icon"></span> PDF</a>
              <!-- <a class="btn btn-info" href="<?php echo base_url('estimate/') ?>">BACK
              TO ESTIMATE LIST</a> -->
            </div>
            <div class="col-xl-5 left" style="margin-bottom: 33px;">
              <h5><span class="fa fa-user-o fa-margin-right"></span> From <span
                  class="invoice-txt business_name"></span></h5>
            ...
            <table class="table-print table-items" style="width: 100%; border-collapse: collapse;margin-top: 55px;">
              <thead>
                <tr>
                  ...
                  <th style="background: #f4f4f4; text-align: right; padding: 5px 8px 5px 0;" class="text-right">Total
                  </th>
                </tr>
              </thead>
              <tbody>
  ...
  <!-- Modal Send Email  -->
  <div class="modal fade bd-example-modal-md" id="modalSendEmail" tabindex="-1" role="dialog"
    aria-labelledby="modalSendEmailTitle" aria-hidden="true">
    ...
    <div class="modal-content">
      ...
      <div class="modal-body">
        <form name="convert-to-work-order-modal-form">
          <p>
            You are going create a new work order based on <b>Estimate# <span id="estimateCustomNumber"></span></b>.<br>
      ...
      <div class="modal-footer">
        ...
        <button type="button"
          data-link="<?php echo base_url('workorder/add/?estimate_id=' . $estimate->id) ?>"
...
<div class="modal fade" id="newJobModal" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel"
  ...
  <script>
    ...
    window.updateUserStatus = (id, status) => {
      $.get(
        '<?php echo url('company/change_status') ?>/' +
        id, {
          status: status
        }, (data, status) => {
          if (data == 'done') {
