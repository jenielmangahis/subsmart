...
<div class="modal-right-side">
    <div class="modal right fade" id="bundle-form-modal" tabindex="" role="dialog" aria-labelledby="myModalLabel2">
                                    ...
                                    <div class="row">
                                        <div class="col-sm-12">
                                            ...
                                            <div class="form-check">
                                                <input class="form-check-input" type="checkbox" id="displayBundle" value="1">
