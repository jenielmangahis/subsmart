...
<div class="modal-right-side">
    <div class="modal right fade" id="non-inventory-form-modal" tabindex="" role="dialog" aria-labelledby="myModalLabel2">
                                ...
                                <th>
                                    <div class="row" style="height: 68.5px;">
                                        ...
                                        <div class="col-sm-10 d-flex align-items-center">
                                            <h5><span>Non-inventory</span></h5> &nbsp;&nbsp; <a href="#" class="text-info" onclick="selectType('non-inventory')"><span>Change type</span></a>
                                        </div>
                                    </div>
                                </th>
                            </tr>
