                        ...
                        <div class="row">
                            <div class="col-md-2">
                                <div class="form-group">
                                    ...
                                    <input type="date" name="adjustment_date" id="adjustmentDate" class="form-control" required>
                                </div>
                            </div>
                            ...
                            <div class="col-md-12 p-0 mb-5">
                                <div class="inventory-table-container w-100">
                                    <div class="inventory-table">
                                        <table class="table table-bordered table-hover" id="inventory-adjustments-table">
                                            <thead>
                                                <th></th>
                                                <th>#</th>
