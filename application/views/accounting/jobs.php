                ...
                <table id="JOB_LIST_TABLE" class="nsm-table w-100">
                    ...
                    <tbody>
                        ...
                        <tr>
                            ...
                            <td>
                                <?php 
                                    if( $job->FName != '' ||  $job->LName != ''){
                                        ...
                                        echo 'Sales Representative Not Specified';
                                    }
                                ?>                                  
                            </td>
                            <td>
                            ...
                            <td><?= $job->job_type != '' && !is_numeric($job->job_type) ? $job->job_type : 'Job Type Not Specified'; ?></td>
                            <td><?= $job->tags != '' ? $job->tags : 'Job Tags Not Specified'; ?></td>
