                                    ...
                                    <div class="tab-pane active standard-accordion" id="standard">
                                            ...
                                            <div class="card p-0">
                                                ...
                                                <div id="favoritesCollapse" class="collapse" data-parent="#favorites" style="">
                                                    <div class="row">
                                                        <div class="col-md-5">
                                                            <ul class="list-unstyled">
                                                                <li class="border-bottom p-3 cursor-pointer">
                                                                    <a href="<?php echo url('accounting/aging_summary_report')?>" class=" font-weight-normal">Accounts receivable aging summary</a>
                                                                ...
                                                                <li class="border-bottom p-3 cursor-pointer">
                                                                    <a href="<?php echo url('accounting/profit_and_loss')?>" class=" font-weight-normal">Profit and Loss</a>
                                                                    <a href="#" class="pl-1 text-secondary h6 position-relative top-1"><i class="fa fa-question-circle-o "></i></a>
                                                        ...
                                                        <div class="col-md-2">
                                                            <img class="growth-icon-hover" src="<?php echo $url->assets; ?>/img/reportIcons/favorites.PNG" alt="" style="position: absolute;right: 0px;bottom: 0px;">
                                                        </div>
                                                    </div>
                                                </div>
                                            </div>
                                        ...
                                        <div id="businessOverview" class="menu-reports">
                                            <div class="card p-0">
                                                ...
                                                <div id="businessOverviewCollapseOne" class="collapse" data-parent="#businessOverview" >
                                                    <div class="row">
                                                        <div class="col-md-5">
                                                            <ul class="list-unstyled">
                                                                <li class="border-bottom p-3 cursor-pointer">
                                                                    <a href="<?php echo url('accounting/audit_log_report'); ?>" class=" font-weight-normal">Audit Log</a>
                                                                    <a href="#" class="pl-1 text-secondary h6 position-relative top-1"><i class="fa fa-question-circle-o "></i></a>
                                                                ...
                                                                <li class="border-bottom p-3 cursor-pointer">
                                                                    <a href="<?php echo url('accounting/balance_sheet_comparison'); ?>" class=" font-weight-normal">Balance Sheet Comparison</a>
                                                                    <a href="#" class="pl-1 text-secondary h6 position-relative top-1"><i class="fa fa-question-circle-o "></i></a>
                                                                ...
                                                                <li class="border-bottom p-3 cursor-pointer">
                                                                    <a href="#" class=" font-weight-normal">Profit and Loss as % of total income</a>
                                                                    <a href="#" class="pl-1 text-secondary h6 position-relative top-1"><i class="fa fa-question-circle-o "></i></a>
                                                                ...
                                                                <li class="border-bottom p-3 cursor-pointer">
                                                                    <a href="#" class=" font-weight-normal">Profit and Loss Comparison</a>
                                                                    <a href="#" class="pl-1 text-secondary h6 position-relative top-1"><i class="fa fa-question-circle-o "></i></a>
                                                        ...
                                                        <div class="col-md-5">
                                                            <ul>
                                                            <li class="border-bottom p-3 cursor-pointer">
                                                                    <a href="#" class=" font-weight-normal">Profit and Loss Detail</a>
                                                                    <a href="#" class="pl-1 text-secondary h6 position-relative top-1"><i class="fa fa-question-circle-o "></i></a>
                                                                ...
                                                                <li class="border-bottom p-3 cursor-pointer">
                                                                    <a href="#" class=" font-weight-normal">Profit and Loss year-to-date comparison</a>
                                                                    <a href="#" class="pl-1 text-secondary h6 position-relative top-1"><i class="fa fa-question-circle-o "></i></a>
                                                                ...
                                                                <li class="border-bottom p-3 cursor-pointer">
                                                                    <a href="#" class=" font-weight-normal">Profit and Loss by Customer</a>
                                                                    <a href="#" class="pl-1 text-secondary h6 position-relative top-1"><i class="fa fa-question-circle-o "></i></a>
                                                                ...
                                                                <li class="border-bottom p-3 cursor-pointer">
                                                                    <a href="#" class=" font-weight-normal">Profit and Loss by Month</a>
                                                                    <a href="#" class="pl-1 text-secondary h6 position-relative top-1"><i class="fa fa-question-circle-o "></i></a>
                                                                ...
                                                                <li class="border-bottom p-3 cursor-pointer">
                                                                    <a href="#" class=" font-weight-normal">Profit and Loss</a>
                                                                    <a href="#" class="pl-1 text-secondary h6 position-relative top-1"><i class="fa fa-question-circle-o "></i></a>
                                                                ...
                                                                <li class="border-bottom p-3 cursor-pointer">
                                                                    <a href="#" class=" font-weight-normal">Quarterly Profit and Loss Summary</a>
                                                                    <a href="#" class="pl-1 text-secondary h6 position-relative top-1"><i class="fa fa-question-circle-o "></i></a>
                                                                ...
                                                                <li class="border-bottom p-3 cursor-pointer">
                                                                    <a href="#" class=" font-weight-normal">Statement of Cash Flows</a>
                                                                    <a href="#" class="pl-1 text-secondary h6 position-relative top-1"><i class="fa fa-question-circle-o "></i></a>
                                                        ...
                                                        <div class="col-md-2">
                                                            <img class="growth-icon-hover" src="<?php echo $url->assets; ?>/img/reportIcons/business_overview.PNG" alt="" style="position: absolute;right: 0px;bottom: 0px;">
                                                        </div>
                                                    </div>
                                                </div>
                                            </div>
                                                ...
                                                <div id="whoOwesYouCollapseOne" class="collapse" data-parent="#whoOwesYou" style="">
                                                    <div class="row">
                                                        <div class="col-md-5">
                                                            <ul class="list-unstyled">
                                                                <li class="border-bottom p-3 cursor-pointer">
                                                                    <a href="#" class=" font-weight-normal">Accounts receivable aging detail</a>
                                                                    <a href="#" class="pl-1 text-secondary h6 position-relative top-1"><i class="fa fa-question-circle-o "></i></a>
                                                                ...
                                                                <li class="border-bottom p-3 cursor-pointer">
                                                                    <a href="#" class=" font-weight-normal">Accounts receivable aging summary</a>
                                                                    <a href="#" class="pl-1 text-secondary h6 position-relative top-1"><i class="fa fa-question-circle-o "></i></a>
                                                                ...
                                                                <li class="border-bottom p-3 cursor-pointer">
                                                                    <a href="#" class=" font-weight-normal">Collections Report</a>
                                                                    <a href="#" class="pl-1 text-secondary h6 position-relative top-1"><i class="fa fa-question-circle-o "></i></a>
                                                                ...
                                                                <li class="border-bottom p-3 cursor-pointer">
                                                                    <a href="#" class=" font-weight-normal">Customer Balance Detail</a>
                                                                    <a href="#" class="pl-1 text-secondary h6 position-relative top-1"><i class="fa fa-question-circle-o "></i></a>
                                                                ...
                                                                <li class="border-bottom p-3 cursor-pointer">
                                                                    <a href="#" class=" font-weight-normal">Customer Balance Summary</a>
                                                                    <a href="#" class="pl-1 text-secondary h6 position-relative top-1"><i class="fa fa-question-circle-o "></i></a>
                                                                ...
                                                                <li class="border-bottom p-3 cursor-pointer">
                                                                    <a href="#" class=" font-weight-normal">Invoice List</a>
                                                                    <a href="#" class="pl-1 text-secondary h6 position-relative top-1"><i class="fa fa-question-circle-o "></i></a>
                                                        ...
                                                        <div class="col-md-5">
                                                            <ul>
                                                                <li class="border-bottom p-3 cursor-pointer">
                                                                    <a href="#" class=" font-weight-normal">Invoices and Received Payments</a>
                                                                    <a href="#" class="pl-1 text-secondary h6 position-relative top-1"><i class="fa fa-question-circle-o "></i></a>
                                                                ...
                                                                <li class="border-bottom p-3 cursor-pointer">
                                                                    <a href="#" class=" font-weight-normal">Open Invoices</a>
                                                                    <a href="#" class="pl-1 text-secondary h6 position-relative top-1"><i class="fa fa-question-circle-o "></i></a>
                                                                ...
                                                                <li class="border-bottom p-3 cursor-pointer">
                                                                    <a href="#" class=" font-weight-normal">Statement List</a>
                                                                    <a href="#" class="pl-1 text-secondary h6 position-relative top-1"><i class="fa fa-question-circle-o "></i></a>
                                                                ...
                                                                <li class="border-bottom p-3 cursor-pointer">
                                                                    <a href="#" class=" font-weight-normal">Terms List</a>
                                                                    <a href="#" class="pl-1 text-secondary h6 position-relative top-1"><i class="fa fa-question-circle-o "></i></a>
                                                                ...
                                                                <li class="border-bottom p-3 cursor-pointer">
                                                                    <a href="#" class=" font-weight-normal">Unbilled charges</a>
                                                                    <a href="#" class="pl-1 text-secondary h6 position-relative top-1"><i class="fa fa-question-circle-o "></i></a>
                                                                ...
                                                                <li class="border-bottom p-3 cursor-pointer">
                                                                    <a href="#" class=" font-weight-normal">Unbilled time</a>
                                                                    <a href="#" class="pl-1 text-secondary h6 position-relative top-1"><i class="fa fa-question-circle-o "></i></a>
                                                        ...
                                                        <div class="col-md-2">
                                                            <img class="growth-icon-hover" src="<?php echo $url->assets; ?>/img/reportIcons/who_owes_you.PNG" alt="" style="position: absolute;right: 0px;bottom: 0px;">
                                                        </div>
                                                    </div>
                                                </div>
                                            </div>
                                                ...
                                                <div id="salesAndCustomersCollapseOne" class="collapse" data-parent="#salesAndCustomers" style="">
                                                    <div class="row">
                                                        <div class="col-md-5">
                                                            <ul class="list-unstyled">
                                                                <li class="border-bottom p-3 cursor-pointer">
                                                                    <a href="#" class=" font-weight-normal">Customer Contact List</a>
                                                                    <a href="#" class="pl-1 text-secondary h6 position-relative top-1"><i class="fa fa-question-circle-o "></i></a>
                                                                    <div class="dropdown pull-right d-inline-block">
                                                                        <span type="button" data-toggle="dropdown" aria-expanded="false">
                                                                            <i class="fa fa-ellipsis-v fa-lg"></i>
                                                                ...
                                                                <li class="border-bottom p-3 cursor-pointer">
                                                                    <a href="#" class=" font-weight-normal">Deposit Detail</a>
                                                                    <a href="#" class="pl-1 text-secondary h6 position-relative top-1"><i class="fa fa-question-circle-o "></i></a>
                                                                    <div class="dropdown pull-right d-inline-block">
                                                                        <span type="button" data-toggle="dropdown" aria-expanded="false">
                                                                            <i class="fa fa-ellipsis-v fa-lg"></i>
                                                                ...
                                                                <li class="border-bottom p-3 cursor-pointer">
                                                                    <a href="#" class=" font-weight-normal">Estimates & Progress Invoicing Summary by Customer</a>
                                                                    <a href="#" class="pl-1 text-secondary h6 position-relative top-1"><i class="fa fa-question-circle-o "></i></a>
                                                                    <div class="dropdown pull-right d-inline-block">
                                                                        <span type="button" data-toggle="dropdown" aria-expanded="false">
                                                                            <i class="fa fa-ellipsis-v fa-lg"></i>
                                                                ...
                                                                <li class="border-bottom p-3 cursor-pointer">
                                                                    <a href="#" class=" font-weight-normal">Estimates by Customer</a>
                                                                    <a href="#" class="pl-1 text-secondary h6 position-relative top-1"><i class="fa fa-question-circle-o "></i></a>
                                                                    <div class="dropdown pull-right d-inline-block">
                                                                        <span type="button" data-toggle="dropdown" aria-expanded="false">
                                                                            <i class="fa fa-ellipsis-v fa-lg"></i>
                                                                ...
                                                                <li class="border-bottom p-3 cursor-pointer">
                                                                    <a href="#" class=" font-weight-normal">Income by Customer Summary</a>
                                                                    <a href="#" class="pl-1 text-secondary h6 position-relative top-1"><i class="fa fa-question-circle-o "></i></a>
                                                                    <div class="dropdown pull-right d-inline-block">
                                                                        <span type="button" data-toggle="dropdown" aria-expanded="false">
                                                                            <i class="fa fa-ellipsis-v fa-lg"></i>
                                                                ...
                                                                <li class="border-bottom p-3 cursor-pointer">
                                                                    <a href="#" class=" font-weight-normal">Inventory Valuation Detail</a>
                                                                    <a href="#" class="pl-1 text-secondary h6 position-relative top-1"><i class="fa fa-question-circle-o "></i></a>
                                                                    <div class="dropdown pull-right d-inline-block">
                                                                        <span type="button" data-toggle="dropdown" aria-expanded="false">
                                                                            <i class="fa fa-ellipsis-v fa-lg"></i>
                                                                ...
                                                                <li class="border-bottom p-3 cursor-pointer">
                                                                    <a href="#" class=" font-weight-normal">Inventory Valuation Summary</a>
                                                                    <a href="#" class="pl-1 text-secondary h6 position-relative top-1"><i class="fa fa-question-circle-o "></i></a>
                                                                    <div class="dropdown pull-right d-inline-block">
                                                                        <span type="button" data-toggle="dropdown" aria-expanded="false">
                                                                            <i class="fa fa-ellipsis-v fa-lg"></i>
                                                                ...
                                                                <li class="border-bottom p-3 cursor-pointer">
                                                                    <a href="#" class=" font-weight-normal">Payment Method List</a>
                                                                    <a href="#" class="pl-1 text-secondary h6 position-relative top-1"><i class="fa fa-question-circle-o "></i></a>
                                                                    <div class="dropdown pull-right d-inline-block">
                                                                        <span type="button" data-toggle="dropdown" aria-expanded="false">
                                                                            <i class="fa fa-ellipsis-v fa-lg"></i>
                                                                ...
                                                                <li class="border-bottom p-3 cursor-pointer">
                                                                    <a href="#" class=" font-weight-normal">Physical Inventory Worksheet</a>
                                                                    <a href="#" class="pl-1 text-secondary h6 position-relative top-1"><i class="fa fa-question-circle-o "></i></a>
                                                                    <div class="dropdown pull-right d-inline-block">
                                                                        <span type="button" data-toggle="dropdown" aria-expanded="false">
                                                                            <i class="fa fa-ellipsis-v fa-lg"></i>
                                                        ...
                                                        <div class="col-md-5">
                                                            <ul>
                                                                <li class="border-bottom p-3 cursor-pointer">
                                                                    <a href="#" class=" font-weight-normal">Product/Service List</a>
                                                                    <a href="#" class="pl-1 text-secondary h6 position-relative top-1"><i class="fa fa-question-circle-o "></i></a>
                                                                    <div class="dropdown pull-right d-inline-block">
                                                                        <span type="button" data-toggle="dropdown" aria-expanded="false">
                                                                            <i class="fa fa-ellipsis-v fa-lg"></i>
                                                                ...
                                                                <li class="border-bottom p-3 cursor-pointer">
                                                                    <a href="#" class=" font-weight-normal">Sales by Customer Detail</a>
                                                                    <a href="#" class="pl-1 text-secondary h6 position-relative top-1"><i class="fa fa-question-circle-o "></i></a>
                                                                    <div class="dropdown pull-right d-inline-block">
                                                                        <span type="button" data-toggle="dropdown" aria-expanded="false">
                                                                            <i class="fa fa-ellipsis-v fa-lg"></i>
                                                                ...
                                                                <li class="border-bottom p-3 cursor-pointer">
                                                                    <a href="#" class=" font-weight-normal">Sales by Customer Summary</a>
                                                                    <a href="#" class="pl-1 text-secondary h6 position-relative top-1"><i class="fa fa-question-circle-o "></i></a>
                                                                    <div class="dropdown pull-right d-inline-block">
                                                                        <span type="button" data-toggle="dropdown" aria-expanded="false">
                                                                            <i class="fa fa-ellipsis-v fa-lg"></i>
                                                                ...
                                                                <li class="border-bottom p-3 cursor-pointer">
                                                                    <a href="#" class=" font-weight-normal">Sales by Customer Type Detail</a>
                                                                    <a href="#" class="pl-1 text-secondary h6 position-relative top-1"><i class="fa fa-question-circle-o "></i></a>
                                                                    <div class="dropdown pull-right d-inline-block">
                                                                        <span type="button" data-toggle="dropdown" aria-expanded="false">
                                                                            <i class="fa fa-ellipsis-v fa-lg"></i>
                                                                ...
                                                                <li class="border-bottom p-3 cursor-pointer">
                                                                    <a href="#" class=" font-weight-normal">Sales by Product/Service Detail</a>
                                                                    <a href="#" class="pl-1 text-secondary h6 position-relative top-1"><i class="fa fa-question-circle-o "></i></a>
                                                                    <div class="dropdown pull-right d-inline-block">
                                                                        <span type="button" data-toggle="dropdown" aria-expanded="false">
                                                                            <i class="fa fa-ellipsis-v fa-lg"></i>
                                                                ...
                                                                <li class="border-bottom p-3 cursor-pointer">
                                                                    <a href="#" class=" font-weight-normal">Sales by Product/Service Summary</a>
                                                                    <a href="#" class="pl-1 text-secondary h6 position-relative top-1"><i class="fa fa-question-circle-o "></i></a>
                                                                    <div class="dropdown pull-right d-inline-block">
                                                                        <span type="button" data-toggle="dropdown" aria-expanded="false">
                                                                            <i class="fa fa-ellipsis-v fa-lg"></i>
                                                                ...
                                                                <li class="border-bottom p-3 cursor-pointer">
                                                                    <a href="#" class=" font-weight-normal">Time Activities by Customer Detail</a>
                                                                    <a href="#" class="pl-1 text-secondary h6 position-relative top-1"><i class="fa fa-question-circle-o "></i></a>
                                                                    <div class="dropdown pull-right d-inline-block">
                                                                        <span type="button" data-toggle="dropdown" aria-expanded="false">
                                                                            <i class="fa fa-ellipsis-v fa-lg"></i>
                                                                ...
                                                                <li class="border-bottom p-3 cursor-pointer">
                                                                    <a href="#" class=" font-weight-normal">Transaction List by Customer</a>
                                                                    <a href="#" class="pl-1 text-secondary h6 position-relative top-1"><i class="fa fa-question-circle-o "></i></a>
                                                                    <div class="dropdown pull-right d-inline-block">
                                                                        <span type="button" data-toggle="dropdown" aria-expanded="false">
                                                                            <i class="fa fa-ellipsis-v fa-lg"></i>
                                                        ...
                                                        <div class="col-md-2">
                                                            <img class="growth-icon-hover" src="<?php echo $url->assets; ?>/img/reportIcons/sales_and_customers.PNG" alt="" style="position: absolute;right: 0px;bottom: 0px;">
                                                        </div>
                                                    </div>
                                                </div>
                                            </div>
                                                ...
                                                <div id="whatYouOweCollapseOne" class="collapse" data-parent="#whatYouOwe" style="">
                                                    <div class="row">
                                                        <div class="col-md-5">
                                                            <ul class="list-unstyled">
                                                                <li class="border-bottom p-3 cursor-pointer">
                                                                    <a href="#" class=" font-weight-normal">1099 Contractor Balance Detail</a>
                                                                    <a href="#" class="pl-1 text-secondary h6 position-relative top-1"><i class="fa fa-question-circle-o "></i></a>
                                                                    <div class="dropdown pull-right d-inline-block">
                                                                        <span type="button" data-toggle="dropdown" aria-expanded="false">
                                                                            <i class="fa fa-ellipsis-v fa-lg"></i>
                                                                ...
                                                                <li class="border-bottom p-3 cursor-pointer">
                                                                    <a href="#" class=" font-weight-normal">1099 Contractor Balance Summary</a>
                                                                    <a href="#" class="pl-1 text-secondary h6 position-relative top-1"><i class="fa fa-question-circle-o "></i></a>
                                                                    <div class="dropdown pull-right d-inline-block">
                                                                        <span type="button" data-toggle="dropdown" aria-expanded="false">
                                                                            <i class="fa fa-ellipsis-v fa-lg"></i>
                                                                ...
                                                                <li class="border-bottom p-3 cursor-pointer">
                                                                    <a href="#" class=" font-weight-normal">Accounts payable aging detail</a>
                                                                    <a href="#" class="pl-1 text-secondary h6 position-relative top-1"><i class="fa fa-question-circle-o "></i></a>
                                                                    <div class="dropdown pull-right d-inline-block">
                                                                        <span type="button" data-toggle="dropdown" aria-expanded="false">
                                                                            <i class="fa fa-ellipsis-v fa-lg"></i>
                                                                ...
                                                                <li class="border-bottom p-3 cursor-pointer">
                                                                    <a href="#" class=" font-weight-normal">Accounts payable aging summary</a>
                                                                    <a href="#" class="pl-1 text-secondary h6 position-relative top-1"><i class="fa fa-question-circle-o "></i></a>
                                                                    <div class="dropdown pull-right d-inline-block">
                                                                        <span type="button" data-toggle="dropdown" aria-expanded="false">
                                                                            <i class="fa fa-ellipsis-v fa-lg"></i>
                                                                ...
                                                                <li class="border-bottom p-3 cursor-pointer">
                                                                    <a href="#" class=" font-weight-normal">Bill Payment List</a>
                                                                    <a href="#" class="pl-1 text-secondary h6 position-relative top-1"><i class="fa fa-question-circle-o "></i></a>
                                                                    <div class="dropdown pull-right d-inline-block">
                                                                        <span type="button" data-toggle="dropdown" aria-expanded="false">
                                                                            <i class="fa fa-ellipsis-v fa-lg"></i>
                                                        ...
                                                        <div class="col-md-5">
                                                            <ul>
                                                                <li class="border-bottom p-3 cursor-pointer">
                                                                    <a href="#" class=" font-weight-normal">Bills and Applied Payments</a>
                                                                    <a href="#" class="pl-1 text-secondary h6 position-relative top-1"><i class="fa fa-question-circle-o "></i></a>
                                                                    <div class="dropdown pull-right d-inline-block">
                                                                        <span type="button" data-toggle="dropdown" aria-expanded="false">
                                                                            <i class="fa fa-ellipsis-v fa-lg"></i>
                                                                ...
                                                                <li class="border-bottom p-3 cursor-pointer">
                                                                    <a href="#" class=" font-weight-normal">Unpaid Bills</a>
                                                                    <a href="#" class="pl-1 text-secondary h6 position-relative top-1"><i class="fa fa-question-circle-o "></i></a>
                                                                    <div class="dropdown pull-right d-inline-block">
                                                                        <span type="button" data-toggle="dropdown" aria-expanded="false">
                                                                            <i class="fa fa-ellipsis-v fa-lg"></i>
                                                                ...
                                                                <li class="border-bottom p-3 cursor-pointer">
                                                                    <a href="#" class=" font-weight-normal">Vendor Balance Detail</a>
                                                                    <a href="#" class="pl-1 text-secondary h6 position-relative top-1"><i class="fa fa-question-circle-o "></i></a>
                                                                    <div class="dropdown pull-right d-inline-block">
                                                                        <span type="button" data-toggle="dropdown" aria-expanded="false">
                                                                            <i class="fa fa-ellipsis-v fa-lg"></i>
                                                                ...
                                                                <li class="border-bottom p-3 cursor-pointer">
                                                                    <a href="#" class=" font-weight-normal">Vendor Balance Summary</a>
                                                                    <a href="#" class="pl-1 text-secondary h6 position-relative top-1"><i class="fa fa-question-circle-o "></i></a>
                                                                    <div class="dropdown pull-right d-inline-block">
                                                                        <span type="button" data-toggle="dropdown" aria-expanded="false">
                                                                            <i class="fa fa-ellipsis-v fa-lg"></i>
                                                        ...
                                                        <div class="col-md-2">
                                                            <img class="growth-icon-hover" src="<?php echo $url->assets; ?>/img/reportIcons/what_you_owe.PNG" alt="" style="position: absolute;right: 0px;bottom: 0px;">
                                                        </div>
                                                    </div>
                                                </div>
                                            </div>
                                            ...
                                            <div class="card p-0">
                                                ...
                                                <div id="expensesAndVendorsCollapseOne" class="collapse" data-parent="#expensesAndVendors" style="">
                                                    ...
                                                    <div class="col-md-5">
                                                        <ul class="list-unstyled">
                                                            <li class="border-bottom p-3 cursor-pointer">
                                                                <a href="#" class=" font-weight-normal">1099 Transaction Detail Report
                                                                </a>
                                                                <a href="#" class="pl-1 text-secondary h6 position-relative top-1"><i class="fa fa-question-circle-o "></i></a>
                                                                <div class="dropdown pull-right d-inline-block">
                                                                    <span type="button" data-toggle="dropdown" aria-expanded="false">
                                                            ...
                                                            <li class="border-bottom p-3 cursor-pointer">
                                                                <a href="#" class=" font-weight-normal">Check Detail</a>
                                                                <a href="#" class="pl-1 text-secondary h6 position-relative top-1"><i class="fa fa-question-circle-o "></i></a>
                                                                <div class="dropdown pull-right d-inline-block">
                                                                    <span type="button" data-toggle="dropdown" aria-expanded="false">
                                                                        <i class="fa fa-ellipsis-v fa-lg"></i>
                                                            ...
                                                            <li class="border-bottom p-3 cursor-pointer">
                                                                <a href="#" class=" font-weight-normal">Expenses by Vendor Summary</a>
                                                                <a href="#" class="pl-1 text-secondary h6 position-relative top-1"><i class="fa fa-question-circle-o "></i></a>
                                                                <div class="dropdown pull-right d-inline-block">
                                                                    <span type="button" data-toggle="dropdown" aria-expanded="false">
                                                                        <i class="fa fa-ellipsis-v fa-lg"></i>
                                                            ...
                                                            <li class="border-bottom p-3 cursor-pointer">
                                                                <a href="#" class=" font-weight-normal">Transaction List by Vendor</a>
                                                                <a href="#" class="pl-1 text-secondary h6 position-relative top-1"><i class="fa fa-question-circle-o "></i></a>
                                                                <div class="dropdown pull-right d-inline-block">
                                                                    <span type="button" data-toggle="dropdown" aria-expanded="false">
                                                                        <i class="fa fa-ellipsis-v fa-lg"></i>
                                                            ...
                                                            <li class="border-bottom p-3 cursor-pointer">
                                                                <a href="#" class=" font-weight-normal">Vendor Contact List</a>
                                                                <a href="#" class="pl-1 text-secondary h6 position-relative top-1"><i class="fa fa-question-circle-o "></i></a>
                                                                <div class="dropdown pull-right d-inline-block">
                                                                    <span type="button" data-toggle="dropdown" aria-expanded="false">
                                                                        <i class="fa fa-ellipsis-v fa-lg"></i>
                                                ...
                                                <div id="salesTaxCollapseOne" class="collapse" data-parent="#salesTax" style="">
                                                    <div class="row">
                                                        <div class="col-md-5">
                                                            <ul class="list-unstyled">
                                                                <li class="border-bottom p-3 cursor-pointer">
                                                                    <a href="#" class=" font-weight-normal">Sales Tax Liability Report</a>
                                                                    <a href="#" class="pl-1 text-secondary h6 position-relative top-1"><i class="fa fa-question-circle-o "></i></a>
                                                                    <div class="dropdown pull-right d-inline-block">
                                                                        <span type="button" data-toggle="dropdown" aria-expanded="false">
                                                                            <i class="fa fa-ellipsis-v fa-lg"></i>
                                                                ...
                                                                <li class="border-bottom p-3 cursor-pointer">
                                                                    <a href="#" class=" font-weight-normal">Taxable Sales Detail</a>
                                                                    <a href="#" class="pl-1 text-secondary h6 position-relative top-1"><i class="fa fa-question-circle-o "></i></a>
                                                                    <div class="dropdown pull-right d-inline-block">
                                                                        <span type="button" data-toggle="dropdown" aria-expanded="false">
                                                                            <i class="fa fa-ellipsis-v fa-lg"></i>
                                                                ...
                                                                <li class="border-bottom p-3 cursor-pointer">
                                                                    <a href="#" class=" font-weight-normal">Taxable Sales Summary</a>
                                                                    <a href="#" class="pl-1 text-secondary h6 position-relative top-1"><i class="fa fa-question-circle-o "></i></a>
                                                                    <div class="dropdown pull-right d-inline-block">
                                                                        <span type="button" data-toggle="dropdown" aria-expanded="false">
                                                                            <i class="fa fa-ellipsis-v fa-lg"></i>
                                                        ...
                                                        <div class="col-md-2">
                                                                <img class="growth-icon-hover" src="<?php echo $url->assets; ?>/img/reportIcons/sales_tax.PNG" alt="" style="position: absolute;right: 0px;bottom: 0px;">
                                                        </div>
                                                    </div>
                                                </div>
                                            </div>
                                                ...
                                                <div id="employeesCollapseOne" class="collapse" data-parent="#employees" style="">
                                                    <div class="row">
                                                        <div class="col-md-5">
                                                            <ul class="list-unstyled">
                                                                <li class="border-bottom p-3 cursor-pointer">
                                                                    <a href="#" class=" font-weight-normal">Recent/Edited Time Activities</a>
                                                                    <a href="#" class="pl-1 text-secondary h6 position-relative top-1"><i class="fa fa-question-circle-o "></i></a>
                                                                    <div class="dropdown pull-right d-inline-block">
                                                                        <span type="button" data-toggle="dropdown" aria-expanded="false">
                                                                            <i class="fa fa-ellipsis-v fa-lg"></i>
                                                                ...
                                                                <li class="border-bottom p-3 cursor-pointer">
                                                                    <a href="#" class=" font-weight-normal">Time Activities by Employee Detail</a>
                                                                    <a href="#" class="pl-1 text-secondary h6 position-relative top-1"><i class="fa fa-question-circle-o "></i></a>
                                                                    <div class="dropdown pull-right d-inline-block">
                                                                        <span type="button" data-toggle="dropdown" aria-expanded="false">
                                                                            <i class="fa fa-ellipsis-v fa-lg"></i>
                                                        ...
                                                        <div class="col-md-2">
                                                            <img class="growth-icon-hover" src="<?php echo $url->assets; ?>/img/reportIcons/employees.PNG" alt="" style="position: absolute;right: 0px;bottom: 0px;">
                                                        </div>
                                                    </div>
                                                </div>
                                            </div>
                                                ...
                                                <div id="forMyAccountantCollapseOne" class="collapse" data-parent="#forMyAccountant" style="">
                                                    <div class="row">
                                                        <div class="col-md-5">
                                                            <ul class="list-unstyled">
                                                                <li class="border-bottom p-3 cursor-pointer">
                                                                    <a href="#" class=" font-weight-normal">Account List</a>
                                                                    <a href="#" class="pl-1 text-secondary h6 position-relative top-1"><i class="fa fa-question-circle-o "></i></a>
                                                                    <div class="dropdown pull-right d-inline-block">
                                                                        <span type="button" data-toggle="dropdown" aria-expanded="false">
                                                                            <i class="fa fa-ellipsis-v fa-lg"></i>
                                                                ...
                                                                <li class="border-bottom p-3 cursor-pointer">
                                                                    <a href="#" class=" font-weight-normal">Balance Sheet Comparison</a>
                                                                    <a href="#" class="pl-1 text-secondary h6 position-relative top-1"><i class="fa fa-question-circle-o "></i></a>
                                                                    <div class="dropdown pull-right d-inline-block">
                                                                        <span type="button" data-toggle="dropdown" aria-expanded="false">
                                                                            <i class="fa fa-ellipsis-v fa-lg"></i>
                                                                ...
                                                                <li class="border-bottom p-3 cursor-pointer">
                                                                    <a href="#" class=" font-weight-normal">General Ledger</a>
                                                                    <a href="#" class="pl-1 text-secondary h6 position-relative top-1"><i class="fa fa-question-circle-o "></i></a>
                                                                    <div class="dropdown pull-right d-inline-block">
                                                                        <span type="button" data-toggle="dropdown" aria-expanded="false">
                                                                            <i class="fa fa-ellipsis-v fa-lg"></i>
                                                                ...
                                                                <li class="border-bottom p-3 cursor-pointer">
                                                                    <a href="#" class=" font-weight-normal">Recent Transactions</a>
                                                                    <a href="#" class="pl-1 text-secondary h6 position-relative top-1"><i class="fa fa-question-circle-o "></i></a>
                                                                    <div class="dropdown pull-right d-inline-block">
                                                                        <span type="button" data-toggle="dropdown" aria-expanded="false">
                                                                            <i class="fa fa-ellipsis-v fa-lg"></i>
                                                        ...
                                                        <div class="col-md-5">
                                                            <ul>
                                                                <li class="border-bottom p-3 cursor-pointer">
                                                                    <a href="#" class=" font-weight-normal">Reconciliation Reports</a>
                                                                    <a href="#" class="pl-1 text-secondary h6 position-relative top-1"><i class="fa fa-question-circle-o "></i></a>
                                                                    <div class="dropdown pull-right d-inline-block">
                                                                        <span type="button" data-toggle="dropdown" aria-expanded="false">
                                                                            <i class="fa fa-ellipsis-v fa-lg"></i>
                                                                ...
                                                                <li class="border-bottom p-3 cursor-pointer">
                                                                    <a href="#" class=" font-weight-normal">Recurring Template List</a>
                                                                    <a href="#" class="pl-1 text-secondary h6 position-relative top-1"><i class="fa fa-question-circle-o "></i></a>
                                                                    <div class="dropdown pull-right d-inline-block">
                                                                        <span type="button" data-toggle="dropdown" aria-expanded="false">
                                                                            <i class="fa fa-ellipsis-v fa-lg"></i>
                                                                ...
                                                                <li class="border-bottom p-3 cursor-pointer">
                                                                    <a href="#" class=" font-weight-normal">Transaction Detail by Account</a>
                                                                    <a href="#" class="pl-1 text-secondary h6 position-relative top-1"><i class="fa fa-question-circle-o "></i></a>
                                                                    <div class="dropdown pull-right d-inline-block">
                                                                        <span type="button" data-toggle="dropdown" aria-expanded="false">
                                                                            <i class="fa fa-ellipsis-v fa-lg"></i>
                                                                ...
                                                                <li class="border-bottom p-3 cursor-pointer">
                                                                    <a href="#" class=" font-weight-normal">Transaction List by Date</a>
                                                                    <a href="#" class="pl-1 text-secondary h6 position-relative top-1"><i class="fa fa-question-circle-o "></i></a>
                                                                    <div class="dropdown pull-right d-inline-block">
                                                                        <span type="button" data-toggle="dropdown" aria-expanded="false">
                                                                            <i class="fa fa-ellipsis-v fa-lg"></i>
                                                                ...
                                                                <li class="border-bottom p-3 cursor-pointer">
                                                                    <a href="#" class=" font-weight-normal">Transaction List with Splits</a>
                                                                    <a href="#" class="pl-1 text-secondary h6 position-relative top-1"><i class="fa fa-question-circle-o "></i></a>
                                                                    <div class="dropdown pull-right d-inline-block">
                                                                        <span type="button" data-toggle="dropdown" aria-expanded="false">
                                                                            <i class="fa fa-ellipsis-v fa-lg"></i>
                                                                ...
                                                                <li class="border-bottom p-3 cursor-pointer">
                                                                    <a href="#" class=" font-weight-normal">Trial Balance</a>
                                                                    <a href="#" class="pl-1 text-secondary h6 position-relative top-1"><i class="fa fa-question-circle-o "></i></a>
                                                                    <div class="dropdown pull-right d-inline-block">
                                                                        <span type="button" data-toggle="dropdown" aria-expanded="false">
                                                                            <i class="fa fa-ellipsis-v fa-lg"></i>
                                                        ...
                                                        <div class="col-md-2">
                                                            <img class="growth-icon-hover" src="<?php echo $url->assets; ?>/img/reportIcons/for_my_account.PNG" alt="" style="position: absolute;right: 0px;bottom: 0px;">
                                                        </div>
                                                    </div>
                                                </div>
                                            </div>
                                                ...
                                                <div id="payrollCollapseOne" class="collapse" data-parent="#payroll" style="">
                                                    <div class="row">
                                                        <div class="col-md-5">
                                                            <ul class="list-unstyled">
                                                                <li class="border-bottom p-3 cursor-pointer">
                                                                    <a href="#" class=" font-weight-normal">Employee Details</a>
                                                                    <a href="#" class="pl-1 text-secondary h6 position-relative top-1"><i class="fa fa-question-circle-o "></i></a>
                                                                    <div class="dropdown pull-right d-inline-block">
                                                                        <span type="button" data-toggle="dropdown" aria-expanded="false">
                                                                            <i class="fa fa-ellipsis-v fa-lg"></i>
                                                                ...
                                                                <li class="border-bottom p-3 cursor-pointer">
                                                                    <a href="#" class=" font-weight-normal">Employee Directory</a>
                                                                    <a href="#" class="pl-1 text-secondary h6 position-relative top-1"><i class="fa fa-question-circle-o "></i></a>
                                                                    <div class="dropdown pull-right d-inline-block">
                                                                        <span type="button" data-toggle="dropdown" aria-expanded="false">
                                                                            <i class="fa fa-ellipsis-v fa-lg"></i>
                                                                ...
                                                                <li class="border-bottom p-3 cursor-pointer">
                                                                    <a href="#" class=" font-weight-normal">Multiple Worksites</a>
                                                                    <a href="#" class="pl-1 text-secondary h6 position-relative top-1"><i class="fa fa-question-circle-o "></i></a>
                                                                    <div class="dropdown pull-right d-inline-block">
                                                                        <span type="button" data-toggle="dropdown" aria-expanded="false">
                                                                            <i class="fa fa-ellipsis-v fa-lg"></i>
                                                                ...
                                                                <li class="border-bottom p-3 cursor-pointer">
                                                                    <a href="#" class=" font-weight-normal">Paycheck List</a>
                                                                    <a href="#" class="pl-1 text-secondary h6 position-relative top-1"><i class="fa fa-question-circle-o "></i></a>
                                                                    <div class="dropdown pull-right d-inline-block">
                                                                        <span type="button" data-toggle="dropdown" aria-expanded="false">
                                                                            <i class="fa fa-ellipsis-v fa-lg"></i>
                                                                ...
                                                                <li class="border-bottom p-3 cursor-pointer">
                                                                    <a href="#" class=" font-weight-normal">Payroll Billing Summary</a>
                                                                    <a href="#" class="pl-1 text-secondary h6 position-relative top-1"><i class="fa fa-question-circle-o "></i></a>
                                                                    <div class="dropdown pull-right d-inline-block">
                                                                        <span type="button" data-toggle="dropdown" aria-expanded="false">
                                                                            <i class="fa fa-ellipsis-v fa-lg"></i>
                                                                ...
                                                                <li class="border-bottom p-3 cursor-pointer">
                                                                    <a href="#" class=" font-weight-normal">Payroll Deductions/Contributions</a>
                                                                    <a href="#" class="pl-1 text-secondary h6 position-relative top-1"><i class="fa fa-question-circle-o "></i></a>
                                                                    <div class="dropdown pull-right d-inline-block">
                                                                        <span type="button" data-toggle="dropdown" aria-expanded="false">
                                                                            <i class="fa fa-ellipsis-v fa-lg"></i>
                                                                ...
                                                                <li class="border-bottom p-3 cursor-pointer">
                                                                    <a href="#" class=" font-weight-normal">Payroll Details</a>
                                                                    <a href="#" class="pl-1 text-secondary h6 position-relative top-1"><i class="fa fa-question-circle-o "></i></a>
                                                                    <div class="dropdown pull-right d-inline-block">
                                                                        <span type="button" data-toggle="dropdown" aria-expanded="false">
                                                                            <i class="fa fa-ellipsis-v fa-lg"></i>
                                                                ...
                                                                <li class="border-bottom p-3 cursor-pointer">
                                                                    <a href="#" class=" font-weight-normal">Payroll Summary by Employee</a>
                                                                    <a href="#" class="pl-1 text-secondary h6 position-relative top-1"><i class="fa fa-question-circle-o "></i></a>
                                                                    <div class="dropdown pull-right d-inline-block">
                                                                        <span type="button" data-toggle="dropdown" aria-expanded="false">
                                                                            <i class="fa fa-ellipsis-v fa-lg"></i>
                                                                ...
                                                                <li class="border-bottom p-3 cursor-pointer">
                                                                    <a href="#" class=" font-weight-normal">Payroll Summary</a>
                                                                    <a href="#" class="pl-1 text-secondary h6 position-relative top-1"><i class="fa fa-question-circle-o "></i></a>
                                                                    <div class="dropdown pull-right d-inline-block">
                                                                        <span type="button" data-toggle="dropdown" aria-expanded="false">
                                                                            <i class="fa fa-ellipsis-v fa-lg"></i>
                                                                ...
                                                                <li class="border-bottom p-3 cursor-pointer">
                                                                    <a href="#" class=" font-weight-normal">Payroll Tax Liability</a>
                                                                    <a href="#" class="pl-1 text-secondary h6 position-relative top-1"><i class="fa fa-question-circle-o "></i></a>
                                                                    <div class="dropdown pull-right d-inline-block">
                                                                        <span type="button" data-toggle="dropdown" aria-expanded="false">
                                                                            <i class="fa fa-ellipsis-v fa-lg"></i>
                                                    ...
                                                    <div  class="col-md-5">
                                                        <ul>
                                                            <li class="border-bottom p-3 cursor-pointer">
                                                                <a href="#" class=" font-weight-normal">Payroll Tax Payments</a>
                                                                <a href="#" class="pl-1 text-secondary h6 position-relative top-1"><i class="fa fa-question-circle-o "></i></a>
                                                                <div class="dropdown pull-right d-inline-block">
                                                                    <span type="button" data-toggle="dropdown" aria-expanded="false">
                                                                        <i class="fa fa-ellipsis-v fa-lg"></i>
                                                            ...
                                                            <li class="border-bottom p-3 cursor-pointer">
                                                                <a href="#" class=" font-weight-normal">Payroll Tax and Wage Summary</a>
                                                                <a href="#" class="pl-1 text-secondary h6 position-relative top-1"><i class="fa fa-question-circle-o "></i></a>
                                                                <div class="dropdown pull-right d-inline-block">
                                                                    <span type="button" data-toggle="dropdown" aria-expanded="false">
                                                                        <i class="fa fa-ellipsis-v fa-lg"></i>
                                                            ...
                                                            <li class="border-bottom p-3 cursor-pointer">
                                                                <a href="#" class=" font-weight-normal">Retirement Plans</a>
                                                                <a href="#" class="pl-1 text-secondary h6 position-relative top-1"><i class="fa fa-question-circle-o "></i></a>
                                                                <div class="dropdown pull-right d-inline-block">
                                                                    <span type="button" data-toggle="dropdown" aria-expanded="false">
                                                                        <i class="fa fa-ellipsis-v fa-lg"></i>
                                                            ...
                                                            <li class="border-bottom p-3 cursor-pointer">
                                                                <a href="#" class=" font-weight-normal">Total Pay</a>
                                                                <a href="#" class="pl-1 text-secondary h6 position-relative top-1"><i class="fa fa-question-circle-o "></i></a>
                                                                <div class="dropdown pull-right d-inline-block">
                                                                    <span type="button" data-toggle="dropdown" aria-expanded="false">
                                                                        <i class="fa fa-ellipsis-v fa-lg"></i>
                                                            ...
                                                            <li class="border-bottom p-3 cursor-pointer">
                                                                <a href="#" class=" font-weight-normal">Total Payroll Cost</a>
                                                                <a href="#" class="pl-1 text-secondary h6 position-relative top-1"><i class="fa fa-question-circle-o "></i></a>
                                                                <div class="dropdown pull-right d-inline-block">
                                                                    <span type="button" data-toggle="dropdown" aria-expanded="false">
                                                                        <i class="fa fa-ellipsis-v fa-lg"></i>
                                                            ...
                                                            <li class="border-bottom p-3 cursor-pointer">
                                                                <a href="#" class=" font-weight-normal">Vacation and Sick Leave</a>
                                                                <a href="#" class="pl-1 text-secondary h6 position-relative top-1"><i class="fa fa-question-circle-o "></i></a>
                                                                <div class="dropdown pull-right d-inline-block">
                                                                    <span type="button" data-toggle="dropdown" aria-expanded="false">
                                                                        <i class="fa fa-ellipsis-v fa-lg"></i>
                                                            ...
                                                            <li class="border-bottom p-3 cursor-pointer">
                                                                <a href="#" class=" font-weight-normal">Workers' Compensation</a>
                                                                <a href="#" class="pl-1 text-secondary h6 position-relative top-1"><i class="fa fa-question-circle-o "></i></a>
                                                                <div class="dropdown pull-right d-inline-block">
                                                                    <span type="button" data-toggle="dropdown" aria-expanded="false">
                                                                        <i class="fa fa-ellipsis-v fa-lg"></i>
                                                    ...
                                                    <div class="col-md-2">
                                                            <img class="growth-icon-hover" src="<?php echo $url->assets; ?>/img/reportIcons/payroll.PNG" alt="" style="position: absolute;right: 0px;bottom: 0px;">
                                                        </div>
                                                    </div>
                                                </div>
                                            </div>
