                        ...
                        <div class="col-lg-12 column" id="column">
                            <div class="row">
                                ...
                                <div class="changeCol" id="changeCol">
                                    ...
                                    <?php foreach(estimateInvoice() as $estCol) : ?>
                                    <div class="form-check">
                                        <input type="checkbox" id="sort-asc" name="<?= $estCol['name_in'] ?>" class="form-check-input <?= $estCol['name_in'] ?>" value="<?= $estCol['description'] ?>">
                                        <label for="sort-asc" class="form-check-label"><?= $estCol['name'] ?></label>
                                    </div>
                                    <?php endforeach; ?>
                                </div>
                            </div>
                    ...
                    <div class="header-footer">
                        ...
                        <div class="head_foot" id="head_foot">
                            ...
                            <div class="form-check" style="margin-top: 20px;">
                                <div class="row">
                                    <div class="col-5">
                                        <input type="checkbox" id="sort-asc" name="header[]" value="isLogo" class="form-check-input header">
                            ...
                            <div class="form-check" style="margin-top: 20px;">
                                <div class="row">
                                    <div class="col-5">
                                        <input type="checkbox" id="changeCompany1" name="header[]" value="isCompany" class="form-check-input header">
                                        <label for="sort-asc" class="form-check-label">Company Name</label>
                                    </div>
                                    <div class="col-6">
                                        <input type="text" onchange="changeCompany()" value="<?=$clients->business_name?>" name="company_name" class="form-control company_name">
                                    </div>
                                </div>
                            </div>
                            <div class="form-check" style="margin-top: 20px;">
                                <div class="row">
                                    <div class="col-5">
                                        <input type="checkbox" id="changeReport1" name="header[]" value="isReport" class="form-check-input header" >
                                        <label for="sort-asc" class="form-check-label">Report Title</label>
                                    </div>
                                    <div class="col-6">
                                        <input type="text" id="sort-asc" onchange="changeReport()" name="report_title" class="form-control report_title">
                                    </div>
                                </div>
                            </div>
                            ...
                            <div class="form-check" style="margin-top: 20px;">
                                <div class="row">
                                    <div class="col-5">
                                        <input type="checkbox" id="sort-asc" name="header[]" value="isDate" class="form-check-input header">
                            ...
                            <div class="form-check" style="margin-top: 20px;">
                                <div class="row">
                                    <div class="col-5">
                                        <input type="checkbox" id="sort-asc" name="header[]" value="isTime" class="form-check-input header">
