<script type="text/javascript">
    ...
    function generatePDF(preview = false, orientation, generate_pdf) {
        ...
        var reportTitle = "Balance Sheet Summary";
    ...
    function renderReportList() {
        theadColumnNames = $(`#balance-sheet-summary th`).map(function() {
            return $(this).text();
        }).get();
        theadTotalColumn = $("#balance-sheet-summary").find('tr:first th').length;
        ...
        $.ajax({
            ...
            success: function(data) {
                loadReportPreview();
                $("#balance-sheet-summary > tbody").html(data);
