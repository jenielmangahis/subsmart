                    ...
                    <div class="nsm-card primary">
                        ...
                        <div class="nsm-card-content">
                            ...
                            <div class="row mb-3">
                                <div class="col-lg-12">
                                    <?php
                                    $tableID = "statementofcashflows_table";
                                    $reportCategory = "statement_of_cash_flows";
                                    ?>
...
<?php include viewPath('accounting/reports/reports_assets/statement_of_cash_flows_js'); ?>
