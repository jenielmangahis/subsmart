                ...
                <div class="col-xl-12">
                    <div class="card">
                        <div class="card-body hid-desk" style="padding-bottom:0px;">
                            <div class="row">
                                <div class="col-sm-6">
                                    <h3 class="page-title" style="margin: 0 !important">Inventory Valuation Summary Report</h3>
                                </div>
                            </div>
                                                ...
                                                <div class="col-3">
                                                    ...
                                                    <div class="dropdown w-100">
                                                        <button class="dropdown-toggle btn btn-transparent hide-toggle w-100" style="text-overflow: ellipsis; overflow: hidden" id="filterDropdown" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
                                                            Active rows&nbsp;&nbsp;<i class="fa fa-caret-down"></i>
                                                        </button>
                                            ...
                                            <div class="container-fluid">
                                                ...
                                                <div class="row">
                                                    <div class="col-12 text-center">
                                                        ...
                                                        <p>Inventory Valuation Summary<br> As of <?=date("F j, Y")?></p>
                                                    </div>
                                                </div>
                                                        ...
                                                        <table class="table" style="width: 100%;" id="report-table">
                                                            <thead>
                                                                <tr>
                                                                    ...
                                                                    <th class="text-right">CALC. AVG</th>
                                                                </tr>
                                                            </thead>
                                                            <tbody>
                                                                <tr>
