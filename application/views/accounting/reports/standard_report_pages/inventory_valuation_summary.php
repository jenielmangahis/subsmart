                                    ...
                                    <div class="col-md-12">
                                        ...
                                        <div class="input-group">
                                            <select name="sort_by" id="sort-by" class="nsm-field form-select">
                                                ...
                                                <option value="product_name" <?php echo ($reportSettings->sort_by == "product_name") ? "selected" : "" ?>>Product Name</option>
                                                <option value="product_quantity" <?php echo ($reportSettings->sort_by == "product_quantity") ? "selected" : "" ?>>Product Quality</option>
                                                <option value="product_asset_value" <?php echo ($reportSettings->sort_by == "product_asset_value") ? "selected" : "" ?>>Product Asset Value</option>
                                                <option value="product_calculated_average" <?php echo ($reportSettings->sort_by == "product_calculated_average") ? "selected" : "" ?>>Product Calculated Average</option>
                                            </select>
