                ...
                <div class="col-xl-12">
                    <div class="card">
                        <div class="card-body hid-desk" style="padding-bottom:0px;">
                            <div class="row">
                                <div class="col-sm-6">
                                    <h3 class="page-title" style="margin: 0 !important">Transaction List by Tag Group Report</h3>
                                </div>
                            </div>
                                            ...
                                            <div class="container-fluid">
                                                                ...
                                                                <li>
                                                                    ...
                                                                    <div class="dropdown-menu p-3" aria-labelledby="dropdownMenuLink">
                                                                        ...
                                                                        <select name="sort_by" id="sort-by" class="form-control">
                                                                            ...
                                                                            <option value="po-number">P.O. Number</option>
                                                                            <option value="po-status">P.O. Status</option>
                                                                    ...
                                                                    <div class="dropdown-menu p-3" aria-labelledby="dropdownMenuLink">
                                                                        ...
                                                                        <div class="row hidden-cols" style="display: none">
                                                                            <div class="col-4">
                                                                                ...
                                                                                <div class="checkbox checkbox-sec d-block my-2">
                                                                                    <input type="checkbox" id="col-paid-by-mas">
                                                                                    <label for="col-paid-by-mas">Paid by MAS</label>
                                                                                </div>
                                                                                <div class="checkbox checkbox-sec d-block my-2">
                                                                                ...
                                                                                <div class="checkbox checkbox-sec d-block my-2">
                                                                                    <input type="checkbox" id="col-ungrouped-tags">
                                                                                    <label for="col-ungrouped-tags">Ungrouped tags</label>
                                                                                </div>
                                                                            </div>
                                                                            <div class="col-4">
                                                                                <div class="checkbox checkbox-sec d-block my-2">
                                                                                ...
                                                                                <div class="checkbox checkbox-sec d-block my-2">
                                                                                    <input type="checkbox" id="col-po-status">
                                                                                    <label for="col-po-status">PO Status</label>
                                                                                </div>
                                                                                <div class="checkbox checkbox-sec d-block my-2">
                                                ...
                                                <div class="row">
                                                    <div class="col-12 text-center">
                                                        ...
                                                        <p>Transaction List by Tag Group<br> <?=date("F 1-j, Y")?></p>
                                                    </div>
                                                </div>
                                                        ...
                                                        <table class="table" style="width: 100%;">
                                                            ...
                                                            <tbody>
                                                                <tr data-toggle="collapse" data-target="#accordion" class="clickable collapse-row collapsed">
                                                                    <td><i class="fa fa-caret-right"></i> Test tag</td>
                                                                    <td></td>
                                                                    <td></td>
                                                                    <td></td>
                                                                    <td></td>
