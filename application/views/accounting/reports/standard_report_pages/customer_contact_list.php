                            ...
                            <div class="row">
                                    ...
                                    <div class="col-md-12">
                                        ...
                                        <div class="input-group">
                                            <select name="sort_by" id="sort-by" class="nsm-field form-select">
                                                <option value="prof_id" <?php echo ($reportSettings->sort_by == "prof_id") ? "selected" : "" ?>>ID</option>
                                                <option value="customer" <?php echo ($reportSettings->sort_by == "customer") ? "selected" : "" ?>>Customer</option>
                                                <option value="phoneNumber" <?php echo ($reportSettings->sort_by == "phoneNumber") ? "selected" : "" ?>>Phone Numbers</option>
                                                <option value="email" <?php echo ($reportSettings->sort_by == "email") ? "selected" : "" ?>>Email</option>
                                                <option value="billingAddress" <?php echo ($reportSettings->sort_by == "billingAddress") ? "selected" : "" ?>>Billing</option>
                                                <option value="shippingAddress" <?php echo ($reportSettings->sort_by == "shippingAddress") ? "selected" : "" ?>>Shipping Address</option>
                                            </select>
                                ...
                                <div class="col-md-4 mb-3">
                                    ...
                                    <select name="date_filter" id="date-filter" class="nsm-field form-select">
                                        <option selected value="get_all" <?php echo ($reportSettings->filter_by == "get_all") ? "selected" : "" ?>>None (get all records)</option>
                                ...
                                <div class="col-md-5 mb-3 dateRangeFilterSection" style="display: none;">
                                    ...
                                    <div class="input-group">
                                        <input name="date_from" class="form-control mt-0" type="date" value="1970-01-01">
                                        <input name="date_to" class="form-control mt-0" type="date" value="9999-12-31">
                                    </div>
                                </div>
