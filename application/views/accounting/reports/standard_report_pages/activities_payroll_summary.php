                    ...
                    <div class="nsm-card primary">
                        ...
                        <div class="nsm-card-content">
                            ...
                            <div class="row mb-3">
                                <div class="col-lg-12">
                                    <?php 
                                        $tableID = "activitiespayrollsummary_table"; 
                                        $reportCategory = "activities_payroll_summary"; 
                                    ?>
                                    <table id="<?php echo $tableID; ?>" class="nsm-table w-100 border-0">
                                        <thead>
                                            <tr>                                                
                                                ...
                                                <th>NAME</th>                                       
                                                <th>HOURS</th>              
                                                <th class="PLACE_RIGHT">GROSS PAY</th>                                       
                                                <th class="PLACE_RIGHT">COMMISSION</th>
                                                <th class="PLACE_RIGHT">BONUS</th>
                                                <th class="PLACE_RIGHT">EMPLOYEE TAXES</th>                                       
                                    ...
                                    <div class="col-md-12">
                                        ...
                                        <div class="input-group">
                                            <select name="sort_by" id="sort-by" class="nsm-field form-select">
                                                <option value="pay_date" <?php echo ($reportSettings->sort_by == "pay_date") ? "selected" : "" ?>>Date</option>
                                                <option value="total_pay" <?php echo ($reportSettings->sort_by == "total_pay") ? "selected" : "" ?>>Amount</option>
                                            </select>
