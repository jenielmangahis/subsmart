                    ...
                    <div class="nsm-card primary">
                        ...
                        <div class="nsm-card-content">
                            ...
                            <div class="row mb-3">
                                <div class="col-lg-12">
                                    <?php 
                                        $tableID = "recentleads_table"; 
                                        $reportCategory = "recent_leads"; 
                                    ?>
                                    ...
                                    <div class="col-md-12">
                                        ...
                                        <div class="input-group">
                                            <select name="sort_by" id="sort-by" class="nsm-field form-select">
                                                ...
                                                <option value="lead" <?php echo ($reportSettings->sort_by == "lead") ? "selected" : "" ?>>Lead</option>
                                                <option value="lead_type" <?php echo ($reportSettings->sort_by == "lead_type") ? "selected" : "" ?>>Type</option>
