                    ...
                    <div class="nsm-card primary">
                        ...
                        <div class="nsm-card-content">
                            ...
                            <div class="row mb-3">
                                <div class="col-lg-12">
                                    <?php 
                                        $tableID = "paycheckhistory_table"; 
                                        $reportCategory = "paycheck_history"; 
                                    ?>
                                    <table id="<?php echo $tableID; ?>" class="nsm-table w-100 border-0">
                                        <thead>
                                            <tr>                                                
                                                ...
                                                <th>CHECK NUMBER</th>                                       
                                                <th>STATUS</th>                                                
                                                <th class="PLACE_RIGHT">TOTAL PAY</th>                                       
                                                <th class="PLACE_RIGHT">NET PAY</th>                                                
                                            </tr>
                                        </thead>
                                        <tbody>
                                            <tr>
                                    ...
                                    <div class="col-md-12">
                                        ...
                                        <div class="input-group">
                                            <select name="sort_by" id="sort-by" class="nsm-field form-select">
                                                ...
                                                <option value="total_pay" <?php echo ($reportSettings->sort_by == "total_pay") ? "selected" : "" ?>>Total Pay</option>
                                                <option value="pay_date" <?php echo ($reportSettings->sort_by == "pay_date") ? "selected" : "" ?>>Pay Date</option>
                                            </select>
