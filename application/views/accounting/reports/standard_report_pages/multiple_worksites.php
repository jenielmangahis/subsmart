                    ...
                    <div class="nsm-card primary">
                        ...
                        <div class="nsm-card-content">
                            ...
                            <div class="row mb-3">
                                <div class="col-lg-12">
                                    <?php 
                                        $tableID = "multipleworksites_table"; 
                                        $reportCategory = "multiple_worksites"; 
                                    ?>
                                    ...
                                    <div class="col-md-12">
                                        ...
                                        <div class="input-group">
                                            <select name="sort_by" id="sort-by" class="nsm-field form-select">
                                                <option value="worksites" <?php echo ($reportSettings->sort_by == "worksites") ? "selected" : "" ?>>Worksites</option>
                                            </select>
