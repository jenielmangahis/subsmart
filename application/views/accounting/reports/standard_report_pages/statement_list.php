                    ...
                    <div class="nsm-card primary">
                        ...
                        <div class="nsm-card-content">
                            ...
                            <div class="row mb-3">
                                <div class="col-lg-12">
                                    <?php 
                                        $tableID = "statementlist_table"; 
                                        $reportCategory = "statement_list"; 
                                    ?>
                                    ...
                                    <div class="col-md-12">
                                        ...
                                        <div class="input-group">
                                            <select name="sort_by" id="sort-by" class="nsm-field form-select">
                                                <option value="statement_id" <?php echo ($reportSettings->sort_by == "statement_id") ? "selected" : "" ?>>Num</option>
                                                <option value="customer" <?php echo ($reportSettings->sort_by == "customer") ? "selected" : "" ?>>Customer</option>
                                                <option value="statement_date" <?php echo ($reportSettings->sort_by == "statement_date") ? "selected" : "" ?>>Statement Date</option>
                                            </select>
