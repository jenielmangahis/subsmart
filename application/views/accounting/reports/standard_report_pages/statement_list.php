                ...
                <div class="col-xl-12">
                    <div class="card">
                        <div class="card-body hid-desk" style="padding-bottom:0px;">
                            <div class="row">
                                <div class="col-sm-6">
                                    <h3 class="page-title" style="margin: 0 !important">Statement List Report</h3>
                                </div>
                            </div>
                                            ...
                                            <div class="container-fluid">
                                                                    ...
                                                                    <div class="dropdown-menu p-3" aria-labelledby="dropdownMenuLink">
                                                                        ...
                                                                        <div class="row">
                                                                            <div class="col-4">
                                                                                ...
                                                                                <div class="checkbox checkbox-sec d-block my-2">
                                                                                    <input type="checkbox" checked="checked" id="col-statement-date">
                                                                                    <label for="col-statement-date">Statement Date</label>
                                                                                </div>
                                                                            </div>
                                                                            <div class="col-4">
                                                                                <div class="checkbox checkbox-sec d-block my-2">
                                                                                    <input type="checkbox" id="col-transaction-type">
                                                ...
                                                <div class="row">
                                                    <div class="col-12 text-center">
                                                        ...
                                                        <p>Statement List<br> Statement Date <?=date("F 1-j, Y")?></p>
                                                    </div>
                                                </div>
