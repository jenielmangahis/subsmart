                    ...
                    <div class="nsm-card primary">
                        ...
                        <div class="nsm-card-content">
                            ...
                            <div class="row mb-3">
                                <div class="col-lg-12">                                   
                                    <?php 
                                        $tableID = "accountlist_table"; 
                                        $reportCategory = "account_list"; 
                                    ?>
                                    ...
                                    <div class="col-md-12">
                                        ...
                                        <div class="input-group">
                                            <select name="sort_by" id="sort-by" class="nsm-field form-select" style="width:125px !important;">
                                                <option value="account" <?php echo ($reportSettings->sort_by == "account") ? "selected" : "" ?>>Account Name</option>
                                                <option value="type" <?php echo ($reportSettings->sort_by == "type") ? "selected" : "" ?>>Account Type</option>
                                            </select>
