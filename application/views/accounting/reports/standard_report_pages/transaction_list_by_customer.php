                            ...
                            <ul class="dropdown-menu dropdown-menu-end p-3" style="width: 20%">
                                <div class="row g-3">
                                    <div class="col-12">
                                        ...
                                        <input type="text" name="custom_report_name" id="custom-report-name" class="nsm-field form-control" value="Transaction List by Customer">
                                    </div>
                                    <div class="col-12">
                                        ...
                                        <div class="nsm-page-buttons page-button-container">
                                            ...
                                            <ul class="dropdown-menu p-3">
                                                ...
                                                <select name="sort_by" id="sort-by" class="nsm-field form-select">
                                                    ...
                                                    <option value="billing-address" <?=$sort_by === 'billing-address' ? 'selected' : ''?>>Billing Address</option>
                                                    ...
                                                    <option value="sales-printed" <?=$sort_by === 'sales-printed' ? 'selected' : ''?>>Sales Printed</option>
                                                    ...
                                                    <option value="shipping-address" <?=$sort_by === 'shipping-address' ? 'selected' : ''?>>Shipping Address</option>
                                        ...
                                        <div class="nsm-page-buttons page-button-container">
                                            ...
                                            <ul class="dropdown-menu dropdown-menu-end p-3 w-25">
                                                ...
                                                <div class="row">
                                                    ...
                                                    <div class="col-12 col-md-4">
                                                        <div class="form-check">
                                                            <input type="checkbox" name="col_chk" id="col-sales-printed" class="form-check-input" <?=isset($columns) && in_array('Sales Printed', $columns) || !isset($columns) ? 'checked' : ''?>>
                                                    ...
                                                    <div class="col-12 col-md-4">
                                                        <div class="form-check">
                                                            <input type="checkbox" name="col_chk" id="col-<?=$group['id']?>" class="form-check-input" <?=isset($columns) && in_array($group['name'], $columns) || !isset($columns) ? 'checked' : ''?>>
                                                            <label for="col-<?=$group['id']?>" class="form-check-label"><?=$group['name']?></label>
                                                        </div>
                                                    </div>
                                                    <?php endforeach; ?>
                                                    <div class="col-12 col-md-4">
                                                        <div class="form-check">
                                                            <input type="checkbox" name="col_chk" id="col-ungrouped-tags" class="form-check-input" <?=isset($columns) && in_array('Ungrouped Tags', $columns) || !isset($columns) ? 'checked' : ''?>>
                                                            <label for="col-ungrouped-tags" class="form-check-label">Ungrouped Tags</label>
                                                        </div>
                                                    </div>
                                                </div>
                                            </ul>
