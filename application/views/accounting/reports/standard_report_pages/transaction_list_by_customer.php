                ...
                <div class="col-xl-12">
                    <div class="card">
                        <div class="card-body hid-desk" style="padding-bottom:0px;">
                            <div class="row">
                                <div class="col-sm-6">
                                    <h3 class="page-title" style="margin: 0 !important">Transaction List by Customer Report</h3>
                                </div>
                            </div>
                                                            ...
                                                            <div class="form-row">
                                                                ...
                                                                <div class="col">
                                                                    <select id="row-columns" class="form-control">
                                                                        ...
                                                                        <option value="ungrouped-tags">Ungrouped tags</option>
                                                                    </select>
                                                                </div>
                                                            </div>
                                                        </div>
                                            ...
                                            <div class="container-fluid">
                                                                ...
                                                                <li>
                                                                    ...
                                                                    <div class="dropdown-menu p-3" aria-labelledby="dropdownMenuLink">
                                                                        ...
                                                                        <div class="row">
                                                                            ...
                                                                            <div class="col-4">
                                                                                <div class="checkbox checkbox-sec d-block my-2">
                                                                                    <input type="checkbox" checked="checked" id="col-numb">
                                                                                    <label for="col-numb">Num</label>
                                                                                </div>
                                                                                <div class="checkbox checkbox-sec d-block my-2">
                                                ...
                                                <div class="row">
                                                    <div class="col-12 text-center">
                                                        ...
                                                        <p>Transaction List by Customer<br> <?=date("F 1-j, Y")?></p>
                                                    </div>
                                                </div>
