                    ...
                    <div class="nsm-card primary">
                        ...
                        <div class="nsm-card-content">
                            ...
                            <div class="row mb-3">
                                <div class="col-lg-12">
                                    <?php 
                                        $tableID = "payrolltaxliability_table"; 
                                        $reportCategory = "payroll_tax_liability"; 
                                    ?>
                                    ...
                                    <div class="col-md-12">
                                        ...
                                        <div class="input-group">
                                            <select name="sort_by" id="sort-by" class="nsm-field form-select">
                                                <option value="tax_type" <?php echo ($reportSettings->sort_by == "tax_type") ? "selected" : "" ?>>Tax Type</option>
                                            </select>
