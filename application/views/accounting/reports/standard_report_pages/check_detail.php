                    ...
                    <div class="nsm-card primary">
                        ...
                        <div class="nsm-card-content">
                            ...
                            <div class="row mb-3">
                                <div class="col-lg-12">                                   
                                    <?php 
                                        $tableID = "checkdetail_table"; 
                                        $reportCategory = "check_detail"; 
                                    ?>
                                    ...
                                    <div class="col-md-12">
                                        ...
                                        <div class="input-group">
                                            <select name="sort_by" id="sort-by" class="nsm-field form-select">
                                                <option value="payment_date" <?php echo ($reportSettings->sort_by == "payment_date") ? "selected" : "" ?>>Date</option>
                                                <option value="check_no" <?php echo ($reportSettings->sort_by == "check_no") ? "selected" : "" ?>>Num</option>
