                            ...
                            <div class="nsm-card-header d-block">
                                            ...
                                            <ul class="dropdown-menu dropdown-menu-end p-3 w-25">
                                                ...
                                                <div class="row">
                                                    <div class="col-12 col-md-4">
                                                        <div class="form-check">
                                                            <input type="checkbox" id="col-product" class="form-check-input" checked>
                                                            <label for="col-product" class="form-check-label">Product</label>
                                                        </div>
                                                    </div>
                                                    <div class="col-12 col-md-4">
                                                        <div class="form-check">
                                                            <input type="checkbox" id="col-description" class="form-check-input" checked>
                                                            <label for="col-description" class="form-check-label">Description</label>
                                                        </div>
                                                    </div>
                                                    <div class="col-12 col-md-4">
                                                        <div class="form-check">
                                                            <input type="checkbox" id="col-qty-on-hand" class="form-check-input" checked>
                                                            <label for="col-qty-on-hand" class="form-check-label">Qty on Hand</label>
                                                        </div>
                                                    </div>

                                                    <div class="col-12 col-md-4">
                                                        <div class="form-check">
                                                            <input type="checkbox" id="col-reorder-point" class="form-check-input" checked>
                                                            <label for="col-reorder-point" class="form-check-label">Reorder Point</label>
                                                        </div>
                                                    </div>
                                                    <div class="col-12 col-md-4">
                                                        <div class="form-check">
                                                            <input type="checkbox" id="col-qty-on-po" class="form-check-input" checked>
                                                            <label for="col-qty-on-po" class="form-check-label">Qty on PO</label>
                                                        </div>
                                                    </div>
                                                    <div class="col-12 col-md-4">
                                                        <div class="form-check">
                                                            <input type="checkbox" id="col-physical-count" class="form-check-input" checked>
                                                            <label for="col-physical-count" class="form-check-label">Physical Count</label>
                                                        </div>
                                                    </div>
                                                    ...
                                                    <div class="col-12 col-md-4">
                                                        <div class="form-check">
                                                            <input type="checkbox" id="col-sku" class="form-check-input">
                                                            <label for="col-sku" class="form-check-label">SKU</label>
                                                        </div>
                                                    </div>
                                                    <div class="col-12 col-md-4">
                                                        <div class="form-check">
                                                            <input type="checkbox" id="col-price" class="form-check-input">
                                                            <label for="col-price" class="form-check-label">Price</label>
                                                        </div>
                                                    </div>
                                                    ...
                                                    <div class="col-12 col-md-4">
                                                        <div class="form-check">
                                                            <input type="checkbox" id="col-income-account" class="form-check-input">
                                                            <label for="col-income-account" class="form-check-label">Income Account</label>
                                                        </div>
                                                    </div>
                                                    <div class="col-12 col-md-4">
                                                        <div class="form-check">
                                                            <input type="checkbox" id="col-purchase-description" class="form-check-input">
                                                            <label for="col-purchase-description" class="form-check-label">Purchase Description</label>
                                                        </div>
                                                    </div>

                                                    <div class="col-12 col-md-4">
                                                        <div class="form-check">
                                                            <input type="checkbox" id="col-cost" class="form-check-input">
                                                            <label for="col-cost" class="form-check-label">Cost</label>
                                                        </div>
                                                    </div>
                                                    <div class="col-12 col-md-4">
                                                        <div class="form-check">
                                                            <input type="checkbox" id="col-expense-account" class="form-check-input">
                                                            <label for="col-expense-account" class="form-check-label">Expense Account</label>
                                                        </div>
                                                    </div>
                                                </div>
                                            </ul>
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-12 grid-mb text-center">
                                        <p class="fw-bold">Physical Inventory Worksheet</p>
                                    </div>
                                </div>
                            </div>
                                ...
                                <table class="nsm-table">
                                    <thead>
                                        <tr>
                                            ...
                                            <td data-name="Physical Count">PHYSICAL COUNT</td>
                                        </tr>
                                    </thead>
                                    <tbody>
                                        <tr>
