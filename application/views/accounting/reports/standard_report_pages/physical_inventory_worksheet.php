                    ...
                    <div class="nsm-card primary">
                        ...
                        <div class="nsm-card-content">
                            ...
                            <div class="row mb-3">
                                <div class="col-lg-12">
                                    <?php 
                                        $tableID = "physicalinventoryworksheet_table"; 
                                        $reportCategory = "physical_inventory_worksheet"; 
                                    ?>
                                    ...
                                    <div class="col-md-12">
                                        ...
                                        <div class="input-group">
                                            <select name="sort_by" id="sort-by" class="nsm-field form-select">
                                                ...
                                                <option value="reorder_points">Reorder Points</option>
                                                <option value="qty_on_po">Qty on PO</option>
