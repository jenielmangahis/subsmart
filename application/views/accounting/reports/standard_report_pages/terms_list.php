                                    ...
                                    <div class="col-md-12">
                                        ...
                                        <div class="input-group">
                                            <select name="sort_by" id="sort-by" class="nsm-field form-select">
                                                <option value="term_id" selected>Default</option>
                                                <option value="term">Term</option>
                                                <option value="type">Type</option>
                                                <option value="net_due_days">Net Due Days</option>
                                                <option value="day_of_month_due">Day of Month Due</option>
                                                <option value="discount_percentage">Discount Percentage</option>
                                                <option value="discount_days">Discount Days</option>
                                                <option value="discount_on_day_of_month">Discount on Day of Month</option>
                                                <option value="minimum_days_to_pay">Minimum Days to Pay</option>
                                            </select>
