                    ...
                    <div class="nsm-card primary">
                        ...
                        <div class="nsm-card-content">
                            ...
                            <div class="row mb-3">
                                <div class="col-lg-12">
                                    <?php 
                                        $tableID = "balancesheetcomparison_table"; 
                                        $reportCategory = "balance_sheet_comparison"; 
                                    ?>
                                    <table id="<?php echo $tableID; ?>" class="nsm-table w-100 border-0 accordion">
                                        <thead>
                                            <tr>
                                                <th style="width:60%;"></th>
                                                <th style="width:20%; text-align:right;">AS OF <?= date('F d, Y'); ?></th>
                                                <th style="width:20%;text-align:right;">AS OF <?= date('F d, Y', strtotime("-1 year")); ?></th>                                                
                                            </tr>
                                        </thead>
                                        <tbody>
                                            <tr>
                    ...
                    <div class="row">
                        <div class="col-lg-12">
                            <div class="row">
                                ...
                                <div class="col-md-12" style="display:none;"><hr class="mt-0"></div>
                                <div class="col-md-5 mb-3" style="display:none;">
