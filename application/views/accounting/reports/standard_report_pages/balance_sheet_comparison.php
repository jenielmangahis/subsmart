                                    ...
                                    <div class="col-12 col-md-6">
                                        ...
                                        <div class="dropdown">
                                            ...
                                            <ul class="dropdown-menu dropdown-menu-end p-3 w-100">
                                                ...
                                                <div class="form-check">
                                                    <input type="checkbox" id="previous-year" name="selected_period" class="form-check-input" checked>
                                                    <label for="previous-year" class="form-check-label">Previous year (PY)</label>
                                                </div>
                                                <div class="row">
                                                    <div class="col">
                                                        <div class="form-check d-inline-block">
                                                            <input type="checkbox" id="previous-year-dollar-change" class="form-check-input">
                                                            <label for="previous-year-dollar-change" class="form-check-label">$ change</label>
                                                        </div>
                                                        <div class="form-check d-inline-block">
                                                            <input type="checkbox" id="previous-year-percent-change" class="form-check-input">
                                ...
                                <table class="nsm-table">
                                    <thead>
                                        <tr>
                                            ...
                                            <td data-name="Total" colspan="2">TOTAL</td>
                                        </tr>
                                        <tr class="text-right">
                                            <td>AS OF <?=date("F d, Y")?></td>
