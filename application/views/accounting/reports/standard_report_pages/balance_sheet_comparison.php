                ...
                <div class="col-xl-12">
                    <div class="card">
                        <div class="card-body hid-desk" style="padding-bottom:0px;">
                            <div class="row">
                                <div class="col-sm-6">
                                    <h3 class="page-title" style="margin: 0 !important">Balance Sheet Comparison Report</h3>
                                </div>
                            </div>
                                            ...
                                            <div class="form-row">
                                                ...
                                                <div class="col-3">
                                                    ...
                                                    <div class="dropdown w-100">
                                                        <button class="dropdown-toggle btn btn-transparent hide-toggle w-100" style="text-overflow: ellipsis; overflow: hidden" id="filterDropdown" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
                                                ...
                                                <div class="col-3">
                                                    ...
                                                    <div class="dropdown w-100">
                                                        <button class="dropdown-toggle btn btn-transparent hide-toggle w-100" id="filterDropdown" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
                                                            Previous year&nbsp;&nbsp;<i class="fa fa-caret-down"></i>
                                                        </button>
                                                        ...
                                                        <div class="dropdown-menu p-3 w-100" aria-labelledby="filterDropdown">
                                                            ...
                                                            <div class="checkbox checkbox-sec d-block my-2">
                                                                <input type="checkbox" id="previous-year" checked>
                                                            ...
                                                            <div class="row">
                                                                <div class="col">
                                                                    <div class="checkbox checkbox-sec my-2">
                                                                        ...
                                                                        <label for="previous-year-dollar-change">$ change</label>
                                                                    </div>
                                                                    <div class="checkbox checkbox-sec my-2">
                                                                        <input type="checkbox" id="previous-year-percent-change">
                                                                        <label for="previous-year-percent-change">% change</label>
                                                                    </div>
                                                                </div>
                                                            </div>
                                                            <div class="checkbox checkbox-sec d-block my-2">
                                            ...
                                            <div class="container-fluid">
                                                ...
                                                <div class="row">
                                                    <div class="col-12 text-center">
                                                        ...
                                                        <p>Balance Sheet <br> As of <?=date("F d, Y")?></p>
                                                    </div>
                                                </div>
                                                        ...
                                                        <table class="table" style="width: 100%;" id="report-table">
                                                            <thead>
                                                                ...
                                                                <tr class="text-right">
                                                                    ...
                                                                    <th>AS OF <?=date("F d, Y", strtotime("-1 year"))?>(PY)</th>
                                                                </tr>
                                                            </thead>
                                                            <tbody>
