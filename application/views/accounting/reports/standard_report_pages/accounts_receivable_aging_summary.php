                            ...
                            <div class="row mb-4">
                                <div class="col-lg-12 headerInfo">
                                    ...
                                    <div class="reportTitleInfo">
                                        ...
                                        <h5><small id="reportDate">As of <?= $reportSettings && strtotime($reportSettings->report_date_from_text) > 0 ? date('F d, Y', strtotime($reportSettings->report_date_from_text)) : date('F d, Y'); ?></small></h5>
                                    </div>
                                </div>
                            </div>
                            <div class="row mb-3">
                                    ...
                                    <table id="<?php echo $tableID; ?>" class="nsm-table w-100 border-0">
                                        <thead>
                                            <tr>
                                                ...
                                                <th data-name="91 and Over">91 AND OVER</th>
                        ...
                        <div class="col-lg-12">
                            <div class="row">
                                ...
                                <div class="col-md-4 mb-3">
                                    ...
                                    <div class="">
                                        <input type="date" id="filter-date" name="date_from" class="form-control nsm-field date" value="<?= $reportSettings && $reportSettings->report_date_from_text != '' ? date("Y-m-d",strtotime($reportSettings->report_date_from_text)) : date("Y-m-d"); ?>" data-type="filter-date">
                                    </div>
                                </div>
                            </div>
                        </div>
