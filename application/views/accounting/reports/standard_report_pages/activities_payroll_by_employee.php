                    ...
                    <div class="nsm-card primary">
                        ...
                        <div class="nsm-card-content">
                            <div class="row mb-4">
                                <div class="col-lg-12 headerInfo">
                                    ...
                                    <div class="reportTitleInfo">
                                        ...
                                        <h5>
                                            <small id="reportDate">
                                                <span id="date_from_text"><?= date("F d, Y", strtotime($reportSettings->report_date_from_text)); ?></span> &mdash; <span id="date_to_text"><?= date("F d, Y", strtotime($reportSettings->report_date_to_text)); ?></span>
                                            </small>
                                        </h5>
                                    </div>
                                </div>
                            ...
                            <div class="row mb-3">
                                <div class="col-lg-12">
                                    <?php 
                                        $tableID = "activitiespayrollbyemployee_table"; 
                                        $reportCategory = "activities_payroll_by_employee"; 
                                    ?>
                                    ...
                                    <div class="col-md-12">
                                        ...
                                        <div class="input-group">
                                            <select name="sort_by" id="sort-by" class="nsm-field form-select">
                                                <option value="net_pay" <?php echo ($reportSettings->sort_by == "net_pay") ? "selected" : "" ?>>Net Pay</option>
                                                <option value="gross_pay" <?php echo ($reportSettings->sort_by == "gross_pay") ? "selected" : "" ?>>Gross Pay</option>
                                                <option value="commission" <?php echo ($reportSettings->sort_by == "commission") ? "selected" : "" ?>>Commission</option>
                                                <option value="bonus" <?php echo ($reportSettings->sort_by == "bonus") ? "selected" : "" ?>>Bonus</option>
                                                <option value="taxes" <?php echo ($reportSettings->sort_by == "taxes") ? "selected" : "" ?>>Taxes</option>
                                            </select>
