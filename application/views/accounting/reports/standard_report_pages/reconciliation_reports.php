                    ...
                    <div class="nsm-card primary">
                        ...
                        <div class="nsm-card-content">
                            ...
                            <div class="row mb-3">
                                <div class="col-lg-12">
                                    <?php 
                                        $tableID = "reconciliationreports_table"; 
                                        $reportCategory = "reconciliation_reports"; 
                                    ?>
                                    ...
                                    <div class="col-md-12">
                                        ...
                                        <div class="input-group">
                                            <select name="sort_by" id="sort-by" class="nsm-field form-select">
                                                <option value="id" <?php echo ($reportSettings->sort_by == "id") ? "selected" : "" ?>>Statement Ending Date</option>
                                                <option value="vendor" <?php echo ($reportSettings->sort_by == "vendor") ? "selected" : "" ?>>Reconciled On</option>
                                                <option value="phone_numbers" <?php echo ($reportSettings->sort_by == "phone_numbers") ? "selected" : "" ?>>Ending Balance</option>
                                                <option value="email" <?php echo ($reportSettings->sort_by == "email") ? "selected" : "" ?>>Changes</option>
                                                <option value="fullname" <?php echo ($reportSettings->sort_by == "fullname") ? "selected" : "" ?>>Auto Adjustment</option>
                                                <option value="address" <?php echo ($reportSettings->sort_by == "address") ? "selected" : "" ?>>Statements</option>
                                                <option value="account_number" <?php echo ($reportSettings->sort_by == "account_number") ? "selected" : "" ?>>Action</option>
                                            </select>
