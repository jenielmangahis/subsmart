                            ...
                            <div class="nsm-card-header d-block">
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-12 grid-mb text-center">
                                        <p class="m-0 fw-bold">Unpaid Bills</p>
                                        <p><?=date("F 1-j, Y")?></p>
                                    </div>
                                </div>
                            </div>
                                    ...
                                    <tbody>
                                        ...
                                        foreach($billsNi as $billn): ?>
                                            <tr>
                                                ...
                                                <td><?= number_format($billn->remaining_balance,2); ?></td>
                                                <td>$<?= number_format($billn->total_amount,2); ?></td>
                                            </tr>
                                        <?php endforeach; ?>
                                    </tbody>
                                </table>
...
<?php include viewPath('accounting/reports/reports_modals/deposit_detail_modal'); ?>
