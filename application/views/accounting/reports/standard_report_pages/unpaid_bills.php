                    ...
                    <div class="nsm-card primary">
                        ...
                        <div class="nsm-card-content">
                            ...
                            <div class="row mb-3">
                                <div class="col-lg-12">
                                    <?php 
                                        $tableID = "unpaidbills_table"; 
                                        $reportCategory = "unpaid_bills_summary"; 
                                    ?>
                                    <table id="<?php echo $tableID; ?>" class="nsm-table w-100 border-0 accordion">
                                        <thead>
                                            <tr>
                                                <th class="PLACE_LEFT" style="width:50%;">VENDOR</th>
                                                <th class="PLACE_LEFT" style="width:10%;">BILL DATE</th>
                                                <th class="PLACE_LEFT" style="width:10%;">DUE DATE</th>                                                
                                                <th class="PLACE_RIGHT">REMAINING BALANCE</th>
                                                <th class="PLACE_RIGHT">TOTAL AMOUNT</th>
                                            </tr>
                                        </thead>
                                        <tbody>
                                            <tr>
                                    ...
                                    <div class="col-md-12">
                                        ...
                                        <div class="input-group">
                                            <select name="sort_by" id="sort-by" class="nsm-field form-select">
                                                <option value="vendor" <?php echo ($reportSettings->sort_by == "vendor") ? "selected" : "" ?>>Vendor Name</option>
                                                <option value="bill_date" <?php echo ($reportSettings->sort_by == "bill_date") ? "selected" : "" ?>>Bill Date</option>
                                                <option value="due_date" <?php echo ($reportSettings->sort_by == "due_date") ? "selected" : "" ?>>Due Date</option>
                                                <option value="remaining_balance" <?php echo ($reportSettings->sort_by == "remaining_balance") ? "selected" : "" ?>>Remaining Balance</option>
