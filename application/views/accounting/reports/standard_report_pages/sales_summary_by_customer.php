                    ...
                    <div class="nsm-card primary">
                        ...
                        <div class="nsm-card-content">
                            ...
                            <div class="row mb-3">
                                <div class="col-lg-12">
                                    <?php 
                                        $tableID = "salessummarybycustomer_table"; 
                                        $reportCategory = "sales_summary_by_customer"; 
                                    ?>
                                    <table id="<?php echo $tableID; ?>" class="nsm-table w-100 border-0 accordion">
                                        <thead>
                                            <tr>
                                                <th class="PLACE_LEFT" style="width:70%;">CUSTOMER</th>
                                                <th class="PLACE_LEFT">TOTAL INVOICES PAID</th>                                       
                                                <th class="PLACE_RIGHT">TOTAL SALES</th>
                                            </tr>
                                        </thead>
                                        <tbody>
                                            <tr>
