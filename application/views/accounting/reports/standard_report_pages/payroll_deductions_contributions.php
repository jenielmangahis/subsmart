                    ...
                    <div class="nsm-card primary">
                        ...
                        <div class="nsm-card-content">
                            ...
                            <div class="row mb-3">
                                <div class="col-lg-12">
                                    <?php
                                        $tableID = 'payroll_deductions_contributions_table';
$reportCategory = 'payroll_deductions_contributions_details';
?>
                                    <table id="<?php echo $tableID; ?>" class="nsm-table w-100 border-0 accordion">
                                        <thead>
                                            <tr>
                                                ...
                                                <th>TYPE</th>
                                                <th>DESCRIPTION</th>
                                                <th style="text-align:right">EMPLOYEE DEDUCTIONS</th>
                                                <th style="text-align:right">COMPANY CONTRIBUTIONS</th>
                                                <th style="text-align:right">PLAN TOTAL</th>
                                            </tr>
                                        </thead>
                                        <tbody>
                                            <tr>
                                    ...
                                    <div class="col-md-12">
                                        ...
                                        <div class="input-group">
                                            <select name="sort_by" id="sort-by" class="nsm-field form-select">
                                                <option value="FName"
                                                    <?php echo ($reportSettings->sort_by == 'FName') ? 'selected' : ''; ?>>
                                                    Employee</option>
