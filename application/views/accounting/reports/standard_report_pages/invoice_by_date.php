                    ...
                    <div class="nsm-card primary">
                        ...
                        <div class="nsm-card-content">
                            ...
                            <div class="row mb-3">
                                <div class="col-lg-12">
                                    <?php 
                                        $tableID = "invoicebydate_table"; 
                                        $reportCategory = "invoice_by_date"; 
                                    ?>
                                    ...
                                    <div class="col-md-12">
                                        ...
                                        <div class="input-group">
                                            <select name="sort_by" id="sort-by" class="nsm-field form-select">
                                                ...
                                                <option value="invoice_balance" <?php echo ($reportSettings->sort_by == "invoice_balance") ? "selected" : "" ?>>Balance Amount</option>
                                                <option value="invoice_total" <?php echo ($reportSettings->sort_by == "invoice_total") ? "selected" : "" ?>>Total Amount</option>
                                            </select>
