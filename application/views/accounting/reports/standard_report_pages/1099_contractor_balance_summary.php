                    ...
                    <div class="nsm-card primary">
                        ...
                        <div class="nsm-card-content">
                            ...
                            <div class="row mb-3">
                                <div class="col-lg-12">
                                    <?php 
                                        $tableID = "contractorbalancesummary_table"; 
                                        $reportCategory = "contractor_balance_summary"; 
                                    ?>
                                    ...
                                    <div class="col-md-12">
                                        ...
                                        <div class="input-group">
                                            <select name="sort_by" id="sort-by" class="nsm-field form-select">
                                                <option value="vendor_id" <?php echo ($reportSettings->sort_by == "vendor_id") ? "selected" : "" ?>>ID</option>
