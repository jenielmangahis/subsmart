                    ...
                    <div class="nsm-card primary">
                        ...
                        <div class="nsm-card-content">
                            ...
                            <div class="row mb-3">
                                <div class="col-lg-12">                                   
                                    <?php 
                                        $tableID = "incomebycustomerysummary_table"; 
                                        $reportCategory = "income_by_customer_summary"; 
                                    ?>
                                    ...
                                    <div class="col-md-12">
                                        ...
                                        <div class="input-group">
                                            <select name="sort_by" id="sort-by" class="nsm-field form-select">
                                                ...
                                                <option value="income" <?php echo ($reportSettings->sort_by == "income") ? "selected" : "" ?>>Income</option>
                                                <option value="expense" <?php echo ($reportSettings->sort_by == "expense") ? "selected" : "" ?>>Expense</option>
                                                <option value="net_income" <?php echo ($reportSettings->sort_by == "net_income") ? "selected" : "" ?>>Net Income</option>
                                            </select>
