                                    ...
                                    <table id="<?php echo $tableID; ?>" class="nsm-table w-100 border-0">
                                        <thead>
                                            <tr>
                                                ...
                                                <th style="text-align: right;">EXCESS WAGES</th>
                                                <th style="text-align: right;">TAXABLE WAGES</th>
                                                <th style="text-align: right;">TAX AMOUNT</th>
                                                <th style="text-align: right;" <?=isset($columns) && !in_array('Tax Percentage', $columns) ? 'style="display: none"' : ''?>>TAX PERCENTAGE</th>
                                            </tr>
                                        </thead>
                                        <tbody>
                                            <tr>
