                ...
                <div class="col-xl-12">
                    <div class="card">
                        <div class="card-body hid-desk" style="padding-bottom:0px;">
                            <div class="row">
                                <div class="col-sm-6">
                                    <h3 class="page-title" style="margin: 0 !important">Payroll details</h3>
                                </div>
                            </div>
                                        ...
                                        <table class="table" style="width: 100%;">
                                            <thead>
                                                <tr>
                                                    ...
                                                    <th class="text-right">Employee taxes & deductions</th>
                                                    <th class="text-right">Net pay</th>
                                                    <th class="text-right">Employer taxes & deductions</th>
                                                    ...
                                                    <td class="text-right">
                                                        <table class="w-100">
                                                            <tbody>
                                                                ...
                                                                <tr>
                                                                    <td class="text-right border-0">Employee taxes</td>
                                                                    <td class="text-right border-0">$0.00</td>
                                                                </tr>
                                                            </tbody>
                                                        </table>
                                                    ...
                                                    <td class="text-right">
                                                        <table class="w-100">
                                                            <tbody>
                                                                ...
                                                                <tr>
                                                                    <td class="text-right border-0">Employer taxes</td>
                                                                    <td class="text-right border-0">$0.00</td>
                                                                </tr>
                                                                <tr>
                                                                    <td class="text-right border-0">FL SUI</td>
                                                                    <td class="text-right border-0">$0.00</td>
                                                                </tr>
                                                            </tbody>
                                                        </table>
