                    ...
                    <div class="nsm-card primary">
                        ...
                        <div class="nsm-card-content">
                            ...
                            <div class="row mb-3">
                                <div class="col-lg-12">
                                    <?php 
                                        $tableID = "payrolldetails_table"; 
                                        $reportCategory = "payroll_details"; 
                                    ?>
                                    <table id="<?php echo $tableID; ?>" class="nsm-table w-100 border-0 accordion">
                                        <thead>
                                            <tr>
                                                ...
                                                <th class="text-end">EMPLOYEE TAXES & DEDUCTIONS</th>
                                                <th class="text-end">&nbsp;</th>
                                                <th class="text-end">NET PAY</th>
                                                <th class="text-end">EMPLOYER TAXES & CONTRIBUTIONS</th>
                                                <th class="text-end">&nbsp;</th>
                                                <th class="text-end">TOTAL PAYROLL COST</th>
                                            </tr>
                                        </thead>
                                        <tbody>
                                            <tr>
