                            ...
                            <ul class="dropdown-menu dropdown-menu-end p-3" style="width: 20%">
                                <div class="row g-3">
                                    <div class="col-12">
                                        ...
                                        <input type="text" name="custom_report_name" id="custom-report-name" class="nsm-field form-control" value="Transaction List by Vendor">
                                    </div>
                                    <div class="col-12">
                                        ...
                                        <div class="nsm-page-buttons page-button-container">
                                            ...
                                            <ul class="dropdown-menu p-3">
                                                ...
                                                <select name="sort_by" id="sort-by" class="nsm-field form-select">
                                                    ...
                                                    <option value="delivery-date" <?=$sort_by === 'delivery-date' ? 'selected' : ''?>>Delivery Date</option>
                                ...
                                <table class="nsm-table grid-mb" id="reports-table">
                                    ...
                                    <tbody>
                                        ...
                                        <tr>
                                            ...
                                            <td data-name="PO Status" <?=isset($columns) && !in_array('PO Status', $columns) ? 'style="display: none"' : ''?>><?=$transaction['po_status']?></td>
                                            ...
                                            <td data-name="A/P Paid" <?=isset($columns) && !in_array('A/P Paid', $columns) ? 'style="display: none"' : ''?>><?=$transaction['ap_paid']?></td>
                                        ...
                                        <tr class="clickable collapse-row collapse" id="accordion-<?=$index?>">
                                            ...
                                            <td data-name="PO Status" <?=isset($columns) && !in_array('PO Status', $columns) ? 'style="display: none"' : ''?>><?=$tran['po_status']?></td>
                                            ...
                                            <td data-name="A/P Paid" <?=isset($columns) && !in_array('A/P Paid', $columns) ? 'style="display: none"' : ''?>><?=$tran['ap_paid']?></td>
