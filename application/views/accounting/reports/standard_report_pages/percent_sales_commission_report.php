                    ...
                    <div class="nsm-card primary">
                        ...
                        <div class="nsm-card-content">
                            <div class="row mb-4">
                                <div class="col-lg-12 headerInfo">
                                    ...
                                    <div class="reportTitleInfo">
                                        ...
                                        <h5>
                                            <small id="reportDate">
                                                <span id="date_from_text"><?php echo date('F d, Y', strtotime($reportSettings->report_date_from_text)); ?></span> &mdash; 
                                                <span id="date_to_text"><?php echo date('F d, Y', strtotime($reportSettings->report_date_to_text)); ?></span>
                                            </small>
                                        </h5>
                                    </div>
                                </div>
                            ...
                            <div class="row mb-3">
                                <div class="col-lg-12">
                                    <?php
                                        $tableID = 'percent_sales_commission_table';
$reportCategory = 'percent_sales_commission_list';
?>
                        ...
                        <div class="col-lg-12">
                            <div class="row">
                                    ...
                                    <div class="col-md-12">
                                        ...
                                        <div class="input-group">
                                            <select name="sort_by" id="sort-by" class="nsm-field form-select">
                                                <option value="FName" <?php echo ($reportSettings->sort_by == 'FName') ? 'selected' : ''; ?>>Employee Name</option>
                                                <option value="pay_period_start" <?php echo ($reportSettings->sort_by == 'pay_period_start') ? 'selected' : ''; ?>>Date</option>
                                            </select>
                                ...
                                <div class="col-md-5 mb-3">
                                    ...
                                    <div class="input-group">
                                        <input name="date_from" class="form-control mt-0" type="date" value="<?php echo $reportSettings && strtotime($reportSettings->report_date_from_text) > 0 ? date('Y-m-d', strtotime($reportSettings->report_date_from_text)) : date('Y-m-01'); ?>">
                                        <input name="date_to" class="form-control mt-0" type="date" value="<?php echo $reportSettings && strtotime($reportSettings->report_date_to_text) > 0 ? date('Y-m-d', strtotime($reportSettings->report_date_to_text)) : date('Y-m-t'); ?>">
                                    </div>  
                                </div>
                            </div>
                        </div>
