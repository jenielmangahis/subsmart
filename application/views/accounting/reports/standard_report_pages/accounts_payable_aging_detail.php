                            ...
                            <ul class="dropdown-menu dropdown-menu-end p-3" style="width: 20%">
                                <div class="row g-3">
                                    <div class="col-12">
                                        ...
                                        <input type="text" name="custom_report_name" id="custom-report-name" class="nsm-field form-control" value="A/P Aging Detail">
                                    </div>
                                    <div class="col-12">
                                        ...
                                        <div class="nsm-page-buttons page-button-container">
                                            ...
                                            <ul class="dropdown-menu dropdown-menu-end p-3 w-25">
                                                ...
                                                <div class="row">
                                                    ...
                                                    <div class="col-12 col-md-4">
                                                        <div class="form-check">
                                                            <input type="checkbox" name="col_chk" id="col-address" class="form-check-input" <?=isset($columns) && in_array('Address', $columns) || !isset($columns) ? 'checked' : ''?>>
                                                            <label for="col-address" class="form-check-label">Address</label>
                                                        </div>
                                                    </div>
                                                    <div class="col-12 col-md-4">
                                                        <div class="form-check">
