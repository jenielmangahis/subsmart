                ...
                <div class="col-xl-12">
                    <div class="card">
                        <div class="card-body hid-desk" style="padding-bottom:0px;">
                            <div class="row">
                                <div class="col-sm-6">
                                    <h3 class="page-title" style="margin: 0 !important">Profit and Loss by Month Report</h3>
                                </div>
                            </div>
                                            ...
                                            <div class="container-fluid">
                                                ...
                                                <div class="row">
                                                    <div class="col-12 text-center">
                                                        ...
                                                        <p>Profit and Loss by Month<br> January 1-<?=date("F d, Y")?></p>
                                                    </div>
                                                </div>
                                                    ...
                                                    <div class="col-12">
                                                        <table class="table" style="width: 100%;" id="report-table">
                                                            <thead>
                                                                <tr>
                                                                    <th></th>
                                                                    <th class="text-right">JAN 2022</th>
                                                                    <th class="text-right">FEB 2022</th>
                                                                    <th class="text-right">MAR 2022</th>
                                                                    <th class="text-right">APR 2022</th>
                                                                    <th class="text-right">MAY 2022</th>
                                                                    <th class="text-right">JUN 1-<?=date("j")?>, 2022</th>
