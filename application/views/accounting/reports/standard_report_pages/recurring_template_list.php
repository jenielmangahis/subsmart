                    ...
                    <div class="nsm-card primary">
                        ...
                        <div class="nsm-card-content">
                            ...
                            <div class="row mb-3">
                                <div class="col-lg-12">
                                    <?php
                                        $tableID = 'recurring_template_list_table';
$reportCategory = 'recurring_template_list_details';
?>
                                    ...
                                    <div class="col-md-12">
                                        ...
                                        <div class="input-group">
                                            <select name="sort_by" id="sort-by" class="nsm-field form-select">
                                                <option value="recurring_type" <?php echo ($reportSettings->sort_by == 'recurring_type') ? 'selected' : ''; ?>>Recurring type</option>
                                                <option value="txn_type" <?php echo ($reportSettings->sort_by == 'txn_type') ? 'selected' : ''; ?>>Transaction Type</option>
                                            </select>
