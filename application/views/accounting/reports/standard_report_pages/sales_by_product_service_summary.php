                    ...
                    <div class="nsm-card primary">
                        ...
                        <div class="nsm-card-content">
                            ...
                            <div class="row mb-3">
                                <div class="col-lg-12">                                   
                                    <?php 
                                        $tableID = "salesbyproductservicesummary_table"; 
                                        $reportCategory = "sales_by_product_service_summary"; 
                                    ?>
                                    ...
                                    <div class="col-md-12">
                                        ...
                                        <div class="input-group">
                                            <select name="sort_by" id="sort-by" class="nsm-field form-select" style="width:125px !important;">
                                                ...
                                                <option value="quantity" <?php echo ($reportSettings->sort_by == "quantity") ? "selected" : "" ?>>Quantity</option>
                                                <option value="amount" <?php echo ($reportSettings->sort_by == "amount") ? "selected" : "" ?>>Amount</option>
                                                <option value="sales_percentage" <?php echo ($reportSettings->sort_by == "sales_percentage") ? "selected" : "" ?>>Sales by (%)</option>
                                                <option value="average_price" <?php echo ($reportSettings->sort_by == "average_price") ? "selected" : "" ?>>Average Price</option>
                                                <option value="COGS" <?php echo ($reportSettings->sort_by == "COGS") ? "selected" : "" ?>>COGS</option>
                                                <option value="gross_margin" <?php echo ($reportSettings->sort_by == "gross_margin") ? "selected" : "" ?>>Gross Margin</option>
                                                <option value="gross_margin_percentage" <?php echo ($reportSettings->sort_by == "gross_margin_percentage") ? "selected" : "" ?>>Gross Margin by (%)</option>
                                            </select>
