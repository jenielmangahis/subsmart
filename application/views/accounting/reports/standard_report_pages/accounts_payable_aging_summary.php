                            ...
                            <ul class="dropdown-menu dropdown-menu-end p-3" style="width: 20%">
                                <div class="row g-3">
                                    <div class="col-12">
                                        ...
                                        <input type="text" name="custom_report_name" id="custom-report-name" class="nsm-field form-control" value="A/P Aging Summary">
                                    </div>
                                    <div class="col-12">
                                    ...
                                    <div class="col-12 col-md-6 grid-mb">
                                        <div class="nsm-page-buttons page-button-container">
                                            ...
                                            <ul class="dropdown-menu p-3">
                                                <div class="form-check">
                                                    <input type="radio" id="sort-default" name="sort_order" class="form-check-input" value="default" <?=!isset($sort_in) ? 'checked' : ''?>>
                                                    <label for="sort-default" class="form-check-label">Default</label>
                                                </div>
                                                <div class="form-check">
                                                    <input type="radio" id="sort-total-asc" name="sort_order" class="form-check-input" value="asc" <?=isset($sort_in) && $sort_in === 'asc' ? 'checked' : ''?>>
                                                    <label for="sort-total-asc" class="form-check-label">Total in ascending order</label>
                                                </div>
                                                <div class="form-check">
                                                    <input type="radio" id="sort-total-desc" name="sort_order" class="form-check-input" value="desc" <?=isset($sort_in) && $sort_in === 'desc' ? 'checked' : ''?>>
                                                    <label for="sort-total-desc" class="form-check-label">Total in descending order</label>
                                                </div>
                                            </ul>
                                ...
                                <table class="nsm-table grid-mb" id="reports-table">
                                    <thead>
                                        <tr>
                                            ...
                                            <td data-name="<?=$column['name']?>"><?=strtoupper($column['name'])?></td>
                                            <?php endforeach; ?>
