                    ...
                    <div class="nsm-card primary">
                        ...
                        <div class="nsm-card-content">
                            ...
                            <div class="row mb-3">
                                <div class="col-lg-12">
                                    <?php 
                                        $tableID = "profitandlosssdetail_table"; 
                                        $reportCategory = "profit_and_loss_detail"; 
                                    ?>
                                    <table id="<?php echo $tableID; ?>" class="nsm-table w-100 border-0 accordion">
                                        <thead>
                                            <tr>
                                                ...
                                                <th class="PLACE_LEFT">POSTING</th>                                                
                                    ...
                                    <div class="col-md-12">
                                        ...
                                        <div class="input-group">
                                            <select name="sort_by" id="sort-by" class="nsm-field form-select">
                                                ...
                                                <option value="transaction_date" <?php echo ($reportSettings->sort_by == "transaction_date") ? "selected" : "" ?>>Transaction Date</option>
                                                <option value="transaction_amount" <?php echo ($reportSettings->sort_by == "transaction_amount") ? "selected" : "" ?>>Total Amount</option>
                                            </select>
