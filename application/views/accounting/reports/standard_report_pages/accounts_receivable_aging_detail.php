                            ...
                            <ul class="dropdown-menu dropdown-menu-end p-3" style="width: max-content">
                                ...
                                <div class="row grid-mb">
                                    <div class="col-12">
                                        ...
                                        <input type="text" class="nsm-field form-control datepicker" name="filter_min_days_past_due" id="filter-min-days-past-due">
                                    </div>
                                </div>
                                <div class="row">
                            ...
                            <div class="nsm-card-header d-block">
                                        ...
                                        <div class="nsm-page-buttons page-button-container">
                                            ...
                                            <ul class="dropdown-menu dropdown-menu-end p-3 w-25">
                                                ...
                                                <div class="row">
                                                    ...
                                                    <div class="col-12 col-md-4">
                                                        <div class="form-check">
                                                            <input type="checkbox" id="col-past-due" class="form-check-input">
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-12 grid-mb text-center">
                                        <p class="m-0 fw-bold">A/R Aging Detail</p>
                                ...
                                <table class="nsm-table">
                                    ...
                                    <tbody>
                                        <tr data-toggle="collapse" data-target="#accordion" class="clickable collapse-row collapsed">
                                            <td><i class="bx bx-fw bx-caret-right"></i> Current</td>
                                            <td></td>
                                            <td></td>
                                            <td></td>
                                            <td></td>
                                        ...
                                        <tr  class="clickable collapse-row collapse"  id="accordion">
                                            <td>&emsp;<b>Total for Current</b></td>
                                            <td></td>
                                            <td></td>
                                            <td></td>
                                            <td></td>
