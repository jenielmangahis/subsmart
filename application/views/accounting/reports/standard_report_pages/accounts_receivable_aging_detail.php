                                    ...
                                    <div class="col-12 col-md-6">
                                        ...
                                        <select class="nsm-field form-select" name="filter_report_period"
                                            ...
                                            <option value="all-dates"
                                                <?php echo $filter_date === 'all-dates' ? 'selected' : ''; ?>>All Dates</option>
                                            <option value="custom" <?php echo $filter_date === 'custom' ? 'selected' : ''; ?>>
                                                Custom</option>
                                            <option value="today"
                                                <?php echo empty($filter_date) || $filter_date === 'today' ? 'selected' : ''; ?>>
                                                Today</option>
                                            <option value="this-week"
                                                <?php echo $filter_date === 'this-week' ? 'selected' : ''; ?>>This Week</option>
                                            <option value="this-week-to-date"
                                                <?php echo $filter_date === 'this-week-to-date' ? 'selected' : ''; ?>>This
                                                Week-to-date</option>
                                            <option value="this-month"
                                                <?php echo $filter_date === 'this-month' ? 'selected' : ''; ?>>This Month</option>
                                            <option value="this-month-to-date"
                                                <?php echo $filter_date === 'this-month-to-date' ? 'selected' : ''; ?>>This
                                                Month-to-date</option>
                                            <option value="this-quarter"
                                                <?php echo $filter_date === 'this-quarter' ? 'selected' : ''; ?>>This Quarter
                                            </option>
                                            <option value="this-quarter-to-date"
                                                <?php echo $filter_date === 'this-quarter-to-date' ? 'selected' : ''; ?>>This
                                                Quarter-to-date</option>
                                            <option value="this-year"
                                                <?php echo $filter_date === 'this-year' ? 'selected' : ''; ?>>This Year</option>
                                            <option value="this-year-to-date"
                                                <?php echo $filter_date === 'this-year-to-date' ? 'selected' : ''; ?>>This
                                                Year-to-date</option>
                                            <option value="this-year-to-last-month"
                                                <?php echo $filter_date === 'this-year-to-last-month' ? 'selected' : ''; ?>>This
                                                Year-to-last-month</option>
                                            <option value="yesterday"
                                                <?php echo $filter_date === 'yesterday' ? 'selected' : ''; ?>>Yesterday</option>
                                            <option value="recent" <?php echo $filter_date === 'recent' ? 'selected' : ''; ?>>
                                                Recent</option>
                                            <option value="last-week"
                                                <?php echo $filter_date === 'last-week' ? 'selected' : ''; ?>>Last Week</option>
                                            <option value="last-week-to-date"
                                                <?php echo $filter_date === 'last-week-to-date' ? 'selected' : ''; ?>>Last
                                                Week-to-date</option>
                                            <option value="last-month"
                                                <?php echo $filter_date === 'last-month' ? 'selected' : ''; ?>>Last Month</option>
                                            <option value="last-month-to-date"
                                                <?php echo $filter_date === 'last-month-to-date' ? 'selected' : ''; ?>>Last
                                                Month-to-date</option>
                                            <option value="last-quarter"
                                                <?php echo $filter_date === 'last-quarter' ? 'selected' : ''; ?>>Last Quarter
                                            </option>
                                            <option value="last-quarter-to-date"
                                                <?php echo $filter_date === 'last-quarter-to-date' ? 'selected' : ''; ?>>Last
                                                Quarter-to-date</option>
                                            <option value="last-year"
                                                <?php echo $filter_date === 'last-year' ? 'selected' : ''; ?>>Last Year</option>
                                            <option value="last-year-to-date"
                                                <?php echo $filter_date === 'last-year-to-date' ? 'selected' : ''; ?>>Last
                                                Year-to-date</option>
                                            <option value="since-30-days-ago"
                                                <?php echo $filter_date === 'since-30-days-ago' ? 'selected' : ''; ?>>Since 30
                                                Days Ago</option>
                                            <option value="since-60-days-ago"
                                                <?php echo $filter_date === 'since-60-days-ago' ? 'selected' : ''; ?>>Since 60
                                                Days Ago</option>
                                            <option value="since-90-days-ago"
                                                <?php echo $filter_date === 'since-90-days-ago' ? 'selected' : ''; ?>>Since 90
                                                Days Ago</option>
                                            <option value="since-365-days-ago"
                                                <?php echo $filter_date === 'since-365-days-ago' ? 'selected' : ''; ?>>Since 365
                                                Days Ago</option>
                                            <option value="next-week"
                                                <?php echo $filter_date === 'next-week' ? 'selected' : ''; ?>>Next Week</option>
                                            <option value="next-4-weeks"
                                                <?php echo $filter_date === 'next-4-weeks' ? 'selected' : ''; ?>>Next 4 Weeks
                                            </option>
                                            <option value="next-month"
                                                <?php echo $filter_date === 'next-month' ? 'selected' : ''; ?>>Next Month</option>
                                            <option value="next-quarter"
                                                <?php echo $filter_date === 'next-quarter' ? 'selected' : ''; ?>>Next Quarter
                                            </option>
                                            <option value="next-year"
                                                <?php echo $filter_date === 'next-year' ? 'selected' : ''; ?>>Next Year</option>
                                        </select>
                                    </div>
                    ...
                    <div class="col-auto">
                        <div class="nsm-card primary">
                            <div class="nsm-card-header d-block">
                                    ...
                                    <div class="col-12 col-md-6 grid-mb text-end">
                                        <div class="nsm-page-buttons page-button-container">
                                            <button type="button" class="nsm-button" data-bs-toggle="modal"
                                                data-bs-target="#email_report_modal">
                                ...
                                <div
                                    class="row <?php echo !isset($header_alignment) ? 'text-center' : 'text-'.$header_alignment; ?>">
                                    ...
                                    <div class="col-12 grid-mb">
                                        <h4 class="fw-bold"><span class="company-name"><?php echo $clients->business_name; ?></span></h4>
                                    </div>
                                    <?php } ?>
                                    ...
                                    <div class="col-12 grid-mb">
                                        <p class="m-0"><?php echo $report_period; ?></p>
                                    </div>
                                    <?php } ?>
                                </div>
                            </div>
                                ...
                                <div class="table-wrapper">
                                    <table class="nsm-table grid-mb" id="reports-table">
                                        ...
                                        <tbody>
                                            ...
                                            <tr data-bs-toggle="collapse" data-bs-target="#accordion-<?php echo $index; ?>"
                                            ...
                                            id="accordion-<?php echo $index; ?>">
                                                ...
                                                <tr >
                                                    ...
                                                    <td data-name="Date"
                                                        <?php echo isset($columns) && !in_array('Date', $columns) ? 'style="display: none"' : ''; ?>>
                                                        <?php echo $tran['date'] != '' || $tran['date'] != null ? $tran['date'] : '---'; ?></td>
                                                    <td data-name="Transaction Type"
                                                        <?php echo isset($columns) && !in_array('Transaction Type', $columns) ? 'style="display: none"' : ''; ?>>
                                                        <?php echo $tran['transaction_type'] != '' || $tran['transaction_type'] != null ? $tran['transaction_type'] : '---'; ?></td>
                                                    <td data-name="Num"
                                                        <?php echo isset($columns) && !in_array('Num', $columns) ? 'style="display: none"' : ''; ?>>
                                                        <?php echo $tran['num'] != '' || $tran['num'] != null ? $tran['num'] : '---'; ?></td>
                                                    <td data-name="Create Date"
                                                        <?php echo isset($columns) && !in_array('Create Date', $columns) ? 'style="display: none"' : ''; ?>>
                                                        <?php echo $tran['create_date'] != '' || $tran['create_date'] != null ? $tran['create_date'] : '---'; ?></td>
                                                    <td data-name="Created By"
                                                        <?php echo isset($columns) && !in_array('Created By', $columns) ? 'style="display: none"' : ''; ?>>
                                                        <?php echo $tran['created_by'] != '' || $tran['created_by'] != null ? $tran['created_by'] : '---'; ?></td>
                                                    <td data-name="Last Modified"
                                                        <?php echo isset($columns) && !in_array('Last Modified', $columns) ? 'style="display: none"' : ''; ?>>
                                                        <?php echo $tran['last_modified'] != '' || $tran['last_modified'] != null ? $tran['last_modified'] : '---'; ?></td>
                                                    <td data-name="Last Modified By"
                                                        <?php echo isset($columns) && !in_array('Last Modified By', $columns) ? 'style="display: none"' : ''; ?>>
                                                        <?php echo $tran['last_modified_by'] != '' || $tran['last_modified_by'] != null ? $tran['last_modified_by'] : '---'; ?></td>
                                                    <td data-name="Customer"
                                                        <?php echo isset($columns) && !in_array('Customer', $columns) ? 'style="display: none"' : ''; ?>>
                                                        <?php echo $tran['customer'] != '' || $tran['customer'] != null ? $tran['customer'] : '---'; ?></td>
                                                    <td data-name="Phone"
                                                        <?php echo isset($columns) && !in_array('Phone', $columns) ? 'style="display: none"' : ''; ?>>
                                                        <?php echo $tran['phone'] != '' || $tran['phone'] != null ? $tran['phone'] : '---'; ?></td>
                                                    <td data-name="Phone Numbers"
                                                        <?php echo isset($columns) && !in_array('Phone Numbers', $columns) ? 'style="display: none"' : ''; ?>>
                                                        <?php echo $tran['phone_numbers'] != '' || $tran['phone_numbers'] != null ? $tran['phone_numbers'] : '---'; ?></td>
                                                    <td data-name="Email"
                                                        <?php echo isset($columns) && !in_array('Email', $columns) ? 'style="display: none"' : ''; ?>>
                                                        <?php echo $tran['email'] != '' || $tran['email'] != null ? $tran['email'] : '---'; ?></td>
                                                    <td data-name="Full Name"
                                                        <?php echo isset($columns) && !in_array('Full Name', $columns) ? 'style="display: none"' : ''; ?>>
                                                        <?php echo $tran['full_name'] != '' || $tran['full_name'] != null ? $tran['full_name'] : '---'; ?></td>
                                                    <td data-name="Billing Address"
                                                        <?php echo isset($columns) && !in_array('Billing Address', $columns) ? 'style="display: none"' : ''; ?>>
                                                        <?php echo $tran['billing_address'] != '' || $tran['billing_address'] != null ? $tran['billing_address'] : '---'; ?></td>
                                                    <td data-name="Shipping Address"
                                                        <?php echo isset($columns) && !in_array('Shipping Address', $columns) ? 'style="display: none"' : ''; ?>>
                                                        <?php echo $tran['shipping_address'] != '' || $tran['shipping_address'] != null ? $tran['shipping_address'] : '---'; ?></td>
                                                    <td data-name="Company Name"
                                                        <?php echo isset($columns) && !in_array('Company Name', $columns) ? 'style="display: none"' : ''; ?>>
                                                        <?php echo $tran['company_name'] != '' || $tran['company_name'] != null ? $tran['company_name'] : '---'; ?></td>
                                                    <td data-name="Sales Rep"
                                                        <?php echo isset($columns) && !in_array('Sales Rep', $columns) ? 'style="display: none"' : ''; ?>>
                                                        <?php echo $tran['sales_rep'] != '' || $tran['sales_rep'] != null ? $tran['sales_rep'] : '---'; ?></td>
                                                    <td data-name="P.O. Number"
                                                        <?php echo isset($columns) && !in_array('P.O. Number', $columns) ? 'style="display: none"' : ''; ?>>
                                                        <?php echo $tran['po_number'] != '' || $tran['po_number'] != null ? $tran['po_number'] : '---'; ?></td>
                                                    <td data-name="Ship Via"
                                                        <?php echo isset($columns) && !in_array('Ship Via', $columns) ? 'style="display: none"' : ''; ?>>
                                                        <?php echo $tran['ship_via'] != '' || $tran['ship_via'] != null ? $tran['ship_via'] : '---'; ?></td>
                                                    <td data-name="Terms"
                                                        <?php echo isset($columns) && !in_array('Terms', $columns) ? 'style="display: none"' : ''; ?>>
                                                        <?php echo $tran['terms'] != '' || $tran['terms'] != null ? $tran['terms'] : '---'; ?></td>
                                                    <td data-name="Client/Vendor Message"
                                                        <?php echo isset($columns) && !in_array('Client/Vendor Message', $columns) ? 'style="display: none"' : ''; ?>>
                                                        <?php echo $tran['client_vendor_message'] != '' || $tran['client_vendor_message'] != null ? $tran['client_vendor_message'] : '---'; ?></td>
                                                    <td data-name="Due Date"
                                                        <?php echo isset($columns) && !in_array('Due Date', $columns) ? 'style="display: none"' : ''; ?>>
                                                        <?php echo $tran['due_date'] != '' || $tran['due_date'] != null ? $tran['due_date'] : '---'; ?></td>
                                                    <td data-name="Past Due"
                                                        <?php echo isset($columns) && !in_array('Past Due', $columns) ? 'style="display: none"' : ''; ?>>
                                                        <?php echo $tran['past_due'] != '' || $tran['past_due'] != null ? $tran['past_due'] : '---'; ?></td>
                                                    <td data-name="Sent"
                                                        <?php echo isset($columns) && !in_array('Sent', $columns) ? 'style="display: none"' : ''; ?>>
                                                        <?php echo $tran['sent'] != '' || $tran['sent'] != null ? $tran['sent'] : '---'; ?></td>
                                                    <td data-name="Delivery Address"
                                                        <?php echo isset($columns) && !in_array('Delivery Address', $columns) ? 'style="display: none"' : ''; ?>>
                                                        <?php echo $tran['delivery_address'] != '' || $tran['delivery_address'] != null ? $tran['delivery_address'] : '---'; ?></td>
                                                    <td data-name="Amount"
                                                        <?php echo isset($columns) && !in_array('Amount', $columns) ? 'style="display: none"' : ''; ?>>
                                                        <?php echo $tran['amount'] != '' || $tran['amount'] != null ? $tran['amount'] : '---'; ?></td>
                                                    <td data-name="Open Balance"
                                                        <?php echo isset($columns) && !in_array('Open Balance', $columns) ? 'style="display: none"' : ''; ?>>
                                                        <?php echo $tran['open_balance'] != '' || $tran['open_balance'] != null ? $tran['open_balance'] : '---'; ?></td>
                                                    <td data-name="Memo/Description"
                                                        <?php echo isset($columns) && !in_array('Memo/Description', $columns) ? 'style="display: none"' : ''; ?>>
                                                        <?php echo $tran['memo_description'] != '' || $tran['memo_description'] != null ? $tran['memo_description'] : '---'; ?></td>
                                                </tr>
                                                <?php } ?>
                                                <tr class="clickable collapse-row collapse group-total"
                                                id="accordion-<?php echo $index; ?>">
                                                <td colspan="<?php echo isset($columns) ? $total_index : '24'; ?>"><b>Total for
                            ...
                            <div
                                class="nsm-card-footer <?php echo !isset($footer_alignment) ? 'text-center' : 'text-'.$footer_alignment; ?>">
