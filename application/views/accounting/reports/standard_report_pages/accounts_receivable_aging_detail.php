                                            ...
                                            <div class="container-fluid">
                                                                    ...
                                                                    <div class="dropdown-menu p-3" aria-labelledby="dropdownMenuLink">
                                                                        ...
                                                                        <div class="row hidden-cols" style="display: none">
                                                                            <div class="col-4">
                                                                                ...
                                                                                <div class="checkbox checkbox-sec d-block my-2">
                                                                                    <input type="checkbox" id="col-past-due">
                                                                            ...
                                                                            <div class="col-4">
                                                                                ...
                                                                                <div class="checkbox checkbox-sec d-block my-2">
                                                                                    <input type="checkbox" id="col-send">
                                                                                    <label for="col-send">Send</label>
                                                                                </div>
                                                                                <div class="checkbox checkbox-sec d-block my-2">
                                                ...
                                                <div class="row">
                                                    <div class="col-12 text-center">
                                                        ...
                                                        <p>A/R Aging Detail<br> As of <?=date("F d, Y")?></p>
                                                    </div>
                                                </div>
                                                        ...
                                                        <table class="table" style="width: 100%;" id="report-table">
                                                            ...
                                                            <tbody>
                                                                <tr data-toggle="collapse" data-target="#accordion" class="clickable collapse-row collapsed">
                                                                    <td><i class="fa fa-caret-right"></i> Current</td>
                                                                    <td></td>
                                                                    <td></td>
                                                                    <td></td>
                                                                    <td></td>
