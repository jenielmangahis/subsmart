                    ...
                    <div class="nsm-card primary">
                        ...
                        <div class="nsm-card-content">
                            ...
                            <div class="row mb-3">
                                <div class="col-lg-12">
                                    <?php 
                                        $tableID = "recenteditedtimeactivities_table"; 
                                        $reportCategory = "recent_edited_time_activities"; 
                                    ?>
                                    <table id="<?php echo $tableID; ?>" class="nsm-table w-100 border-0">
                                        <thead>
                                            <tr>
                                                <th class="PLACE_LEFT">ACTIVITY DATE</th>
                                                <th class="PLACE_LEFT">CUSTOMER</th>
                                                <th class="PLACE_LEFT">EMPLOYEE</th>
                                                <th class="PLACE_LEFT">PRODUCT/SERVICE</th>
                                                <th class="PLACE_LEFT">DESCRIPTION</th>                                                
                                                <th class="PLACE_LEFT">DURATION</th>
                                                <th class="PLACE_LEFT">START TIME</th>
                                                <th class="PLACE_LEFT">END TIME</th>
                                                <th class="PLACE_LEFT">BREAK</th>
                                                <th class="PLACE_LEFT">BILLABLE</th>
                                                <th class="PLACE_RIGHT">RATES</th>
                                    ...
                                    <div class="col-md-12">
                                        ...
                                        <div class="input-group">
                                            <select name="sort_by" id="sort-by" class="nsm-field form-select">
                                                <option value="activity_date" <?php echo ($reportSettings->sort_by == "activity_date") ? "selected" : "" ?>>Date</option>
                                                <option value="employee" <?php echo ($reportSettings->sort_by == "employee") ? "selected" : "" ?>>Employee Name</option>
                                                <option value="customer" <?php echo ($reportSettings->sort_by == "customer") ? "selected" : "" ?>>Customer Name</option>
                                            </select>
