                            ...
                            <div class="nsm-card-header d-block">
                                            ...
                                            <ul class="dropdown-menu dropdown-menu-end p-3 w-25">
                                                ...
                                                <div class="row">
                                                    <div class="col-12 col-md-4">
                                                        <div class="form-check">
                                                            <input type="checkbox" id="col-activity-date" class="form-check-input" checked>
                                                    ...
                                                    <div class="col-12 col-md-4">
                                                        <div class="form-check">
                                                            <input type="checkbox" id="col-employee" class="form-check-input" checked>
                                                    ...
                                                    <div class="col-12 col-md-4">
                                                        <div class="form-check">
                                                            <input type="checkbox" id="col-duration" class="form-check-input" checked>
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-12 grid-mb text-center">
                                        <p class="m-0 fw-bold">Unbilled Time</p>
                                        <p>Activity: All Dates</p>
                                    </div>
                                </div>
                            </div>
