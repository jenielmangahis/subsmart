                            ...
                            <div class="row mb-4">
                                <div class="col-lg-12 headerInfo">
                                    ...
                                    <div class="reportTitleInfo">
                                        ...
                                        <h5><small id="reportDate">From <span id="date_from_text"></span> to <span id="date_to_text"></span> for employees</small></h5>
                                    </div>
                                </div>
                            </div>
                            <div class="row mb-3">
                                <div class="col-lg-12">
                                    <?php 
                                        $tableID = "statemandatedretirementplans_table"; 
                                        $reportCategory = "state_mandated_retirement_plans"; 
                                    ?>
