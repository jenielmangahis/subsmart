                            ...
                            <div class="nsm-card-header d-block">
                                            ...
                                            <ul class="dropdown-menu dropdown-menu-end p-3 w-25">
                                                ...
                                                <div class="row">
                                                    <div class="col-12 col-md-4">
                                                        <div class="form-check">
                                                            <input type="checkbox" id="col-product-service" class="form-check-input" checked>
                                                    ...
                                                    <div class="col-12 col-md-4">
                                                        <div class="form-check">
                                                            <input type="checkbox" id="col-price" class="form-check-input" checked>
                                                    ...
                                                    <div class="col-12 col-md-4">
                                                        <div class="form-check">
                                                            <input type="checkbox" id="col-cost" class="form-check-input" checked>
                                                    ...
                                                    <div class="col-12 col-md-4">
                                                        <div class="form-check">
                                                            <input type="checkbox" id="col-preferred-vendor" class="form-check-input">
                                                            <label for="col-preferred-vendor" class="form-check-label">Preferred Vendor</label>
                                                        </div>
                                                    </div>
                                                    ...
                                                    <div class="col-12 col-md-4">
                                                        <div class="form-check">
                                                            <input type="checkbox" id="col-reorder-point" class="form-check-input">
                                                            <label for="col-reorder-point" class="form-check-label">Reorder Point</label>
                                                        </div>
                                                    </div>
                                                    <div class="col-12 col-md-4">
                                                        <div class="form-check">
                                                            <input type="checkbox" id="col-qty-on-po" class="form-check-input">
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-12 grid-mb text-center">
                                        <p class="fw-bold">Product/Service List</p>
                                    </div>
                                </div>
                            </div>
