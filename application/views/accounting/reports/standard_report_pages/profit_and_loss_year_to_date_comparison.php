                                    ...
                                    <div class="col-12 col-md-6">
                                        ...
                                        <div class="dropdown">
                                            ...
                                            <ul class="dropdown-menu dropdown-menu-end p-3 w-100">
                                                ...
                                                <div class="form-check">
                                                    <input type="checkbox" id="year-to-date" name="selected_period" class="form-check-input" checked>
                                                    <label for="year-to-date" class="form-check-label">Year-to-date (YTD)</label>
                                                </div>
                                                <div class="row">
                                                    <div class="col">
                                                        <div class="form-check d-inline-block">
                                                            <input type="checkbox" id="ytd-percent" class="form-check-input">
                            ...
                            <div class="nsm-card-header d-block">
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-12 grid-mb text-center">
                                        <p class="m-0 fw-bold">Profit and Loss YTD Comparison</p>
