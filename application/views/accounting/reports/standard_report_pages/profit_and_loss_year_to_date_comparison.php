                ...
                <div class="col-xl-12">
                    <div class="card">
                        <div class="card-body hid-desk" style="padding-bottom:0px;">
                            <div class="row">
                                <div class="col-sm-6">
                                    <h3 class="page-title" style="margin: 0 !important">Profit and Loss YTD Comparison Report</h3>
                                </div>
                            </div>
                                        ...
                                        <div class="form-group">
                                            <div class="form-row">
                                                ...
                                                <div class="col-3">
                                                    ...
                                                    <div class="dropdown w-100">
                                                        <button class="dropdown-toggle btn btn-transparent hide-toggle w-100" id="filterDropdown" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
                                                            Year-to-date&nbsp;&nbsp;<i class="fa fa-caret-down"></i>
                                                        </button>
                                                        ...
                                                        <div class="dropdown-menu p-3" aria-labelledby="filterDropdown">
                                                            ...
                                                            <div class="checkbox checkbox-sec d-block my-2">
                                                                <input type="checkbox" id="year-to-date" checked name="selected_period">
                                            ...
                                            <div class="container-fluid">
                                                ...
                                                <div class="row">
                                                    <div class="col-12 text-center">
                                                        ...
                                                        <p>Profit and Loss YTD Comparison<br> <?=date("F 1")?>-<?=date("d, Y")?></p>
                                                    </div>
                                                </div>
                                                    ...
                                                    <div class="col-12">
                                                        <table class="table" style="width: 100%;" id="report-table">
                                                            <thead>
                                                                ...
                                                                <tr class="text-right">
                                                                    <th><?=date("M 1")?>-<?=date("j, Y")?></th>
                                                                    <th>Jan 1-<?=date("M j, Y")?>(YTD)</th>
                                                                </tr>
                                                            </thead>
                                                            <tbody>
