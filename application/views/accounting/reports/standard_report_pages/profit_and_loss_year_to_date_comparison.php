                    ...
                    <div class="nsm-card primary">
                        ...
                        <div class="nsm-card-content">
                            ...
                            <div class="row mb-3">
                                <div class="col-lg-12">                                   
                                    <?php 
                                        $tableID = "profitlossytdcomparison_table"; 
                                        $reportCategory = "profit_loss_ytd_comparison"; 
                                    ?>
                                    <!-- <table class="nsm-table w-100 border-0">
                                        <thead>
                                            <tr>
                                                <th>&nbsp;</th>
                                                <th>&nbsp;</th>
                                    ...
                                    <table id="<?php echo $tableID; ?>" class="nsm-table w-100 border-0">
                                        <thead>
                                            <tr>
                                                <th></th>
                                                <th></th>
                                                <th class="text-end"><?php echo strtoupper(date('M 1-t, Y')); ?></th>
                                                <th class="text-end"><?php echo strtoupper("JAN 1 - " . date('M j, Y')); ?></th>
                                            </tr>
                                        </thead>
                                        <tbody>
                                            <tr>
