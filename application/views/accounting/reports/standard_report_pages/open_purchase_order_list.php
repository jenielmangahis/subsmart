                    ...
                    <div class="nsm-card primary">
                        ...
                        <div class="nsm-card-content">
                            ...
                            <div class="row mb-3">
                                <div class="col-lg-12">
                                    <?php 
                                        $tableID = "openpurchaseorderlist_table"; 
                                        $reportCategory = "open_purchase_order_list"; 
                                    ?>
                                    ...
                                    <div class="col-md-12">
                                        ...
                                        <div class="input-group">
                                            <select name="sort_by" id="sort-by" class="nsm-field form-select">
                                                <option value="vendor" <?php echo ($reportSettings->sort_by == "activity_date") ? "selected" : "" ?>>Vendor Name</option>
                                                <option value="total_amount" <?php echo ($reportSettings->sort_by == "total_amount") ? "selected" : "" ?>>Amount</option>
                                                <option value="total_balance" <?php echo ($reportSettings->sort_by == "total_balance") ? "selected" : "" ?>>Balance</option>
                                            </select>
