                    ...
                    <div class="nsm-card primary">
                        ...
                        <div class="nsm-card-content">
                            ...
                            <div class="row mb-2">
                                <div class="col-lg-12">
                                    <center>
                                        <h5><strong id="reportName">Vendor Contact List</strong></h5>
                                    </center>
                                </div>
                            </div>
                            <!-- <div class="row mb-3"> 
                            ...
                            <div class="row mb-3">
                                <div class="col-lg-12">
                                    <table id="vendorcontactlist_table" class="nsm-table w-100 border-0" data-tableName="Test Table 1">
                                        <thead>
                                            <tr>
                                                <th>VENDOR</th>
                                                <th>PHONE NUMBERS</th>
                            ...
                            <div class="form-group">
                                ...
                                <div class="row">
                                    <div class="input-group mb-2">
                                        ...
                                        <input id="pdfReportFilename" class="form-control" type="text" value="Vendor Contact List" required>
                                    ...
                                    <div class="input-group">
                                        ...
                                        <input id="xlsxReportFileName" class="form-control" type="text" value="Vendor Contact List" required>
...
<script type="text/javascript">
    ...
    function renderReportList(businessName, reportName, filename, notes, reportConfig) {
        $("#vendorcontactlist_table > tbody").empty().html('<tr><td colspan="6"><center><div class="spinner-border spinner-border-sm" role="status"></div>&nbsp;&nbsp;Fetching Result... </center></td></tr>');
        $.ajax({
            type: "POST",
            url: "<?php echo base_url('accounting_controllers/Reports/getReportData/vendor_contact_list'); ?>",
            data: { 
            ...
            success: function(data) {
                $("#vendorcontactlist_table > tbody").empty().html(data);
                loadReportPreview();
            }
        });
    }
    ...
    $('#sendEmailForm').submit(function(event) {
        ...
        $.ajax({
            type: "POST",
            url: "<?php echo base_url('AccountingMailer/emailReport/vendor_contact_list'); ?>",
            data: {
                emailTo: emailTo,
                emailCC: emailCC,
