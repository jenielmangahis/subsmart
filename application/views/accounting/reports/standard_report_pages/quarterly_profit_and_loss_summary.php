                ...
                <div class="col-xl-12">
                    <div class="card">
                        <div class="card-body hid-desk" style="padding-bottom:0px;">
                            <div class="row">
                                <div class="col-sm-6">
                                    <h3 class="page-title" style="margin: 0 !important">Quarterly Profit and Loss Summary Report</h3>
                                </div>
                            </div>
                                            ...
                                            <div class="container-fluid">
                                                ...
                                                <div class="row">
                                                    <div class="col-12 text-center">
                                                        ...
                                                        <p>Quarterly Profit and Loss Summary<br> January 1-<?=date("F d, Y")?></p>
                                                    </div>
                                                </div>
                                                    ...
                                                    <div class="col-12">
                                                        <table class="table" style="width: 100%;" id="report-table">
                                                            <thead>
                                                                <tr>
                                                                    <th></th>
                                                                    <th class="text-right">JAN-MAR, <?=date("Y")?></th>
                                                                    <th class="text-right">APR 1-<?=strtoupper(date("M d, Y"))?></th>
