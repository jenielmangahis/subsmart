                    ...
                    <div class="nsm-card primary">
                        ...
                        <div class="nsm-card-content">
                            ...
                            <div class="row mb-3">
                                <div class="col-lg-12">
                                    <?php 
                                        $tableID = "quarterlyprofitandloss_table"; 
                                        $reportCategory = "quarterly_profit_and_loss_month"; 
                                    ?>
                                    <table id="<?php echo $tableID; ?>" class="nsm-table w-100 border-0 accordion">
                                        <thead>
                                            <tr>
                                                <th></th>
                                                <th class="PLACE_RIGHT">JAN-MAR, <?=date("Y")?></th>
                                                <th class="PLACE_RIGHT">APR-JUN, <?=date("Y")?></th>
                                                <th class="PLACE_RIGHT">JUL-SEPT, <?=date("Y")?></th>                                                
                                                <th class="PLACE_RIGHT">OCT-DEC, <?=date("Y")?></th>
