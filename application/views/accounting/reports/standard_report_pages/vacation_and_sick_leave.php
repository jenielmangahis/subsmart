                    ...
                    <div class="nsm-card primary">
                        ...
                        <div class="nsm-card-content">
                            ...
                            <div class="row mb-3">
                                <div class="col-lg-12">
                                    <?php 
                                        $tableID = "vacationsickleave_table"; 
                                        $reportCategory = "vacation_and_sick_leave"; 
                                    ?>
                                    ...
                                    <div class="col-md-12">
                                        ...
                                        <div class="input-group">
                                            <select name="sort_by" id="sort-by" class="nsm-field form-select">
                                                ...
                                                <option value="leave_date" <?php echo ($reportSettings->sort_by == "leave_date") ? "selected" : "" ?>>Leave Date</option>
                                                <option value="leave_type" <?php echo ($reportSettings->sort_by == "leave_type") ? "selected" : "" ?>>Leave Type</option>
                                            </select>
