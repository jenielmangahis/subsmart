                    ...
                    <div class="nsm-card primary">
                        ...
                        <div class="nsm-card-content">
                            ...
                            <div class="row mb-3">
                                <div class="col-lg-12">
                                    <?php 
                                        $tableID = "estimates_table"; 
                                        $reportCategory = "estimates"; 
                                    ?>
                            ...
                            <div class="row">
                                    ...
                                    <div class="col-md-12">
                                        ...
                                        <div class="input-group">
                                            <select name="sort_by" id="sort-by" class="nsm-field form-select">
                                                ...
                                                <option value="job" <?php echo ($reportSettings->sort_by == "job") ? "selected" : "" ?>>Job</option>
                                ...
                                <div class="col-md-3 mb-3">
                                    ...
                                    <select name="status_filter" id="status-filter" class="nsm-field form-select">
                                        <option value="" <?php echo ($reportSettings->status_filter == "none") ? "selected" : "" ?>>None</option>
                                        <option value="Draft" <?php echo ($reportSettings->status_filter == "Draft") ? "selected" : "" ?>>Draft</option>
                                        <option value="Pending" <?php echo ($reportSettings->status_filter == "Pending") ? "selected" : "" ?>>Pending</option>
                                        <option value="Submitted" <?php echo ($reportSettings->status_filter == "Submitted") ? "selected" : "" ?>>Submitted</option>
                                        <option value="Accepted" <?php echo ($reportSettings->status_filter == "Accepted") ? "selected" : "" ?>>Accepted</option>
                                        <option value="Invoiced" <?php echo ($reportSettings->status_filter == "Invoiced") ? "selected" : "" ?>>Invoiced</option>
                                        <option value="Lost" <?php echo ($reportSettings->status_filter == "Lost") ? "selected" : "" ?>>Lost</option>
                                        <option value="Declined By Customer" <?php echo ($reportSettings->status_filter == "Declined By Customer") ? "selected" : "" ?>>Declined By Customer</option>
