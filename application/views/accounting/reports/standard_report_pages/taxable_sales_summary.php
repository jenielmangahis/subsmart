                ...
                <div class="col-xl-12">
                    <div class="card">
                        <div class="card-body hid-desk" style="padding-bottom:0px;">
                            <div class="row">
                                <div class="col-sm-6">
                                    <h3 class="page-title" style="margin: 0 !important">Taxable Sales Summary Report</h3>
                                </div>
                            </div>
                                    ...
                                    <div class="col-md-6">
                                        <div class="form-group">
                                            <div class="form-row">
                                                ...
                                                <div class="col-2 d-flex align-items-end">
                                                    <input type="text" name="end_date" id="end-date" class="date form-control" value="<?=date("03/31/Y")?>">
                                                </div>
                                            </div>
                                        </div>
                                        <div class="form-group">
                                            ...
                                            <div class="container-fluid">
                                                ...
                                                <div class="row">
                                                    <div class="col-12 text-center">
                                                        ...
                                                        <p>Taxable Sales Summary<br>January - March, 2022</p>
                                                    </div>
                                                </div>
