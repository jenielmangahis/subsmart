                                    ...
                                    <div class="col-md-12">
                                        ...
                                        <div class="input-group">
                                            <select name="sort_by" id="sort-by" class="nsm-field form-select">
                                                <option value="product_type" <?php echo ($reportSettings->sort_by == "product_type") ? "selected" : "" ?>>Type</option>
                                                <option value="total" <?php echo ($reportSettings->sort_by == "num") ? "selected" : "" ?>>Total</option>
                                            </select>
