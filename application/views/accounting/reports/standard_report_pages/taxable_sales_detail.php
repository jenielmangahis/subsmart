            ...
            <div class="card">
                <div class="card-body customizeComponent">
                    ...
                    <div class="row">
                        <div class="col-md-2">
                            <div class="col-md-12">
                                <label class="form-label fw-bold">Rows/columns <small class="text-muted fw-normal">(Group by)</small></label>
                                <select class="nsm-field form-select" name="filter_group_by" id="filter-group-by">
                                    ...
                                    <option value="MemoDescription">Memo/Description</option>
                    ...
                    <div class="nsm-card primary">
                        ...
                        <div class="nsm-card-content">
                            ...
                            <div class="row mb-2">
                                <div class="col-lg-12">
                                    <center>
                                        <h5><strong id="REPORT_NAME">Taxable Sales Detail Report</strong></h5>
                                    </center>
                                </div>
                            </div>
                            <div class="row mb-2">
                            ...
                            <div class="row mb-2">
                                <div class="col-lg-12">
                                    <table id="taxableSalesDetail_table" class="nsm-table w-100 display">
                                        <thead>
                                            <tr>
                                                <th>DATE</th>
                        ...
                        <div class="col-sm-12 mt-1 mb-3">
                            <div class="form-group">
                                ...
                                <div class="input-group">
                                    <input id="EMAIL_REPORT_FILENAME" class="form-control" type="text" value="Taxable Sales Detail Report" required>
...
<script type="text/javascript">
    ...
    var taxableSalesDetail_table = $('#taxableSalesDetail_table').DataTable({
        "ordering": false,
        // paging: false,
    ...
    var TABLE_SETTINGS = taxableSalesDetail_table.settings();
    ...
    //     win.document.write("<style>#taxableSalesDetail_table>tbody>tr>td{font-size: 12px;} #taxableSalesDetail_table>thead>tr>th{font-size: 10px;}table{width: 100% !important}.avatar {width: 34px;min-width: 34px;height: 34px;}</style>");
