                ...
                <div class="col-xl-12">
                    <div class="card">
                        <div class="card-body hid-desk" style="padding-bottom:0px;">
                            <div class="row">
                                <div class="col-sm-6">
                                    <h3 class="page-title" style="margin: 0 !important">Taxable Sales Detail Report</h3>
                                </div>
                            </div>
                                            ...
                                            <div class="container-fluid">
                                                                    ...
                                                                    <div class="dropdown-menu p-3" aria-labelledby="dropdownMenuLink">
                                                                        ...
                                                                        <div class="row hidden-cols" style="display: none">
                                                                            ...
                                                                            <div class="col-4">
                                                                                ...
                                                                                <div class="checkbox checkbox-sec d-block my-2">
                                                                                    <input type="checkbox" id="col-balance">
                                                ...
                                                <div class="row">
                                                    <div class="col-12 text-center">
                                                        ...
                                                        <p>Taxable Sales Detail<br> January - March, 2022</p>
                                                    </div>
                                                </div>
