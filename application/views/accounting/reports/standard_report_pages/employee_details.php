                                        ...
                                        <table class="table" style="width: 100%;">
                                            <thead>
                                                <tr>
                                                    ...
                                                    <th>PAY INFO</th>
                                                    <th></th>
                                                    <th class="text-right">TAX INFO</th>
                                                    <th></th>
                                                    <th>NOTES</th>
                                                </tr>
                                            </thead>
                                            <tbody>
                                                <tr>
                                                    <td rowspan="2">
                                                        <p class="m-0">Test Employee</p>
                                                        <p class="m-0">Test Address</p>
                                                        <p class="m-0">Hired: 06/15/2022</p>
                                                        <p class="m-0">Term: 06/15/2022</p>
                                                        <p class="m-0">Born: 06/15/2022</p>
                                                    </td>
