                    ...
                    <div class="nsm-card primary">
                        ...
                        <div class="nsm-card-content">
                            ...
                            <div class="row mb-3">
                                <div class="col-lg-12">
                                    <?php 
                                        $tableID = "payrolltaxpayments_table"; 
                                        $reportCategory = "payroll_tax_payments"; 
                                    ?>
                                    ...
                                    <div class="col-md-12">
                                        ...
                                        <div class="input-group">
                                            <select name="sort_by" id="sort-by" class="nsm-field form-select">
                                                ...
                                                <option value="employee_tax" <?php echo ($reportSettings->sort_by == "employee_tax") ? "selected" : "" ?>>Amount</option>
                                            </select>
