                    ...
                    <div class="nsm-card primary">
                        ...
                        <div class="nsm-card-content">
                            ...
                            <div class="row mb-3">
                                <div class="col-lg-12">
                                    <?php 
                                        $tableID = "transactionlistbydate_table"; 
                                        $reportCategory = "transaction_list_by_date"; 
                                    ?>
                                    <table id="<?php echo $tableID; ?>" class="nsm-table w-100 border-0">
                                        <thead>
                                            <tr>                                                
                                                ...
                                                <th class="PLACE_LEFT">CUSTOMER NAME</th>
                                                <th class="PLACE_LEFT">DESCRIPTION</th>                                                
                                                <th class="PLACE_LEFT">PO NUMBER</th>
                                                <th class="PLACE_LEFT">DUE DATE</th>
                                                <th class="PLACE_RIGHT">AMOUNT</th>
                                                <th class="PLACE_RIGHT">OPEN BALANCE</th>
                                                <th class="PLACE_RIGHT">TAX AMOUNT</th>
                                            </tr>
                                        </thead>
                                        <tbody>
                                            <tr>
                        ...
                        <div class="col-lg-12">
                            <div class="row">
                                    ...
                                    <div class="col-md-12">
                                        ...
                                        <div class="input-group">
                                            <select name="sort_by" id="sort-by" class="nsm-field form-select">
                                                ...
                                                <option value="transaction_amount" <?php echo ($reportSettings->sort_by == "transaction_amount") ? "selected" : "" ?>>Amount</option>
                                            </select>
                                ...
                                <div class="col-md-5 mb-3">
                                    ...
                                    <div class="input-group">
                                        <input name="date_from" class="form-control mt-0" type="date" value="<?php echo (isset($reportSettings->report_date_from_text)) ? $reportSettings->report_date_from_text : date('Y-m-01'); ?>">
