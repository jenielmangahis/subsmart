                    ...
                    <div class="nsm-card primary">
                        ...
                        <div class="nsm-card-content">
                            ...
                            <div class="row mb-2">
                                <div class="col-lg-12">
                                    <center>
                                        <h5><strong id="reportName">Audit Log List</strong></h5>
                                    </center>
                                </div>
                            </div>
                            <!-- <div class="row mb-3"> 
                            ...
                            <div class="form-group">
                                ...
                                <div class="row">
                                    <div class="input-group borderRadius0 pdfAttachment">
                                        ...
                                        <input id="pdfReportFilename" class="form-control" type="text" value="Audit Log List" required>
                                    ...
                                    <div class="input-group borderRadius0">
                                        ...
                                        <input id="xlsxReportFileName" class="form-control" type="text" value="Audit Log List" required>
