                            ...
                            <ul class="dropdown-menu dropdown-menu-end p-3" style="width: max-content">
                                ...
                                <div class="row">
                                    <div class="col-12">
                                        ...
                                        <div class="form-check d-inline-block">
                                            <input type="radio" id="current-method" class="form-check-input" name="aging_method" checked>
                                            <label for="current-method" class="form-check-label">Current</label>
                                        </div>
                                        <div class="form-check d-inline-block">
                                            <input type="radio" id="report-date-method" class="form-check-input" name="aging_method">
                                ...
                                <div class="row grid-mb">
                                    <div class="col-12">
                                        ...
                                        <input type="text" class="nsm-field form-control datepicker" value="1" name="filter_min_days_past_due" id="filter-min-days-past-due">
                                    </div>
                                </div>
                                <div class="row">
                            ...
                            <div class="nsm-card-header d-block">
                                        ...
                                        <div class="nsm-page-buttons page-button-container">
                                            ...
                                            <ul class="dropdown-menu dropdown-menu-end p-3 w-25">
                                                ...
                                                <div class="row">
                                                    ...
                                                    <div class="col-12 col-md-4">
                                                        <div class="form-check">
                                                            <input type="checkbox" id="col-full-name" class="form-check-input">
                                                    ...
                                                    <div class="col-12 col-md-4">
                                                        <div class="form-check">
                                                            <input type="checkbox" id="col-past-due" class="form-check-input" checked>
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-12 grid-mb text-center">
                                        <p class="m-0 fw-bold">Collections Report</p>
                                ...
                                <table class="nsm-table">
                                    <thead>
                                        <tr>
                                            ...
                                            <td data-name="Past Due">PAST DUE</td>
