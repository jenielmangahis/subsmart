                            ...
                            <div class="row mb-4">
                                <div class="col-lg-12 headerInfo">
                                    ...
                                    <div class="reportTitleInfo">
                                        ...
                                        <h5><small id="reportDate"><span id="date_from_text"></span> &mdash; <span
                                                    id="date_to_text"></span></small></h5>
                                    </div>
                                </div>
                            </div>
                            <div class="row mb-3">
                                <div class="col-lg-12">
                                    <?php 
                                        $tableID = "workerscompensation_table"; 
                                        $reportCategory = "workers_compensation"; 
                                    ?>
                                    <table id="<?php echo $tableID; ?>" class="nsm-table w-100 border-0 accordion">
                                        <thead>
                                            <tr>
                                                <th>EMPLOYEE</th>
                                                <th>STATE</th>
                                                <th>WORKER'S COMP CLASS</th>
                                                <th style="text-align:right;">PREMIUM WAGE PAID</th>
                                                <th style="text-align:right;">BONUS PAID</th>                                                
                                                <th style="text-align:right;">EMPLOYEE TAXES</th>                                                
                            ...
                            <div class="row">
                                ...
                                <div class="col-md-3 mb-3">
                                    ...
                                    <select name="header_align" id="header-align" class="nsm-field form-select">
                                        ...
                                        <option value="R"
                                            <?php echo ($reportSettings->header_align == "R") ? "selected" : "" ?>>Right
                                        </option>
                                    </select>
                                </div>
                                <div class="col-md-3 mb-3">
                                    ...
                                    <select name="footer_align" id="footer-align" class="nsm-field form-select">
                                        ...
                                        <option value="R"
                                            <?php echo ($reportSettings->footer_align == "R") ? "selected" : "" ?>>Right
                                        </option>
                                    </select>
                                </div>
                                <div class="col-md-2 mb-3">
                                    ...
                                    <div class="col-md-12">
                                        ...
                                        <div class="input-group">
                                            <select name="sort_by" id="sort-by" class="nsm-field form-select">
                                                <option value="employee" <?php echo ($reportSettings->sort_by == "employee") ? "selected" : "" ?>>Employee Name</option>
                                                <option value="state" <?php echo ($reportSettings->sort_by == "state") ? "selected" : "" ?>>State</option>
                                                <option value="bonus_pay" <?php echo ($reportSettings->sort_by == "bonus_pay") ? "selected" : "" ?>>Bonus</option>
                                                <option value="employee_tax" <?php echo ($reportSettings->sort_by == "employee_tax") ? "selected" : "" ?>>Employee Tax</option>
                                                <option value="gross_pay" <?php echo ($reportSettings->sort_by == "gross_pay") ? "selected" : "" ?>>Wages Paid</option>
                                            </select>
                                ...
                                <div class="col-md-5 mb-3">
                                    <label class="mb-1 fw-xnormal">Date Range <small class="text-muted">(From &mdash;
                                            To)</small></label>
                                    <div class="input-group">
                                        <input name="date_from" class="form-control mt-0" type="date"
                                            value="<?php echo (isset($reportSettings->report_date_from_text)) ? $reportSettings->report_date_from_text : date('Y').'-01-01'; ?>">
                                        <input name="date_to" class="form-control mt-0" type="date"
                                            value="<?php echo (isset($reportSettings->report_date_to_text)) ? $reportSettings->report_date_to_text : date('Y-m-d'); ?>">
                                    </div>
                                </div>
                            </div>
                        </div>
