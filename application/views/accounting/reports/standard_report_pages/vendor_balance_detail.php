                ...
                <div class="col-xl-12">
                    <div class="card">
                        <div class="card-body hid-desk" style="padding-bottom:0px;">
                            <div class="row">
                                <div class="col-sm-6">
                                    <h3 class="page-title" style="margin: 0 !important">Vendor Balance Detail Report</h3>
                                </div>
                            </div>
                                            ...
                                            <div class="container-fluid">
                                                                        ...
                                                                        <div class="row hidden-cols" style="display: none">
                                                                            ...
                                                                            <div class="col-4">
                                                                                <div class="checkbox checkbox-sec d-block my-2">
                                                                                    ...
                                                                                    <label for="col-full-name">Address</label>
                                                                                </div>
                                                                                <div class="checkbox checkbox-sec d-block my-2">
                                                ...
                                                <div class="row">
                                                    <div class="col-12 text-center">
                                                        ...
                                                        <p>Vendor Balance Detail<br> All Dates</p>
                                                    </div>
                                                </div>
                                                    ...
                                                    <div class="col-12">
                                                        <table class="table" style="width: 100%;">
                                                            ...
                                                            <tbody>
                                                                ...
                                                                <tr class="clickable collapse-row collapse" id="accordion">
                                                                    <td>&emsp;<b>Total for Test Vendor</b></td>
                                                                    <td></td>
                                                                    <td></td>
                                                                    <td></td>
                                                                    <td class="text-right"><b>$22,544.77</b></td>
