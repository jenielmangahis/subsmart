                    ...
                    <div class="nsm-card primary">
                        ...
                        <div class="nsm-card-content">
                            ...
                            <div class="row mb-3">
                                <div class="col-lg-12">
                                    <?php 
                                        $tableID = "profitlosscomparison_table"; 
                                        $reportCategory = "profit_and_loss_comparison"; 

                                        $date_a = 'JAN 01 TO ' . date("M d, Y");
                                        $date_b = 'JAN 01 TO ' . date("M d, Y", strtotime("-1 year"));
                                    ?>
                                    <table id="<?php echo $tableID; ?>" class="nsm-table w-100 border-0 accordion">
                                        <thead>
                                            <tr>
                                                <th></th>
                                                <th class="PLACE_RIGHT"><?= strtoupper($date_a); ?></th>
                                                <th class="PLACE_RIGHT"><?= strtoupper($date_b); ?></th>
