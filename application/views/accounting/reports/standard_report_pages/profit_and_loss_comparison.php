                ...
                <div class="col-xl-12">
                    <div class="card">
                        <div class="card-body hid-desk" style="padding-bottom:0px;">
                            <div class="row">
                                <div class="col-sm-6">
                                    <h3 class="page-title" style="margin: 0 !important">Profit and Loss Comparison Report</h3>
                                </div>
                            </div>
                                                ...
                                                <div class="col-3">
                                                    ...
                                                    <div class="dropdown w-100">
                                                        ...
                                                        <div class="dropdown-menu p-3 w-100" aria-labelledby="filterDropdown">
                                                            ...
                                                            <div class="checkbox checkbox-sec d-block my-2">
                                                                <input type="checkbox" id="previous-year" checked name="selected_period">
                                            ...
                                            <div class="container-fluid">
                                                ...
                                                <div class="row">
                                                    <div class="col-12 text-center">
                                                        ...
                                                        <p>Profit and Loss Comparison<br> January 1-<?=date("F d, Y")?></p>
                                                    </div>
                                                </div>
                                                    ...
                                                    <div class="col-12">
                                                        <table class="table" style="width: 100%;">
                                                            <thead>
                                                                ...
                                                                <tr class="text-right">
                                                                    <th>Jan 1-<?=date("M j, Y")?></th>
                                                                    <th>Jan 1-<?=date("M j, Y", strtotime("-1 year"))?>(PY)</th>
                                                                </tr>
                                                            </thead>
                                                            <tbody>
