                            ...
                            <ul class="dropdown-menu dropdown-menu-end p-3" style="width: 20%">
                                <div class="row g-3">
                                    <div class="col-12">
                                        ...
                                        <input type="text" name="custom_report_name" id="custom-report-name" class="nsm-field form-control" value="Bills and Applied Payments">
                                    </div>
                                    <div class="col-12">
                                ...
                                <table class="nsm-table grid-mb" id="reports-table">
                                    ...
                                    <tbody>
                                        ...
                                        <tr data-bs-toggle="collapse" data-bs-target="#accordion-<?=$index?>" class="clickable collapse-row collapsed">
                                            <td colspan="22"><i class="bx bx-fw bx-caret-right"></i> <b><?=$vendor['name']?></b></td>
                                        </tr>
