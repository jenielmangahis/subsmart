                ...
                <div class="col-xl-12">
                    <div class="card">
                        <div class="card-body hid-desk" style="padding-bottom:0px;">
                            <div class="row">
                                <div class="col-sm-6">
                                    <h3 class="page-title" style="margin: 0 !important">Bills and Applied Payments Report</h3>
                                </div>
                            </div>
                                            ...
                                            <div class="container-fluid">
                                                                    ...
                                                                    <div class="dropdown-menu p-3" aria-labelledby="dropdownMenuLink">
                                                                        ...
                                                                        <div class="row">
                                                                            ...
                                                                            <div class="col-4">
                                                                                ...
                                                                                <div class="checkbox checkbox-sec d-block my-2">
                                                                                    <input type="checkbox" id="col-craeted-by">
                                                                                    <label for="col-craeted-by">Created By</label>
                                                                                </div>
                                                                            </div>
                                                                            <div class="col-4">
                                                                                <div class="checkbox checkbox-sec d-block my-2">
                                                ...
                                                <div class="row">
                                                    <div class="col-12 text-center">
                                                        ...
                                                        <p>Bills and Applied Payments<br> January 1 - <?=date("F j, Y")?></p>
                                                    </div>
                                                </div>
                                                        ...
                                                        <table class="table" style="width: 100%;">
                                                            ...
                                                            <tbody>
                                                                ...
                                                                <tr class="clickable collapse-row collapse" id="accordion">
                                                                    <td>&emsp;<b>06/18/2022</b></td>
                                                                    <td><b>Bill Payment (Check)</b></td>
                                                                    <td></td>
                                                                    <td><b>123</b></td>
