                                    ...
                                    <div class="col-md-12">
                                        ...
                                        <div class="input-group">
                                            <select name="sort_by" id="sort-by" class="nsm-field form-select">
                                                <option value="estimate_id">Default</option>
                                                <option value="customer">Customer</option>
                                                ...
                                                <option value="invoiced_amount">Invoiced Amount</option>
                                                <option value="percent_amount">% Amount</option>
                                                <option value="balance">Balance</option>
                                                <option value="remaining_amount">Remaining Balance</option>
                                            </select>
