                    ...
                    <div class="nsm-card primary">
                        ...
                        <div class="nsm-card-content">
                            ...
                            <div class="row mb-3">
                                <div class="col-lg-12">                                   
                                    <?php 
                                        $tableID = "estimateprogressinvoicing_table"; 
                                        $reportCategory = "estimate_progress_invoicing"; 
                                    ?>
                                    ...
                                    <div class="col-md-12">
                                        ...
                                        <div class="input-group">
                                            <select name="sort_by" id="sort-by" class="nsm-field form-select">
                                                ...
                                                <option value="balance" <?php echo ($reportSettings->sort_by == "balance") ? "selected" : "" ?>>Balance</option>
                                                <option value="invoiced_amount" <?php echo ($reportSettings->sort_by == "invoiced_amount") ? "selected" : "" ?>>Invoiced Amount</option>
                                                <option value="percent_amount" <?php echo ($reportSettings->sort_by == "percent_amount") ? "selected" : "" ?>>% Amount</option>
                                                <option value="balance" <?php echo ($reportSettings->sort_by == "balance") ? "selected" : "" ?>>Balance</option>
                                                <option value="remaining_amount" <?php echo ($reportSettings->sort_by == "remaining_amount") ? "selected" : "" ?>>Remaining Balance</option>
                                            </select>
