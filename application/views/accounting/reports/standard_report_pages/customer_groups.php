                                    ...
                                    <div class="row">
                                        <div class="col-md-4 mb-3">
                                            ...
                                            <select name="status_filter" id="status-filter" class="nsm-field form-select">
                                                <option value="active_customer_group" <?php echo ($reportSettings->status_filter == "active_customer_group") ? "selected" : "" ?>>Active Customer Groups</option>
                                                <option value="all_customer_group" <?php echo ($reportSettings->status_filter == "all_customer_group") ? "selected" : "" ?>>All Customer Groups</option>
                                            </select>
                                        </div>
                                    </div>
                                </div>
