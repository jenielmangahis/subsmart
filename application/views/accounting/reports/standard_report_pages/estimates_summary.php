                    ...
                    <div class="nsm-card primary">
                        ...
                        <div class="nsm-card-content">
                            ...
                            <div class="row mb-3">
                                <div class="col-lg-12">                                   
                                    <?php 
                                        $tableID = "estimatessummary_table"; 
                                        $reportCategory = "estimates_summary"; 
                                    ?>
                                    ...
                                    <div class="col-md-12">
                                        ...
                                        <div class="input-group">
                                            <select name="sort_by" id="sort-by" class="nsm-field form-select">
                                                <option value="estimate_no" <?php echo ($reportSettings->sort_by == "estimate_no") ? "selected" : "" ?>>Estimate No.</option>
                                            </select>
