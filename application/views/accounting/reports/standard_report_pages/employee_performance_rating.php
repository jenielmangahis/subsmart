                    ...
                    <div class="nsm-card primary">
                        ...
                        <div class="nsm-card-content">
                            ...
                            <div class="row mb-3">
                                <div class="col-lg-12">
                                    <?php 
                                        $tableID = "employeeperformancerating_table"; 
                                        $reportCategory = "employee_performance_rating"; 
                                    ?>
                                    ...
                                    <div class="col-md-12">
                                        ...
                                        <div class="input-group">
                                            <select name="sort_by" id="sort-by" class="nsm-field form-select">
                                                <option value="total_points" <?php echo ($reportSettings->sort_by == "total_points") ? "selected" : "" ?>>Total Points</option>
                                                <option value="employee_name" <?php echo ($reportSettings->sort_by == "employee_name") ? "selected" : "" ?>>Employee</option>
                                                <option value="employee_type" <?php echo ($reportSettings->sort_by == "employee_type") ? "selected" : "" ?>>Type</option>
