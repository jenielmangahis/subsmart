                    ...
                    <div class="nsm-card primary">
                        ...
                        <div class="nsm-card-content">
                            ...
                            <div class="row mb-3">
                                <div class="col-lg-12">
                                    <?php 
                                        $tableID = "commercialvsresidential_table"; 
                                        $reportCategory = "commercial_vs_residential"; 
                                    ?>
                                    ...
                                    <div class="col-md-12">
                                        ...
                                        <div class="input-group">
                                            <select name="sort_by" id="sort-by" class="nsm-field form-select">
                                                ...
                                                <option value="invoice_date" <?php echo ($reportSettings->sort_by == "invoice_date") ? "selected" : "" ?>>Date</option>
                                                <option value="num" <?php echo ($reportSettings->sort_by == "num") ? "selected" : "" ?>>Num</option>
                                                <option value="invoice_balance" <?php echo ($reportSettings->sort_by == "invoice_balance") ? "selected" : "" ?>>Balance</option>
                                                <option value="total_amount" <?php echo ($reportSettings->sort_by == "total_amount") ? "selected" : "" ?>>Total</option>
                                            </select>
