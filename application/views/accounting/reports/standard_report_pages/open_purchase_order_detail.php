                    ...
                    <div class="nsm-card primary">
                        ...
                        <div class="nsm-card-content">
                            ...
                            <div class="row mb-3">
                                <div class="col-lg-12">
                                    <?php
                                        $tableID = 'open_purchase_order_detail_table';
$reportCategory = 'open_purchase_order_details';
?>
                                    ...
                                    <div class="col-md-12">
                                        ...
                                        <div class="input-group">
                                            <select name="sort_by" id="sort-by" class="nsm-field form-select">
                                                <option value="created_at" <?php echo ($reportSettings->sort_by == 'created_at') ? 'selected' : ''; ?>>Created Date</option>
                                                <option value="updated_at" <?php echo ($reportSettings->sort_by == 'updated_at') ? 'selected' : ''; ?>>Last Modified</option>
                                            </select>
