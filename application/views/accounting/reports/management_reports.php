                            ...
                            <div class="accordion-item">
                                <h2 class="accordion-header">
                                    <button class="accordion-button content-title" type="button"
                                        ...
                                        data-bs-target="#collapse-management" aria-expanded="true"
                                        aria-controls="collapse-management">
                                        Reports
                                    </button>
                                </h2>
                                <div id="collapse-management" class="accordion-collapse collapse show">
                                    <div class="accordion-body">
                                        <div class="row">    
                                            <?php foreach ($managementReports as $reportType) { ?>                                              
                                                    ...
                                                    <li class="p-3 cursor-pointer">
                                                        ...
                                                        <div class="dropdown float-end d-inline-block"
                                                            ...
                                                            <ul class="dropdown-menu dropdown-menu-end">                                                                
                                                                <li><a class="dropdown-item btn-remove-management-reports" href="javascript:void(0);" data-name="<?= $reportType->name; ?>" data-id="<?= $reportType->id; ?>">Remove</a></li>
                                                            </ul>                                                            
                                                        </div>
                                                    </li>
                                                </ul>
...
$(function(){
    ...
    $('.btn-remove-management-reports').on('click', function(){
        var rid = $(this).attr('data-id');
        var report_name = $(this).attr('data-name');
        var url = base_url + 'accounting/reports/_remove_management_reports';

        Swal.fire({
            title: 'Management Reports',
            html: `Proceed with removing <b>${report_name}</b> report in management report list?`,
            icon: 'question',
                ...
                $.ajax({
                    ...
                    success: function(result) {
                        if( result.is_success == 1 ) {
                            ...
                            icon: 'success',
                            title: 'Success',
                            text: 'Report was successfully removed',
                            }).then((result) => {
