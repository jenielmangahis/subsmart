                                    ...
                                    <div class="row customer-details">
                                        ...
                                        <div class="col-md-3">
                                            <div class="form-group">
                                                ...
                                                <input type="text" name="delayed_credit_date" id="delayed-credit-date" class="form-control date" value="<?=isset($credit) ? date("m/d/Y", strtotime($credit->delayed_credit_date)) : date("m/d/Y")?>">
                                            </div>
                                        </div>
                                    </div>
