...
<?php else : ?>
<form onsubmit="updateTransaction(event, this)" id="modal-form" data-href="/accounting/update-transaction/delayed-credit/<?=$credit->id?>">
<?php endif; ?>
    <div id="delayedCreditModal" class="modal fade modal-fluid" role="dialog">
                        ...
                        <div class="col-6 d-flex align-items-center">
                            <div class="dropdown mr-1">
                                ...
                                <div class="dropdown-menu" style="width: 500px">
                                    ...
                                    <table class="table table-borderless table-hover cursor-pointer" id="recent-delayed-credits">
                                        <tbody></tbody>
                                    </table>
                                </div>
                            </div>
                        ...
                        <div class="col">
                            <div class="card p-0 m-0" style="min-height: 100%">
                                <div class="card-body" style="padding-bottom: 1.25rem">
                                    <div class="row">
                                        ...
                                        <div class="col-md-3">
                                            <div class="form-group">
                                                ...
                                                <input type="text" name="delayed_credit_date" id="delayed-credit-date" class="form-control date" value="<?=isset($credit) ? $credit->delayed_credit_date : date("m/d/Y")?>">
                                            </div>
                                        </div>
                                    </div>
                                    ...
                                    <div class="row">
                                        <div class="col-md-12">
                                            <div class="delayed-credit-item-table-container w-100">
                                                <div class="delayed-credit-item-table">
                                                    <table class="table table-bordered table-hover" id="delayed-credit-item-table">
                                                        <thead>
                                                            <th width="20%">NAME</th>
                                                            <th>TYPE</th>
                                                ...
                                                <div class="delayed-credit-item-table-footer">
                                                    <div class="row">
                                                        <div class="col-md-6">
                                            ...
                                            <div class="row">
                                                <div class="col-md-6">
                                                    <div class="form-group">
                                                        ...
                                                        <textarea name="memo" id="memo" class="form-control"><?=isset($credit) ? str_replace("<br />", "", $credit->memo) : ''?></textarea>
                                                    </div>
                                                </div>
                                                <div class="col-md-8">
