...
<?php else : ?>
<form onsubmit="updateTransaction(event, this)" id="modal-form" data-href="/accounting/vendors/<?=$vendorCredit->vendor_id?>/update-transaction/vendor-credit/<?=$vendorCredit->id?>">
<?php endif; ?>
        ...
        <div class="modal-dialog">
            ...
            <div class="modal-content" style="height: 100%;">
                <div class="modal-header" style="background: #f4f5f8;border-bottom: 0">
                    <h4 class="modal-title"><a href="#"><i class="fa fa-history fa-lg" style="margin-right: 10px"></i></a>Vendor Credit <span><?=isset($vendorCredit) ? "#$vendorCredit->ref_no" : ''?></span></h4>
