                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-md-2">
                                            <div class="form-group">
                                                ...
                                                <input type="text" name="sales_receipt_date" id="sales-receipt-date" class="form-control date" value="<?=isset($receipt) ? date("m/d/Y", strtotime($receipt->sales_receipt_date)) : date("m/d/Y")?>">
                                            ...
                                            <div class="row">
                                                ...
                                                <div class="col-md-8">
                                                    <div class="attachments">
                                                        ...
                                                        <div id="sales-receipt-attachments" class="dropzone" style="border: 1px solid #e1e2e3;background: #ffffff;width: 100%;">
