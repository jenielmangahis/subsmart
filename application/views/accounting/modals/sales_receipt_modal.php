...
<?php endif; ?>
    <div id="salesReceiptModal" class="modal fade modal-fluid" role="dialog">
                        ...
                        <div class="col-6 d-flex align-items-center">
                            <div class="dropdown mr-1">
                                ...
                                <div class="dropdown-menu" style="width: 500px">
                                    ...
                                    <table class="table table-borderless table-hover cursor-pointer" id="recent-sales-receipts">
                                        <tbody></tbody>
                                    </table>
                                </div>
                            </div>
                                ...
                                <div class="card-body" style="padding-bottom: 1.25rem">
                                    ...
                                    <div class="row">
                                        <div class="col-md-3">
                                            ...
                                            <div class="form-group">
                                                <label for="shipping-address">Shipping to</label>
                                                <textarea name="shipping_address" id="shipping-address" class="form-control"></textarea>
                                            </div>
                                        </div>
                                        <div class="col-md-6">
                                            <div class="row">
                                                <div class="col-md-3">
                                                    <div class="form-group">
                                                        ...
                                                        <input type="text" name="sales_receipt_date" id="sales-receipt-date" class="form-control date" <?=isset($receipt) ? "value='$receipt->sales_receipt_date'" : ''?>>
                                                        <a href="#" class="text-info" onclick="makeRecurring('sales_receipt')">Create recurring sale</a>
                                                    </div>
                                                </div>
                                            </div>
                                            <div class="row">
                                                <div class="col-md-3">
                                                    <div class="form-group">
                                                        ...
                                                        <input type="text" name="ship_via" id="ship-via" class="form-control" <?=isset($receipt) ? "value='$receipt->ship_via'" : ''?>>
                                                    </div>
                                                </div>
                                                <div class="col-md-3">
                                                    <div class="form-group">
                                                        <label for="shipping-date">Shipping date</label>
                                                        <input type="text" class="form-control date" name="shipping_date" id="shipping-date">
                                                    </div>
                                                </div>
                                                <div class="col-md-3">
                                                    <div class="form-group">
                                                        <label for="tracking-no">Tracking no.</label>
                                                        <input type="text" class="form-control" name="tracking_no" id="tracking-no">
                                                    </div>
                                                </div>
                                            </div>
                                            <div class="row">
                                    ...
                                    <div class="row">
                                        <div class="col-md-12">
                                            <div class="sales-receipt-item-table-container w-100">
                                                <div class="sales-receipt-item-table">
                                                    <table class="table table-bordered table-hover" id="sales-receipt-item-table">
                                                        <thead>
                                                            <th width="20%">NAME</th>
                                                            <th>TYPE</th>
