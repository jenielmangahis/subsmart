...
<div class="full-screen-modal">
    <div id="viewPrintCreditMemoModal" class="modal fade modal-fluid d-flex" role="dialog">
                ...
                <div class="modal-footer">
                    <div class="row w-100">
                        ...
                        <div class="col-md-4">
                            ...
                            <a href="/accounting/download-credit-memo-pdf/<?=$creditMemo->id?>" class="btn btn-secondary float-right mr-1" id="download-pdf">
                                Download
                            </a>
                        </div>
                    </div>
