                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-md-3">
                                            <div class="form-group">
                                                ...
                                                <input type="text" name="payment_date" id="payment_date" class="form-control date" value="<?=isset($expense) ? date("m/d/Y", strtotime($expense->payment_date)) : date("m/d/Y")?>" required>
                                            </div>
                                        </div>
                                        <div class="col-md-3">
                                            <div class="form-group">
