               ...
               <div class="modal-body" style="margin-bottom: 100px">
                  ...
                  <div class="row" style="margin-top: 20px">
                     <div class="col-md-3">
                        ...
                        <textarea name="mailing_address" id="mailing_address" cols="40" rows="4" placeholder="" style="resize: none;" class="form-control"></textarea>
                     </div>
                     <div class="col-md-3">
                  ...
                  <div class="form-group">
                     <div class="row">
                        <div class="col-md-4">
                           <div class="form-group">
                              <label for="">Memo</label>
                              <textarea name="name" id="checkMemo" cols="30" rows="3" placeholder="" style="width: 100%;resize: none;" class="form-control"></textarea>
                           </div>
                        </div>
                        <div class="col-md-4">
