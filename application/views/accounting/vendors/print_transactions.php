            ...
            <div>
                <table class="table table-bordered table-hover clickable" style="width: 100%; margin-bottom: 1rem; color: #212529;border-collapse: collapse; margin-top: 1rem;">
                    <tbody>
                        ...
                        <tr style="font-size: 13px">
                            <td>
                                <p><?=$transac['payeeName']?></p>
                                <?php if($transac['transaction']->payee_type === 'vendor') : ?>
                                    <?php if($transac['payee']->mail_add !== null && $transac['payee']->mail_add !== "") : ?>
                                    <p><?=$transac['payee']->street?></p>
                                    <?php endif; ?>
                                    <p><?=$transac['payee']->city !== null && $transac['payee']->city !== "" ? $transac['payee']->city.', ' : ""?><?=$transac['payee']->state !== null && $transac['payee']->state !== "" ? $transac['payee']->state.' ' : ""?><?=$transac['payee']->zip !== null && $transac['payee']->zip !== "" ? $transac['payee']->zip : ""?></p>
                                <?php elseif($transac['transaction']->payee_type === 'customer') : ?>
                                    <?php if($transac['payee']->mail_add !== null && $transac['payee']->mail_add !== "") : ?>
                                    <p><?=$transac['payee']->mail_add?></p>
                                    <?php endif; ?>
                                    <p><?=$transac['payee']->city !== null && $transac['payee']->city !== "" ? $transac['payee']->city.', ' : ""?><?=$transac['payee']->state !== null && $transac['payee']->state !== "" ? $transac['payee']->state.' ' : ""?><?=$transac['payee']->zip_code !== null && $transac['payee']->zip_code !== "" ? $transac['payee']->zip_code : ""?></p>
                                <?php else : ?>
                                    <?php if($transac['payee']->address !== null && $transac['payee']->address !== "") : ?>
                                    <p><?=$transac['payee']->address?></p>
                                    <?php endif; ?>
                                    <p><?=$transac['payee']->city !== null && $transac['payee']->city !== "" ? $transac['payee']->city.', ' : ""?><?=$transac['payee']->state !== null && $transac['payee']->state !== "" ? $transac['payee']->state.' ' : ""?><?=$transac['payee']->postal_code !== null && $transac['payee']->postal_code !== "" ? $transac['payee']->postal_code : ""?></p>
                                <?php endif; ?>
                            </td>
                            <td><strong>Reference No:</strong> <?=$transac['transaction']->ref_no?></td>
                        </tr>
                    </tbody>
                </table>
            </div>
                ...
                <table style="width: 100%; margin-bottom: 1rem; color: #212529;border-collapse: collapse; margin-top: 1rem">
                    <tbody>
                        <tr style="font-size: 13px">
                            ...
                            <td width="33.3%" style="padding: 5px"><strong>SHIP TO</strong></td>
