...
<form onsubmit="updateTransaction(event, this)" id="modal-form" data-href="/accounting/vendors/<?=$expense->payee_id?>/update-transaction/expense/<?=$expense->id?>">
                            ...
                            <div class="card p-0 m-0">
                                <div class="card-body" style="padding-bottom: 1.25rem">
                                    <div class="row">
                                        ...
                                        <div class="col-md-3">
                                            <div class="form-group">
                                                ...
                                                <input type="text" name="payment_date" id="payment_date" class="form-control date" value="<?=date("m/d/Y", strtotime($expense->payment_date))?>" required>
                                            </div>
                                        </div>
                                        <div class="col-md-3">
                                            <div class="form-group">
                                        ...
                                        <div class="col-md-2">
                                            <div class="form-group">
                                                ...
                                                <input type="text" name="ref_no" id="ref_no" class="form-control" value="<?=$expense->ref_no?>">
                                            </div>
                                        </div>
                                        <div class="col-md-8">
                                            <div class="form-group">
                                                ...
                                                <select name="tags[]" id="tags" class="form-control" multiple="multiple">
                                                    <?php if($expense->tags !== null && $expense->tags !== "") : ?>
                                                        <?php foreach(json_decode($expense->tags, true) as $tagId) : ?>
                                                            <?php 
                                    ...
                                    <div class="row">
                                            ...
                                            <div class="row">
                                                <div class="col-md-6">
                                                    <div class="form-group">
                                                        ...
                                                        <textarea name="memo" id="memo" class="form-control"><?=$expense->memo?></textarea>
                                                    </div>
                                                </div>
                                                <div class="col-md-8">
                                        ...
                                        <div class="col-md-6">
                                            <h5 class="m-0 text-right">Total : $<span class="transaction-total-amount"><?=number_format(floatval($expense->total_amount), 2, '.', ',')?></span></h5>
                                        </div>
                                    </div>
                                </div>
                            </div>
