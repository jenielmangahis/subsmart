                        ...
                        <div class="nsm-page-buttons page-button-container">
                            ...
                            <ul class="dropdown-menu dropdown-menu-end table-settings p-3">
                                ...
                                <div class="form-check">
                                    <input type="checkbox" checked="checked" name="address_chk" id="address_chk" class="form-check-input">
                                    <label for="address_chk" class="form-check-label">Address</label>
                                </div>
                                <div class="form-check">
                                    <input type="checkbox" checked="checked" name="attachments_chk" id="attachments_chk" class="form-check-input">
                                    <label for="attachments_chk" class="form-check-label">Attachments</label>
                                </div>
                                <div class="form-check">
                                    <input type="checkbox" checked="checked" name="phone_chk" id="phone_chk" class="form-check-input">
                                    <label for="phone_chk" class="form-check-label">Phone</label>
                                </div>
                                <div class="form-check">
                                    <input type="checkbox" checked="checked" name="email_chk" id="email_chk" class="form-check-input">
                                    <label for="email_chk" class="form-check-label">Bank Balance</label>
                                </div>
                                <p class="m-0">Other</p>
                                <div class="form-check">
