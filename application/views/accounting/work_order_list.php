                        ...
                        <table class="table table-hover table-to-list" data-id="work_orders">
                            ...
                            <tbody>
                                ...
                                <tr>
                                    <td>
                                        <div class="table-name">
                                            <div class="checkbox checkbox-sm">
                                                <input type="checkbox"
                                                    name="id[<?php echo $workorder->id ?>]"
                                                    value="<?php echo $workorder->id ?>"
                                                    class="select-one"
                                                    id="work_order_id_<?php echo $workorder->id ?>">
                                                <label
                                                    for="work_order_id_<?php echo $workorder->id ?>"></label>
                                            </div>
                                    ...
                                    <td>
                                        <a
                                            href="<?php echo base_url('customer/view/' . $workorder->customer_id) ?>">
                                            <?php //echo get_customer_by_id($workorder->customer_id)->contact_name
                                    ...
                                    <td><?php echo get_user_by_id($workorder->user_id)->name ?>
                                    </td>
                                    <td><?php echo ($workorder->priority_id > 0)?get_priority_by_id($workorder->priority_id)->title:'' ?>
                                    </td>
                                    <td><?php echo ($workorder->status_id > 0)?get_status_by_id($workorder->status_id)->title:''; ?>
                                    </td>
                                    <td class="text-right">
                                        <div class="dropdown dropdown-btn">
                                            <button class="btn btn-default dropdown-toggle" type="button"
                                                id="dropdown-edit" data-toggle="dropdown" aria-expanded="true">
                                            ...
                                            <ul class="dropdown-menu dropdown-menu-right" role="menu"
                                                ...
                                                <li role="presentation"><a role="menuitem" tabindex="-1" href="#"
                                                        data-toggle="modal" data-target="#modalCloneWorkorder"
                                                ...
                                                <li role="presentation"><a role="menuitem" tabindex="-1"
                                                        ...
                                                        data-name="WO-00433"><span class="fa fa-money icon"></span>
                                                        Create Invoice</a>
                                                </li>
                                                <li role="presentation"><a role="menuitem" tabindex="-1"
                                                        ...
                                                        data-name="WO-00433"><span class="fa fa-trash-o icon"></span>
                                                        Delete</a></li>
                                            </ul>
                                        </div>
                                    </td>
