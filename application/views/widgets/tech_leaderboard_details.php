<div class="col-lg-12">
    ...
    <div class="col-lg-12 float-left">
        <img title="<?= $tech->FName.' '.$tech->LName ?>" src="<?php echo userProfileImage($tech->id) ?>" alt="user" class="rounded-circle float-left mr-2" style="height: 50px;">
        ...
        <div class="float-right col-lg-2 no-padding mt-3"><?php echo ($tech->id==105?'1':0) ?> Jobs</div>
    </div>
    <?php endforeach ?>
</div>