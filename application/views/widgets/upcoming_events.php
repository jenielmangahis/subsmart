...
<div class="<?= $class ?>"  id="widget_<?= $id ?>">
    <div class="card" style="margin-top:0;">
        <div class="card-header" style="background: #1972c5; color:white;">
                    ...
                    foreach ($events as $jb) :
                        ...
                        <div class="mb-2 col-lg-12 float-left jobsRow" style="border-bottom: 1px solid #ccc; padding-bottom: 5px; cursor: pointer">
                            ...
                            <div class="col-lg-3 float-left no-padding text-center" style="border-right:1px solid #ccc; padding-right:5px;">
                                ...
                                <div class="job-status text-center mb-2" style="background:<?= $jb->event_color?>; color:white;"><?php echo strtoupper(event_status($jb->status)); ?></div>
                            ...
                            <div class="col-lg-7 float-left mt-2" style="padding-right: 0;">
                                <a href="<?php echo base_url('events/event_preview/' . $jb->id); ?>">
                                    <h6 style="font-weight:600; margin:0;font-size: 13px;"><?php echo $jb->event_number . ' : ' . $jb->event_type. ' - ' . $jb->event_tag; ?></h6>
                                    <small class="text-muted" ><?= $jb->event_address ?></small><br>
                                    <i> <small class="text-muted" ><?= $jb->event_description; ?></small></i>
                                    <a href="<?=$jb->url_link; ?>" target=""><small style="color: darkred;"><?=$jb->url_link; ?></small></a>
                                </a>
                            </div>
