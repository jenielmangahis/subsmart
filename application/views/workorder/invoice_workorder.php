              ...
              <div class="page-title-box pt-1 pb-0">
                  <div class="row align-items-center">
                      <div class="col-sm-12">
                          ...
                          <h3 style="font-family: Sarabun, sans-serif">Converting Invoice to New Work Orders</h3>
                            ...
                            <div class="select-wrap">
                                ...
                                <select id="sel-customer" name="customer_id" class="form-control m_select">
                                        ...
                                        <?php foreach($customers as $c){ ?>
                                            <option <?php if(isset($customers)){ if($c->prof_id == $invoice->customer_id){echo "selected";} } ?>  value="<?= $c->prof_id; ?>"><?= $c->contact_name . '' . $c->first_name . ' ' . $c->last_name; ?></option>
                                        <?php } ?>
                                    </select>
                                    <!-- </div> -->
                            </div>      
