    ...
    <div wrapper__section>
        ...
        <!-- <div style="background-color:#fdeac3; width:100%;padding:.5%;margin-bottom:5px;margin-top:5px;margin-bottom:10px;">
          ...
          <div class="card">
            ...
            <br> -->
            <?php echo form_open_multipart('workorder/updateWorkorderSolar', [ 'class' => 'form-validate', 'autocomplete' => 'off' ]); ?> 
                    <div class="row">
                                                    ...
                                                    <label for="lead_source">Lead Source</label>
                                                        <select id="lead_source" name="lead_source" class="form-control custom-select m_select">
                                                            ...
                                                            <?php foreach($lead_source as $lead){ ?>
                                                                <option value="<?php echo $lead->ls_id; ?>" <?php if($workorder->lead_source_id == $lead->ls_id){ echo "selected"; }else{ echo ''; } ?>><?php echo $lead->ls_name; ?></option>
                                                            <?php } ?>
                                                        </select>
                                                </div>    
                                            </div>   
                    ...
                    <div class="row leftangle">                   
                        <div class=" col-md-6 box-left-mini">
                            ...
                            <div class="behind_container" style="background-color:#ced4e4;margin-top:-20px;padding:20px;">
                                <div class="row"> 
                                    ...
                                    <input type="radio" name="tor" value="Asphalt Single" class="form-" <?php if($solars->tor == 'Asphalt Single'){ echo "checked"; }else{ echo ''; } ?>> Asphalt Single &emsp;
                                    <input type="radio" name="tor" value="Flat" class="form-" <?php if($solars->tor == 'Flat'){ echo "checked"; }else{ echo ''; } ?>> Flat &emsp;
                                    <input type="radio" name="tor" value="Concrete Tile" class="form-" <?php if($solars->tor == 'Concrete Tile'){ echo "checked"; }else{ echo ''; } ?>> Concrete Tile &emsp; <br>
                                    <input type="radio" name="tor" value="Clay Tile" class="form-" <?php if($solars->tor == 'Clay Tile'){ echo "checked"; }else{ echo ''; } ?>> Clay Tile &emsp;
                                    <input type="radio" name="tor" value="Steel Single" class="form-" <?php if($solars->tor == 'Steel Single'){ echo "checked"; }else{ echo ''; } ?>> Steel Single &emsp;
                                    <input type="radio" name="tor" value="Metal" class="form-" <?php if($solars->tor == 'Metal'){ echo "checked"; }else{ echo ''; } ?>> Metal
                                    <br><br><hr>
                                    </div>
                                </div>
                                <div class="row"> 
                                    ...
                                    <input type="text" name="sfoh" class="form-control" value="<?php echo $solars->sfoh; ?>">
                                    <br><hr>
                                    </div>
                                </div>
                                <div class="row"> 
                                    ...
                                    <input type="radio" name="aor" value="0-5" class="form-" <?php if($solars->aor == '0-5'){ echo "checked"; }else{ echo ''; } ?>> 0-5 &emsp;
                                    <input type="radio" name="aor" value="5-10" class="form-" <?php if($solars->aor == '5-10'){ echo "checked"; }else{ echo ''; } ?>> 5-10 &emsp;
                                    <input type="radio" name="aor" value="10-15" class="form-" <?php if($solars->aor == '10-15'){ echo "checked"; }else{ echo ''; } ?>> 10-15 &emsp;
                                    <input type="radio" name="aor" value="15-20" class="form-" <?php if($solars->aor == '15-20'){ echo "checked"; }else{ echo ''; } ?>> 15-20
                                    <br><br><hr>
                                    </div>
                                </div>
                                <div class="row"> 
                                    ...
                                    <input type="radio" name="spmp" value="Front Only" class="form-" <?php if($solars->spmp == 'Front Only'){ echo "checked"; }else{ echo ''; } ?>> Front Only &emsp;
                                    <input type="radio" name="spmp" value="Back Only" class="form-" <?php if($solars->spmp == 'Back Only'){ echo "checked"; }else{ echo ''; } ?>> Back Only &emsp;
                                    <input type="radio" name="spmp" value="Side Only" class="form-" <?php if($solars->spmp == 'Side Only'){ echo "checked"; }else{ echo ''; } ?>> Side Only  <br>
                                    <input type="radio" name="spmp" value="No Preference" class="form-" <?php if($solars->spmp == 'No Preference'){ echo "checked"; }else{ echo ''; } ?>> No Preference &emsp;
                                    <input type="radio" name="spmp" value="Other" class="form-" <?php if($solars->spmp == 'Other'){ echo "checked"; }else{ echo ''; } ?>> Other
                                    <br><br><hr>
                                    </div>
                                </div>
                                <div class="row"> 
                                    ...
                                    <input type="radio" name="hoa" value="Yes" class="form-" <?php if($solars->hoa == 'Yes'){ echo "checked"; }else{ echo ''; } ?>> Yes &emsp;
                                    <input type="radio" name="hoa" value="No" class="form-" <?php if($solars->hoa == 'No'){ echo "checked"; }else{ echo ''; } ?>> No &emsp;
                                    <br>
                                    <b>If Yes: Contact Name/Number</b>
                                    <input type="text" name="hoa_text" class="form-control" value="<?php echo $solars->hoa_text; ?>">
                                    <br><hr>
                                    </div>
                                </div>
                                <div class="row"> 
                                    ...
                                    <div class="col-md-10">
                                        <div style="float:right;" class="estbill">
                                            ...
                                            <input type="number" name="estimated_bill" class="form-control" aria-label="Amount" value="<?php echo $solars->estimated_bill; ?>">
                                    ...
                                    <input type="radio" name="ebis" value="Yes" class="form-" <?php if($solars->ebis == 'Yes'){ echo "checked"; }else{ echo ''; } ?>> Yes &emsp;
                                    <input type="radio" name="ebis" value="No" class="form-" <?php if($solars->ebis == 'No'){ echo "checked"; }else{ echo ''; } ?>> No &emsp;
                                    <br>
                                    <h6>How do you get your Invoice</h6>
                                    <input type="radio" name="hdygi" value="Paper" class="form-" <?php if($solars->hdygi == 'Paper'){ echo "checked"; }else{ echo ''; } ?>> Paper &emsp;
                                    <input type="radio" name="hdygi" value="Paperless" class="form-" <?php if($solars->hdygi == 'Paperless'){ echo "checked"; }else{ echo ''; } ?>> Paperless &emsp;
                                    ...
                                    <input type="text" name="eba_text" class="form-control" value="<?php echo $solars->eba_text; ?>">
                                    <br><hr>
                                    </div>
                                </div>
                                <div class="row" style="margin-bottom:70px;"> 
                                    ...
                                    <input type="radio" name="es" value="Employed" class="form-" <?php if($solars->es == 'Employed'){ echo "checked"; }else{ echo ''; } ?>> Employed &emsp;
                                    <input type="radio" name="es" value="Unemployed" class="form-" <?php if($solars->es == 'Unemployed'){ echo "checked"; }else{ echo ''; } ?>> Unemployed &emsp;
                                    <input type="radio" name="es" value="Retired" class="form-" <?php if($solars->es == 'Retired'){ echo "checked"; }else{ echo ''; } ?>> Retired <br>
                                    <input type="radio" name="es" value="Retired with Income" class="form-" <?php if($solars->es == 'Retired with Income'){ echo "checked"; }else{ echo ''; } ?>> Retired with Income
                                    <!-- <hr> -->
                                    </div>
                                </div>
                            </div>
                        ...
                        <div class=" col-md-6">
                            ...
                            <br>
                                <div class="row"> 
                                    <div class="col-md-6">
                                        <input type="text" name="firstname" id="firstname" value="<?php echo $customers->first_name; ?>" class="form-control border-top-0 border-right-0 border-left-0" onkeyup="primaryName()">
                                        <b>First name:</b>
                                    </div>
                                    <div class="col-md-6">
                                        <input type="text" name="lastname" id="lastname" value="<?php echo $customers->last_name; ?>" class="form-control border-top-0 border-right-0 border-left-0" onkeyup="primaryName()">
                                        <b>Last name:</b>
                                    </div>
                                </div>
                                <div class="row"> 
                                    <div class="col-md-12">
                                        <input type="text" name="address" value="<?php echo $customers->mail_add; ?>" class="form-control border-top-0 border-right-0 border-left-0">
                                        <b>Address:</b>
                                    </div>
                                </div>
                                <div class="row"> 
                                    <div class="col-md-5">
                                        <input type="text" name="city" value="<?php echo $customers->city; ?>" class="form-control border-top-0 border-right-0 border-left-0">
                                        <b>City:</b>
                                    </div>
                                    <div class="col-md-7">
                                        <input type="text" name="country" value="<?php echo $customers->country; ?>" class="form-control border-top-0 border-right-0 border-left-0">
                                        <b>County:</b>
                                    </div>
                                </div>
                                <div class="row"> 
                                    <div class="col-md-12">
                                        <input type="text" name="postcode" value="<?php echo $customers->zip_code; ?>" class="form-control border-top-0 border-right-0 border-left-0">
                                        <b>Postcode:</b>
                                    </div>
                                </div>
                                <div class="row"> 
                                    <div class="col-md-12">
                                        <input type="text" name="phone" value="<?php echo $customers->phone_h; ?>" class="form-control border-top-0 border-right-0 border-left-0">
                                        <b>Phone:</b>
                                    </div>
                                </div>
                                <div class="row"> 
                                    <div class="col-md-12">
                                        <input type="text" name="mobile" value="<?php echo $customers->phone_m; ?>" class="form-control border-top-0 border-right-0 border-left-0">
                                        <b>Mobile:</b>
                                    </div>
                                </div>
                                <div class="row"> 
                                    <div class="col-md-12">
                                        <input type="text" name="email" value="<?php echo $customers->email; ?>" class="form-control border-top-0 border-right-0 border-left-0">
                                        <b>Email:</b>
                                    </div>
                                </div>
                                <div class="row"> 
                                    <div class="col-md-12">
                                        <input type="text" name="comments" value="<?php echo $workorder->comments; ?>" class="form-control border-top-0 border-right-0 border-left-0">
                                        <b>Comments:</b>
                                    </div>
                                </div>
                                <br>
                    ...
                    <div class="row">                   
                        ...
                        <input type="hidden" name="payment_method_value" id="payment_method_value" value="<?php echo $workorder->payment_method; ?>">
                            ...
                            <div class="form-group col-md-4">
                                ...
                                <input type="text" class="form-control input-element" name="payment_amount" id="payment_amount" value="<?php echo $workorder->payment_amount; ?>" />
                            </div>
                    </div>
                    ...
                    <br><br>
                            ...
                            <div>
                                <div class="form-group lawas">
                                        <button type="submit" name="action" class="btn btn-flat btn-primary" value="submit">Update</button>
