                ...
                <div class="box">
                    ...
                    <div class="page-title-box">
                        <div class="row align-items-center">
                            <div class="col-sm-6">
                                <h1 class="page-title">Edit priority</h1>
                                <ol class="breadcrumb">
                                    <li class="breadcrumb-item active">Update priority details.</li>
                                </ol>
                            </div>
                            <div class="col-sm-6">
                                <div class="float-right d-none d-md-block">
                                    <div class="dropdown">
                                        <a href="<?php echo url('workorder/priority') ?>" class="btn btn-primary"
                                           aria-expanded="false">
                                            <i class="mdi mdi-settings mr-2"></i> Go Back to Priority
                                        </a>
                                    </div>
                                </div>
                            </div>
                                        ...
                                        <div class="col-sm-6">
                                            <div class="form-group">
                                                ...
                                                <input type="text" class="form-control"
                                                       name="title"
                                                       id="title"
                                                       value="<?php echo (!empty($priority)) ? $priority->title : '' ?>"
                                                       required
