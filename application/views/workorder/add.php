                            ...
                            <div class="row align-items-center pt-3 bg-white">
                                <div class="col-md-12">
                                    ...
                                    <div class="banking-tab-container">
                                        <div class="rb-01">
                                            <ul class="nav nav-tabs border-0">
                                                <li class="nav-item">
                                                    <a class="h6 mb-0 nav-link banking-sub-tab active" data-toggle="tab" href="#basic">Basic Work Order</a>
                                                </li>
                                                <li class="nav-item">
                                                    <a class="h6 mb-0 nav-link banking-sub-tab" data-toggle="tab" href="#advance1">Advance Work Order 1</a>
                                                </li>
                                                <li class="nav-item">
                                                    <a class="h6 mb-0 nav-link banking-sub-tab" data-toggle="tab" href="#advance2">Advance Work Order 2</a>
                                                </li>
                                            </ul>
                                        </div>
                                    </div>
                                    <div class="tab-content mt-4" >
                                        ...
                                        <div class="tab-pane fade standard-accordion" id="advance1">
                                            <div class="col-sm-12">
                                                <h3 class="page-title">Advance Work Order 1</h3>
                                            </div>
                                                                ...
                                                                <div class=" col-md-6">
                                                                    ...
                                                                    <div class="sigPad" id="smoothed" style="width:404px;">
                                                                        ...
                                                                        <div class="sig sigWrapper" style="height:auto;">
                                                                            <div class="typed"></div>
                                                                            <canvas class="pad" id="company_representative_approval_signaturesdf"
                                        ...
                                        <div class="tab-pane standard-accordion" id="advance2">
                                            <div class="col-sm-6">
                                                <h3 class="page-title">Advance Work Order 2</h3>
                                            </div>
                                                        <?php echo form_open_multipart('workorder/save', ['class' => 'form-validate require-validation', 'id' => 'workorder_form', 'autocomplete' => 'off']); ?>
