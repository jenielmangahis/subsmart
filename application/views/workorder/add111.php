               ...
               <div class="card-body">
                  ...
                  <div class="row">
                     ...
                     <div class="col-md-4 form-group">
                        ...
                        <input type="text" class="form-control" name="contact_pwd" id="contact_pwd" min="4" placeholder="Enter (4 to 10 Letters password)" required/>
                     </div>
                     <div class="col-md-4 form-group">
                  ...
                  <div class="row">
                     <div class="col-md-3 form-group">
                        ...
                        <input type="text" class="form-control" name="contact_dob" id="contact_dob" placeholder="Enter DOB"/>
                     </div>
                     <div class="col-md-3 form-group">
                  ...
                  <div class="row">
                     ...
                     <div class="col-md-9 form-group">
                        ...
                        <label class="checkbox-inline">
                        <input type="checkbox" name="plan_type[]" value="Basic Interactive">Basic Interactive
                        </label>
                        <label class="checkbox-inline">
                        <input type="checkbox" name="plan_type[]" value="Interactive Automation">Interactive Automation
                        </label>
                        <label class="checkbox-inline">
                        <input type="checkbox" name="plan_type[]" value="Interactive Pro Video">Interactive Pro Video
                        </label>						
                     </div>
                  </div>
                  <div class="row">
                     <div class="col-md-2 form-group">
                        ...
                        <br/><input type="checkbox" name="ip_cam[]" value="Honeywell">Honeywell  WO  WI
                        <br/><input type="checkbox" name="ip_cam[]" value="Alarm.com">Alarm.com  WO  WI
                     </div>
                     <div class="col-md-2 form-group">
                        <label for=""> DVR:</label>
                        <br/><input type="checkbox" name="chk_dvr[]" value="Honeywell/AVYCON">Honeywell/AVYCON
                        <br/><input type="checkbox" name="chk_dvr[]" value="Other">Other
                     </div>
                     <div class="col-md-4 form-group">
                     ...
                     <div class="col-md-2 form-group">
                        ...
                        <br/><input type="checkbox" name="thermostat[]" value="Honeywell">Honeywell
                        <br/><input type="checkbox" name="thermostat[]" value="Alarm.com">Alarm.com
                     </div>
                     <div class="col-md-2 form-group">
                        <label for=""> Doorbell CAM:</label>
                        <br/><input type="checkbox" name="doorbell_cam[]" value="Honeywell">Honeywell
                        <br/><input type="checkbox" name="[]" value="Alarm.com">Alarm.com
                     </div>
                  </div>
                  <div class="row">
                     <div class=" col-md-4">
                        <label for="inst_date"> Installation Date:</label>
                        <input type="text" class="form-control" name="inst_date" id="inst_date" placeholder=""/>
                        <br/>
                            Install Time: <input type="checkbox" name="inst_time[]" value="8-10">8-10   
                            <input type="checkbox" name="inst_time[]" value="10-12">10-12  
                            <input type="checkbox" name="inst_time[]" value="12-2">12-2 
                            <input type="checkbox" name="inst_time[]" value="2-4">2-4 
                            <input type="checkbox" name="inst_time[]" value="4-6">4-6 
                            <input type="checkbox" name="inst_time[]" value="Firm">Firm
                     </div>
                     <div class="col-md-6">
                  ...
                  <div class="row">
                     <div class="col-md-12 form-group">                         
                        ...
                        <label class="checkbox-inline">
                        <input type="checkbox" name="chk_enhance_pers[]" value="PERS w/Fall Detec">PERS w/Fall Detec
                        </label>  
                     </div>
                  </div>
                  <div class="row">
                  ...
                  <div class="row">
                     ...
                     <div class=" col-md-12">
                        Credit Card Type: <input type="radio" name="radio_credit_card" value="Visa">Visa
                        <input type="radio" name="radio_credit_card" value="Amex">Amex
                        <input type="radio" name="radio_credit_card" value="Mastercard">Mastercard
                        <input type="radio" name="radio_credit_card" value="Discover">Discover
                     </div>
                     <div class=" col-md-6">
                        <div class="row">
                           <div class=" col-md-6">
                           ...
                           <div class=" col-md-3">
                              ...
                              <input type="text" class="form-control" name="exp_date" id="exp_date" placeholder=""/>
                           </div>
                           <div class=" col-md-3">
                  ...
                  <div class="row">
                     ...
                     <div class=" col-md-4">
                        <input type="text" class="form-control" name="cancel_custome_sign" id="cancel_custome_sign" placeholder=""/>
                        <label for="">COSTOMER SIGNATURE </label>
                     </div>
                     <div class=" col-md-4">
                        <input type="text" class="form-control" name="cancel_trans_date" id="cancel_trans_date" placeholder=""/>
                        <label for="">DATE </label>
                     </div>
                     <div class=" col-md-4">
                        <input type="text" class="form-control" name="cancel_customer_name" id="cancel_customer_name" placeholder=""/>
                        <label for="">CUSTOMER’S NAME </label>
                     </div>
                     <div class=" col-md-4">
                        <input type="text" class="form-control" name="cancel_customer_address" id="cancel_customer_address" placeholder=""/>
                        <label for="">CUSTOMER’S ADDRESS</label>
                     </div>
                     <div class=" col-md-4">
                        <input type="text" class="form-control" name="cancel_customer_phone" id="cancel_customer_phone" placeholder=""/>
