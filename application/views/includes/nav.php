        ...
        <div id="navigation">
            ...
            <ul class="navigation-menu d-flex justify-content-center">
                ...
                <?php if (hasPermissions('report')): ?>
                    <li class="has-submenu"><a href="<?php echo url('reports/main') ?>"><i class="fa fa-bookmark"
                ...
                <li class="has-submenu">
                    ...
                    <div class="dropdown-menu dropdown-menu-right profile-dropdown">
                        ...
                        <a class="dropdown-item" href="<?php echo base_url('/company') ?>"><i
                                    class="mdi mdi-wallet m-r-5"></i> My Tools</a>
                        <a class="dropdown-item" href="<?php echo base_url('esign') ?>"><i
                                    class="mdi mdi-wallet m-r-5"></i> eSign</a>
                        <a class="dropdown-item" href="<?php echo base_url('/users') ?>"><i
                                    class="mdi mdi-wallet m-r-5"></i> Affiliates</a>
                        <a class="dropdown-item" href="<?php //echo base_url('dashboard/blank/?page=Add-ons') ?>"><i
                                    class="mdi mdi-wallet m-r-5"></i> Inventory</a>
                    </div>
                </li>
