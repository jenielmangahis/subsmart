...
<nav class="navbar-side d-none d-md-block">
    <ul class="nav">
        ...
        <li class="submenus active"><a href="<?php echo base_url('inventory') ?>" title="My Customers" style="color: #fff;"><i class="fa fa-address-card-o" aria-hidden="true"></i> My Inventory</a></li>
    </ul>
</nav>