...
<nav class="navbar-side d-none d-md-block">
    <ul class="nav">
        ...
        ?>
        <li class="submenus <?= $is_active_plans; ?>"><a href="<?php echo base_url('admin/nsmart_plans') ?>" title="Plans" style="color: #fff;">
            <span class="fa fa-cubes"></span>Plans</a>
        </li>

        <li class="submenus <?= $is_active_features; ?>"><a href="<?php echo base_url('admin/nsmart_features') ?>" title="Features" style="color: #fff;">
        ...
        <li class="submenus <?= $is_active_industry_module; ?>"><a href="<?php echo base_url('admin/industry_modules') ?>" title="Industry Modules" style="color: #fff;">
