...
<nav class="navbar-side d-none d-md-block">
    <ul class="nav">
        ...
        <li class="nav-header">Before After</li>
        <li class="submenus active"><a href="<?php echo base_url('before-after/main') ?>" title="Job List" style="color: #fff;"><i class="fa fa-user" aria-hidden="true"></i> Before After</a></li>
    </ul>
</nav>