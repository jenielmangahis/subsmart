...
<nav class="navbar-side d-none d-md-block">
    <ul class="nav">
        ...
        <li class="submenus <?php if($this->uri->segment(2) == "index" || ($this->uri->segment(1) == "customer" && $this->uri->segment(2) == "") ) {echo "active";} ?> "><a href="<?php echo base_url('customer') ?>" title="My Customers" style="color: #fff;"><span
