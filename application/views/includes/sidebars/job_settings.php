...
<nav class="navbar-side d-none d-md-block">
    <ul class="nav">
        ...
        <li class="submenus active"><a href="<?php echo base_url('job/settings') ?>" title="My Job Prefix" style="color: #fff;"><i class="fa fa-address-card-o" aria-hidden="true"></i> Prefixes</a></li>
        <li class="submenus"><a href="<?php echo base_url('job/job_types') ?>" title="My Job Types" style="color: #fff;"><i class="fa fa-list" aria-hidden="true"></i> Job Types</a></li>
        <li class="submenus"><a href="<?php echo base_url('job') ?>" title="My Cutom Fields" style="color: #fff;"><i class="fa fa-magic" aria-hidden="true"></i> Custom Fields</a></li>
    </ul>   
</nav>