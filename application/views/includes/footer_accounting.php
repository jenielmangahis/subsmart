...
<script src="<?php echo $url->assets ?>plugins/select2/dist/js/select2.full.js">
</script>
<script
	...
	function appendFavoriteReports() {
		...
		for (var x = 0; x < favoriteReports.length; x++) {
			...
			reports = '<li class="border-bottom p-3 cursor-pointer">' +
				'<a href="' + favoriteReports[x][1] + '" class="h5 mb-0 font-weight-normal">' + favoriteReports[x][0] +
				'</a>' +
				...
				'</div>' +
				'<a href="#" onclick="removeFavoriteReports(' + x +
				')" class="pr-4 text-secondary h6 pull-right"><i class="fa fa-star fa-lg"></i></a>' +
				'</li>';
