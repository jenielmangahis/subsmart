            ...
            <ul class="navigation-menu d-flex justify-content-center">
                ...
                <li class="has-submenu">
                    ...
                    <div class="dropdown-menu dropdown-menu-right">
                        ...
                        <a class="dropdown-item" href="<?php echo base_url('admin/job') ?>"><i class="fa fa-briefcase"></i> Jobs</a>
...
<!--                            <img class="cash-static" src="<?php echo base_url('assets/css/icons/images/cash-1.1s-47px.svg') ?>" alt="" style="margin: 0 auto">
                ...
                <li class="has-submenu">
                    ...
                    <div class="dropdown-menu dropdown-menu-right profile-dropdown">
                        ...
                        <a class="dropdown-item" href="<?php echo url('/admin/companies') ?>">
                            <i class="mdi mdi-wallet m-r-5"></i><b> List </b>
                        </a>
