            ...
            <div class="container-fluid">
                            ...
                            <!--                                <li class="dropdown notification-list list-inline-item ml-auto" style="vertical-align: middle">
                                                                    ...
                                                                    <div class="plus-icon-container">
                                                                        <a href="javascript:void (0)">
                                                                            <img class="plus-icon-static" src="<?php echo $url->assets; ?>/css/icons/images/add-1.1s-47px.svg"
                            alt="">
                            <img class="plus-icon-hover"
                                src="<?php echo $url->assets; ?>/css/icons/images/add-1.1s-47px%20(2).svg"
                                alt="">
                            </a>
                    </div>
                    </li>-->
                    <!--                            <li title="SMS" class="dropdown notification-list list-inline-item ml-auto" style="vertical-align: middle">
                                <div class="conversation-icon-container dropdown-toggle" data-toggle="dropdown" role="button" aria-haspopup="false" aria-expanded="false">
                                    <a href="#" onclick="$('#createSMS').modal('show')">
                                        <img class="conversation-icon-static" src="<?php echo $url->assets; ?>/css/icons/sms.svg"
                    alt="">
                    <img class="conversation-icon-hover"
                        src="<?php echo $url->assets; ?>/css/icons/sms.svg"
                        alt="">
                    </a>
                    <a class="nav-link dropdown-toggle arrow-none" data-toggle="dropdown" href="index.html#"
                        role="button" aria-haspopup="false" aria-expanded="false">

                    </a>
                </div>
                </li>
                <li title="Call" class="dropdown notification-list list-inline-item ml-auto"
                    style="vertical-align: middle">
                    <div class="conversation-icon-container dropdown-toggle" data-toggle="dropdown" role="button"
                        aria-haspopup="false" aria-expanded="false">
                        <a href="javascript:void (0)">
                            <img class="conversation-icon-static"
                                src="<?php echo $url->assets; ?>/css/icons/support.svg"
                                alt="">
                            <img class="conversation-icon-hover"
                                src="<?php echo $url->assets; ?>/css/icons/support.svg"
                                alt="">
                ...
                <li title="Tasks" class="dropdown notification-list list-inline-item ml-auto"
                    ...
                    <div class="schedule-icon-container dropdown-toggle" data-toggle="dropdown" role="button"
                        aria-haspopup="false" aria-expanded="false">
                        <span class="badge badge-pill badge-danger noti-icon-badge notify-badge"
                            style="visibility: <?php echo (count($newtasks) > 0) ? 'visible' : 'hidden'; ?>;z-index: 20;top: 1px;right: 0;"
                            id="scheduleBadge"><?php echo (count($newtasks) != 0) ? count($newtasks) : null; ?></span>

                        <img class="schedule-icon-static"
                            src="<?php echo $url->assets; ?>/css/icons/tasks.svg"
                            alt="">
                        <img class="schedule-icon-hover"
                            src="<?php echo $url->assets; ?>/css/icons/tasks.svg"
                            alt="">
                    </div>
                    ...
                    <div class="dropdown-menu dropdown-menu-right dropdown-menu-lg">
                        ...
                        <div class="slimscroll notification-item-list">
                            ...
                            <a href="<?php echo base_url('taskhub/view/' . $value->task_id); ?>"
                                class="dropdown-item notify-item active">
                                <div class="notify-icon bg-success"></div>
                                <p class="notify-details"><?php echo $value->subject; ?><span
                                        class="text-muted">
                                        <?php
                ...
                <li class="dropdown notification-list list-inline-item ml-auto" style="vertical-align: middle">
                    ...
                    <!--</span>-->
                    <!--                                </a>-->
                    <div class="wrapper-bell dropdown-toggle" data-toggle="dropdown" role="button" aria-haspopup="false"
                        aria-expanded="false">
                        <span class="badge badge-pill badge-danger noti-icon-badge notify-badge"
                            style="visibility: visible; z-index: 20;width:auto; top: -4px;right: 3px; display:none;"
                            id="notifyBadge"> <?php //echo (getNotificationCount() != 0) ? getNotificationCount() : null;
                                                                                                                                                                                                                        ?>
                        </span>

                        <div class="bell" onclick='bell_acknowledged()'>
                            <div class="anchor-bell material-icons layer-1"
                                style="animation:<?php echo (getNotificationCount() != 0) ? 'animation-layer-1 5000ms infinite' : 'unset' ?>">
                                notifications_active</div>
                            <div class="anchor-bell material-icons layer-2"
                                style="animation:<?php echo (getNotificationCount() != 0) ? 'animation-layer-2 5000ms infinite' : 'unset' ?>">
                                notifications</div>
                            <div class="anchor-bell material-icons layer-3"
                                style="animation:<?php echo (getNotificationCount() != 0) ? 'animation-layer-3 5000ms infinite' : 'unset' ?>">
                                notifications</div>
                        </div>
                    </div>
                    ...
                    <div class="dropdown-menu dropdown-menu-right dropdown-menu-lg">
                        ...
                        <div class="slimscroll notification-item-list" id="notificationList">
                            <div id="autoNotifications">
                                <a href="#" id="notificationDP" data-id="416&quot;"
                                    class="dropdown-item notify-item active" style="background-color:#e6e3e3">
                                    <p class="notify-details" style="margin-left: 50px;"><span class="text-muted">No new
                            ...
                            <!-- <a href="javascript:void(0);" class="dropdown-item notify-item active">
                                            ...
                                            <p class="notify-details">Item needs to reorder (<?php echo $reorders_count; ?>)<span
                                class="text-muted">Please replenish immediately.</span></p>
                            </a> -->
                ...
                <li class="dropdown notification-list list-inline-item ml-auto"
                    ...
                    <!--                     lou       <input type="hidden" id="clock-end-time" value="--><?php //echo ($expected_endbreak)?$expected_endbreak:null;
                                                                                                                        ?>
                    <!--">-->
                    <input type="hidden" id="clockedin_date_time"
                        value="<?= $checkin_date_time ?>">
                    <input type="hidden" id="attendance_status"
                        value="<?= $attendance_status ?>">
                    <input type="hidden" id="overtime_status_acknowledgement"
                        value="<?= $overtime_status_acknowledgement ?>">
                    <input type="hidden" id="break_duration_for_auto_out"
                        value="<?= $break_duration_for_auto_out ?>">
                    <input type="hidden" id="lunchStartTime"
                        value="<?php echo $lunch_in; ?>"
                        data-value="<?php echo date('h:i A', $lunch_in) ?>">
                    <input type="hidden" id="latestLunchTime"
                        value="<?php echo $latest_lunch_in; ?>"
                        data-value="<?php echo date('h:i A', $latest_lunch_in) ?>">
                    <input type="hidden" id="clock-status"
                        value="<?php echo ($analog_active == 'clock-break') ? 1 : 0; ?>">
                    <input type="hidden" id="attendanceId"
                        value="<?php echo $attn_id; ?>">
                    <input type="hidden" id="employeeShiftStart"
                        value="<?php echo (!empty($expected_shift)) ? $expected_shift : 0; ?>">
                    <input type="hidden" id="employeePingStart"
                        value="<?php echo $sched_notify; ?>">
                    <input type="hidden" id="employeePingEnd"
                        value="<?php echo $over_notify; ?>">
                    <input type="hidden" id="employeeOvertime"
                        value="<?php echo $expected_endshift; ?>">
                    <input type="hidden" id="timeDifference"
                        value="<?php echo $time_difference; ?>">
                    <input type="hidden" id="unScheduledShift"
                        value="<?php echo $shift_end; ?>"
                        data-value="<?php echo date('h:i A', $shift_end) ?>">
                    ...
                    <div class="preview-clock-details">
                        ...
                        <div class="clock-section">
                            ...
                            <span
                                style="display: block;float: right;width: 50%;color: grey; font-size: 10px">(HH:MM)</span>
                        </div>
                    </div>
                </li>
