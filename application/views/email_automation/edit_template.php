...
<div class="wrapper" role="wrapper">
    ...
    <div wrapper__section>
        <div class="container-fluid p-40">
            ...
            <input type="hidden" name="tid" value="<?= $emailTemplate->id; ?>">
            <div class="row">
                <div class="col-xl-12">
                    <div class="card mt-0">
                        ...
                        <div class="card-body">
                            <div class="row">
                                <div class="col-md-8 form-group">
                                    ...
                                    <input type="text" class="form-control" name="name" id="" value="<?= $emailTemplate->name; ?>" required placeholder="" autofocus/>
                                </div>
                            </div>
                              ...
                              <div class="col-md-8">
                                  <div class="row">
                                    <div class="col-md-12 form-group">
                                        ...
                                        <input type="text" class="form-control" name="email_subject" value="<?= $emailTemplate->email_subject; ?>" id="email_subject" required placeholder="" autofocus/>
                                    </div>

                                    <div class="col-md-12 form-group">
                                        <label for="formClient-Name">Email Body</label>
                                        <textarea name="email_body" cols="40" rows="30"  class="form-control" id="email_body" autocomplete="off"><?= $emailTemplate->email_body; ?></textarea>
                                    </div>
                                  </div>                                  
                              </div>
                            </div>
