...
<div class="form-group">
  ...
  <textarea name="email_body" id="automation_email_body_create" cols="40" rows="5" class="email-body-create form-control"><?php echo $email_automation->email_body; ?></textarea>
</div>
