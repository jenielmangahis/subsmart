                        ...
                        <div class="card-body hid-desk pt-0" style="padding-bottom:0px; padding-left:0px; padding-right:0px;">
                            <div class="row margin-bottom-ter mb-2 align-items-center" style="background-color:white; padding:0px;">
                                <div class="col-auto pl-0">
                                    <h5 class="page-title pt-0 mb-0 mt-0" style="position:relative;top:2px;">Event Types</h5>
                                </div>
                        ...
                        <div class="pl-3 pr-3 mt-0 row">
                          <div class="col mb-4 left alert alert-warning mt-0 mb-2">
                              <span style="color:black;font-family: 'Open Sans',sans-serif !important;font-weight:300 !important;font-size: 14px;">
                                  Event types can be separated into seminars, conference, trade show, work shop, corporate, private, or charity.
                                  Event types can also be track for categories where an invoice will not be submit like estimates, tasks, demos and reminders.
                                  With our Crm you can choose, create or delete the appropriate classification for your business model.
                              </span>
                          </div>
                        </div>
                            ...
                            <div class="tab-pan" id="tab1">
                                ...
                                <table class="table table-bordered table-striped" id="jobTypeTable">
                                    ...
                                    <?php if(!empty($event_types)): ?>
                                        <?php foreach($event_types as $types) : ?>
                                            <tr>
...
<script>
    $(document).ready(function () {
        ...
        $("#form_add_tag").submit(function(e) {
            ...
            $.ajax({
                type: "POST",
                url: "<?= base_url(); ?>events/add_job_type",
        ...
        $(".delete_tags").on( "click", function( event ) {
            ...
            Swal.fire({
                ...
                if (result.value) {
                    $.ajax({
                        type: "POST",
                        url: "<?= base_url(); ?>events/delete_job_type",
