                ...
                <div class="col-md-4">
                    <div class="card">
                        <div class="card-body">
                            ...
                            <hr>
                            <a href="#" data-toggle="modal" data-target="#share_job_modal" data-backdrop="static" data-keyboard="false" class="btn btn-primary pull-right text-link"> <span class="fa fa-plus"></span> Share Event</a>
                        </div>
                        <br>
                    </div>
