                    ...
                    <div class="card mt-0" style="min-height: 400px !important;">
                        <div class="row">
                          <div class="col-sm-6 left">
                            <h3 class="page-title"><i class="fa fa-edit"></i> Edit Appointment Type</h3>
                          </div>
                        ...
                        <div class="alert alert-warning mt-2 mb-0" role="alert">
                            <span style="color:black;font-family: 'Open Sans',sans-serif !important;font-weight:300 !important;font-size: 14px;">Edit appointment type.
                            </span>
                        </div>
                        <hr/>
                        <?php include viewPath('flash'); ?>
                        <?php echo form_open_multipart('appointment_types/update_appointment_type', [ 'class' => 'form-validate', 'autocomplete' => 'off' ]); ?>
                          <input type="hidden" name="aid" value="<?= $appointmentType->id; ?>" />
