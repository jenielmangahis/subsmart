<form name="calendar-event-modal-form" id="frm_create_event">
    ...
    <div class="form-group">
        <div class="row">
            <div class="col-md-6 col-sm-12">
                ...
                <select name="customer_id" id="business-customer" class="form-control select2-hidden-accessible" placeholder="Select customer" tabindex="-1" aria-hidden="true">
                </select>
            </div>
            <!-- <div class="col-md-6 col-sm-12">
                <div style="padding-top: 40px">
                    <a href="https://www.markate.com/pro/track/customers/add?returnto=add-event"><span class="fa fa-plus"></span> New Customer</a>
                </div>
            </div> -->
        </div>
    </div>
    ...
    <div class="form-group">
        <div class="row">
            <div class="col-md-12 col-sm-24">
                ...
                <input type="text" name="description" value="<?php echo (!empty($event)) ? $event->description : '' ?>" class="form-control" autocomplete="off">
            </div>
        </div>
    </div>
    <div class="form-group">
                    ...
                    <div class="col-md-6 col-sm-12">
                        ...
                        <div class="form-group">
                            <div class='input-group date datepicker'>
                                <input type='text' value="<?php echo (!empty($event)) ? date('m/d/Y', strtotime($event->start_date)) : '' ?>" name="start_date" class="form-control" id="datepicker_startdate" />
                            </div>
                        </div>
                        <span class="validation-error-field" data-formerrors-for-name="date_start" data-formerrors-message="true" style="display: none;"></span>
                    </div>
                    <div class="col-md-6 col-sm-12">
                        <div data-calendar="time-start-container">
                            ...
                            <div class="form-group">
                                <div class='input-group date timepicker'>
                                    <input type='text' value="<?php echo (!empty($event)) ? $event->start_time : '' ?>" name="start_time" class="form-control" id="datepicker_starttime" />
                                </div>
                            </div>
                            <span class="validation-error-field" data-formerrors-for-name="time_start" data-formerrors-message="true" style="display: none;"></span>
                        </div>
                    </div>
                </div>
            </div>
            <div class="form-group">
                <div class="row">
                    <div class="col-md-6 col-sm-12">
                        ...
                        <div class="form-group">
                            <div class='input-group date timepicker'>
                                <input type='text' value="<?php echo (!empty($event)) ? date('m/d/Y', strtotime($event->end_date)) : '' ?>" name="end_date" class="form-control" id="datepicker_enddate" />
                            </div>
                        </div>
                        <span class="validation-error-field" data-formerrors-for-name="date_end" data-formerrors-message="true" style="display: none;"></span>
                    </div>
                    <div class="col-md-6 col-sm-12">
                        <div data-calendar="time-end-container">
                            ...
                            <div class="form-group">
                                <div class='input-group date timepicker'>
                                    <input type='text' value="<?php echo (!empty($event)) ? $event->end_time : '' ?>" name="end_time" class="form-control" id="datepicker_endtime" />
                                </div>
                            </div>
    ...
    <div class="form-group">
        <div class="row">
            <div class="col-md-6 col-sm-12">
                ...
                <div class="calendar-modal-color-selector" data-calendar="color-selector">
                    ...
                    <?php if (!empty(get_config_item('event_colors'))) { ?>
                        ...
                        <?php foreach (get_config_item('event_colors') as $k => $color) { ?>
                            ...
                            <span class="calendar-modal-color-sq" data-calendar-color-id="<?php echo $color ?>" style="background:<?php echo $color ?>">
                                <?php if (!empty($event)) { ?>
                ...
                <input name="event_color" type="hidden" value="<?php echo (!empty($event)) ? $event->event_color : get_config_item('event_colors')[0] ?>">
            </div>
    ...
    <div class="form-group">
        <div class="row">
            <div class="col-md-12 col-sm-24">
                ...
                <input type="text" name="instructions" value="<?php echo (!empty($event)) ? $event->instructions : '' ?>" class="form-control" autocomplete="off">
            </div>
        </div>
    </div>
    ...
    <div>
        <div class="checkbox checkbox-sec">
            <input type="checkbox" name="is_recurring" value="1" id="is_recurring" data-calendar="recurring-toggle-checkbox" <?php echo (!empty($event) && $event->is_recurring) ? 'checked' : '' ?>>
