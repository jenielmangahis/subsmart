          ...
          <div class="float-right d-md-block">
            <div class="dropdown">
              <?php if (hasPermissions('WORKORDER_MASTER')) : ?>
                ...
                <a class="btn btn-primary btn-md" href="<?php echo url('estimate/add') ?>"><span class="fa fa-plus"></span> New Estimate</a>
              <?php endif ?>
            </div>
          </div>
        </div>
                ...
                <div card__columns>
                  <div class="c__header">
                    ...
                    <div class="card__columns_dec">
                      ...
                      <h4><span><a href="http://oscuz.com/nsmartfrontend/workorder/edit/<?php echo $ss; ?>">View estimate</a></span></h4>
                    </div>
                  </div>
                </div>
            <?php
                        ...
                        <td>
                          <div class="dropdown">
                            ...
                            <ul class="dropdown-menu">
                              <li><a href="<?php echo url('estimate/edit/' . $estimate->id) ?>">Edit</a></li>
                              <li><a href="javascript:void(0)" data-estimate-id="<?php echo 'EST-0000' . $estimate->id ?>" data-toggle="modal" data-target="#modalConvertEstimate">Convert to Work Order</a></li>
                            </ul>
                          </div>
                        </td>
                      </tr>
...
<div class="modal fade" id="modalConvertEstimate" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
  <div class="modal-dialog" role="document">
    <div class="modal-content">
      ...
      <div class="modal-footer">
        ...
        <button type="button" data-link="<?php echo base_url('workorder/add/?estimate_id=' . $estimate->id) ?>" class="btn btn-primary" id="button_convert_estimate">Convert To Work Order</button>
      </div>
    </div>
  </div>
</div>
