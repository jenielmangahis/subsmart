        ...
        <div class="page-title-box">
            <div class="row align-items-center">
                <div class="col-sm-6">
                    ...
                    <ol class="breadcrumb">
                        <li class="breadcrumb-item active">Submit your estimate. Include a breakdown of all costs for this job.</li>
                    </ol>
                </div>
                <div class="col-sm-6">
                    ...
                    <div class="card-body">
                        <div class="row">
                            ...
                            <div class="col-md-6 form-group">
                                ...
                                <select id="customers" name="customer_id" data-customer-source="dropdown" class="form-control searchable-dropdown" placeholder="Select">
                            ...
                            <div class="col-md-6 form-group">
                                ...
                                <input type="text" class="form-control" value="<?php echo $estimate->job_location ?>" name="job_location" id="job_location" required placeholder="Enter address" autofocus onChange="jQuery('#customer_name').text(jQuery(this).val());" />
                            </div>
                            <div class="col-md-6 form-group">
                                <label for="job_name">Job Name</label>
                                <input type="text" class="form-control" value="<?php echo $estimate->job_name ?>" name="job_name" id="job_name" placeholder="Enter Job Name" required />
                            </div>
                        </div>
                        ...
                        <div class="row">
                            <div class="col-md-4 form-group">
                                ...
                                <input type="text" value="" class="form-control" name="estimate" id="estimate" required placeholder="Enter Estimate#" autofocus onChange="jQuery('#customer_name').text(jQuery(this).val());" />
                            </div>
                            <div class="col-md-4 form-group">
                                ...
                                <div class="input-group date" data-provide="datepicker">
                                    <input type="text" value="<?php echo date('d/m/Y', strtotime($estimate->estimate_date)) ?>" class="form-control" name="estimate_date" id="estimate_date" placeholder="Enter Estimate Date">
                            ...
                            <div class="col-md-4 form-group">
                                ...
                                <div class="input-group date" data-provide="datepicker">
                                    <input type="text" value="<?php echo date('d/m/Y', strtotime($estimate->expiry_date)) ?>" class="form-control" name="expiry_date" id="expiry_date" placeholder="Enter Expiry Date">
                                    <div class="input-group-addon">
                                        <span class="glyphicon glyphicon-th"></span>
                                    </div>
                                </div>
                            ...
                            <div class="col-md-4 form-group">
                                ...
                                <input type="text" value="<?php echo $estimate->purchase_order_number ?>" class="form-control" name="purchase_order_number" id="purchase_order_number" required placeholder="Enter Purchase Order#" autofocus onChange="jQuery('#customer_name').text(jQuery(this).val());" />
                            </div>
                            <div class="col-md-4 form-group">
                                        ...
                                        <?php foreach ($plans as $pn) { ?>
                                            <?php if ($estimate->plan_id == $pn->id) { ?>
                                                <div class="checkbox checkbox-sec margin-right mr-4">
                                                    <input onClick="getplanItems(<?= $pn->id; ?>)" type="radio" name="plan_id" value="<?= $pn->id; ?>" id="radio_credit_card<?= $pn->id; ?>" checked>
                                                    <label for="radio_credit_card<?= $pn->id; ?>"><span><?= $pn->plan_name; ?></span></label>
                                                </div>
                                            <?php } else { ?>
                                                <div class="checkbox checkbox-sec margin-right mr-4">
                                                    <input onClick="getplanItems(<?= $pn->id; ?>)" type="radio" name="plan_id" value="<?= $pn->id; ?>" id="radio_credit_card<?= $pn->id; ?>">
                                                    <label for="radio_credit_card<?= $pn->id; ?>"><span><?= $pn->plan_name; ?></span></label>
                                                </div>
                                            <?php } ?>
                                        <?php } ?>
                        ...
                        <div class="row">
                            ...
                            <div class="col-md-4 form-group">
                                <div class="input-group">
                                    ...
                                    <input type="text" value="<?php echo $estimate->deposit_amount ?>" name="deposit_amount" value="0" class="form-control" autocomplete="off">
                                </div>
                            </div>
                            <div class="col-md-4 form-group">
