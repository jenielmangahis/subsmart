               ...
               <div class="card-body">
                     ...
                     <div class="col-md-3 form-group">
                        ...
                        <div class="input-group phone-input">
                           <span class="input-group-btn">
                              <button type="button" class="btn btn-default dropdown-toggle" data-toggle="dropdown" aria-expanded="false"><span class="type-text"><?php echo !empty($contact_phone['type']) ? ucfirst($contact_phone['type']) : '' ?></span> <span class="caret"></span></button>
                           ...
                           <input type="hidden" name="contact_phone[type]" class="type-input" value="<?php echo !empty($contact_phone['type']) ? $contact_phone['type'] : '' ?>" />
                           <input type="text" name="contact_phone[number]" class="form-control" placeholder="Enter Phone" value="<?php echo ($contact_phone) ? $contact_phone['number'] : ''; ?>" />
                        </div>
                     </div>
                     <div class="col-md-3 form-group">
                  ...
                  <div class="row">
                     ...
                     <div class="col-md-3 form-group">
                        ...
                        <input type="text" class="form-control" name="suit" id="suit" placeholder="Enter Suite/Unit" value="<?php echo ($workorder->suit) ? $workorder->suit : ''; ?>" />
                     </div>
                  ...
                  <div class="row">
                     ...
                     <div class="col-md-3 form-group">
                        ...
                        <div class="input-group phone-input">
                           <span class="input-group-btn">
                              <button type="button" class="btn btn-default dropdown-toggle" data-toggle="dropdown" aria-expanded="false"><span class="type-text"><?php echo !empty($verification_phone['type']) ? ucfirst($verification_phone['type']) : '' ?></span> <span class="caret"></span></button>
                              <ul class="dropdown-menu" role="menu">
                                 <li><a class="changePhoneType" href="javascript:;" data-type-value="mobile">Mobile</a></li>
                                 <li><a class="changePhoneType" href="javascript:;" data-type-value="home">Home</a></li>
                                 <li><a class="changePhoneType" href="javascript:;" data-type-value="work">Work</a></li>
                           ...
                           <input type="hidden" name="verification_phone[type]" class="type-input" value="<?php echo !empty($verification_phone['type']) ? $verification_phone['type'] : '' ?>" />
                           <input type="text" name="verification_phone[number]" class="form-control" placeholder="Enter Phone" value="<?php echo ($verification_phone) ? $verification_phone['number'] : ''; ?>" />
                        </div>
                     </div>
                  </div>
                  <div class="row">
                     ...
                     <div class="col-md-3 form-group">
                        ...
                        <div class="input-group phone-input">
                           <span class="input-group-btn">
                              <button type="button" class="btn btn-default dropdown-toggle" data-toggle="dropdown" aria-expanded="false"><span class="type-text"><?php echo !empty($emrg_contact_phone_1['type']) ? ucfirst($emrg_contact_phone_1['type']) : '' ?></span> <span class="caret"></span></button>
                              <ul class="dropdown-menu" role="menu">
                                 <li><a class="changePhoneType" href="javascript:;" data-type-value="mobile">Mobile</a></li>
                                 <li><a class="changePhoneType" href="javascript:;" data-type-value="home">Home</a></li>
                                 <li><a class="changePhoneType" href="javascript:;" data-type-value="work">Work</a></li>
                           ...
                           <input type="hidden" name="emrg_contact_phone_1[type]" class="type-input" value="<?php echo !empty($emrg_contact_phone_1['type']) ? $emrg_contact_phone_1['type'] : '' ?>" />
                           <input type="text" name="emrg_contact_phone_1[number]" class="form-control" placeholder="Enter Phone" value="<?php echo ($emrg_contact_phone_1) ? $emrg_contact_phone_1['number'] : ''; ?>" />
                        </div>
                     </div>
                  </div>
                  <div class="row">
                           ...
                           <div class="panel panel-default">
                              ...
                              <div id="collapse1" class="panel-collapse collapse">
                                 ...
                                 <table class="table">
                                    ...
                                    <tr>
                                       <td>Honeywell</td>
                                       <td><input type="text" value="<?php echo $ip_cam['honeywell']['wo'] ?>" class="form-control" name="ip_cam[honeywell][wo]" placeholder="" />
                                       </td>
                                       <td><input type="text" value="<?php echo $ip_cam['honeywell']['wi'] ?>" class="form-control" name="ip_cam[honeywell][wi]" placeholder="" />
                                       </td>
                                    </tr>
                                    <tr>
                                       <td>AVYCON</td>
                                       <td><input type="text" value="<?php echo $ip_cam['avycon']['wo'] ?>" class="form-control" name="ip_cam[avycon][wo]" placeholder="" />
                                       </td>
                                       <td><input type="text" value="<?php echo $ip_cam['avycon']['wi'] ?>" class="form-control" name="ip_cam[avycon][wi]" placeholder="" />
                                       </td>
                                    </tr>
                                    <tr>
                                       <td>Other</td>
                                       <td><input type="text" value="<?php echo $ip_cam['other']['wo'] ?>" class="form-control" name="ip_cam[other][wo]" placeholder="" />
                                       </td>
                                       <td><input type="text" value="<?php echo $ip_cam['other']['wi'] ?>" class="form-control" name="ip_cam[other][wi]" placeholder="" />
                                       </td>
                                    </tr>
                                 </table>
                              </div>
                              ...
                              <div id="collapse2" class="panel-collapse collapse">
                                 <div class="panel-body">
                                    <table class="table">
                                       ...
                                       <tr>
                                          <td>Deadbolt</td>
                                          <td><input type="text" value="<?php echo $doorlocks['deadbolt']['brass'] ?>" class="form-control" name="doorlocks[deadbolt][brass]" placeholder="" />
                                          </td>
                                          <td><input type="text" value="<?php echo $doorlocks['deadbolt']['nickal'] ?>" class="form-control" name="doorlocks[deadbolt][nickal]" placeholder="" />
                                          </td>
                                          <td><input type="text" value="<?php echo $doorlocks['deadbolt']['bronze'] ?>" class="form-control" name="doorlocks[deadbolt][bronze]" placeholder="" />
                                          </td>
                                       </tr>
                                       <tr>
                                          <td>Handle</td>
                                          <td><input type="text" value="<?php echo $doorlocks['handle']['brass'] ?>" class="form-control" name="doorlocks[handle][brass]" placeholder="" />
                                          </td>
                                          <td><input type="text" value="<?php echo $doorlocks['handle']['nickal'] ?>" class="form-control" name="doorlocks[handle][nickal]" placeholder="" />
                                          </td>
                                          <td><input type="text" value="<?php echo $doorlocks['handle']['bronze'] ?>" class="form-control" name="doorlocks[handle][bronze]" placeholder="" />
                                          </td>
                                       </tr>
                                    </table>
                                 </div>
                           ...
                           <div class="panel panel-default">
                              ...
                              <div id="collapse3" class="panel-collapse collapse">
                                 <table class="table">
                                    ...
                                    <tr>
                                       <td>Honeywell</td>
                                       <td><input type="text" value="<?php echo $chk_dvr['honeywell']['4_channel'] ?>" class="form-control" name="chk_dvr[honeywell][4_channel]" placeholder="" />
                                       </td>
                                       <td><input type="text" value="<?php echo $chk_dvr['honeywell']['8_channel'] ?>" class="form-control" name="chk_dvr[honeywell][8_channel]" placeholder="" />
                                       </td>
                                       <td><input type="text" value="<?php echo $chk_dvr['honeywell']['16_channel'] ?>" class="form-control" name="chk_dvr[honeywell][16_channel]" placeholder="" />
                                       </td>
                                    </tr>
                                    <tr>
                                       <td>AVYCON</td>
                                       <td><input type="text" value="<?php echo $chk_dvr['avycon']['4_channel'] ?>" class="form-control" name="chk_dvr[avycon][4_channel]" placeholder="" />
                                       </td>
                                       <td><input type="text" value="<?php echo $chk_dvr['avycon']['8_channel'] ?>" class="form-control" name="chk_dvr[avycon][8_channel]" placeholder="" />
                                       </td>
                                       <td><input type="text" value="<?php echo $chk_dvr['avycon']['16_channel'] ?>" class="form-control" name="chk_dvr[avycon][16_channel]" placeholder="" />
                                       </td>
                                    </tr>
                                    <tr>
                                       <td>Other</td>
                                       <td><input type="text" value="<?php echo $chk_dvr['other']['4_channel'] ?>" class="form-control" name="chk_dvr[other][4_channel]" placeholder="" />
                                       </td>
                                       <td><input type="text" value="<?php echo $chk_dvr['other']['8_channel'] ?>" class="form-control" name="chk_dvr[other][8_channel]" placeholder="" />
                                       </td>
                                       <td><input type="text" value="<?php echo $chk_dvr['other']['16_channel'] ?>" class="form-control" name="chk_dvr[other][16_channel]" placeholder="" />
                                       </td>
                                    </tr>
                                 </table>
                              </div>
