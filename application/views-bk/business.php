	...
	<div role="wrapper">
		<nav class="navbar-side d-none d-md-block">
			<ul class="nav">
				...
				<li class="active"><a href="<?php echo url('users/businessview') ?>" title="My Profile"><span class="fa fa-user"></span>My Profile</a></li>
				<li><a href="<?php echo url('users/businessdetail') ?>" title="Business Details"><span class="fa fa-briefcase"></span>Business Details</a></li>
