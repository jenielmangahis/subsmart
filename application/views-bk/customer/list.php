      ...
      <div class="page-title-box">
         <div class="row align-items-center">
            <div class="col-sm-6">           
               ...
               <ol class="breadcrumb">
                  <li class="breadcrumb-item active">Listing all customers.</li>
               </ol>
            </div>
            <div class="col-sm-6">
               <div class="float-right d-md-block">
                  <div class="dropdown">
                    <?php if (hasPermissions('WORKORDER_MASTER')): ?>
                        ...
                        <a class="btn btn-primary btn-md" href="<?php echo url('customer/add') ?>"><span class="fa fa-plus"></span> New Customer</a>
                     <?php endif ?>
                  </div>
               </div>
            </div>
                  ...
                  <div class="row">
                     ...
                     <table id="dataTable1" class="table table-bordered table-striped">
                            ...
                            <tbody>        
                                ...
                                <tr>
                                    <td><?php echo 'CU-00'.$customer->id?></td>       
                                    ...
                                    <div class="dropdown">
                                        ...
                                        <ul class="dropdown-menu">
                                          <li><a href="<?php echo url('customer/view/'.$customer->id) ?>">View</a></li>
                                          <li><a href="<?php echo url('customer/edit/'.$customer->id) ?>">Edit</a></li> 
                                          <li><a href="<?php echo base_url('workcalender/?customer_id='.$customer->id.'&action=open_event_modal') ?>">Schedule Appointment</a></li>
                                          <li><a href="<?php echo base_url('estimate/add/?customer_id='.$customer->id) ?>">Create Estimate</a></li>                                    
                                        </ul>
                                    </div>
                                    </td>
                                </tr>
