    ...
    public function formFields()
    {
        $formFields = [
            ...
            'alarm-information' => [
                ...
                'monthly_monitoring' => ['field_name' => 'Monthly Monitoring', 'required' => 'yes', 'is_visible' => 'yes'],
            ...
            'customer-property' => [
                ...
                'revenue' => ['field_name' => 'Revenue', 'required' => 'yes', 'is_visible' => 'yes'],
                'territory' => ['field_name' => 'Territory', 'required' => 'yes', 'is_visible' => 'yes'],
                'property_tax' => ['field_name' => 'Property Tax', 'required' => 'yes', 'is_visible' => 'yes'],
                'add_on' => ['field_name' => 'Add-on', 'required' => 'yes', 'is_visible' => 'yes'],
                'ac_type' => ['field_name' => 'AC Type', 'required' => 'yes', 'is_visible' => 'yes'],
                'payment_history' => ['field_name' => 'Payment History', 'required' => 'yes', 'is_visible' => 'yes'],
                'late_fee_collected' => ['field_name' => 'Late fee collected', 'required' => 'yes', 'is_visible' => 'yes'],
                'alarm_system' => ['field_name' => 'Alarm System', 'required' => 'yes', 'is_visible' => 'yes'],
