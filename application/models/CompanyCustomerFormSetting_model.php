    ...
    public function formFields()
    {
        $formFields = [
            ...
            'alarm-information' => [
                ...
                'comm_type' => ['field_name' => 'Service Package', 'required' => 'yes', 'is_visible' => 'yes'],
                ...
                'secondary_system_type' => ['field_name' => 'Secondary System Type', 'required' => 'no', 'is_visible' => 'yes'],
                'radio_serial_number' => ['field_name' => 'Radio Serial Number', 'required' => 'no', 'is_visible' => 'yes'],
                'panel_location' => ['field_name' => 'Panel Location', 'required' => 'no', 'is_visible' => 'yes'],
                'transformer_location' => ['field_name' => 'Transformer Location', 'required' => 'no', 'is_visible' => 'yes'],
                'dealer_number' => ['field_name' => 'Dealer Number', 'required' => 'no', 'is_visible' => 'yes'],
                'install_type' => ['field_name' => 'Install Type', 'required' => 'no', 'is_visible' => 'yes'],
                'service_provider' => ['field_name' => 'Service Provider', 'required' => 'no', 'is_visible' => 'yes'],
                'dsl_voip' => ['field_name' => 'DSL Voip', 'required' => 'no', 'is_visible' => 'yes'],
                'contract_status' => ['field_name' => 'Contract Status', 'required' => 'no', 'is_visible' => 'yes'],
                'csid_number' => ['field_name' => 'CSID Number', 'required' => 'no', 'is_visible' => 'yes'],
                'panel_phone_number' => ['field_name' => 'Panel Phone Number', 'required' => 'no', 'is_visible' => 'yes'],
                'connection_type' => ['field_name' => 'Connection Type', 'required' => 'no', 'is_visible' => 'yes'],
            ...
            'billing-information' => [
                ...
                'billing_city' => ['field_name' => 'City', 'required' => 'yes', 'is_visible' => 'yes'],
                'billing_state' => ['field_name' => 'State', 'required' => 'yes', 'is_visible' => 'yes'],
                'billing_zip' => ['field_name' => 'ZIP', 'required' => 'yes', 'is_visible' => 'yes'],
                'equipment' => ['field_name' => 'Equipment', 'required' => 'yes', 'is_visible' => 'yes'],
                'initial_dep' => ['field_name' => 'Initial Deposit', 'required' => 'yes', 'is_visible' => 'yes'],
                ...
                'late_fee' => ['field_name' => 'Late Fee Colllected', 'required' => 'yes', 'is_visible' => 'yes'],
                'payment_fee' => ['field_name' => 'Payment Recorded', 'required' => 'yes', 'is_visible' => 'yes'],
