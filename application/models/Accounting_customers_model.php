...
class Accounting_customers_model extends MY_Model
{
    ...
    public function get_customer_by_id($id)
    {
        ...
        acs_profile.mail_add as acs_mail_add, acs_profile.city as acs_city, acs_profile.state as acs_state, acs_profile.zip_code as acs_zip_code, acs_profile.email as acs_email, acs_profile.phone_h as customer_phone_h
