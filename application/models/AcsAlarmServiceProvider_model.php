...
class AcsAlarmServiceProvider_model extends MY_Model
{
    public $table = 'acs_alarm_service_providers';
...
/* End of file AcsAlarmServiceProvider_model.php */
/* Location: ./application/models/AcsAlarmServiceProvider_model.php */
