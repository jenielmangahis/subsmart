 ...
 public function getStatusCount($DATE)
    {
        ...
        $this->db->select('"Scheduled" AS STATUS, ((SELECT COUNT(jobs.status) FROM jobs WHERE jobs.status LIKE "%Scheduled%" AND jobs.job_number LIKE "%JOB%" AND DATE_FORMAT(jobs.start_date, "%Y-%m") = DATE_FORMAT(CURDATE(), "%Y-%m") AND jobs.company_id = "'.$COMPANY_ID.'")+(SELECT COUNT(tickets.ticket_status) FROM tickets WHERE tickets.ticket_status LIKE "%Scheduled%" AND DATE_FORMAT(tickets.ticket_date, "%Y-%m") = DATE_FORMAT(CURDATE(), "%Y-%m") AND tickets.company_id = "'.$COMPANY_ID.'")+(SELECT COUNT(events.status) FROM events WHERE events.status LIKE "%Scheduled%" AND events.event_number LIKE "%EVENT%" AND DATE_FORMAT(events.date_created, "%Y-%m") = DATE_FORMAT(CURDATE(), "%Y-%m") AND events.company_id = "'.$COMPANY_ID.'")+(SELECT COUNT(appointments.appointment_number) FROM appointments WHERE appointments.appointment_number LIKE "%JOB%" AND DATE_FORMAT(appointments.appointment_date, "%Y-%m") = DATE_FORMAT(CURDATE(), "%Y-%m") OR appointments.appointment_number LIKE "%EVENT%" AND DATE_FORMAT(appointments.appointment_date, "%Y-%m") = DATE_FORMAT(CURDATE(), "%Y-%m") OR appointments.appointment_number LIKE "%SERVICES%" AND DATE_FORMAT(appointments.appointment_date, "%Y-%m") = DATE_FORMAT(CURDATE(), "%Y-%m") AND appointments.company_id = "'.$COMPANY_ID.'")) AS TOTAL');

        /*$this->db->select('"Scheduled" AS STATUS, ((SELECT COUNT(jobs.status) FROM jobs WHERE jobs.status LIKE "%Scheduled%" AND jobs.job_number LIKE "%JOB%" AND DATE_FORMAT(jobs.date_created, "%Y-%m") = DATE_FORMAT(CURDATE(), "%Y-%m") AND jobs.company_id = "'.$COMPANY_ID.'")+(SELECT COUNT(events.status) FROM events WHERE events.status LIKE "%Scheduled%" AND events.event_number LIKE "%EVENT%" AND DATE_FORMAT(events.date_created, "%Y-%m") = DATE_FORMAT(CURDATE(), "%Y-%m") AND events.company_id = "'.$COMPANY_ID.'")+(SELECT COUNT(appointments.appointment_number) FROM appointments WHERE appointments.appointment_number LIKE "%JOB%" AND DATE_FORMAT(appointments.created, "%Y-%m") = DATE_FORMAT(CURDATE(), "%Y-%m") OR appointments.appointment_number LIKE "%EVENT%" AND DATE_FORMAT(appointments.created, "%Y-%m") = DATE_FORMAT(CURDATE(), "%Y-%m") OR appointments.appointment_number LIKE "%SERVICES%" AND DATE_FORMAT(appointments.created, "%Y-%m") = DATE_FORMAT(CURDATE(), "%Y-%m") AND appointments.company_id = "'.$COMPANY_ID.'")) AS TOTAL');*/

        $scheduledQueryMonth = $this->db->get();
        array_push($CURRENT_MONTH_COUNT, $scheduledQueryMonth->row());

        // GET ARRIVAL COUNT BASED ON CURRENT MONTH
        $this->db->select('"Arrival" AS STATUS, ((SELECT COUNT(jobs.status) FROM jobs WHERE jobs.status LIKE "%Arrival%" AND jobs.job_number LIKE "%JOB%" AND DATE_FORMAT(jobs.date_created, "%Y-%m") = DATE_FORMAT(CURDATE(), "%Y-%m") AND jobs.company_id = "'.$COMPANY_ID.'")+(SELECT COUNT(events.status) FROM events WHERE events.status LIKE "%Arrival%" AND events.event_number LIKE "%EVENT%" AND DATE_FORMAT(events.date_created, "%Y-%m") = DATE_FORMAT(CURDATE(), "%Y-%m") AND events.company_id = "'.$COMPANY_ID.'")) AS TOTAL');
        ...
        $this->db->select('"Started" AS STATUS, ((SELECT COUNT(jobs.status) FROM jobs WHERE jobs.status LIKE "%Started%" AND jobs.job_number LIKE "%JOB%" AND DATE_FORMAT(jobs.date_created, "%Y-%m") = DATE_FORMAT(CURDATE(), "%Y-%m") AND jobs.company_id = "'.$COMPANY_ID.'")+(SELECT COUNT(events.status) FROM events WHERE events.status LIKE "%Started%" AND events.event_number LIKE "%EVENT%" AND DATE_FORMAT(events.date_created, "%Y-%m") = DATE_FORMAT(CURDATE(), "%Y-%m") AND events.company_id = "'.$COMPANY_ID.'")) AS TOTAL');
        ...
        $this->db->select('"Approved" AS STATUS, ((SELECT COUNT(jobs.status) FROM jobs WHERE jobs.status LIKE "%Approved%" AND jobs.job_number LIKE "%JOB%" AND DATE_FORMAT(jobs.date_created, "%Y-%m") = DATE_FORMAT(CURDATE(), "%Y-%m") AND jobs.company_id = "'.$COMPANY_ID.'")+(SELECT COUNT(events.status) FROM events WHERE events.status LIKE "%Approved%" AND events.event_number LIKE "%EVENT%" AND DATE_FORMAT(events.date_created, "%Y-%m") = DATE_FORMAT(CURDATE(), "%Y-%m") AND events.company_id = "'.$COMPANY_ID.'")) AS TOTAL');
        ...
        $this->db->select('"Finish" AS STATUS, ((SELECT COUNT(jobs.status) FROM jobs WHERE jobs.status LIKE "%Finish%" AND jobs.job_number LIKE "%JOB%" AND DATE_FORMAT(jobs.date_created, "%Y-%m") = DATE_FORMAT(CURDATE(), "%Y-%m") AND jobs.company_id = "'.$COMPANY_ID.'")+(SELECT COUNT(events.status) FROM events WHERE events.status LIKE "%Finish%" AND events.event_number LIKE "%EVENT%" AND DATE_FORMAT(events.date_created, "%Y-%m") = DATE_FORMAT(CURDATE(), "%Y-%m") AND events.company_id = "'.$COMPANY_ID.'")) AS TOTAL');
        $finishQueryMonth = $this->db->get();
        array_push($CURRENT_MONTH_COUNT, $finishQueryMonth->row());

        // GET INVOICED COUNT BASED ON CURRENT MONTH
        $this->db->select('"Invoiced" AS STATUS, ((SELECT COUNT(jobs.status) FROM jobs WHERE jobs.status LIKE "%Invoiced%" AND jobs.job_number LIKE "%JOB%" AND DATE_FORMAT(jobs.date_created, "%Y-%m") = DATE_FORMAT(CURDATE(), "%Y-%m") AND jobs.company_id = "'.$COMPANY_ID.'")+(SELECT COUNT(events.status) FROM events WHERE events.status LIKE "%Invoiced%" AND events.event_number LIKE "%EVENT%" AND DATE_FORMAT(events.date_created, "%Y-%m") = DATE_FORMAT(CURDATE(), "%Y-%m") AND events.company_id = "'.$COMPANY_ID.'")) AS TOTAL');
        ...
        $this->db->select('"Completed" AS STATUS, ((SELECT COUNT(jobs.status) FROM jobs WHERE jobs.status LIKE "%Completed%" AND jobs.job_number LIKE "%JOB%" AND DATE_FORMAT(jobs.date_created, "%Y-%m") = DATE_FORMAT(CURDATE(), "%Y-%m") AND jobs.company_id = "'.$COMPANY_ID.'")+(SELECT COUNT(events.status) FROM events WHERE events.status LIKE "%Completed%" AND events.event_number LIKE "%EVENT%" AND DATE_FORMAT(events.date_created, "%Y-%m") = DATE_FORMAT(CURDATE(), "%Y-%m") AND events.company_id = "'.$COMPANY_ID.'")+(SELECT COUNT(jobs.status) FROM jobs WHERE jobs.status LIKE "%Finished%" AND jobs.job_number LIKE "%JOB%" AND DATE_FORMAT(jobs.date_created, "%Y-%m") = DATE_FORMAT(CURDATE(), "%Y-%m") AND jobs.company_id = "'.$COMPANY_ID.'")+(SELECT COUNT(events.status) FROM events WHERE events.status LIKE "%Finished%" AND events.event_number LIKE "%EVENT%" AND DATE_FORMAT(events.date_created, "%Y-%m") = DATE_FORMAT(CURDATE(), "%Y-%m") AND events.company_id = "'.$COMPANY_ID.'")) AS TOTAL');
        ...
        $this->db->select('"Scheduled" AS STATUS, ((SELECT COUNT(jobs.status) FROM jobs WHERE jobs.status LIKE "%Scheduled%" AND jobs.job_number LIKE "%JOB%" AND DATE_FORMAT(jobs.start_date, "%Y") = DATE_FORMAT(CURDATE(), "%Y") AND jobs.company_id = "'.$COMPANY_ID.'")+(SELECT COUNT(tickets.ticket_status) FROM tickets WHERE tickets.ticket_status LIKE "%Scheduled%" AND DATE_FORMAT(tickets.ticket_date, "%Y") = DATE_FORMAT(CURDATE(), "%Y") AND tickets.company_id = "'.$COMPANY_ID.'")+(SELECT COUNT(events.status) FROM events WHERE events.status LIKE "%Scheduled%" AND events.event_number LIKE "%EVENT%" AND DATE_FORMAT(events.date_created, "%Y") = DATE_FORMAT(CURDATE(), "%Y") AND events.company_id = "'.$COMPANY_ID.'")+(SELECT COUNT(appointments.appointment_number) FROM appointments WHERE appointments.appointment_number LIKE "%JOB%" AND DATE_FORMAT(appointments.appointment_date, "%Y") = DATE_FORMAT(CURDATE(), "%Y") OR appointments.appointment_number LIKE "%EVENT%" AND DATE_FORMAT(appointments.appointment_date, "%Y") = DATE_FORMAT(CURDATE(), "%Y") OR appointments.appointment_number LIKE "%SERVICES%" AND DATE_FORMAT(appointments.appointment_date, "%Y") = DATE_FORMAT(CURDATE(), "%Y") AND appointments.company_id = "'.$COMPANY_ID.'")) AS TOTAL');

        /*$this->db->select('"Scheduled" AS STATUS, ((SELECT COUNT(jobs.status) FROM jobs WHERE jobs.status LIKE "%Scheduled%" AND jobs.job_number LIKE "%JOB%" AND DATE_FORMAT(jobs.date_created, "%Y") = DATE_FORMAT(CURDATE(), "%Y") AND jobs.company_id = "'.$COMPANY_ID.'")+(SELECT COUNT(events.status) FROM events WHERE events.status LIKE "%Scheduled%" AND events.event_number LIKE "%EVENT%" AND DATE_FORMAT(events.date_created, "%Y") = DATE_FORMAT(CURDATE(), "%Y") AND events.company_id = "'.$COMPANY_ID.'")+(SELECT COUNT(appointments.appointment_number) FROM appointments WHERE appointments.appointment_number LIKE "%JOB%" AND DATE_FORMAT(appointments.created, "%Y") = DATE_FORMAT(CURDATE(), "%Y") OR appointments.appointment_number LIKE "%EVENT%" AND DATE_FORMAT(appointments.created, "%Y") = DATE_FORMAT(CURDATE(), "%Y") OR appointments.appointment_number LIKE "%SERVICES%" AND DATE_FORMAT(appointments.created, "%Y") = DATE_FORMAT(CURDATE(), "%Y") AND appointments.company_id = "'.$COMPANY_ID.'")) AS TOTAL');*/
        ...
        $this->db->select('"Arrival" AS STATUS, ((SELECT COUNT(jobs.status) FROM jobs WHERE jobs.status LIKE "%Arrival%" AND jobs.job_number LIKE "%JOB%" AND DATE_FORMAT(jobs.date_created, "%Y") = DATE_FORMAT(CURDATE(), "%Y") AND jobs.company_id = "'.$COMPANY_ID.'")+(SELECT COUNT(events.status) FROM events WHERE events.status LIKE "%Arrival%" AND events.event_number LIKE "%EVENT%" AND DATE_FORMAT(events.date_created, "%Y") = DATE_FORMAT(CURDATE(), "%Y") AND events.company_id = "'.$COMPANY_ID.'")) AS TOTAL');
        $arrivalQueryYear = $this->db->get();
        array_push($CURRENT_YEAR_COUNT, $arrivalQueryYear->row());

        // GET STARTED COUNT BASED ON CURRENT YEAR
        $this->db->select('"Started" AS STATUS, ((SELECT COUNT(jobs.status) FROM jobs WHERE jobs.status LIKE "%Started%" AND jobs.job_number LIKE "%JOB%" AND DATE_FORMAT(jobs.date_created, "%Y") = DATE_FORMAT(CURDATE(), "%Y") AND jobs.company_id = "'.$COMPANY_ID.'")+(SELECT COUNT(events.status) FROM events WHERE events.status LIKE "%Started%" AND events.event_number LIKE "%EVENT%" AND DATE_FORMAT(events.date_created, "%Y") = DATE_FORMAT(CURDATE(), "%Y") AND events.company_id = "'.$COMPANY_ID.'")) AS TOTAL');
        $startedQueryYear = $this->db->get();
        array_push($CURRENT_YEAR_COUNT, $startedQueryYear->row());

        // GET APPROVED COUNT BASED ON CURRENT YEAR
        $this->db->select('"Approved" AS STATUS, ((SELECT COUNT(jobs.status) FROM jobs WHERE jobs.status LIKE "%Approved%" AND jobs.job_number LIKE "%JOB%" AND DATE_FORMAT(jobs.date_created, "%Y") = DATE_FORMAT(CURDATE(), "%Y") AND jobs.company_id = "'.$COMPANY_ID.'")+(SELECT COUNT(events.status) FROM events WHERE events.status LIKE "%Approved%" AND events.event_number LIKE "%EVENT%" AND DATE_FORMAT(events.date_created, "%Y") = DATE_FORMAT(CURDATE(), "%Y") AND events.company_id = "'.$COMPANY_ID.'")) AS TOTAL');
        $approvedQueryYear = $this->db->get();
        array_push($CURRENT_YEAR_COUNT, $approvedQueryYear->row());

        // GET FINISH COUNT BASED ON CURRENT YEAR
        $this->db->select('"Finish" AS STATUS, ((SELECT COUNT(jobs.status) FROM jobs WHERE jobs.status LIKE "%Finish%" AND jobs.job_number LIKE "%JOB%" AND DATE_FORMAT(jobs.date_created, "%Y") = DATE_FORMAT(CURDATE(), "%Y") AND jobs.company_id = "'.$COMPANY_ID.'")+(SELECT COUNT(events.status) FROM events WHERE events.status LIKE "%Finish%" AND events.event_number LIKE "%EVENT%" AND DATE_FORMAT(events.date_created, "%Y") = DATE_FORMAT(CURDATE(), "%Y") AND events.company_id = "'.$COMPANY_ID.'")) AS TOTAL');
        $finishQueryYear = $this->db->get();
        array_push($CURRENT_YEAR_COUNT, $finishQueryYear->row());

        // GET INVOICED COUNT BASED ON CURRENT YEAR
        $this->db->select('"Invoiced" AS STATUS, ((SELECT COUNT(jobs.status) FROM jobs WHERE jobs.status LIKE "%Invoiced%" AND jobs.job_number LIKE "%JOB%" AND DATE_FORMAT(jobs.date_created, "%Y") = DATE_FORMAT(CURDATE(), "%Y") AND jobs.company_id = "'.$COMPANY_ID.'")+(SELECT COUNT(events.status) FROM events WHERE events.status LIKE "%Invoiced%" AND events.event_number LIKE "%EVENT%" AND DATE_FORMAT(events.date_created, "%Y") = DATE_FORMAT(CURDATE(), "%Y") AND events.company_id = "'.$COMPANY_ID.'")) AS TOTAL');
        ...
        $this->db->select('"Completed" AS STATUS, ((SELECT COUNT(jobs.status) FROM jobs WHERE jobs.status LIKE "%Completed%" AND jobs.job_number LIKE "%JOB%" AND DATE_FORMAT(jobs.date_created, "%Y") = DATE_FORMAT(CURDATE(), "%Y") AND jobs.company_id = "'.$COMPANY_ID.'")+(SELECT COUNT(events.status) FROM events WHERE events.status LIKE "%Completed%" AND events.event_number LIKE "%EVENT%" AND DATE_FORMAT(events.date_created, "%Y") = DATE_FORMAT(CURDATE(), "%Y") AND events.company_id = "'.$COMPANY_ID.'")+(SELECT COUNT(jobs.status) FROM jobs WHERE jobs.status LIKE "%Finished%" AND jobs.job_number LIKE "%JOB%" AND DATE_FORMAT(jobs.date_created, "%Y") = DATE_FORMAT(CURDATE(), "%Y") AND jobs.company_id = "'.$COMPANY_ID.'")+(SELECT COUNT(events.status) FROM events WHERE events.status LIKE "%Finished%" AND events.event_number LIKE "%EVENT%" AND DATE_FORMAT(events.date_created, "%Y") = DATE_FORMAT(CURDATE(), "%Y") AND events.company_id = "'.$COMPANY_ID.'")) AS TOTAL');
