...
class Jobs_model extends MY_Model
{
    ...
    {
        $this->db->select('items.id as fk_item_id, items.id, items.title, items.price, items.type, items.retail, job_items.cost, job_items.qty, job_items.commission, items_has_storage_loc.name as location_name, items_has_storage_loc.id as location_id, job_items.points, job_items.tax, job_items.item_name AS job_item_name');
