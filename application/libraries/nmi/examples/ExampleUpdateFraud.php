...
$request->setRequestType(RequestType_Update);
$request->setSubType(SubType_UpdateFraud);
$request->setCardEaseReference('B7BBB119-B1BA-DB11-BB19-00065B3E6C8D');
$request->addExtendedProperty(new ExtendedProperty('3rdmanstate', 'Chargeback'));
