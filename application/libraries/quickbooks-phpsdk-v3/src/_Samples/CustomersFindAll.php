...
include($_SERVER['DOCUMENT_ROOT'].'/application/libraries/quickbooks-phpsdk-v3/src/config.php');
...
$dataService = DataService::Configure(array(
  'auth_mode'       => 'oauth2',
  'ClientID'        => "ABKxVifUuZJQlWQicGT4ZoF1vWhDgcjZ7vVFkmgGXOzO9cljn2",
  'ClientSecret'    => "ABKxVifUuZJQlWQicGT4ZoF1vWhDgcjZ7vVFkmgGXOzO9cljn2",
