...
class Deposits extends MY_Controller {
	...
	public function __construct()
    {
        ...
        $this->page_data['page']->title = 'Deposits';
    ...
    public function index()
    {
        ...
        $this->page_data['clients'] = $this->invoice_model->getclientsData(logged('company_id'));
        // $this->page_data['invoices'] = $this->invoice_model->getPaidInv(logged('company_id'));
        $this->load->view('v2/pages/accounting/sales/deposits/list', $this->page_data);
    }
}