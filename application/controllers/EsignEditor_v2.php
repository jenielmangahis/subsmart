...
class EsignEditor_v2 extends MY_Controller
{
    ...
    public function edit()
    {
        ...
        $this->page_data['page']->title = 'Edit Letter';
        $this->load->view('v2/pages/esign/esigneditor/create', $this->page_data);
    }
...
SQL;
    ...
    public function apiGetEmailTemplates()
    {
        ...
        $this->db->group_end();
        $this->db->join('esign_editor_categories c', 'l.category_id = c.id', 'left');
        $this->db->join('acs_company_dash_settings d', 'd.comp_id = ' . $companyId, 'left');
    ...
    private function createOrUpdateDefaultEmailTemplate($letterId, $defaultForeignCol)
    {
        ...
        $currDefault = $this->db->get('acs_company_dash_settings')->row();
