...
if [[ "$CONFIGURATION" == "Debug" ]]; then
  install_xcframework "${PODS_ROOT}/PSPDFKit/PSPDFKit.xcframework" "${PODS_ROOT}/PSPDFKit/PSPDFKit.dSYMs" "true" "ios-arm64_x86_64-simulator/PSPDFKit.framework" "ios-x86_64-maccatalyst/PSPDFKit.framework" "ios-arm64/PSPDFKit.framework"
  install_xcframework "${PODS_ROOT}/PSPDFKit/PSPDFKitUI.xcframework" "${PODS_ROOT}/PSPDFKit/PSPDFKitUI.dSYMs" "true" "ios-arm64_x86_64-simulator/PSPDFKitUI.framework" "ios-arm64/PSPDFKitUI.framework" "ios-x86_64-maccatalyst/PSPDFKitUI.framework"
fi
