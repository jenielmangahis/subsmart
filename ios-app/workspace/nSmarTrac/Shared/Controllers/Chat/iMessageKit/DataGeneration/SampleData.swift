...
final internal class SampleData {
    ...
    let nathan = MockUser(senderId: "000001", displayName: "Tommy Nguyen")
    let steven = MockUser(senderId: "000002", displayName: "Jonah Abanil")
    let wu = MockUser(senderId: "000003", displayName: "Jon Aba")

    lazy var senders = [nathan, steven, wu]
    
    lazy var contactsToShare = [
        MockContactItem(name: "System", initials: "S"),
        MockContactItem(name: "Tommy Nguyen", initials: "TN", emails: ["test@test.com"]),
        MockContactItem(name: "Jonah Abanil", initials: "JA", phoneNumbers: ["+1-202-555-0114", "+1-202-555-0145"]),
        MockContactItem(name: "Jon Cody", initials: "JC", phoneNumbers: ["202-555-0158"]),
    ...
    let messageImages: [UIImage] = [#imageLiteral(resourceName: "img-bgLogin.jpg"), #imageLiteral(resourceName: "img-bgLogin.jpg")]
    let emojis = [
        "👍",
        "😂😂😂",
        "👋👋👋",
    ...
    func getAvatarFor(sender: SenderType) -> Avatar {
        ...
        let image = UIImage.fontAwesomeIcon(name: .user, style: .solid, textColor: .white, size: CGSize(width: 48, height: 48))
