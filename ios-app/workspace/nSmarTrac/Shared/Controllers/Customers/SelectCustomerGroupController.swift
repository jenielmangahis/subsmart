//
//  SelectCustomerGroupController.swift
//  nSmarTrac
//
...
class SelectCustomerGroupController: UITableViewController {
    ...
    var filteredItems: [CustomerGroup] = []
    ...
    var callback: ((CustomerGroup) -> Void)?
    ...
    func loadData() {
        self.items = App.shared.cache.loadCachedCustomerGroups()
        // check
    ...
    func processData(_ list: [CustomerGroup]) {
        // sort ungrouped
