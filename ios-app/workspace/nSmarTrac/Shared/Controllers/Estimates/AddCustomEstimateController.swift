...
extension AddCustomEstimateController: TLPhotosPickerViewControllerDelegate {
...
extension AddCustomEstimateController: FSPagerViewDataSource, FSPagerViewDelegate {
