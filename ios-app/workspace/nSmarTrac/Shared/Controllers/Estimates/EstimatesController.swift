...
extension EstimatesController: SideMenuNavigationControllerDelegate {
...
extension EstimatesController: UITableViewDelegate, UITableViewDataSource {
    ...
    func tableView(_ tableView: UITableView, cellForRowAt indexPath: IndexPath) -> UITableViewCell {
        ...
        // nameButton
        let nameButton = Utils.createPurpleButton(28, 12, Int(Device.width-40), "Oak Grove MHP (Patriots Park)", hasArrow: true)
        ...
        // amountLabel
        let amountLabel = Utils.createInvoiceLabel(Int(Device.width/2), 12, Int((Device.width-40)/2), "$808.39")
        cell.contentView.addSubview(amountLabel)
        
        // topLeft view
        let topLeft = Utils.createView(20, 50, Int((Device.width-40)/2), 50, "ESTIMATE #", "EST-000010", [.top, .right])
        ...
        // bottomLeft view
        let bottomLeft = Utils.createView(20, 100, Int((Device.width-40)/2), 50, "STATUS", "Submitted", [.top, .right])
        cell.contentView.addSubview(bottomLeft)
        
        // bottomRight view
        let bottomRight = Utils.createView(Int(Device.width/2), 100, Int((Device.width-40)/2), 50, "WORK ORDER #", "WO-00100 New", [.top])
    ...
    @objc func didButtonTapped(_ sender: UIButton) {
        self.pushTo(storyBoard: "Main", identifier: "sb_EstimateDetailController")
    }
}
