...
class JobForecastController: UIViewController {
...
extension JobForecastController: ChartViewDelegate {
    ...
    func setup(_ chartView: BarLineChartViewBase) {
        ...
        xAxis.granularity = 1
        xAxis.labelCount = 7
        xAxis.valueFormatter = JobForecastFormatter(chart: chartView)
...
public class JobForecastFormatter: NSObject, IAxisValueFormatter {
    
    weak var chart: BarLineChartViewBase?
    let names = ["Scheduled", "Unscheduled"]
