...
class EditTaxRateController: UITableViewController {
    ...
    func loadData() {
        ...
        btnSetAsDefault.isSelected  = item.is_default 
    }
    ...
    @IBAction func saveButtonTapped(_ sender: Any) {
        ...
        App.shared.api.putTaxRate(item.id.intValue, params: params) { (success, error) in
...
extension EditTaxRateController: UITextFieldDelegate {
