...
class SignInvoiceController: UIViewController {
    ...
    func initViews() {
        ...
        estimateLabel.text  = "Invoice: #\(item.invoice_number)"
        dateLabel.text      = "Date: \(item.date_issued)"
        amountLabel.text    = "Balance Due: $\(grandTotal.stringValue)"
    }
    ...
    @IBAction func beforeButtonTapped(_ sender: Any) {
        ...
        // set textLabel
        textLabel.text = "I authorized the work to be performed; Payable upon completion."
    }
    ...
    @IBAction func businessButtonTapped(_ sender: Any) {
        ...
        // set textLabel
        textLabel.text = "I received the money."
    }
...
extension SignInvoiceController: YPSignatureDelegate {
