//
//  EditItemLocationController.swift
//  nSmarTrac
//
...
class EditItemLocationController: UITableViewController {
    ...
    func loadData() {
        nameField.text          = itemLoc.name
        qtyField.text           = itemLoc.qty
    }
    ...
    @IBAction func submitButtonTapped(_ sender: Any) {
        ...
        App.shared.api.putItemLocation(itemLoc.id.intValue, params: params) { (success, error) in
...
extension EditItemLocationController: GMSAutocompleteViewControllerDelegate {
