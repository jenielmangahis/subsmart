...
extension InventoryController: SideMenuNavigationControllerDelegate {
...
extension InventoryController: UITableViewDelegate, UITableViewDataSource {
    ...
    func tableView(_ tableView: UITableView, cellForRowAt indexPath: IndexPath) -> UITableViewCell {
        ...
        // topRight view
        let topRight = Utils.createView(Int(Device.width/2), 50, Int((Device.width-40)/2), 50, "DISCOUNT", "$99.99", [.top])
