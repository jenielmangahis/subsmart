//
//  PayrollByEmployeeController.swift
//  nSmarTrac
//
...
class PayrollByEmployeeController: UIViewController {
    ...
    override func viewDidLoad() {
        ...
        self.title = "Payroll By Employee"
    }
...
extension PayrollByEmployeeController: UITableViewDelegate, UITableViewDataSource {
    ...
    func tableView(_ tableView: UITableView, cellForRowAt indexPath: IndexPath) -> UITableViewCell {
        ...
        // topLeft view
        let topLeft = Utils.createView(20, 50, Int((Device.width-40)/2), 50, "HOURLY RATE", "$0.00", [.top, .right])
        cell.contentView.addSubview(topLeft)
        
        // topRight view
        let topRight = Utils.createView(Int(Device.width/2), 50, Int((Device.width-40)/2), 50, "TOTAL HOURS:MINS", "0:00", [.top])
