//
//  YearlyCloseoutController.swift
//  nSmarTrac
//
...
class YearlyCloseoutController: UIViewController {
...
extension YearlyCloseoutController: UITableViewDelegate, UITableViewDataSource {
    ...
    func tableView(_ tableView: UITableView, cellForRowAt indexPath: IndexPath) -> UITableViewCell {
        ...
        // amount view
        let amountView = Utils.createInvoiceLabel(Int(Device.width/2), 12, Int((Device.width-40)/2), "$7,899")
