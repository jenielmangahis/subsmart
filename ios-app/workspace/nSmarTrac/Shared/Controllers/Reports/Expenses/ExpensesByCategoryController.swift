//
//  ExpensesByCategoryController.swift
//  nSmarTrac
//
...
class ExpensesByCategoryController: UIViewController {
    ...
    override func viewDidLoad() {
        ...
        self.title = "Expenses By Category Summary"
    }
...
extension ExpensesByCategoryController: UITableViewDelegate, UITableViewDataSource {
    ...
    func tableView(_ tableView: UITableView, viewForHeaderInSection section: Int) -> UIView? {
        return Utils.createReportHeader(App.shared.headerBgColor, App.shared.headerColor, "Category", "Balance")
    }
    ...
    func tableView(_ tableView: UITableView, cellForRowAt indexPath: IndexPath) -> UITableViewCell {
        ...
        cell.textLabel?.text        = "Category Name Here"
