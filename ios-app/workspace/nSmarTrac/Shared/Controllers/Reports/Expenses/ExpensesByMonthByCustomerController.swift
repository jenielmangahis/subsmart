//
//  ExpensesByMonthByCustomerController.swift
//  nSmarTrac
//
...
class ExpensesByMonthByCustomerController: UIViewController {
    ...
    override func viewDidLoad() {
        ...
        self.title = "Expenses By Customer"
    }
...
extension ExpensesByMonthByCustomerController: UITableViewDelegate, UITableViewDataSource {
    ...
    func tableView(_ tableView: UITableView, cellForRowAt indexPath: IndexPath) -> UITableViewCell {
        ...
        // topRight view
        let topRight = Utils.createView(Int(Device.width/2), 50, Int((Device.width-40)/2), 50, "BILLABLE", "$0.00", [.top])
