//
//  ExpensesByMonthByVendorController.swift
//  nSmarTrac
//
...
class ExpensesByMonthByVendorController: UIViewController {
...
extension ExpensesByMonthByVendorController: UITableViewDelegate, UITableViewDataSource {
    ...
    func tableView(_ tableView: UITableView, viewForHeaderInSection section: Int) -> UIView? {
        return Utils.createReportHeader(App.shared.headerBgColor, App.shared.headerColor, "Month", "Balance")
    }
    ...
    func tableView(_ tableView: UITableView, cellForRowAt indexPath: IndexPath) -> UITableViewCell {
        ...
        cell.textLabel?.text        = "Vendor Name Here"
