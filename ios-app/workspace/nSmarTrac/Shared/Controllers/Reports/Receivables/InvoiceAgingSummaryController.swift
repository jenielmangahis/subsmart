//
//  InvoiceAgingSummaryController.swift
//  nSmarTrac
//
...
class InvoiceAgingSummaryController: UIViewController {
...
extension InvoiceAgingSummaryController: UITableViewDelegate, UITableViewDataSource {
    ...
    func tableView(_ tableView: UITableView, viewForHeaderInSection section: Int) -> UIView? {
        return Utils.createReportHeader(App.shared.headerBgColor, App.shared.headerColor, "Customer Name", "Total")
    }
