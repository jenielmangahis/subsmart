//
//  PaymentByCustomerController.swift
//  nSmarTrac
//
...
class PaymentByCustomerController: UIViewController {
...
extension PaymentByCustomerController: UITableViewDelegate, UITableViewDataSource {
