//
//  PaymentByCustomerGroupController.swift
//  nSmarTrac
//
...
class PaymentByCustomerGroupController: UIViewController {
    ...
    override func viewDidLoad() {
        ...
        self.title = "Sales By Customer Groups"
    }
...
extension PaymentByCustomerGroupController: UITableViewDelegate, UITableViewDataSource {
    ...
    func tableView(_ tableView: UITableView, viewForHeaderInSection section: Int) -> UIView? {
        return Utils.createReportHeader(App.shared.headerBgColor, App.shared.headerColor, "Customer Group", "Total Sales")
    }
    ...
    func tableView(_ tableView: UITableView, cellForRowAt indexPath: IndexPath) -> UITableViewCell {
        ...
        cell.textLabel?.text        = "Group Name Here"
