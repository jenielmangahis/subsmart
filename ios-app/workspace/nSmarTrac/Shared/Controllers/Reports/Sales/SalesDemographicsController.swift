//
//  SalesDemographicsController.swift
//  nSmarTrac
//
...
class SalesDemographicsController: UIViewController {
...
extension SalesDemographicsController: UITableViewDelegate, UITableViewDataSource {
    ...
    func tableView(_ tableView: UITableView, cellForRowAt indexPath: IndexPath) -> UITableViewCell {
        ...
        cell.textLabel?.text        = "Pensacola, FL"
        cell.textLabel?.font        = UIFont.robotoFont(ofSize: 13)
        cell.detailTextLabel?.text  = "$204.00"
        ...
        if indexPath.row == 2 {
            ...
            cell.detailTextLabel?.text  = "$612.00"
