//
//  TimesheetEntriesController.swift
//  nSmarTrac
//
...
class TimesheetEntriesController: UIViewController {
...
extension TimesheetEntriesController: UITableViewDelegate, UITableViewDataSource {
    ...
    func tableView(_ tableView: UITableView, cellForRowAt indexPath: IndexPath) -> UITableViewCell {
        ...
        // topRight view
        let topRight = Utils.createView(Int(Device.width/2), 50, Int((Device.width-40)/2), 50, "HOURS:MINS", "0:00", [.top])
        cell.contentView.addSubview(topRight)
        
        // bottomLeft view
        let bottomLeft = Utils.createView(20, 100, Int(Device.width-40), 50, "NOTES", "Lorem ipsum dolor", [.top])
