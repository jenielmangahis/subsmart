//
//  APIClient+TimesheetLeave.swift
//  nSmarTrac
//
...
extension APIClient {
    ...
    func getTimesheetLeaves(completion: @escaping (_ list: [TimesheetLeave], _ error: NSError?) -> Void) {
        let path = apiURL.timesheetLeave + "?user_id=\(App.shared.user!.id)"
        
        APIClient.manager.request(path, method: .get, parameters: nil, encoding: JSONEncoding.default, headers: getAuthHeaders())
            .validate()
            .responseObject { (response: DataResponse<TimesheetLeaveResponse>) in
    ...
    func getTimesheetLeave(_ id: Int, completion: @escaping (_ item: TimesheetLeave?, _ error: NSError?) -> Void) {
        let path = apiURL.timesheetLeave + "?id=\(id)"
    ...
    func postTimesheetLeave(_ params: Parameters, completion: @escaping (_ result: Response?, _ error: NSError?) -> Void) {
        
        APIClient.manager.request(apiURL.timesheetLeave, method: .post, parameters: params, encoding: JSONEncoding.default, headers: getAuthHeaders())
            .validate()
    ...
    func putTimesheetLeave(_ id: Int, params: Parameters, completion: @escaping (_ success: Bool, _ error: NSError?) -> Void) {
        let path = apiURL.timesheetLeave + "?id=\(id)"
    ...
    func deleteTimesheetLeave(_ id: Int, completion: @escaping (_ success: Bool, _ error: NSError?) -> Void) {
        let path = apiURL.timesheetLeave + "?id=\(id)"
