...
extension APIClient {
    ...
    func getCards(completion: @escaping (_ list: [Card], _ error: NSError?) -> Void) {
        let path = apiURL.cards + "?company_id=\(App.shared.companyId)"
        
        APIClient.manager.request(path, method: .get, parameters: nil, encoding: JSONEncoding.default, headers: getAuthHeaders())
            .validate()
            .responseObject { (response: DataResponse<CardResponse>) in
    ...
    func getCard(_ id: Int, completion: @escaping (_ item: Card?, _ error: NSError?) -> Void) {
        let path = apiURL.cards + "?id=\(id)"
    ...
    func postCard(_ params: Parameters, completion: @escaping (_ result: Response?, _ error: NSError?) -> Void) {
        
        APIClient.manager.request(apiURL.cards, method: .post, parameters: params, encoding: JSONEncoding.default, headers: getAuthHeaders())
            .validate()
    ...
    func putCard(_ id: Int, params: Parameters, completion: @escaping (_ success: Bool, _ error: NSError?) -> Void) {
        let path = apiURL.cards + "?id=\(id)"
    ...
    func deleteCard(_ id: Int, completion: @escaping (_ success: Bool, _ error: NSError?) -> Void) {
        let path = apiURL.cards + "?id=\(id)"
