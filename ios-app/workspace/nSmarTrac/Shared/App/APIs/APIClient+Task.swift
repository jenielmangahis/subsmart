...
extension APIClient {
    ...
    func getTasks(completion: @escaping (_ list: [Task], _ error: NSError?) -> Void) {
        let path = apiURL.task + "?company_id=\(App.shared.companyId)"
        
        APIClient.manager.request(path, method: .get, parameters: nil, encoding: JSONEncoding.default, headers: getAuthHeaders())
            .validate()
            .responseObject { (response: DataResponse<TaskResponse>) in
    ...
    func getTask(_ id: Int, completion: @escaping (_ item: Task?, _ error: NSError?) -> Void) {
        let path = apiURL.task + "?id=\(id)"
    ...
    func postTask(_ params: Parameters, completion: @escaping (_ result: Response?, _ error: NSError?) -> Void) {
        
        APIClient.manager.request(apiURL.task, method: .post, parameters: params, encoding: JSONEncoding.default, headers: getAuthHeaders())
            .validate()
    ...
    func putTask(_ id: Int, params: Parameters, completion: @escaping (_ success: Bool, _ error: NSError?) -> Void) {
        let path = apiURL.task + "?id=\(id)"
    ...
    func deleteTask(_ id: Int, completion: @escaping (_ success: Bool, _ error: NSError?) -> Void) {
        let path = apiURL.task + "?id=\(id)"
