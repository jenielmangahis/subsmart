//
//  APIClient+TimesheetDepartments.swift
//  nSmarTrac
//
...
extension APIClient {
    ...
    func getTimesheetDepartments(completion: @escaping (_ list: [TimesheetDepartment], _ error: NSError?) -> Void) {
        let path = apiURL.timesheetDepartments + "?company_id=\(App.shared.companyId)"
        
        APIClient.manager.request(path, method: .get, parameters: nil, encoding: JSONEncoding.default, headers: getAuthHeaders())
            .validate()
            .responseObject { (response: DataResponse<TimesheetDepartmentResponse>) in
    ...
    func getTimesheetDepartment(_ id: Int, completion: @escaping (_ item: TimesheetDepartment?, _ error: NSError?) -> Void) {
        let path = apiURL.timesheetDepartments + "?id=\(id)"
    ...
    func postTimesheetDepartment(_ params: Parameters, completion: @escaping (_ result: Response?, _ error: NSError?) -> Void) {
        
        APIClient.manager.request(apiURL.timesheetDepartments, method: .post, parameters: params, encoding: JSONEncoding.default, headers: getAuthHeaders())
            .validate()
    ...
    func putTimesheetDepartment(_ id: Int, params: Parameters, completion: @escaping (_ success: Bool, _ error: NSError?) -> Void) {
        let path = apiURL.timesheetDepartments + "?id=\(id)"
    ...
    func deleteTimesheetDepartment(_ id: Int, completion: @escaping (_ success: Bool, _ error: NSError?) -> Void) {
        let path = apiURL.timesheetDepartments + "?id=\(id)"
