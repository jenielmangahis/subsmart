...
extension APIClient {
    ...
    func getEstimates(completion: @escaping (_ list: [Estimate], _ error: NSError?) -> Void) {
        let path = apiURL.estimates + "?company_id=\(App.shared.companyId)"
        
        APIClient.manager.request(path, method: .get, parameters: nil, encoding: JSONEncoding.default, headers: getAuthHeaders())
            .validate()
            .responseObject { (response: DataResponse<EstimateResponse>) in
    ...
    func getEstimate(_ id: Int, completion: @escaping (_ item: Estimate?, _ error: NSError?) -> Void) {
        let path = apiURL.estimates + "?id=\(id)"
    ...
    func postEstimate(_ params: Parameters, completion: @escaping (_ result: Response?, _ error: NSError?) -> Void) {
        
        APIClient.manager.request(apiURL.estimates, method: .post, parameters: params, encoding: JSONEncoding.default, headers: getAuthHeaders())
            .validate()
    ...
    func putEstimate(_ id: Int, params: Parameters, flag: String = "", completion: @escaping (_ success: Bool, _ error: NSError?) -> Void) {
        let path = apiURL.estimates + "?id=\(id)&flag=\(flag)"
    ...
    func deleteEstimate(_ id: Int, completion: @escaping (_ success: Bool, _ error: NSError?) -> Void) {
        let path = apiURL.estimates + "?id=\(id)"
    ...
    func uploadEstimatePhoto(_ image: UIImage, imageName: String, params: Parameters, completion: @escaping (_ success: Bool, _ error: NSError?) -> Void) {
        ...
        APIClient.manager.upload(multipartFormData: { multipartFormData in
            multipartFormData.append(imageData!, withName: "file", fileName: imageName, mimeType: "image/jpg")
                        ...
                        to: baseURL + "UploadEstimatePhoto.php",
                        method: .post,
    ...
    func uploadEstimateSignature(_ image: UIImage, imageName: String, params: Parameters, completion: @escaping (_ success: Bool, _ error: NSError?) -> Void) {
        ...
        APIClient.manager.upload(multipartFormData: { multipartFormData in
            multipartFormData.append(imageData!, withName: "file", fileName: imageName, mimeType: "image/jpg")
                        ...
                        usingThreshold: UInt64.init(),
                        to: baseURL + "UploadEstimateSignature.php",
                        method: .post,
                        headers: getUploadHeaders()) { (result) in
                            switch result {
                            case .success(let upload, _, _):
