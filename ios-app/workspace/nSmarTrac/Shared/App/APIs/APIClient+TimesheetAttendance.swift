//
//  APIClient+TimesheetAttendance.swift
//  nSmarTrac
//
...
extension APIClient {
    ...
    func getTimesheetAttendances(completion: @escaping (_ list: [TimesheetAttendance], _ error: NSError?) -> Void) {
        let path = apiURL.timesheetAttendance + "?user_id=\(App.shared.user!.id)"
        
        APIClient.manager.request(path, method: .get, parameters: nil, encoding: JSONEncoding.default, headers: getAuthHeaders())
            .validate()
            .responseObject { (response: DataResponse<TimesheetAttendanceResponse>) in
    ...
    func getTimesheetAttendance(_ id: Int, completion: @escaping (_ item: TimesheetAttendance?, _ error: NSError?) -> Void) {
        let path = apiURL.timesheetAttendance + "?id=\(id)"
    ...
    func postTimesheetAttendance(_ params: Parameters, completion: @escaping (_ result: Response?, _ error: NSError?) -> Void) {
        
        APIClient.manager.request(apiURL.timesheetAttendance, method: .post, parameters: params, encoding: JSONEncoding.default, headers: getAuthHeaders())
            .validate()
    ...
    func putTimesheetAttendance(_ id: Int, params: Parameters, completion: @escaping (_ success: Bool, _ error: NSError?) -> Void) {
        let path = apiURL.timesheetAttendance + "?id=\(id)"
    ...
    func deleteTimesheetAttendance(_ id: Int, completion: @escaping (_ success: Bool, _ error: NSError?) -> Void) {
        let path = apiURL.timesheetAttendance + "?id=\(id)"
