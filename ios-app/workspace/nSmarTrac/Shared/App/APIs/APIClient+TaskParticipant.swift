//
//  APIClient+TaskParticipant.swift
//  nSmarTrac
//
...
extension APIClient {
    ...
    func getTaskParticipants(_ taskId: Int, completion: @escaping (_ list: [TaskParticipant], _ error: NSError?) -> Void) {
        let path = apiURL.taskParticipant + "?task_id=\(taskId)"
        
        APIClient.manager.request(path, method: .get, parameters: nil, encoding: JSONEncoding.default, headers: getAuthHeaders())
            .validate()
            .responseObject { (response: DataResponse<TaskParticipantResponse>) in
    ...
    func postTaskParticipant(_ params: Parameters, completion: @escaping (_ result: Response?, _ error: NSError?) -> Void) {
        
        APIClient.manager.request(apiURL.taskParticipant, method: .post, parameters: params, encoding: JSONEncoding.default, headers: getAuthHeaders())
            .validate()
    ...
    func putTaskParticipant(_ id: Int, params: Parameters, completion: @escaping (_ success: Bool, _ error: NSError?) -> Void) {
        let path = apiURL.taskParticipant + "?id=\(id)"
    ...
    func deleteTaskParticipant(_ id: Int, completion: @escaping (_ success: Bool, _ error: NSError?) -> Void) {
        let path = apiURL.taskParticipant + "?id=\(id)"
