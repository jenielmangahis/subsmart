...
extension APIClient {
    ...
    func getTimesheetLogs(completion: @escaping (_ list: [TimesheetLog], _ error: NSError?) -> Void) {
        let path = apiURL.timesheetLogs + "?user_id=\(App.shared.user!.id)"
        
        APIClient.manager.request(path, method: .get, parameters: nil, encoding: JSONEncoding.default, headers: getAuthHeaders())
            .validate()
            .responseObject { (response: DataResponse<TimesheetLogResponse>) in
    ...
    func getTimesheetLog(_ id: Int, completion: @escaping (_ item: TimesheetLog?, _ error: NSError?) -> Void) {
        let path = apiURL.timesheetLogs + "?id=\(id)"
    ...
    func postTimesheetLog(_ params: Parameters, completion: @escaping (_ result: Response?, _ error: NSError?) -> Void) {
        
        APIClient.manager.request(apiURL.timesheetLogs, method: .post, parameters: params, encoding: JSONEncoding.default, headers: getAuthHeaders())
            .validate()
    ...
    func putTimesheetLog(_ id: Int, params: Parameters, completion: @escaping (_ success: Bool, _ error: NSError?) -> Void) {
        let path = apiURL.timesheetLogs + "?id=\(id)"
    ...
    func deleteTimesheetLog(_ id: Int, completion: @escaping (_ success: Bool, _ error: NSError?) -> Void) {
        let path = apiURL.timesheetLogs + "?id=\(id)"
