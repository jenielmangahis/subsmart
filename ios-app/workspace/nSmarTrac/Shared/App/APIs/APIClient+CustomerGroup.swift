...
extension APIClient {
    ...
    func getCustomerGroups(completion: @escaping (_ list: [CustomerGroup], _ error: NSError?) -> Void) {
        let path = apiURL.customerGroup + "?company_id=\(App.shared.companyId)"
        
        APIClient.manager.request(path, method: .get, parameters: nil, encoding: JSONEncoding.default, headers: getAuthHeaders())
            .validate()
            .responseObject { (response: DataResponse<CustomerGroupResponse>) in
    ...
    func getCustomerGroup(_ id: Int, completion: @escaping (_ item: CustomerGroup?, _ error: NSError?) -> Void) {
        let path = apiURL.customerGroup + "?id=\(id)"
    ...
    func postCustomerGroup(_ params: Parameters, completion: @escaping (_ result: Response?, _ error: NSError?) -> Void) {
        
        APIClient.manager.request(apiURL.customerGroup, method: .post, parameters: params, encoding: JSONEncoding.default, headers: getAuthHeaders())
            .validate()
    ...
    func putCustomerGroup(_ id: Int, params: Parameters, completion: @escaping (_ success: Bool, _ error: NSError?) -> Void) {
        let path = apiURL.customerGroup + "?id=\(id)"
    ...
    func deleteCustomerGroup(_ id: Int, completion: @escaping (_ success: Bool, _ error: NSError?) -> Void) {
        let path = apiURL.customerGroup + "?id=\(id)"
