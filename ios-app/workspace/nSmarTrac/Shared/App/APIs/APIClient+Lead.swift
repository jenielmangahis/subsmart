...
extension APIClient {
    ...
    func getLeads(completion: @escaping (_ list: [Lead], _ error: NSError?) -> Void) {
        let path = apiURL.lead + "?company_id=\(App.shared.companyId)"
        
        APIClient.manager.request(path, method: .get, parameters: nil, encoding: JSONEncoding.default, headers: getAuthHeaders())
            .validate()
            .responseObject { (response: DataResponse<LeadResponse>) in
    ...
    func getLead(_ id: Int, completion: @escaping (_ item: Lead?, _ error: NSError?) -> Void) {
        let path = apiURL.lead + "?id=\(id)"
    ...
    func postLead(_ params: Parameters, completion: @escaping (_ result: Response?, _ error: NSError?) -> Void) {
        
        APIClient.manager.request(apiURL.lead, method: .post, parameters: params, encoding: JSONEncoding.default, headers: getAuthHeaders())
            .validate()
    ...
    func putLead(_ id: Int, params: Parameters, completion: @escaping (_ success: Bool, _ error: NSError?) -> Void) {
        let path = apiURL.lead + "?id=\(id)"
    ...
    func deleteLead(_ id: Int, completion: @escaping (_ success: Bool, _ error: NSError?) -> Void) {
        let path = apiURL.lead + "?id=\(id)"
