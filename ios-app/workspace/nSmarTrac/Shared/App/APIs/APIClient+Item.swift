...
extension APIClient {
    ...
    func getItems(completion: @escaping (_ list: [Item], _ error: NSError?) -> Void) {
        let path = apiURL.item + "?company_id=\(App.shared.companyId)"
    ...
    func getItem(_ id: Int, completion: @escaping (_ item: Item?, _ error: NSError?) -> Void) {
        let path = apiURL.item + "?id=\(id)"
    ...
    func postItem(_ params: Parameters, completion: @escaping (_ result: Response?, _ error: NSError?) -> Void) {
        
        APIClient.manager.request(apiURL.item, method: .post, parameters: params, encoding: JSONEncoding.default, headers: getAuthHeaders())
            .validate()
    ...
    func putItem(_ id: Int, params: Parameters, completion: @escaping (_ success: Bool, _ error: NSError?) -> Void) {
        let path = apiURL.item + "?id=\(id)"
    ...
    func deleteItem(_ id: Int, completion: @escaping (_ success: Bool, _ error: NSError?) -> Void) {
        let path = apiURL.item + "?id=\(id)"
