//
//  APIClient+WorkOrderTypes.swift
//  nSmarTrac
//
...
extension APIClient {
    ...
    func getWorkOrderTypes(completion: @escaping (_ list: [WorkOrderType], _ error: NSError?) -> Void) {
        let path = apiURL.workOrderTypes + "?company_id=\(App.shared.companyId)"
        
        APIClient.manager.request(path, method: .get, parameters: nil, encoding: JSONEncoding.default, headers: getAuthHeaders())
            .validate()
            .responseObject { (response: DataResponse<WorkOrderTypeResponse>) in
    ...
    func getWorkOrderType(_ id: Int, completion: @escaping (_ item: WorkOrderType?, _ error: NSError?) -> Void) {
        let path = apiURL.workOrderTypes + "?id=\(id)"
    ...
    func postWorkOrderType(_ params: Parameters, completion: @escaping (_ result: Response?, _ error: NSError?) -> Void) {
        
        APIClient.manager.request(apiURL.workOrderTypes, method: .post, parameters: params, encoding: JSONEncoding.default, headers: getAuthHeaders())
            .validate()
    ...
    func putWorkOrderType(_ id: Int, params: Parameters, completion: @escaping (_ success: Bool, _ error: NSError?) -> Void) {
        let path = apiURL.workOrderTypes + "?id=\(id)"
    ...
    func deleteWorkOrderType(_ id: Int, completion: @escaping (_ success: Bool, _ error: NSError?) -> Void) {
        let path = apiURL.workOrderTypes + "?id=\(id)"
