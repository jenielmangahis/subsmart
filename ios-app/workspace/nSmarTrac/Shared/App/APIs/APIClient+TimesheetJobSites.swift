//
//  APIClient+TimesheetJobSites.swift
//  nSmarTrac
//
...
extension APIClient {
    ...
    func getTimesheetJobSites(completion: @escaping (_ list: [TimesheetJobSite], _ error: NSError?) -> Void) {
        let path = apiURL.timesheetJobSites + "?company_id=\(App.shared.companyId)"
        
        APIClient.manager.request(path, method: .get, parameters: nil, encoding: JSONEncoding.default, headers: getAuthHeaders())
            .validate()
            .responseObject { (response: DataResponse<TimesheetJobSiteResponse>) in
    ...
    func getTimesheetJobSite(_ id: Int, completion: @escaping (_ item: TimesheetJobSite?, _ error: NSError?) -> Void) {
        let path = apiURL.timesheetJobSites + "?id=\(id)"
    ...
    func postTimesheetJobSite(_ params: Parameters, completion: @escaping (_ result: Response?, _ error: NSError?) -> Void) {
        
        APIClient.manager.request(apiURL.timesheetJobSites, method: .post, parameters: params, encoding: JSONEncoding.default, headers: getAuthHeaders())
            .validate()
    ...
    func putTimesheetJobSite(_ id: Int, params: Parameters, completion: @escaping (_ success: Bool, _ error: NSError?) -> Void) {
        let path = apiURL.timesheetJobSites + "?id=\(id)"
    ...
    func deleteTimesheetJobSite(_ id: Int, completion: @escaping (_ success: Bool, _ error: NSError?) -> Void) {
        let path = apiURL.timesheetJobSites + "?id=\(id)"
