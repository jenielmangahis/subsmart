...
extension APIClient {
    ...
    func getPayments(completion: @escaping (_ list: [Payment], _ error: NSError?) -> Void) {
        let path = apiURL.payments + "?company_id=\(App.shared.companyId)"
        
        APIClient.manager.request(path, method: .get, parameters: nil, encoding: JSONEncoding.default, headers: getAuthHeaders())
            .validate()
            .responseObject { (response: DataResponse<PaymentResponse>) in
    ...
    func getPayment(_ id: Int, completion: @escaping (_ item: Payment?, _ error: NSError?) -> Void) {
        let path = apiURL.payments + "?id=\(id)"
    ...
    func postPayment(_ params: Parameters, completion: @escaping (_ result: Response?, _ error: NSError?) -> Void) {
        
        APIClient.manager.request(apiURL.payments, method: .post, parameters: params, encoding: JSONEncoding.default, headers: getAuthHeaders())
            .validate()
    ...
    func putPayment(_ id: Int, params: Parameters, completion: @escaping (_ success: Bool, _ error: NSError?) -> Void) {
        let path = apiURL.payments + "?id=\(id)"
    ...
    func deletePayment(_ id: Int, completion: @escaping (_ success: Bool, _ error: NSError?) -> Void) {
        let path = apiURL.payments + "?id=\(id)"
