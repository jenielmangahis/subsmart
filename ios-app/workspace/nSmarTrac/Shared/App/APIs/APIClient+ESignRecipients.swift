//
//  APIClient+ESignRecipients.swift
//  nSmarTrac
//
...
extension APIClient {
    ...
    func getESignRecipients(_ id: Int, completion: @escaping (_ list: [ESignRecipient], _ error: NSError?) -> Void) {
        let path = apiURL.eSignRecipients + "?id=\(id)"
        
        APIClient.manager.request(path, method: .get, parameters: nil, encoding: JSONEncoding.default, headers: getAuthHeaders())
            .validate()
            .responseObject { (response: DataResponse<ESignRecipientResponse>) in
    ...
    func getESignRecipient(_ id: Int, completion: @escaping (_ item: ESignRecipient?, _ error: NSError?) -> Void) {
        let path = apiURL.eSignRecipients + "?id=\(id)"
    ...
    func postESignRecipient(_ params: Parameters, completion: @escaping (_ result: Response?, _ error: NSError?) -> Void) {
        
        APIClient.manager.request(apiURL.eSignRecipients, method: .post, parameters: params, encoding: JSONEncoding.default, headers: getAuthHeaders())
            .validate()
    ...
    func putESignRecipient(_ id: Int, params: Parameters, completion: @escaping (_ success: Bool, _ error: NSError?) -> Void) {
        let path = apiURL.eSignRecipients + "?id=\(id)"
    ...
    func deleteESignRecipient(_ id: Int, completion: @escaping (_ success: Bool, _ error: NSError?) -> Void) {
        let path = apiURL.eSignRecipients + "?id=\(id)"
