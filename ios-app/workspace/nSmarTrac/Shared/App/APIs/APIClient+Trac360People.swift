...
extension APIClient {
    ...
    func getTrac360Peoples(_ circle_id: Int, completion: @escaping (_ list: [Trac360People], _ error: NSError?) -> Void) {
        let path = apiURL.trac360People + "?circle_id=\(circle_id)"
        
        APIClient.manager.request(path, method: .get, parameters: nil, encoding: JSONEncoding.default, headers: getAuthHeaders())
            .validate()
            .responseObject { (response: DataResponse<Trac360PeopleResponse>) in
    ...
    func getTrac360People(_ id: Int, completion: @escaping (_ item: Trac360People?, _ error: NSError?) -> Void) {
        let path = apiURL.trac360People + "?id=\(id)"
    ...
    func postTrac360People(_ params: Parameters, completion: @escaping (_ result: Response?, _ error: NSError?) -> Void) {
        
        APIClient.manager.request(apiURL.trac360People, method: .post, parameters: params, encoding: JSONEncoding.default, headers: getAuthHeaders())
            .validate()
    ...
    func putTrac360People(_ id: Int, params: Parameters, completion: @escaping (_ success: Bool, _ error: NSError?) -> Void) {
        let path = apiURL.trac360People + "?id=\(id)"
    ...
    func deleteTrac360People(_ id: Int, completion: @escaping (_ success: Bool, _ error: NSError?) -> Void) {
        let path = apiURL.trac360People + "?id=\(id)"
