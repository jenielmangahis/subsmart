//
//  APIClient+CustomerSource.swift
//  nSmarTrac
//
...
extension APIClient {
    ...
    func getCustomerSources(completion: @escaping (_ list: [CustomerSource], _ error: NSError?) -> Void) {
        let path = apiURL.customerSource + "?company_id=\(App.shared.companyId)"
        
        APIClient.manager.request(path, method: .get, parameters: nil, encoding: JSONEncoding.default, headers: getAuthHeaders())
            .validate()
            .responseObject { (response: DataResponse<CustomerSourceResponse>) in
    ...
    func getCustomerSource(_ id: Int, completion: @escaping (_ item: CustomerSource?, _ error: NSError?) -> Void) {
        let path = apiURL.customerSource + "?id=\(id)"
    ...
    func postCustomerSource(_ params: Parameters, completion: @escaping (_ result: Response?, _ error: NSError?) -> Void) {
        
        APIClient.manager.request(apiURL.customerSource, method: .post, parameters: params, encoding: JSONEncoding.default, headers: getAuthHeaders())
            .validate()
    ...
    func putCustomerSource(_ id: Int, params: Parameters, completion: @escaping (_ success: Bool, _ error: NSError?) -> Void) {
        let path = apiURL.customerSource + "?id=\(id)"
    ...
    func deleteCustomerSource(_ id: Int, completion: @escaping (_ success: Bool, _ error: NSError?) -> Void) {
        let path = apiURL.customerSource + "?id=\(id)"
