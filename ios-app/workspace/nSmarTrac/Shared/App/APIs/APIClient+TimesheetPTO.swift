...
extension APIClient {
    ...
    func getTimesheetPTOs(completion: @escaping (_ list: [TimesheetPTO], _ error: NSError?) -> Void) {
        let path = apiURL.timesheetPTO + "?company_id=\(App.shared.companyId)"
        
        APIClient.manager.request(path, method: .get, parameters: nil, encoding: JSONEncoding.default, headers: getAuthHeaders())
            .validate()
            .responseObject { (response: DataResponse<TimesheetPTOResponse>) in
    ...
    func getTimesheetPTO(_ id: Int, completion: @escaping (_ item: TimesheetPTO?, _ error: NSError?) -> Void) {
        let path = apiURL.timesheetPTO + "?id=\(id)"
    ...
    func postTimesheetPTO(_ params: Parameters, completion: @escaping (_ result: Response?, _ error: NSError?) -> Void) {
        
        APIClient.manager.request(apiURL.timesheetPTO, method: .post, parameters: params, encoding: JSONEncoding.default, headers: getAuthHeaders())
            .validate()
    ...
    func putTimesheetPTO(_ id: Int, params: Parameters, completion: @escaping (_ success: Bool, _ error: NSError?) -> Void) {
        let path = apiURL.timesheetPTO + "?id=\(id)"
    ...
    func deleteTimesheetPTO(_ id: Int, completion: @escaping (_ success: Bool, _ error: NSError?) -> Void) {
        let path = apiURL.timesheetPTO + "?id=\(id)"
