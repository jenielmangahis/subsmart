...
extension APIClient {
    ...
    func getItemLocations(_ itemId: Int, completion: @escaping (_ list: [ItemLocation], _ error: NSError?) -> Void) {
        let path = apiURL.itemLocation + "?item_id=\(itemId)"
        
        APIClient.manager.request(path, method: .get, parameters: nil, encoding: JSONEncoding.default, headers: getAuthHeaders())
            .validate()
            .responseObject { (response: DataResponse<ItemLocationResponse>) in
    ...
    func postItemLocation(_ params: Parameters, completion: @escaping (_ result: Response?, _ error: NSError?) -> Void) {
        
        APIClient.manager.request(apiURL.itemLocation, method: .post, parameters: params, encoding: JSONEncoding.default, headers: getAuthHeaders())
            .validate()
    ...
    func putItemLocation(_ id: Int, params: Parameters, completion: @escaping (_ success: Bool, _ error: NSError?) -> Void) {
        let path = apiURL.itemLocation + "?id=\(id)"
    ...
    func deleteItemLocation(_ id: Int, completion: @escaping (_ success: Bool, _ error: NSError?) -> Void) {
        let path = apiURL.itemLocation + "?id=\(id)"
