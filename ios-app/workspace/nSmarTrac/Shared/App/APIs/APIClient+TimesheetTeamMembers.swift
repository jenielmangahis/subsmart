//
//  APIClient+TimesheetTeamMembers.swift
//  nSmarTrac
//
...
extension APIClient {
    ...
    func getTimesheetTeamMembers(_ status: String = "", completion: @escaping (_ list: [TimesheetTeamMember], _ error: NSError?) -> Void) {
        let path = apiURL.timesheetTeamMembers + "?company_id=\(App.shared.companyId)&status=\(status)"
    ...
    func getTimesheetTeamMember(_ id: Int, completion: @escaping (_ item: TimesheetTeamMember?, _ error: NSError?) -> Void) {
        let path = apiURL.timesheetTeamMembers + "?id=\(id)"
    ...
    func postTimesheetTeamMember(_ params: Parameters, completion: @escaping (_ result: Response?, _ error: NSError?) -> Void) {
        
        APIClient.manager.request(apiURL.timesheetTeamMembers, method: .post, parameters: params, encoding: JSONEncoding.default, headers: getAuthHeaders())
            .validate()
    ...
    func putTimesheetTeamMember(_ id: Int, params: Parameters, completion: @escaping (_ success: Bool, _ error: NSError?) -> Void) {
        let path = apiURL.timesheetTeamMembers + "?id=\(id)"
    ...
    func deleteTimesheetTeamMember(_ id: Int, completion: @escaping (_ success: Bool, _ error: NSError?) -> Void) {
        let path = apiURL.timesheetTeamMembers + "?id=\(id)"
