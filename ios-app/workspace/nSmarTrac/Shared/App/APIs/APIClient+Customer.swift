...
extension APIClient {
    ...
    func getCustomers(completion: @escaping (_ list: [Customer], _ error: NSError?) -> Void) {
        let path = apiURL.customer + "?company_id=\(App.shared.companyId)"
        
        APIClient.manager.request(path, method: .get, parameters: nil, encoding: JSONEncoding.default, headers: getAuthHeaders())
            .validate()
            .responseObject { (response: DataResponse<CustomerResponse>) in
    ...
    func getCustomer(_ id: Int, completion: @escaping (_ item: Customer?, _ error: NSError?) -> Void) {
        let path = apiURL.customer + "?id=\(id)"
    ...
    func postCustomer(_ params: Parameters, completion: @escaping (_ result: Response?, _ error: NSError?) -> Void) {
        
        APIClient.manager.request(apiURL.customer, method: .post, parameters: params, encoding: JSONEncoding.default, headers: getAuthHeaders())
            .validate()
    ...
    func putCustomer(_ id: Int, params: Parameters, flag: String = "", completion: @escaping (_ success: Bool, _ error: NSError?) -> Void) {
        let path = apiURL.customer + "?id=\(id)&flag=\(flag)"
    ...
    func deleteCustomer(_ id: Int, completion: @escaping (_ success: Bool, _ error: NSError?) -> Void) {
        let path = apiURL.customer + "?id=\(id)"
