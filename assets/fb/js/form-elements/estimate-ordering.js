class EstimateOrdering extends FormElement {
    ...
    getElement() {
        ...
        element_container.content += `${this.initTable()}
                                        ...
                                        <button class="btn btn-sm form-btn d-inline" onclick="${this.addOption}" id="addBtn-2283 type="button">Add Another Option</button>
                                        <button class="btn btn-sm form-btn d-inline" onclick="${this.addBulkOption}" id="addBtn-2283 type="button">Add Options in Bulk</button>
                                    </div>
                                    <div class="row">
