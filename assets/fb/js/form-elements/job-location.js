class JobLocation extends FormElement {
    ...
    getElement() {
        ...
        element_container.content += `
                <div class="input-group-append">
                    <button class="btn btn-sm form-btn" onclick="toggleAddCustomer(${this.id})" id="addBtn-${this.id} type="button">Add Job Location</button>
                </div>
            </div>
        `
