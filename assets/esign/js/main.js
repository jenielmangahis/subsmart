...
const renderPage = (num, status) => {
  ...
  if(status == 1)
  {
    ...
    $('#main-pdf-render-preview').append('<div class="drawer-wrapper ng-scope"><br> <div class="documentPage ng-scope">'+
      '<canvas class="document-page-preview" id="pdf-render-'+num+'-preview" style="width: 100%;" ></canvas>'
      +'<div class="bar-action"> </div><div class="column-indicators"></div><span class="pageNumber ng-binding">Page '+num+'</span></div>');
