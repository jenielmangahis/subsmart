...
function getDocusingTemplates() {
  ...
  $.ajax({
    type: 'GET',
    url: base_url + 'Docusign/apiTemplates',
    success: function({ data }) {
            ...
            <tbody>
                <tr class="node" isfolder="0">
                  <td isfolder="0" style="position: relative;">
                    ...
                    <button class="btn btn-sm btn-secondary btn-action" style="position: absolute;">Use Template</button>
                  </td>
                  <td style="width: 85%" class="pl-2">
                    <div>
