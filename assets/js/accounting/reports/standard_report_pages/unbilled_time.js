...
$('#filter-activity-date-from, #filter-activity-date-to').on('change', function() {
...
$('#run-report').on('click', function(e) {
    ...
    url += groupBy !== 'customer' ? `group-by=${groupBy}&` : '';
...
$('#filter-customer, #filter-employee, #filter-product-service').on('change', function() {
    if($(this).val() !== 'all') {
...
$('#run-report-button').on('click', function() {
    $('#filter-time-activity-date').val($('#time-activity-date').val()).trigger('change');
    if($('#time-activity-date').val() !== 'all-dates') {
        $('#filter-time-activity-date-from').val($('#time-activity-date-from').val());
        $('#filter-time-activity-date-to').val($('#time-activity-date-to').val());
    }
    ...
    url += $('#custom-group-by').val() !== 'customer' ? `group-by=${$('#custom-group-by').val()}&` : '';
    ...
    url += $('#show-report-title').prop('checked') && $('#report-title').val() !== 'Unbilled time' ? `report-title=${$('#report-title').val()}&` : '';
...
$('input[name="col_chk"]').on('change', function() {
    ...
    if(groupBy !== 'none') {
        ...
        if($($('#reports-table thead tr td:visible:not([data-name=""])')[0]).data().name === 'Balance') {
            ...
            $('#reports-table tbody tr[data-bs-toggle="collapse"] td[data-name="Balance"], #reports-table tbody tr.group-total td[data-name="Balance"]').hide();
            $('#reports-table tbody tr[data-bs-toggle="collapse"] td:first-child, #reports-table tbody tr.group-total td:first-child').attr('colspan', 0);
            ...
            $('#print_report_modal tbody tr.group-header td[data-name="Balance"], #print_report_modal tbody tr.group-total td[data-name="Balance"]').hide();
            $('#print_report_modal tbody tr.group-header td:first-child, #print_report_modal tbody tr.group-total td:first-child').attr('colspan', 0);
            ...
            $('#print_preview_report_modal tbody tr.group-header td[data-name="Balance"], #print_preview_report_modal tbody tr.group-total td[data-name="Balance"]').hide();
            $('#print_preview_report_modal tbody tr.group-header td:first-child, #print_preview_report_modal tbody tr.group-total td:first-child').attr('colspan', 0);
        }
    
        if($($('#reports-table thead tr td:visible:not([data-name=""])')[0]).data().name === 'Taxable') {
            $('#reports-table thead tr td[data-name=""]').remove();
            $('#reports-table tbody tr:not([data-bs-toggle="collapse"], .group-total).collapse td[data-name=""]').remove();
    
            $('#reports-table tbody tr[data-bs-toggle="collapse"] td[data-name="Taxable"], #reports-table tbody tr.group-total td[data-name="Taxable"]').hide();
            $('#reports-table tbody tr[data-bs-toggle="collapse"] td:first-child, #reports-table tbody tr.group-total td:first-child').attr('colspan', 0);
    
            $('#print_report_modal thead tr:last-child td[data-name=""]').remove();
            $('#print_report_modal tbody tr:not(.group-header, .group-total) td[data-name=""]').remove();
    
            $('#print_report_modal tbody tr.group-header td[data-name="Taxable"], #print_report_modal tbody tr.group-total td[data-name="Taxable"]').hide();
            $('#print_report_modal tbody tr.group-header td:first-child, #print_report_modal tbody tr.group-total td:first-child').attr('colspan', 0);
            ...
            $('#print_preview_report_modal tbody tr.group-header td[data-name="Taxable"], #print_preview_report_modal tbody tr.group-total td[data-name="Taxable"]').hide();
            $('#print_preview_report_modal tbody tr.group-header td:first-child, #print_preview_report_modal tbody tr.group-total td:first-child').attr('colspan', 0);
        }
    
        if($($('#reports-table thead tr td:visible')[0]).data().name === '' && $($('#reports-table thead tr td:visible')[1]).index() < $('#reports-table thead tr td[data-name="Duration"]').index() ||
        $($('#reports-table thead tr td:visible')[0]).data().name !== '') {
            ...
            $('#reports-table thead tr td:visible').each(function() {
                ...
                if(name === 'Duration' || name === 'Taxable' || name === 'Amount' || name === 'Balance') {
                    return false;
                } else {
                    colspan++;
                }
