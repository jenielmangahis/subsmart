...
$('#run-report').on('click', function(e) {
    ...
    url += filterDate !== 'this-year-to-date' ? `date=${filterDate}&` : '';
    url += filterDate !== 'this-year-to-date' && filterDate !== 'all-dates' ? `from=${$('#filter-report-period-from').val().replaceAll('/', '-')}&to=${$('#filter-report-period-to').val().replaceAll('/', '-')}&` : '';
...
$('#run-report-button').on('click', function() {
    ...
    var url = `${base_url}accounting/reports/view-report/${reportId}?`;
    url += filterDate !== 'this-year-to-date' ? `date=${filterDate}&` : '';
    url += filterDate !== 'this-year-to-date' ? `from=${$('#report-period-date-from').val().replaceAll('/', '-')}&to=${$('#report-period-date-to').val().replaceAll('/', '-')}&` : '';
