...
$('#run-report').on('click', function(e) {
    ...
    url += groupBy !== 'template-type' ? `group-by=${groupBy}&` : '';
...
$('#filter-create-date, #filter-last-modified-date, #filter-end-date').on('change', function() {
...
$('#filter-transaction-type, #filter-distribution-account, #filter-account, #filter-name, #filter-payment-method').on('change', function() {
    if($(this).val() !== 'all') {
        $(`#allow-${$(this).attr('id')}`).prop('checked', true);
    } else {
        $(`#allow-${$(this).attr('id')}`).prop('checked', false);
...
$('#filter-memo, #filter-amount, #filter-template-name').on('change', function() {
    if($(this).val().trim() !== '') {
        $(`#allow-${$(this).attr('id')}`).prop('checked', true);
    } else {
        $(`#allow-${$(this).attr('id')}`).prop('checked', false);
...
$('#run-report-button').on('click', function() {
    ...
    url += $('#allow-filter-end-date').prop('checked') && $('#filter-end-date').val() !== 'all-dates' ? `end-date=${$('#filter-end-date').val()}&` : '';
    url += $('#allow-filter-end-date').prop('checked') && $('#filter-end-date').val() !== 'all-dates' ? `end-date-from=${$('#filter-end-date-from').val().replaceAll('/', '-')}&` : '';
    url += $('#allow-filter-end-date').prop('checked') && $('#filter-end-date').val() !== 'all-dates' ? `end-date-to=${$('#filter-end-date-to').val().replaceAll('/', '-')}&` : '';
    ...
    url += $('#allow-filter-template-name').prop('checked') && $('#filter-template-name').val().trim() !== '' ? `template-name=${$('#filter-template-name').val().trim()}&` : '';
    ...
    url += $('#show-report-title').prop('checked') && $('#report-title').val() !== 'Recurring Template List' ? `report-title=${$('#report-title').val()}&` : '';
