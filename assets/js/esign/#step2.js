                ...
                <div class="dropdown table-management">
                  <button class="btn btn-default dropdown-toggle" type="button" id="dropdownMenuTools" data-toggle="dropdown" aria-haspopup="true" aria-expanded="true">
                    ...
                    <ul class="dropdown-menu" aria-labelledby="dropdownMenuTools">
                        ...
                        .join("")}
                        <li><a href="javascript:void(0);" class="dropdown-item"><i class="bx bxs-key"></i>Add access authentication</a></li>
                        <li><a href="javascript:void(0);" class="dropdown-item"><i class="bx bx-comment-detail"></i>Add private message</a></li>
                    </ul>
                </div>
            </div>
        </div>
