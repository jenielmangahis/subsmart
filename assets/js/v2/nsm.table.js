$(document).ready(function () {
    $(".nsm-table").each(function () {
        let _table = $(this); // Scope to the current table
        ...
        console.log("Head Columns Data Names:", _headCols.map(function () {
        ...
        $(document).on("click", ".nsm-pagination .page-link", function (e) {
            ...
            $(".nsm-row-collapse").each(function (e) {
