$(document).ready(function() {
    ...
    $("#add-timeslots-row").click(function() {
        ...
        var markup = '';
        click++
        markup += '<tr id="tr_'+click+'" class="row-time">';
            ...
            markup += '<td width="" style="text-align:center;">';
    ...
    $(".category-edit").click(function(){
        ...
        var msg = '<span class="spinner-border spinner-border-sm m-0"></span>';
            ...
            $.ajax({
               ...
               success: function(o)
               {
                    ...
                    if(obj.is_success == true) {
                        ...
                        $(".ajax-alert-container").html('<div class="row dashboard-container-1"><div class="col-md-12"><div class="alert alert-danger"><button type="button" class="close" data-dismiss="alert">&times</button>Error Updating Visible Status</div></div></div>');
                    }                  
               }
            });            
        } else {
...
$(".add-custom-field").click(function(){
    ...
    //Left Pane
    var col1 = '<td width="60%">'+fieldNameValue+' <input type="hidden" id="is_field['+fieldName+'][]" name="is_field['+fieldName+'][]" value="'+fieldNameValue+'" /> </td>';
    var col2 = '<td width="20%"><div class="checkbox checkbox-sm"><input type="checkbox" checked="" name="is_visible['+fieldName+'][]" value="1" class="checkbox-select select-form-field-visible" data-field-name="'+fieldName+'" id="is_visible_'+fieldName+'"><label for="is_visible_'+fieldName+'"></label></td>';
