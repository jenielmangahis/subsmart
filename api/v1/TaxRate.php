...
function DELETE_ALL() {
    ...
    $delete = $db->executeQuery("delete from tax_rates");
...
function DELETE($id) {
    ...
    $db = new database_handler();
    $delete = $db->executeQuery("delete from tax_rates where id = $id");
...
function GET($id) {
    // curl
    $db = new database_handler();
    $rows = $db->fetchAll("select * from tax_rates where company_id = $id");
...
function INSERT() {
    ...
    $db = new database_handler();
    $insert = $db->insertQuery($params, "tax_rates");
...
function UPDATE($id) {
    ...
    $db = new database_handler();
    $update = $db->updateQuery($params,'tax_rates', $id,'id');
