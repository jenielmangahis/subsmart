...
function DELETE_ALL() {
    ...
    $delete = $db->executeQuery("delete from credit_cards");
...
function DELETE($id) {
    ...
    $db = new database_handler();
    $delete = $db->executeQuery("delete from credit_cards where id = $id");
...
function GET($id) {
    // curl
    $db = new database_handler();
    $rows = $db->fetchAll("select * from credit_cards where company_id = $id");
...
function INSERT() {
    ...
    $db = new database_handler();
    $insert = $db->insertQuery($params, "credit_cards");
...
function UPDATE($id) {
    ...
    $db = new database_handler();
    $update = $db->updateQuery($params,'credit_cards', $id,'id');
