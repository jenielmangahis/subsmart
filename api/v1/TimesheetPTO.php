...
function DELETE_ALL() {
    ...
    $delete = $db->executeQuery("delete from timesheet_pto");
...
function DELETE($id) {
    ...
    $db = new database_handler();
    $delete = $db->executeQuery("delete from timesheet_pto where id = $id");
...
function GET($id, $flag = "ALL") {
    // curl
    $db = new database_handler();
    $rows = $db->fetchAll("select * from timesheet_pto where company_id = $id");

    if ($flag == "ONE") {
        $rows = $db->fetchAll("select * from timesheet_pto where id = $id");
    }
...
function INSERT() {
    ...
    $db = new database_handler();
    $insert = $db->insertQuery($params, "timesheet_pto");
...
function UPDATE($id) {
    ...
    $db = new database_handler();
    $update = $db->updateQuery($params,'timesheet_pto', $id,'id');
