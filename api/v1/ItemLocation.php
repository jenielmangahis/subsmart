...
function DELETE_ALL() {
    ...
    $delete = $db->executeQuery("delete from items_has_storage_loc");
...
function DELETE($id) {
    ...
    $db = new database_handler();
    $delete = $db->executeQuery("delete from items_has_storage_loc where id = $id");
...
function GET($id) {
    // curl
    $db = new database_handler();
    $rows = $db->fetchAll("select id, name, qty from items_has_storage_loc where item_id = $id");
...
function INSERT() {
    ...
    $db = new database_handler();
    $insert = $db->insertQuery($params, "items_has_storage_loc");
...
function UPDATE($id) {
    ...
    $db = new database_handler();
    $update = $db->updateQuery($params,'items_has_storage_loc', $id,'id');
