...
function DELETE_ALL() {
    ...
    $delete = $db->executeQuery("delete from customer_groups");
...
function DELETE($id) {
    ...
    $db = new database_handler();
    $delete = $db->executeQuery("delete from customer_groups where id = $id");
...
function GET($id) {
    // curl
    $db = new database_handler();
    $rows = $db->fetchAll("select * from customer_groups where company_id = $id");
...
function INSERT() {
    ...
    $db = new database_handler();
    $insert = $db->insertQuery($params, "customer_groups");
...
function UPDATE($id) {
    ...
    $db = new database_handler();
    $update = $db->updateQuery($params,'customer_groups', $id,'id');
