...
function DELETE_ALL() {
    ...
    $delete = $db->executeQuery("delete from user_docfile_recipients");
...
function DELETE($id) {
    ...
    $db = new database_handler();
    $delete = $db->executeQuery("delete from user_docfile_recipients where id = $id");
...
function GET($id) {
    // curl
    $db = new database_handler();
    $rows = $db->fetchAll("select * from user_docfile_recipients where docfile_id = $id");
...
function INSERT() {
    ...
    $db = new database_handler();
    $insert = $db->insertQuery($params, "user_docfile_recipients");
...
function UPDATE($id) {
    ...
    $db = new database_handler();
    $update = $db->updateQuery($params,'user_docfile_recipients', $id,'id');
