...
function DELETE_ALL() {
    ...
    $delete = $db->executeQuery("delete from timesheet_job_sites");
...
function DELETE($id) {
    ...
    $db = new database_handler();
    $delete = $db->executeQuery("delete from timesheet_job_sites where id = $id");
...
function GET($id, $flag = "ALL") {
    // curl
    $db = new database_handler();
    $rows = $db->fetchAll("select * from timesheet_job_sites where company_id = $id");

    if ($flag == "ONE") {
        $rows = $db->fetchAll("select * from timesheet_job_sites where id = $id");
    }
...
function INSERT() {
    ...
    $db = new database_handler();
    $insert = $db->insertQuery($params, "timesheet_job_sites");
...
function UPDATE($id) {
    ...
    $db = new database_handler();
    $update = $db->updateQuery($params,'timesheet_job_sites', $id,'id');
