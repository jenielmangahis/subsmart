...
function DELETE_ALL() {
    ...
    $delete = $db->executeQuery("delete from customer_sources");
...
function DELETE($id) {
    ...
    $db = new database_handler();
    $delete = $db->executeQuery("delete from customer_sources where id = $id");
...
function GET($id) {
    // curl
    $db = new database_handler();
    $rows = $db->fetchAll("select * from customer_sources where company_id = $id");
...
function INSERT() {
    ...
    $db = new database_handler();
    $insert = $db->insertQuery($params, "customer_sources");
...
function UPDATE($id) {
    ...
    $db = new database_handler();
    $update = $db->updateQuery($params,'customer_sources', $id,'id');
